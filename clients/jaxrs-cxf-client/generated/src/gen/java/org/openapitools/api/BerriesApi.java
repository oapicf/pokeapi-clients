...
public interface BerriesApi  {
    ...
    @ApiOperation(value = "List berry firmness", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get berry by firmness", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/berry-flavor/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List berry flavors", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get berries by flavor", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/berry/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List berries", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/berry/{id}/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get a berry", tags={  })
    @ApiResponses(value = { 
