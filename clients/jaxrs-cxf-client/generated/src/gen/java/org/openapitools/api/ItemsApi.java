...
public interface ItemsApi  {
    ...
    @ApiOperation(value = "List item attributes", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get item attribute", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/item-category/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List item categories", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get item category", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List item fling effects", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get item fling effect", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/item/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List items", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/item-pocket/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List item pockets", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/item-pocket/{id}/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get item pocket", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/item/{id}/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get item", tags={  })
    @ApiResponses(value = { 
