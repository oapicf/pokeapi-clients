...
public interface MovesApi  {
    ...
    @ApiOperation(value = "List move meta ailments", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get move meta ailment", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List move battle styles", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get move battle style", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/move-category/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List move meta categories", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get move meta category", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List move learn methods", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get move learn method", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/move/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List moves", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/move/{id}/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get move", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/move-target/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List move targets", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/move-target/{id}/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get move target", tags={  })
    @ApiResponses(value = { 
