...
public interface LocationApi  {
    ...
    @ApiOperation(value = "List location areas", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get location area", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/location/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List locations", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/location/{id}/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get location", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/pal-park-area/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List pal park areas", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get pal park area", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/region/")
    @Produces({ "application/json" })
    @ApiOperation(value = "List regions", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/region/{id}/")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get region", tags={  })
    @ApiResponses(value = { 
