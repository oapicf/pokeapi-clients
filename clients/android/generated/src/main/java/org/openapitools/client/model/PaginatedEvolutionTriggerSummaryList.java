...
import java.net.URI;
import java.util.*;
import org.openapitools.client.model.EvolutionTriggerSummary;
...
public class PaginatedEvolutionTriggerSummaryList {
  ...
  public boolean equals(Object o) {
    ...
    return (this.count == null ? paginatedEvolutionTriggerSummaryList.count == null : this.count.equals(paginatedEvolutionTriggerSummaryList.count)) &&
        (this.next == null ? paginatedEvolutionTriggerSummaryList.next == null : this.next.equals(paginatedEvolutionTriggerSummaryList.next)) &&
        (this.previous == null ? paginatedEvolutionTriggerSummaryList.previous == null : this.previous.equals(paginatedEvolutionTriggerSummaryList.previous)) &&
        (this.results == null ? paginatedEvolutionTriggerSummaryList.results == null : this.results.equals(paginatedEvolutionTriggerSummaryList.results));
  }
