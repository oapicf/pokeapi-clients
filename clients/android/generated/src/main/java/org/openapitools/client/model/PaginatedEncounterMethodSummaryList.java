...
import java.net.URI;
import java.util.*;
import org.openapitools.client.model.EncounterMethodSummary;
...
public class PaginatedEncounterMethodSummaryList {
  ...
  public boolean equals(Object o) {
    ...
    return (this.count == null ? paginatedEncounterMethodSummaryList.count == null : this.count.equals(paginatedEncounterMethodSummaryList.count)) &&
        (this.next == null ? paginatedEncounterMethodSummaryList.next == null : this.next.equals(paginatedEncounterMethodSummaryList.next)) &&
        (this.previous == null ? paginatedEncounterMethodSummaryList.previous == null : this.previous.equals(paginatedEncounterMethodSummaryList.previous)) &&
        (this.results == null ? paginatedEncounterMethodSummaryList.results == null : this.results.equals(paginatedEncounterMethodSummaryList.results));
  }
