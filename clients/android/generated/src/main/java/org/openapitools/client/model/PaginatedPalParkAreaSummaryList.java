...
import java.net.URI;
import java.util.*;
import org.openapitools.client.model.PalParkAreaSummary;
...
public class PaginatedPalParkAreaSummaryList {
  ...
  public boolean equals(Object o) {
    ...
    return (this.count == null ? paginatedPalParkAreaSummaryList.count == null : this.count.equals(paginatedPalParkAreaSummaryList.count)) &&
        (this.next == null ? paginatedPalParkAreaSummaryList.next == null : this.next.equals(paginatedPalParkAreaSummaryList.next)) &&
        (this.previous == null ? paginatedPalParkAreaSummaryList.previous == null : this.previous.equals(paginatedPalParkAreaSummaryList.previous)) &&
        (this.results == null ? paginatedPalParkAreaSummaryList.results == null : this.results.equals(paginatedPalParkAreaSummaryList.results));
  }
