...
class PokemonSpeciesController extends Controller
{
    ...
    public function __construct(
        private readonly PokemonSpeciesApiInterface $api,
    ...
    public function pokemonSpeciesList(Request $request): JsonResponse
    {
        ...
        try {
            $apiResult = $this->api->pokemonSpeciesList($limit, $offset);
     ...
     *
     */
    public function pokemonSpeciesRead(Request $request, int $id): JsonResponse
    {
        $validator = Validator::make(
            array_merge(
                [
        ...
        try {
            $apiResult = $this->api->pokemonSpeciesRead($id);
        } catch (\Exception $exception) {
            // This shouldn't happen
            return response()->json(['error' => $exception->getMessage()], 500);
        }
