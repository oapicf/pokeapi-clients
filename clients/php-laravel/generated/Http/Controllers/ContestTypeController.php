...
class ContestTypeController extends Controller
{
    ...
    public function __construct(
        private readonly ContestTypeApiInterface $api,
    ...
    public function contestTypeList(Request $request): JsonResponse
    {
        ...
        $apiResult = $this->api->contestTypeList($limit, $offset);
     ...
     *
     */
    public function contestTypeRead(Request $request, int $id): JsonResponse
    {
        $validator = Validator::make(
            array_merge(
                [
        ...
        $apiResult = $this->api->contestTypeRead($id);
