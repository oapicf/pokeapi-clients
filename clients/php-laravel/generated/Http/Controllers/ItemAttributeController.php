...
class ItemAttributeController extends Controller
{
    ...
    public function __construct(
        private readonly ItemAttributeApiInterface $api,
    ...
    public function itemAttributeList(Request $request): JsonResponse
    {
        ...
        $apiResult = $this->api->itemAttributeList($limit, $offset);
     ...
     *
     */
    public function itemAttributeRead(Request $request, int $id): JsonResponse
    {
        $validator = Validator::make(
            array_merge(
                [
        ...
        $apiResult = $this->api->itemAttributeRead($id);
