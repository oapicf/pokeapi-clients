...
class EggGroupController extends Controller
{
    ...
    public function __construct(
        private readonly EggGroupApiInterface $api,
    ...
    public function eggGroupList(Request $request): JsonResponse
    {
        ...
        try {
            $apiResult = $this->api->eggGroupList($limit, $offset);
     ...
     *
     */
    public function eggGroupRead(Request $request, int $id): JsonResponse
    {
        $validator = Validator::make(
            array_merge(
                [
        ...
        try {
            $apiResult = $this->api->eggGroupRead($id);
        } catch (\Exception $exception) {
            // This shouldn't happen
            return response()->json(['error' => $exception->getMessage()], 500);
        }
