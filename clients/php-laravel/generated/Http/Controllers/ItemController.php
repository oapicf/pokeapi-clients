...
class ItemController extends Controller
{
    ...
    public function __construct(
        private readonly ItemApiInterface $api,
    ...
    public function itemList(Request $request): JsonResponse
    {
        ...
        $apiResult = $this->api->itemList($limit, $offset);
     ...
     *
     */
    public function itemRead(Request $request, int $id): JsonResponse
    {
        $validator = Validator::make(
            array_merge(
                [
        ...
        $apiResult = $this->api->itemRead($id);
