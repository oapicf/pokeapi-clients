...
var routes = Routes{
...

	{
		"ContestEffectRead",
		http.MethodGet,
		"/api/v2/api/v2/contest-effect/:id/",
		ContestEffectRead,
	},
...

	{
		...
		http.MethodGet,
		"/api/v2/api/v2/encounter-condition/:id/",
		EncounterConditionRead,
	},
...

	{
		"PokemonSpeciesRead",
		http.MethodGet,
		"/api/v2/api/v2/pokemon-species/:id/",
		PokemonSpeciesRead,
	},
...

	{
		"VersionGroupRead",
		http.MethodGet,
		"/api/v2/api/v2/version-group/:id/",
		VersionGroupRead,
	},
}
