...
class EncounterConditionValueApi {
    ...
    def encounterConditionValueList ( Integer limit, Integer offset, Closure onSuccess, Closure onFailure)  {
    ...
    def encounterConditionValueRead ( Integer id, Closure onSuccess, Closure onFailure)  {
