...
export class LocationAreaDetailPokemonEncountersInnerVersionDetailsInner {
    ...
    static getAttributeTypeMap() {
        return LocationAreaDetailPokemonEncountersInnerVersionDetailsInner.attributeTypeMap;
    }
