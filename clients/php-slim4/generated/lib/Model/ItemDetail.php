...
{
  "required" : [ "attributes", "baby_trigger_for", "category", "effect_entries", "flavor_text_entries", "fling_effect", "game_indices", "held_by_pokemon", "id", "machines", "name", "names", "sprites" ],
  "properties" : {
    "id" : {
      "type" : "integer",
      "readOnly" : true
    ...
    "baby_trigger_for" : {
      "$ref" : "#/components/schemas/ItemDetail_baby_trigger_for"
    },
    "machines" : {
      "type" : "array",
      "items" : {
