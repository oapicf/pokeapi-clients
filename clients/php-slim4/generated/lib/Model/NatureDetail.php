 ...
 * @link    https://github.com/openapitools/openapi-generator
 */
class NatureDetail extends BaseModel
{
    /**
...
{
  "required" : [ "berries", "decreased_stat", "hates_flavor", "id", "increased_stat", "likes_flavor", "move_battle_style_preferences", "name", "names", "pokeathlon_stat_changes" ],
  "properties" : {
    "id" : {
      "type" : "integer",
      "readOnly" : true
