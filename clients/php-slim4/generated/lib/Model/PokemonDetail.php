 ...
 * @link    https://github.com/openapitools/openapi-generator
 */
class PokemonDetail extends BaseModel
{
    /**
...
{
  "required" : [ "abilities", "cries", "forms", "game_indices", "held_items", "id", "location_area_encounters", "moves", "name", "past_abilities", "past_types", "species", "sprites", "stats", "types" ],
  "properties" : {
    "id" : {
      "type" : "integer",
      "readOnly" : true
    ...
    "sprites" : {
      "$ref" : "#/components/schemas/PokemonDetail_sprites"
    },
    "cries" : {
      "$ref" : "#/components/schemas/PokemonDetail_cries"
    },
    "stats" : {
      "type" : "array",
      "items" : {
