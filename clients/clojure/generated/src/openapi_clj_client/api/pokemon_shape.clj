(ns openapi-clj-client.api.pokemon-shape
...
(defn-spec pokemon-shape-list string?
  ""
...
(defn-spec pokemon-shape-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec pokemon-shape-read string?
  ""
  [id int?]
  (let [res (:data (pokemon-shape-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
