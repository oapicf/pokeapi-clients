(ns openapi-clj-client.api.pokemon-habitat
...
(defn-spec pokemon-habitat-list string?
  ""
...
(defn-spec pokemon-habitat-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec pokemon-habitat-read string?
  ""
  [id int?]
  (let [res (:data (pokemon-habitat-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
