(ns openapi-clj-client.api.pokeathlon-stat
...
(defn-spec pokeathlon-stat-list string?
  ""
...
(defn-spec pokeathlon-stat-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec pokeathlon-stat-read string?
  ""
  [id int?]
  (let [res (:data (pokeathlon-stat-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
