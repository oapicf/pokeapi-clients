(ns openapi-clj-client.api.pokemon-color
...
(defn-spec pokemon-color-list string?
  ""
...
(defn-spec pokemon-color-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec pokemon-color-read string?
  ""
  [id int?]
  (let [res (:data (pokemon-color-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
