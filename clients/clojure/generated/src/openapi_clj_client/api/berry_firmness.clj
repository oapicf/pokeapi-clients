(ns openapi-clj-client.api.berry-firmness
...
(defn-spec berry-firmness-list string?
  ""
...
(defn-spec berry-firmness-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec berry-firmness-read string?
  ""
  [id int?]
  (let [res (:data (berry-firmness-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
