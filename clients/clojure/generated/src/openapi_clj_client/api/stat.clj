(ns openapi-clj-client.api.stat
...
(defn-spec stat-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec stat-read string?
  ""
  [id int?]
  (let [res (:data (stat-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
