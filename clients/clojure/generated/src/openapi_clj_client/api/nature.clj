(ns openapi-clj-client.api.nature
...
(defn-spec nature-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec nature-read string?
  ""
  [id int?]
  (let [res (:data (nature-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
