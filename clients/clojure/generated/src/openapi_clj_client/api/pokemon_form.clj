(ns openapi-clj-client.api.pokemon-form
...
(defn-spec pokemon-form-list string?
  ""
...
(defn-spec pokemon-form-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec pokemon-form-read string?
  ""
  [id int?]
  (let [res (:data (pokemon-form-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
