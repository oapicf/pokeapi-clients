(ns openapi-clj-client.api.pokemon
...
(defn-spec pokemon-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec pokemon-read string?
  ""
  [id int?]
  (let [res (:data (pokemon-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
