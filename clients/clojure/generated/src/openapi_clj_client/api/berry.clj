(ns openapi-clj-client.api.berry
...
(defn-spec berry-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec berry-read string?
  ""
  [id int?]
  (let [res (:data (berry-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
