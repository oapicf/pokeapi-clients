(ns openapi-clj-client.api.type
...
(defn-spec type-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec type-read string?
  ""
  [id int?]
  (let [res (:data (type-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
