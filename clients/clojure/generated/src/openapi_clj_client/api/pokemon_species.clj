(ns openapi-clj-client.api.pokemon-species
...
(defn-spec pokemon-species-list string?
  ""
...
(defn-spec pokemon-species-read-with-http-info any?
  ""
  [id int?]
...
(defn-spec pokemon-species-read string?
  ""
  [id int?]
  (let [res (:data (pokemon-species-read-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode string? res st/string-transformer)
       res)))
