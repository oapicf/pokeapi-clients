...
(defn-spec contest-effect-list-with-http-info any?
  "List contest effects
  Contest effects refer to the effects of moves when used in contests."
  ([] (contest-effect-list-with-http-info nil))
  ([{:keys [limit offset q]} (s/map-of keyword? any?)]
   (call-api "/api/v2/contest-effect/" :get
             {:path-params   {}
              :header-params {}
...
(defn-spec contest-effect-list paginated-contest-effect-summary-list-spec
  "List contest effects
  Contest effects refer to the effects of moves when used in contests."
  ([] (contest-effect-list nil))
  ([optional-params any?]
   (let [res (:data (contest-effect-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode paginated-contest-effect-summary-list-spec res st/string-transformer)
        res))))


(defn-spec contest-effect-retrieve-with-http-info any?
  "Get contest effect
  Contest effects refer to the effects of moves when used in contests."
  [id string?]
  (check-required-params id)
  (call-api "/api/v2/contest-effect/{id}/" :get
            {:path-params   {"id" id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec contest-effect-retrieve contest-effect-detail-spec
  "Get contest effect
  Contest effects refer to the effects of moves when used in contests."
  [id string?]
  (let [res (:data (contest-effect-retrieve-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode contest-effect-detail-spec res st/string-transformer)
       res)))
...
(defn-spec contest-type-list paginated-contest-type-summary-list-spec
  "List contest types
  Contest types are categories judges used to weigh a Pokémon's condition in Pokémon contests. Check out [Bulbapedia](http://bulbapedia.bulbagarden.net/wiki/Contest_condition) for greater detail."
  ...
  ([optional-params any?]
   (let [res (:data (contest-type-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode paginated-contest-type-summary-list-spec res st/string-transformer)
        res))))


(defn-spec contest-type-retrieve-with-http-info any?
  "Get contest type
  Contest types are categories judges used to weigh a Pokémon's condition in Pokémon contests. Check out [Bulbapedia](http://bulbapedia.bulbagarden.net/wiki/Contest_condition) for greater detail."
  [id string?]
  (check-required-params id)
...
(defn-spec contest-type-retrieve contest-type-detail-spec
  "Get contest type
  Contest types are categories judges used to weigh a Pokémon's condition in Pokémon contests. Check out [Bulbapedia](http://bulbapedia.bulbagarden.net/wiki/Contest_condition) for greater detail."
  [id string?]
  (let [res (:data (contest-type-retrieve-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode contest-type-detail-spec res st/string-transformer)
       res)))
...
(defn-spec super-contest-effect-list paginated-super-contest-effect-summary-list-spec
  "List super contest effects
  Super contest effects refer to the effects of moves when used in super contests."
  ...
  ([optional-params any?]
   (let [res (:data (super-contest-effect-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode paginated-super-contest-effect-summary-list-spec res st/string-transformer)
        res))))


(defn-spec super-contest-effect-retrieve-with-http-info any?
...
(defn-spec super-contest-effect-retrieve super-contest-effect-detail-spec
  "Get super contest effect
  Super contest effects refer to the effects of moves when used in super contests."
  [id string?]
  (let [res (:data (super-contest-effect-retrieve-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode super-contest-effect-detail-spec res st/string-transformer)
       res)))
