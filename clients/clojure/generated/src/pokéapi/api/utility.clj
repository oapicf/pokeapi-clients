...
(defn-spec language-list paginated-language-summary-list-spec
  "List languages
  Languages for translations of API resource information."
  ([] (language-list nil))
  ([optional-params any?]
   (let [res (:data (language-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode paginated-language-summary-list-spec res st/string-transformer)
        res))))


(defn-spec language-retrieve-with-http-info any?
  "Get language
  Languages for translations of API resource information."
  [id string?]
...
(defn-spec language-retrieve language-detail-spec
  "Get language
  Languages for translations of API resource information."
  [id string?]
  (let [res (:data (language-retrieve-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode language-detail-spec res st/string-transformer)
       res)))
