...
(defn-spec encounter-condition-list-with-http-info any?
  "List encounter conditions
  Conditions which affect what pokemon might appear in the wild, e.g., day or night."
  ([] (encounter-condition-list-with-http-info nil))
  ([{:keys [limit offset q]} (s/map-of keyword? any?)]
   (call-api "/api/v2/encounter-condition/" :get
             {:path-params   {}
              :header-params {}
...
(defn-spec encounter-condition-list paginated-encounter-condition-summary-list-spec
  "List encounter conditions
  Conditions which affect what pokemon might appear in the wild, e.g., day or night."
  ([] (encounter-condition-list nil))
  ([optional-params any?]
   (let [res (:data (encounter-condition-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode paginated-encounter-condition-summary-list-spec res st/string-transformer)
        res))))


(defn-spec encounter-condition-retrieve-with-http-info any?
  "Get encounter condition
  Conditions which affect what pokemon might appear in the wild, e.g., day or night."
  [id string?]
  (check-required-params id)
  (call-api "/api/v2/encounter-condition/{id}/" :get
            {:path-params   {"id" id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec encounter-condition-retrieve encounter-condition-detail-spec
  "Get encounter condition
  Conditions which affect what pokemon might appear in the wild, e.g., day or night."
  [id string?]
  (let [res (:data (encounter-condition-retrieve-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode encounter-condition-detail-spec res st/string-transformer)
       res)))
...
(defn-spec encounter-condition-value-list paginated-encounter-condition-value-summary-list-spec
  "List encounter condition values
  Encounter condition values are the various states that an encounter condition can have, i.e., time of day can be either day or night."
  ...
  ([optional-params any?]
   (let [res (:data (encounter-condition-value-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode paginated-encounter-condition-value-summary-list-spec res st/string-transformer)
        res))))


(defn-spec encounter-condition-value-retrieve-with-http-info any?
...
(defn-spec encounter-condition-value-retrieve encounter-condition-value-detail-spec
  "Get encounter condition value
  Encounter condition values are the various states that an encounter condition can have, i.e., time of day can be either day or night."
  [id string?]
  (let [res (:data (encounter-condition-value-retrieve-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode encounter-condition-value-detail-spec res st/string-transformer)
       res)))
...
(defn-spec encounter-method-list paginated-encounter-method-summary-list-spec
  "List encounter methods
  Methods by which the player might can encounter Pokémon in the wild, e.g., walking in tall grass. Check out Bulbapedia for greater detail."
  ...
  ([optional-params any?]
   (let [res (:data (encounter-method-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode paginated-encounter-method-summary-list-spec res st/string-transformer)
        res))))


(defn-spec encounter-method-retrieve-with-http-info any?
...
(defn-spec encounter-method-retrieve encounter-method-detail-spec
  "Get encounter method
  Methods by which the player might can encounter Pokémon in the wild, e.g., walking in tall grass. Check out Bulbapedia for greater detail."
  [id string?]
