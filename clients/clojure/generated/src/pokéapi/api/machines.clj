...
(defn-spec machine-list paginated-machine-summary-list-spec
  "List machines
  Machines are the representation of items that teach moves to Pokémon. They vary from version to version, so it is not certain that one specific TM or HM corresponds to a single Machine."
  ([] (machine-list nil))
  ([optional-params any?]
   (let [res (:data (machine-list-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode paginated-machine-summary-list-spec res st/string-transformer)
        res))))


(defn-spec machine-retrieve-with-http-info any?
  "Get machine
  Machines are the representation of items that teach moves to Pokémon. They vary from version to version, so it is not certain that one specific TM or HM corresponds to a single Machine."
  [id string?]
...
(defn-spec machine-retrieve machine-detail-spec
  "Get machine
  Machines are the representation of items that teach moves to Pokémon. They vary from version to version, so it is not certain that one specific TM or HM corresponds to a single Machine."
  [id string?]
  (let [res (:data (machine-retrieve-with-http-info id))]
    (if (:decode-models *api-context*)
       (st/decode machine-detail-spec res st/string-transformer)
       res)))
