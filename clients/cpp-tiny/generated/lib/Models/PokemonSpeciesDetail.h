...
#ifndef TINY_CPP_CLIENT_PokemonSpeciesDetail_H_
#define TINY_CPP_CLIENT_PokemonSpeciesDetail_H_
...
public:
    ...
    PokemonSpeciesDetail(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PokemonSpeciesDetail_H_ */
