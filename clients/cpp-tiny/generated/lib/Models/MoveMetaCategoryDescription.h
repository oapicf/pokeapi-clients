...
#ifndef TINY_CPP_CLIENT_MoveMetaCategoryDescription_H_
#define TINY_CPP_CLIENT_MoveMetaCategoryDescription_H_
...
public:
    ...
    MoveMetaCategoryDescription(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_MoveMetaCategoryDescription_H_ */
