...
#ifndef TINY_CPP_CLIENT_AbilityEffectText_H_
#define TINY_CPP_CLIENT_AbilityEffectText_H_
...
public:
	 ...
	 */
    AbilityEffectText();
    AbilityEffectText(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AbilityEffectText_H_ */
