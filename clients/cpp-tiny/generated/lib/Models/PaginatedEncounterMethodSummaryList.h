...
#ifndef TINY_CPP_CLIENT_PaginatedEncounterMethodSummaryList_H_
#define TINY_CPP_CLIENT_PaginatedEncounterMethodSummaryList_H_
...
public:
    ...
    PaginatedEncounterMethodSummaryList(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PaginatedEncounterMethodSummaryList_H_ */
