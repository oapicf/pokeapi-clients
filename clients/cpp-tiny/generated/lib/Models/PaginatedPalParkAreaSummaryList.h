...
#ifndef TINY_CPP_CLIENT_PaginatedPalParkAreaSummaryList_H_
#define TINY_CPP_CLIENT_PaginatedPalParkAreaSummaryList_H_
...
public:
    ...
    PaginatedPalParkAreaSummaryList(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PaginatedPalParkAreaSummaryList_H_ */
