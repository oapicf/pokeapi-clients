...
#ifndef TINY_CPP_CLIENT_MoveDamageClassDetail_H_
#define TINY_CPP_CLIENT_MoveDamageClassDetail_H_
...
public:
    ...
    MoveDamageClassDetail(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_MoveDamageClassDetail_H_ */
