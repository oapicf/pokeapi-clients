...
#ifndef TINY_CPP_CLIENT_PaginatedMoveTargetSummaryList_H_
#define TINY_CPP_CLIENT_PaginatedMoveTargetSummaryList_H_
...
public:
    ...
    PaginatedMoveTargetSummaryList(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PaginatedMoveTargetSummaryList_H_ */
