...
#ifndef TINY_CPP_CLIENT_PaginatedEncounterConditionSummaryList_H_
#define TINY_CPP_CLIENT_PaginatedEncounterConditionSummaryList_H_
...
public:
    ...
    PaginatedEncounterConditionSummaryList(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PaginatedEncounterConditionSummaryList_H_ */
