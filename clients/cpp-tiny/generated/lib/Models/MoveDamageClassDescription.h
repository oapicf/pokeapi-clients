...
#ifndef TINY_CPP_CLIENT_MoveDamageClassDescription_H_
#define TINY_CPP_CLIENT_MoveDamageClassDescription_H_
...
public:
    ...
    MoveDamageClassDescription(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_MoveDamageClassDescription_H_ */
