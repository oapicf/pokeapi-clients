...
#ifndef TINY_CPP_CLIENT_ItemAttributeDescription_H_
#define TINY_CPP_CLIENT_ItemAttributeDescription_H_
...
public:
    ...
    ItemAttributeDescription(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ItemAttributeDescription_H_ */
