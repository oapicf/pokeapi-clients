...
#ifndef TINY_CPP_CLIENT_AbilityFlavorText_H_
#define TINY_CPP_CLIENT_AbilityFlavorText_H_
...
public:
	 ...
	 */
    AbilityFlavorText();
    AbilityFlavorText(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AbilityFlavorText_H_ */
