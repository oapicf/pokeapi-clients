...
#ifndef TINY_CPP_CLIENT_PaginatedBerryFirmnessSummaryList_H_
#define TINY_CPP_CLIENT_PaginatedBerryFirmnessSummaryList_H_
...
public:
    ...
    PaginatedBerryFirmnessSummaryList(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_PaginatedBerryFirmnessSummaryList_H_ */
