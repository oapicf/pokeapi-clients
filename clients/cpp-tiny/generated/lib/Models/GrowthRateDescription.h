...
#ifndef TINY_CPP_CLIENT_GrowthRateDescription_H_
#define TINY_CPP_CLIENT_GrowthRateDescription_H_
...
public:
    ...
    GrowthRateDescription(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_GrowthRateDescription_H_ */
