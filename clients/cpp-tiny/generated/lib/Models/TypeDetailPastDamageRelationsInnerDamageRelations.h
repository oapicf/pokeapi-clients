...
#ifndef TINY_CPP_CLIENT_TypeDetail_past_damage_relations_inner_damage_relations_H_
#define TINY_CPP_CLIENT_TypeDetail_past_damage_relations_inner_damage_relations_H_
...
public:
    ...
    TypeDetail_past_damage_relations_inner_damage_relations(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~TypeDetail_past_damage_relations_inner_damage_relations();
...
#endif /* TINY_CPP_CLIENT_TypeDetail_past_damage_relations_inner_damage_relations_H_ */
