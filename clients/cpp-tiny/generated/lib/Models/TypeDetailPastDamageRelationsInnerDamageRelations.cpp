...
TypeDetail_past_damage_relations_inner_damage_relations::TypeDetail_past_damage_relations_inner_damage_relations(std::string jsonString)
{
...
void
TypeDetail_past_damage_relations_inner_damage_relations::fromJson(std::string jsonObj)
{
