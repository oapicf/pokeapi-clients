...
public class RegionApiControllerImp extends RegionApiControllerImpInterface {
    @Override
    public String regionList(Http.Request request, Integer limit, Integer offset) throws Exception {
        //Do your magic!!!
        return new String();
    }

    @Override
    public String regionRead(Http.Request request, Integer id) throws Exception {
        //Do your magic!!!
        return new String();
    }
