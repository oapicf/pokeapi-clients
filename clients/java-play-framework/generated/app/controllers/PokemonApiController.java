...
public class PokemonApiController extends Controller {
    ...
    public Result pokemonList(Http.Request request) throws Exception {
        ...
        return imp.pokemonListHttp(request, limit, offset);
    }

    @ApiAction
    public Result pokemonRead(Http.Request request, Integer id) throws Exception {
        return imp.pokemonReadHttp(request, id);
    }
