...
public class ItemPocketApiController extends Controller {
    ...
    @Inject
    private ItemPocketApiController(Config configuration, ItemPocketApiControllerImpInterface imp) {
        this.imp = imp;
    ...
    public Result itemPocketList(Http.Request request) throws Exception {
        ...
        return imp.itemPocketListHttp(request, limit, offset);
    }

    @ApiAction
    public Result itemPocketRead(Http.Request request, Integer id) throws Exception {
        return imp.itemPocketReadHttp(request, id);
    }
