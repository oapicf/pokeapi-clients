...
public class PalParkAreaApiController extends Controller {
    ...
    @Inject
    private PalParkAreaApiController(Config configuration, PalParkAreaApiControllerImpInterface imp) {
        this.imp = imp;
    ...
    public Result palParkAreaList(Http.Request request) throws Exception {
        ...
        return imp.palParkAreaListHttp(request, limit, offset);
    }

    @ApiAction
    public Result palParkAreaRead(Http.Request request, Integer id) throws Exception {
        return imp.palParkAreaReadHttp(request, id);
    }
