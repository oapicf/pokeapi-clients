...
public class LocationApiController extends Controller {
    ...
    public Result locationList(Http.Request request) throws Exception {
        ...
        return imp.locationListHttp(request, limit, offset);
    }

    @ApiAction
    public Result locationRead(Http.Request request, Integer id) throws Exception {
        return imp.locationReadHttp(request, id);
    }
