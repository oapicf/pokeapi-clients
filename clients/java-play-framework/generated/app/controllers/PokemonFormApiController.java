...
public class PokemonFormApiController extends Controller {
    ...
    @Inject
    private PokemonFormApiController(Config configuration, PokemonFormApiControllerImpInterface imp) {
        this.imp = imp;
    ...
    public Result pokemonFormList(Http.Request request) throws Exception {
        ...
        return imp.pokemonFormListHttp(request, limit, offset);
    }

    @ApiAction
    public Result pokemonFormRead(Http.Request request, Integer id) throws Exception {
        return imp.pokemonFormReadHttp(request, id);
    }
