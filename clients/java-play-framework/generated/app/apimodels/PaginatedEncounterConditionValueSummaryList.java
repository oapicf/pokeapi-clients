...
public class PaginatedEncounterConditionValueSummaryList   {
  ...
  private List<@Valid EncounterConditionValueSummary> results = null;
  ...
  **/
  ...
  public PaginatedEncounterConditionValueSummaryList results(List<@Valid EncounterConditionValueSummary> results) {
   ...
   * @return results
  **/
  public List<@Valid EncounterConditionValueSummary> getResults() {
    return results;
  }

  public void setResults(List<@Valid EncounterConditionValueSummary> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(count, paginatedEncounterConditionValueSummaryList.count) &&
        Objects.equals(next, paginatedEncounterConditionValueSummaryList.next) &&
        Objects.equals(previous, paginatedEncounterConditionValueSummaryList.previous) &&
        Objects.equals(results, paginatedEncounterConditionValueSummaryList.results);
  }
