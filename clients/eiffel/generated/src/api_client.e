...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {HTTP_BASIC_AUTH}, "basicAuth")
			is_basic_auth_configured := True 
			authentications.force (create {API_KEY_AUTH}.make ("query", "sessionid"), "cookieAuth")
			is_api_key_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://pokeapi.co"
			-- default base path.
