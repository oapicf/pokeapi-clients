...
**effect_entries** | [**LIST [MOVE_CHANGE_EFFECT_ENTRIES_INNER]**](MoveChange_effect_entries_inner.md) |  | [readonly] [default to null]
**effect_changes** | [**LIST [MOVE_DETAIL_EFFECT_CHANGES_INNER]**](MoveDetail_effect_changes_inner.md) |  | [readonly] [default to null]
**generation** | [**GENERATION_SUMMARY**](GenerationSummary.md) |  | [default to null]
**meta** | [**MOVE_META**](MoveMeta.md) |  | [readonly] [default to null]
**names** | [**LIST [MOVE_NAME]**](MoveName.md) |  | [readonly] [default to null]
**past_values** | [**LIST [MOVE_CHANGE]**](MoveChange.md) |  | [readonly] [default to null]
**stat_changes** | [**LIST [MOVE_DETAIL_STAT_CHANGES_INNER]**](MoveDetail_stat_changes_inner.md) |  | [readonly] [default to null]
...
**machines** | [**LIST [MOVE_DETAIL_MACHINES_INNER]**](MoveDetail_machines_inner.md) |  | [readonly] [default to null]
**flavor_text_entries** | [**LIST [MOVE_FLAVOR_TEXT]**](MoveFlavorText.md) |  | [readonly] [default to null]
**learned_by_pokemon** | [**LIST [ABILITY_DETAIL_POKEMON_INNER_POKEMON]**](AbilityDetail_pokemon_inner_pokemon.md) |  | [readonly] [default to null]
