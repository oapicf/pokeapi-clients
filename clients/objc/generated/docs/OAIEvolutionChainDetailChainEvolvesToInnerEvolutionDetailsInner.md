# OAIEvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner
...
**minBeauty** | **NSNumber*** |  | 
**minHappiness** | **NSNumber*** |  | 
**minLevel** | **NSNumber*** |  | 
**needsOverworldRain** | **NSNumber*** |  | 
**partySpecies** | **NSString*** |  | 
**partyType** | **NSString*** |  | 
**relativePhysicalStats** | **NSString*** |  | 
**timeOfDay** | **NSString*** |  | 
**tradeSpecies** | **NSString*** |  | 
**trigger** | [**OAIAbilityDetailPokemonInnerPokemon***](OAIAbilityDetailPokemonInnerPokemon.md) |  | 
**turnUpsideDown** | **NSNumber*** |  | 
