...
@interface OAIItemApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIItemApi

NSString* kOAIItemApiErrorDomain = @"OAIItemApiErrorDomain";
NSInteger kOAIItemApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) itemReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIItemApiErrorDomain code:kOAIItemApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
