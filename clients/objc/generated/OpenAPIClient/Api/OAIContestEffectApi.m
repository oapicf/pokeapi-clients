#import "OAIContestEffectApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAIContestEffectApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIContestEffectApi

NSString* kOAIContestEffectApiErrorDomain = @"OAIContestEffectApiErrorDomain";
NSInteger kOAIContestEffectApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) contestEffectReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIContestEffectApiErrorDomain code:kOAIContestEffectApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
