#import "OAILocationAreaApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAILocationAreaApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAILocationAreaApi

NSString* kOAILocationAreaApiErrorDomain = @"OAILocationAreaApiErrorDomain";
NSInteger kOAILocationAreaApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) locationAreaReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAILocationAreaApiErrorDomain code:kOAILocationAreaApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
