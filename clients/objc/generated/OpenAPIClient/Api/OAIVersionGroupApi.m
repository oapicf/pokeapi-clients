#import "OAIVersionGroupApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAIVersionGroupApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIVersionGroupApi

NSString* kOAIVersionGroupApiErrorDomain = @"OAIVersionGroupApiErrorDomain";
NSInteger kOAIVersionGroupApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) versionGroupReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIVersionGroupApiErrorDomain code:kOAIVersionGroupApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
