#import "OAIBerryFlavorApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAIBerryFlavorApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIBerryFlavorApi

NSString* kOAIBerryFlavorApiErrorDomain = @"OAIBerryFlavorApiErrorDomain";
NSInteger kOAIBerryFlavorApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) berryFlavorReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIBerryFlavorApiErrorDomain code:kOAIBerryFlavorApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
