#import "OAIPalParkAreaApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAIPalParkAreaApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIPalParkAreaApi

NSString* kOAIPalParkAreaApiErrorDomain = @"OAIPalParkAreaApiErrorDomain";
NSInteger kOAIPalParkAreaApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) palParkAreaReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIPalParkAreaApiErrorDomain code:kOAIPalParkAreaApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
