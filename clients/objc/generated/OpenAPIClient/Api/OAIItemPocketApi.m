#import "OAIItemPocketApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAIItemPocketApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIItemPocketApi

NSString* kOAIItemPocketApiErrorDomain = @"OAIItemPocketApiErrorDomain";
NSInteger kOAIItemPocketApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) itemPocketReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIItemPocketApiErrorDomain code:kOAIItemPocketApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
