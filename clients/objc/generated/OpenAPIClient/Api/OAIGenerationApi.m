#import "OAIGenerationApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAIGenerationApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIGenerationApi

NSString* kOAIGenerationApiErrorDomain = @"OAIGenerationApiErrorDomain";
NSInteger kOAIGenerationApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) generationReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIGenerationApiErrorDomain code:kOAIGenerationApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
