#import "OAIBerryFirmnessApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAIBerryFirmnessApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIBerryFirmnessApi

NSString* kOAIBerryFirmnessApiErrorDomain = @"OAIBerryFirmnessApiErrorDomain";
NSInteger kOAIBerryFirmnessApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) berryFirmnessReadWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIBerryFirmnessApiErrorDomain code:kOAIBerryFirmnessApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
