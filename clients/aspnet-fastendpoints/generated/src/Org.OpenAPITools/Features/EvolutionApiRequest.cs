...
public class EvolutionChainListRequest
{
    /// <summary>
...
public class EvolutionChainRetrieveRequest
{
    /// <summary>
...
public class EvolutionTriggerListRequest
{
    /// <summary>
    /// Number of results to return per page.
    /// </summary>
...
public class EvolutionTriggerRetrieveRequest
{
    /// <summary>
    /// This parameter can be a string or an integer.
    /// </summary>
