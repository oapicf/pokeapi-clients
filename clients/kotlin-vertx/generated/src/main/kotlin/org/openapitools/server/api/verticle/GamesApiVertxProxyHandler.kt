...
class GamesApiVertxProxyHandler(private val vertx: Vertx, private val service: GamesApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
            ...
            when (action) {
                ...
                "generationList" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.generationList(limit,offset,q,context)
                ...
                "generationRetrieve" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.generationRetrieve(id,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "pokedexList" -> {
                    ...
                    val q = ApiHandlerUtils.searchStringInJson(params,"q")
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.pokedexList(limit,offset,q,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "pokedexRetrieve" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.pokedexRetrieve(id,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "versionGroupList" -> {
                    ...
                    val q = ApiHandlerUtils.searchStringInJson(params,"q")
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.versionGroupList(limit,offset,q,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "versionGroupRetrieve" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.versionGroupRetrieve(id,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "versionList" -> {
                    ...
                    val q = ApiHandlerUtils.searchStringInJson(params,"q")
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.versionList(limit,offset,q,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
                ...
                "versionRetrieve" -> {
                    ...
                    GlobalScope.launch(vertx.dispatcher()){
                        val result = service.versionRetrieve(id,context)
                        val payload = JsonObject(Json.encode(result.payload)).toBuffer()
                        val res = OperationResponse(result.statusCode,result.statusMessage,payload,result.headers)
                        msg.reply(res.toJson())
                    }.invokeOnCompletion{
