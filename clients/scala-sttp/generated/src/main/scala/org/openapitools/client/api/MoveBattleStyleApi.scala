...
class MoveBattleStyleApi(baseUrl: String) {
   ...
   * @param offset 
   */
  def moveBattleStyleList(limit: Option[Int] = None, offset: Option[Int] = None
): Request[Either[Either[String, String], Unit], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/api/v2/move-battle-style/?limit=${ limit }&offset=${ offset }")
   ...
   * @param id 
   */
  def moveBattleStyleRead(id: Int
): Request[Either[Either[String, String], Unit], Any] =
    basicRequest
