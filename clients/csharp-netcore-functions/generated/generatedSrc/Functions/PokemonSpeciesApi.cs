...
{ 
    ...
    { 
        ...
        public async Task<IActionResult> _PokemonSpeciesList([HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "/api/v2/pokemon-species/")]HttpRequest req, ExecutionContext context)
        {
        ...
        public async Task<IActionResult> _PokemonSpeciesRead([HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "/api/v2/pokemon-species/{id}/")]HttpRequest req, ExecutionContext context, int id)
        {
