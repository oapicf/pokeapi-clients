...
{ 
    ...
    { 
        ...
        public async Task<IActionResult> _MoveTargetList([HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "/api/v2/move-target/")]HttpRequest req, ExecutionContext context)
        {
        ...
        public async Task<IActionResult> _MoveTargetRead([HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "/api/v2/move-target/{id}/")]HttpRequest req, ExecutionContext context, int id)
        {
