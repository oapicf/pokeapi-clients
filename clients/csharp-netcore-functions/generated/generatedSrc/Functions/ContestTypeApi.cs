...
{ 
    ...
    { 
        ...
        public async Task<IActionResult> _ContestTypeList([HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "/api/v2/contest-type/")]HttpRequest req, ExecutionContext context)
        {
        ...
        public async Task<IActionResult> _ContestTypeRead([HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "/api/v2/contest-type/{id}/")]HttpRequest req, ExecutionContext context, int id)
        {
