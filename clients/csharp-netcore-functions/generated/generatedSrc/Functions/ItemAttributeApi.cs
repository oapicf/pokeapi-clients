...
{ 
    ...
    { 
        ...
        public async Task<IActionResult> _ItemAttributeList([HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "/api/v2/item-attribute/")]HttpRequest req, ExecutionContext context)
        {
        ...
        public async Task<IActionResult> _ItemAttributeRead([HttpTrigger(AuthorizationLevel.Anonymous, "GET", Route = "/api/v2/item-attribute/{id}/")]HttpRequest req, ExecutionContext context, int id)
        {
