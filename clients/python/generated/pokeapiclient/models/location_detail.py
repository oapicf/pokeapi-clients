...
class LocationDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "names": [LocationName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None,
            "game_indices": [LocationGameIndex.from_dict(_item) for _item in obj["game_indices"]] if obj.get("game_indices") is not None else None,
            "areas": [LocationAreaSummary.from_dict(_item) for _item in obj["areas"]] if obj.get("areas") is not None else None
        })
        return _obj
