...
class GrowthRateDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "descriptions": [GrowthRateDescription.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None,
            "levels": [Experience.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None,
