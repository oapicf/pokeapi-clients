...
class ContestTypeDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "berry_flavor": BerryFlavorSummary.from_dict(obj["berry_flavor"]) if obj.get("berry_flavor") is not None else None,
            "names": [ContestTypeName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None
        })
        return _obj
