...
class EncounterConditionValueDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "condition": EncounterConditionSummary.from_dict(obj["condition"]) if obj.get("condition") is not None else None,
            "names": [EncounterConditionValueName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None
        })
        return _obj
