...
class PokeathlonStatDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "affecting_natures": PokeathlonStatDetailAffectingNatures.from_dict(obj["affecting_natures"]) if obj.get("affecting_natures") is not None else None,
            "names": [PokeathlonStatName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None
        })
        return _obj
