...
class ItemCategoryDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "names": [ItemCategoryName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None,
            "pocket": ItemPocketSummary.from_dict(obj["pocket"]) if obj.get("pocket") is not None else None
        })
        return _obj
