...
class MoveLearnMethodDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "names": [MoveLearnMethodName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None,
            "descriptions": [MoveLearnMethodDescription.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None,
