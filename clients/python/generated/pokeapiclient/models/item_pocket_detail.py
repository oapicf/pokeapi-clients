...
class ItemPocketDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "categories": [ItemCategorySummary.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
            "names": [ItemPocketName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None
        })
        return _obj
