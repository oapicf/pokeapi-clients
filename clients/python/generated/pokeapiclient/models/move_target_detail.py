...
class MoveTargetDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "descriptions": [MoveTargetDescription.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None,
            "moves": [MoveSummary.from_dict(_item) for _item in obj["moves"]] if obj.get("moves") is not None else None,
            "names": [MoveTargetName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None
        })
        return _obj
