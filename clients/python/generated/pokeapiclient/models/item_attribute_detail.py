...
class ItemAttributeDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "descriptions": [ItemAttributeDescription.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None,
            "items": [AbilityDetailPokemonInnerPokemon.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "names": [ItemAttributeName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None
        })
        return _obj
