...
class BerryFlavorDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "berries": [BerryFlavorDetailBerriesInner.from_dict(_item) for _item in obj["berries"]] if obj.get("berries") is not None else None,
            "contest_type": ContestTypeSummary.from_dict(obj["contest_type"]) if obj.get("contest_type") is not None else None,
            "names": [BerryFlavorName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None
        })
        return _obj
