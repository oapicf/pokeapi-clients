...
class StatDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "affecting_moves": StatDetailAffectingMoves.from_dict(obj["affecting_moves"]) if obj.get("affecting_moves") is not None else None,
            "affecting_natures": StatDetailAffectingNatures.from_dict(obj["affecting_natures"]) if obj.get("affecting_natures") is not None else None,
            "characteristics": [CharacteristicSummary.from_dict(_item) for _item in obj["characteristics"]] if obj.get("characteristics") is not None else None,
            ...
            "names": [StatName.from_dict(_item) for _item in obj["names"]] if obj.get("names") is not None else None
        })
        return _obj
