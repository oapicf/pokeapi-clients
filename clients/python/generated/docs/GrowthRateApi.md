...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    api_instance = pokeapiclient.GrowthRateApi(api_client)
    limit = 56 # int |  (optional)
    offset = 56 # int |  (optional)

    try:
        api_response = api_instance.growth_rate_list(limit=limit, offset=offset)
        print("The response of GrowthRateApi->growth_rate_list:\n")
        pprint(api_response)
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GrowthRateApi->growth_rate_read:\n")
        pprint(api_response)
    except Exception as e:
