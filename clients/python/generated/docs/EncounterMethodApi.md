...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    api_instance = pokeapiclient.EncounterMethodApi(api_client)
    limit = 56 # int |  (optional)
    offset = 56 # int |  (optional)

    try:
        api_response = api_instance.encounter_method_list(limit=limit, offset=offset)
        print("The response of EncounterMethodApi->encounter_method_list:\n")
        pprint(api_response)
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EncounterMethodApi->encounter_method_read:\n")
        pprint(api_response)
    except Exception as e:
