...
# **move_list**
> str move_list(limit=limit, offset=offset)
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    api_instance = pokeapiclient.MoveApi(api_client)
    limit = 56 # int |  (optional)
    offset = 56 # int |  (optional)

    try:
        api_response = api_instance.move_list(limit=limit, offset=offset)
        print("The response of MoveApi->move_list:\n")
        pprint(api_response)
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MoveApi->move_read:\n")
        pprint(api_response)
    except Exception as e:
