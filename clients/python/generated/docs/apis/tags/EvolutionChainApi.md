<a name="__pageTop"></a>
# pokeapiclient.apis.tags.evolution_chain_api.EvolutionChainApi

All URIs are relative to *https://pokeapi.co*

Method | HTTP request | Description
------------- | ------------- | -------------
[**evolution_chain_list**](#evolution_chain_list) | **get** /api/v2/evolution-chain/ | 
[**evolution_chain_read**](#evolution_chain_read) | **get** /api/v2/evolution-chain/{id}/ | 
...
from pokeapiclient.apis.tags import evolution_chain_api
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.evolution_chain_list(
...
default | [ApiResponseForDefault](#evolution_chain_list.ApiResponseForDefault) | Default response

#### evolution_chain_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.evolution_chain_read(
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
decimal.Decimal, int,  | decimal.Decimal,  | A unique integer value identifying this evolution chain. | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
default | [ApiResponseForDefault](#evolution_chain_read.ApiResponseForDefault) | Default response

#### evolution_chain_read.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyTextPlain, ] |  |
