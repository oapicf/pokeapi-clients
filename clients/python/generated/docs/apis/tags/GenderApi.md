<a name="__pageTop"></a>
# pokeapiclient.apis.tags.gender_api.GenderApi

All URIs are relative to *https://pokeapi.co*

Method | HTTP request | Description
------------- | ------------- | -------------
[**gender_list**](#gender_list) | **get** /api/v2/gender/ | 
[**gender_read**](#gender_read) | **get** /api/v2/gender/{id}/ | 
...
from pokeapiclient.apis.tags import gender_api
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.gender_list(
...
default | [ApiResponseForDefault](#gender_list.ApiResponseForDefault) | Default response

#### gender_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.gender_read(
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
decimal.Decimal, int,  | decimal.Decimal,  | A unique integer value identifying this gender. | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
default | [ApiResponseForDefault](#gender_read.ApiResponseForDefault) | Default response

#### gender_read.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyTextPlain, ] |  |
