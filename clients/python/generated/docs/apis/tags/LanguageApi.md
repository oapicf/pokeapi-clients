<a name="__pageTop"></a>
# pokeapiclient.apis.tags.language_api.LanguageApi

All URIs are relative to *https://pokeapi.co*

Method | HTTP request | Description
------------- | ------------- | -------------
[**language_list**](#language_list) | **get** /api/v2/language/ | 
[**language_read**](#language_read) | **get** /api/v2/language/{id}/ | 
...
from pokeapiclient.apis.tags import language_api
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.language_list(
...
default | [ApiResponseForDefault](#language_list.ApiResponseForDefault) | Default response

#### language_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.language_read(
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
decimal.Decimal, int,  | decimal.Decimal,  | A unique integer value identifying this language. | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
default | [ApiResponseForDefault](#language_read.ApiResponseForDefault) | Default response

#### language_read.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyTextPlain, ] |  |
