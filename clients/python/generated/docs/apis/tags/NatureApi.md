<a name="__pageTop"></a>
# pokeapiclient.apis.tags.nature_api.NatureApi

All URIs are relative to *https://pokeapi.co*

Method | HTTP request | Description
------------- | ------------- | -------------
[**nature_list**](#nature_list) | **get** /api/v2/nature/ | 
[**nature_read**](#nature_read) | **get** /api/v2/nature/{id}/ | 
...
from pokeapiclient.apis.tags import nature_api
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.nature_list(
...
default | [ApiResponseForDefault](#nature_list.ApiResponseForDefault) | Default response

#### nature_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.nature_read(
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
decimal.Decimal, int,  | decimal.Decimal,  | A unique integer value identifying this nature. | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
default | [ApiResponseForDefault](#nature_read.ApiResponseForDefault) | Default response

#### nature_read.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyTextPlain, ] |  |
