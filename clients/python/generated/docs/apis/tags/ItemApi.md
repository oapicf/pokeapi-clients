<a name="__pageTop"></a>
# pokeapiclient.apis.tags.item_api.ItemApi

All URIs are relative to *https://pokeapi.co*

Method | HTTP request | Description
------------- | ------------- | -------------
[**item_list**](#item_list) | **get** /api/v2/item/ | 
[**item_read**](#item_read) | **get** /api/v2/item/{id}/ | 
...
from pokeapiclient.apis.tags import item_api
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.item_list(
...
default | [ApiResponseForDefault](#item_list.ApiResponseForDefault) | Default response

#### item_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.item_read(
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
decimal.Decimal, int,  | decimal.Decimal,  | A unique integer value identifying this item. | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
default | [ApiResponseForDefault](#item_read.ApiResponseForDefault) | Default response

#### item_read.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyTextPlain, ] |  |
