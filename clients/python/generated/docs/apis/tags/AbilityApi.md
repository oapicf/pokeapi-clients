<a name="__pageTop"></a>
# pokeapiclient.apis.tags.ability_api.AbilityApi
...
[**ability_read**](#ability_read) | **get** /api/v2/ability/{id}/ | 
...
default | [ApiResponseForDefault](#ability_list.ApiResponseForDefault) | Default response

#### ability_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
decimal.Decimal, int,  | decimal.Decimal,  | A unique integer value identifying this ability. | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
default | [ApiResponseForDefault](#ability_read.ApiResponseForDefault) | Default response

#### ability_read.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyTextPlain, ] |  |
