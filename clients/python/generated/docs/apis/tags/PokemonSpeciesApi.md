<a name="__pageTop"></a>
# pokeapiclient.apis.tags.pokemon_species_api.PokemonSpeciesApi

All URIs are relative to *https://pokeapi.co*

Method | HTTP request | Description
------------- | ------------- | -------------
[**pokemon_species_list**](#pokemon_species_list) | **get** /api/v2/pokemon-species/ | 
[**pokemon_species_read**](#pokemon_species_read) | **get** /api/v2/pokemon-species/{id}/ | 
...
from pokeapiclient.apis.tags import pokemon_species_api
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.pokemon_species_list(
...
default | [ApiResponseForDefault](#pokemon_species_list.ApiResponseForDefault) | Default response

#### pokemon_species_list.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.pokemon_species_read(
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
decimal.Decimal, int,  | decimal.Decimal,  | A unique integer value identifying this pokemon species. | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
default | [ApiResponseForDefault](#pokemon_species_read.ApiResponseForDefault) | Default response

#### pokemon_species_read.ApiResponseForDefault
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor0ResponseBodyTextPlain, ] |  |
