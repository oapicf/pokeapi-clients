...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    api_instance = pokeapiclient.GenerationApi(api_client)
    limit = 56 # int |  (optional)
    offset = 56 # int |  (optional)

    try:
        api_response = api_instance.generation_list(limit=limit, offset=offset)
        print("The response of GenerationApi->generation_list:\n")
        pprint(api_response)
...
with pokeapiclient.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GenerationApi->generation_read:\n")
        pprint(api_response)
    except Exception as e:
