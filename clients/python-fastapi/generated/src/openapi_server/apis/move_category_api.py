...
async def move_category_list(
    ...
    if not BaseMoveCategoryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMoveCategoryApi.subclasses[0]().move_category_list(limit, offset)
...
async def move_category_read(
    ...
    if not BaseMoveCategoryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMoveCategoryApi.subclasses[0]().move_category_read(id)
