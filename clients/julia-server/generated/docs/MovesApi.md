...
# **move_ailment_list**
> `move_ailment_list`(req::`HTTP.Request`; `limit`=nothing, `offset`=nothing, `q`=nothing,) -> `PaginatedMoveMetaAilmentSummaryList`
...
> `move_ailment_retrieve`(req::`HTTP.Request`, `id`::`String`;) -> `MoveMetaAilmentDetail`
...
> `move_battle_style_list`(req::`HTTP.Request`; `limit`=nothing, `offset`=nothing, `q`=nothing,) -> `PaginatedMoveBattleStyleSummaryList`
...
> `move_battle_style_retrieve`(req::`HTTP.Request`, `id`::`String`;) -> `MoveBattleStyleDetail`
...
# **move_category_list**
> `move_category_list`(req::`HTTP.Request`; `limit`=nothing, `offset`=nothing, `q`=nothing,) -> `PaginatedMoveMetaCategorySummaryList`
...
> `move_category_retrieve`(req::`HTTP.Request`, `id`::`String`;) -> `MoveMetaCategoryDetail`
...
> `move_learn_method_list`(req::`HTTP.Request`; `limit`=nothing, `offset`=nothing, `q`=nothing,) -> `PaginatedMoveLearnMethodSummaryList`
...
> `move_learn_method_retrieve`(req::`HTTP.Request`, `id`::`String`;) -> `MoveLearnMethodDetail`
...
# **move_list**
> `move_list`(req::`HTTP.Request`; `limit`=nothing, `offset`=nothing, `q`=nothing,) -> `PaginatedMoveSummaryList`
...
# **move_retrieve**
> `move_retrieve`(req::`HTTP.Request`, `id`::`String`;) -> `MoveDetail`
...
# **move_target_list**
> `move_target_list`(req::`HTTP.Request`; `limit`=nothing, `offset`=nothing, `q`=nothing,) -> `PaginatedMoveTargetSummaryList`
...
> `move_target_retrieve`(req::`HTTP.Request`, `id`::`String`;) -> `MoveTargetDetail`
