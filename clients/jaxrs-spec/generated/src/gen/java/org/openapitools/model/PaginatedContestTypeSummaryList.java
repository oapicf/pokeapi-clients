...
public class PaginatedContestTypeSummaryList   {
  ...
  private @Valid List<@Valid ContestTypeSummary> results = new ArrayList<>();
  ...
  @Valid public List<@Valid ContestTypeSummary> getResults() {
    return results;
  }
  ...
  public PaginatedContestTypeSummaryList removeResultsItem(ContestTypeSummary resultsItem) {
