...
public class PokemonHabitatDetail   {
  private Integer id;
  private String name;
  private @Valid List<@Valid PokemonHabitatName> names = new ArrayList<>();
  ...
  public PokemonHabitatDetail(
    ...
    @JsonProperty(required = true, value = "names") List<@Valid PokemonHabitatName> names,
  ...
  @NotNull @Valid public List<@Valid PokemonHabitatName> getNames() {
    return names;
  }
  ...
  public PokemonHabitatDetail removeNamesItem(PokemonHabitatName namesItem) {
  ...
  public PokemonHabitatDetail removePokemonSpeciesItem(PokemonSpeciesSummary pokemonSpeciesItem) {
