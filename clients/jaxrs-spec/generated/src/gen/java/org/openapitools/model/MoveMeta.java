...
public class MoveMeta   {
  ...
  @JsonCreator
  public MoveMeta(
    @JsonProperty(required = true, value = "ailment") MoveMetaAilmentSummary ailment,
    @JsonProperty(required = true, value = "category") MoveMetaCategorySummary category
  ) {
  ...
  @JsonProperty(required = true, value = "ailment")
  @NotNull @Valid public MoveMetaAilmentSummary getAilment() {
    return ailment;
  }
  ...
  @NotNull @Valid public MoveMetaCategorySummary getCategory() {
    return category;
  }
