...
public class GenderDetail   {
  ...
  @Valid public List<@Valid GenderDetailPokemonSpeciesDetailsInner> getPokemonSpeciesDetails() {
  ...
  @Valid public List<@Valid AbilityDetailPokemonInnerPokemon> getRequiredForEvolution() {
