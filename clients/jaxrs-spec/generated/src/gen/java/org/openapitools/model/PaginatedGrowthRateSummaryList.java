...
@JsonTypeName("PaginatedGrowthRateSummaryList")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2026-02-07T15:24:06.001755207Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class PaginatedGrowthRateSummaryList   {
  private Integer count;
  private URI next;
  private URI previous;
  private @Valid List<@Valid GrowthRateSummary> results = new ArrayList<>();
  ...
  /**
   **/
  public PaginatedGrowthRateSummaryList count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  /**
   **/
  public PaginatedGrowthRateSummaryList next(URI next) {
    this.next = next;
    return this;
  }
  ...
  /**
   **/
  public PaginatedGrowthRateSummaryList previous(URI previous) {
  ...
  /**
   **/
  public PaginatedGrowthRateSummaryList results(List<@Valid GrowthRateSummary> results) {
  ...
  @Valid public List<@Valid GrowthRateSummary> getResults() {
    return results;
  }
  ...
  public PaginatedGrowthRateSummaryList addResultsItem(GrowthRateSummary resultsItem) {
  ...
  public PaginatedGrowthRateSummaryList removeResultsItem(GrowthRateSummary resultsItem) {
