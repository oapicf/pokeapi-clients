...
public class PaginatedPokemonColorSummaryList   {
  ...
  private @Valid List<@Valid PokemonColorSummary> results = new ArrayList<>();
  ...
  @Valid public List<@Valid PokemonColorSummary> getResults() {
    return results;
  }
  ...
  public PaginatedPokemonColorSummaryList removeResultsItem(PokemonColorSummary resultsItem) {
