...
public class PaginatedLocationSummaryList   {
  ...
  private @Valid List<@Valid LocationSummary> results = new ArrayList<>();
  ...
  @Valid public List<@Valid LocationSummary> getResults() {
    return results;
  }
  ...
  public PaginatedLocationSummaryList removeResultsItem(LocationSummary resultsItem) {
