...
@JsonTypeName("PaginatedNatureSummaryList")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2026-02-07T04:17:57.915073257Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class PaginatedNatureSummaryList   {
  private Integer count;
  private URI next;
  private URI previous;
  private @Valid List<@Valid NatureSummary> results = new ArrayList<>();
  ...
  /**
   **/
  public PaginatedNatureSummaryList count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  /**
   **/
  public PaginatedNatureSummaryList next(URI next) {
    this.next = next;
    return this;
  }
  ...
  /**
   **/
  public PaginatedNatureSummaryList previous(URI previous) {
  ...
  /**
   **/
  public PaginatedNatureSummaryList results(List<@Valid NatureSummary> results) {
  ...
  @Valid public List<@Valid NatureSummary> getResults() {
    return results;
  }

  @JsonProperty("results")
  public void setResults(List<@Valid NatureSummary> results) {
    this.results = results;
  }

  public PaginatedNatureSummaryList addResultsItem(NatureSummary resultsItem) {
  ...
  public PaginatedNatureSummaryList removeResultsItem(NatureSummary resultsItem) {
