...
public class PaginatedRegionSummaryList   {
  ...
  private @Valid List<@Valid RegionSummary> results = new ArrayList<>();
  ...
  @Valid public List<@Valid RegionSummary> getResults() {
    return results;
  }
  ...
  public PaginatedRegionSummaryList removeResultsItem(RegionSummary resultsItem) {
