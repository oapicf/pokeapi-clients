#' Create a new PaginatedRegionSummaryList
#'
#' @description
#' PaginatedRegionSummaryList Class
#'
#' @docType class
#' @title PaginatedRegionSummaryList
#' @description PaginatedRegionSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{RegionSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedRegionSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedRegionSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedRegionSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedRegionSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedRegionSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedRegionSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedRegionSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedRegionSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedRegionSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedRegionSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedRegionSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedRegionSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedRegionSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[RegionSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedRegionSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedRegionSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedRegionSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedRegionSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedRegionSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedRegionSummaryList$lock()
