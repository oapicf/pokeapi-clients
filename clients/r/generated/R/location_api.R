...
LocationApi <- R6::R6Class(
  ...
  public = list(
    ...
    LocationList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$LocationListWithHttpInfo(limit, offset, ...)
    ...
    LocationListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    LocationRead = function(id, ...){
      apiResponse <- self$LocationReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    LocationReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
