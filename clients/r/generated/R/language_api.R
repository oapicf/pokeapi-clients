...
LanguageApi <- R6::R6Class(
  ...
  public = list(
    ...
    LanguageList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$LanguageListWithHttpInfo(limit, offset, ...)
    ...
    LanguageListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    LanguageRead = function(id, ...){
      apiResponse <- self$LanguageReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    LanguageReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
