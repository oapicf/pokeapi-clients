#' Create a new TypeDetailPastDamageRelationsInnerDamageRelations
#'
#' @description
#' TypeDetailPastDamageRelationsInnerDamageRelations Class
#'
#' @docType class
#' @title TypeDetailPastDamageRelationsInnerDamageRelations
#' @description TypeDetailPastDamageRelationsInnerDamageRelations Class
...
#' @export
TypeDetailPastDamageRelationsInnerDamageRelations <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TypeDetailPastDamageRelationsInnerDamageRelations class.
    #'
    ...
    #'
    #' @return TypeDetailPastDamageRelationsInnerDamageRelations as a base R list.
    #' @examples
    #' # convert array of TypeDetailPastDamageRelationsInnerDamageRelations (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TypeDetailPastDamageRelationsInnerDamageRelations to a base R type
    #'
    ...
    #' @description
    #' Deserialize JSON string into an instance of TypeDetailPastDamageRelationsInnerDamageRelations
    #'
    #' @param input_json the JSON input
    #' @return the instance of TypeDetailPastDamageRelationsInnerDamageRelations
    ...
    #' @return TypeDetailPastDamageRelationsInnerDamageRelations in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TypeDetailPastDamageRelationsInnerDamageRelations and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`no_damage_to`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TypeDetailPastDamageRelationsInnerDamageRelations: the required field `no_damage_to` is missing."))
      }
      ...
      if (!is.null(input_json$`half_damage_to`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TypeDetailPastDamageRelationsInnerDamageRelations: the required field `half_damage_to` is missing."))
      }
      ...
      if (!is.null(input_json$`double_damage_to`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TypeDetailPastDamageRelationsInnerDamageRelations: the required field `double_damage_to` is missing."))
      }
      ...
      if (!is.null(input_json$`no_damage_from`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TypeDetailPastDamageRelationsInnerDamageRelations: the required field `no_damage_from` is missing."))
      }
      ...
      if (!is.null(input_json$`half_damage_from`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TypeDetailPastDamageRelationsInnerDamageRelations: the required field `half_damage_from` is missing."))
      }
      ...
      if (!is.null(input_json$`double_damage_from`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TypeDetailPastDamageRelationsInnerDamageRelations: the required field `double_damage_from` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TypeDetailPastDamageRelationsInnerDamageRelations
    toString = function() {
      self$toJSONString()
    },
...
# TypeDetailPastDamageRelationsInnerDamageRelations$unlock()
#
## Below is an example to define the print function
# TypeDetailPastDamageRelationsInnerDamageRelations$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TypeDetailPastDamageRelationsInnerDamageRelations$lock()
