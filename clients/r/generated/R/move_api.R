...
MoveApi <- R6::R6Class(
  ...
  public = list(
    ...
    MoveList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$MoveListWithHttpInfo(limit, offset, ...)
    ...
    MoveListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    MoveRead = function(id, ...){
      apiResponse <- self$MoveReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    MoveReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
