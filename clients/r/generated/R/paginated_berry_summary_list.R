#' Create a new PaginatedBerrySummaryList
#'
#' @description
#' PaginatedBerrySummaryList Class
#'
#' @docType class
#' @title PaginatedBerrySummaryList
#' @description PaginatedBerrySummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{BerrySummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedBerrySummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedBerrySummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedBerrySummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedBerrySummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedBerrySummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedBerrySummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedBerrySummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedBerrySummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedBerrySummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedBerrySummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedBerrySummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedBerrySummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedBerrySummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[BerrySummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedBerrySummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedBerrySummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedBerrySummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedBerrySummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedBerrySummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedBerrySummaryList$lock()
