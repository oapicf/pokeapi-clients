...
UtilityApi <- R6::R6Class(
  ...
  public = list(
    ...
    LanguageList = function(limit = NULL, offset = NULL, q = NULL, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$LanguageListWithHttpInfo(limit, offset, q, data_file = data_file, ..., .parse = .parse)
    ...
    LanguageListWithHttpInfo = function(limit = NULL, offset = NULL, q = NULL, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
    ...
    LanguageRetrieve = function(id, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$LanguageRetrieveWithHttpInfo(id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    LanguageRetrieveWithHttpInfo = function(id, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
