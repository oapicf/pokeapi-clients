#' Create a new PaginatedPokedexSummaryList
#'
#' @description
#' PaginatedPokedexSummaryList Class
#'
#' @docType class
#' @title PaginatedPokedexSummaryList
#' @description PaginatedPokedexSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{PokedexSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedPokedexSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedPokedexSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedPokedexSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedPokedexSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedPokedexSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedPokedexSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedPokedexSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedPokedexSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedPokedexSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedPokedexSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedPokedexSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedPokedexSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedPokedexSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[PokedexSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedPokedexSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedPokedexSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedPokedexSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedPokedexSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedPokedexSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedPokedexSummaryList$lock()
