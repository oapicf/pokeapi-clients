#' Create a new PaginatedLanguageSummaryList
#'
#' @description
#' PaginatedLanguageSummaryList Class
#'
#' @docType class
#' @title PaginatedLanguageSummaryList
#' @description PaginatedLanguageSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{LanguageSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedLanguageSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedLanguageSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedLanguageSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedLanguageSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedLanguageSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedLanguageSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedLanguageSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedLanguageSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedLanguageSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedLanguageSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedLanguageSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedLanguageSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedLanguageSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[LanguageSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedLanguageSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedLanguageSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedLanguageSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedLanguageSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedLanguageSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedLanguageSummaryList$lock()
