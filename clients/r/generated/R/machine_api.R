...
MachineApi <- R6::R6Class(
  ...
  public = list(
    ...
    MachineList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$MachineListWithHttpInfo(limit, offset, ...)
    ...
    MachineListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    MachineRead = function(id, ...){
      apiResponse <- self$MachineReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    MachineReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
