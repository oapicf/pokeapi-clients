#' Create a new PaginatedGenerationSummaryList
#'
#' @description
#' PaginatedGenerationSummaryList Class
#'
#' @docType class
#' @title PaginatedGenerationSummaryList
#' @description PaginatedGenerationSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{GenerationSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedGenerationSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedGenerationSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedGenerationSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedGenerationSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedGenerationSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedGenerationSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedGenerationSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedGenerationSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedGenerationSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedGenerationSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedGenerationSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedGenerationSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedGenerationSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[GenerationSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedGenerationSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedGenerationSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedGenerationSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedGenerationSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedGenerationSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedGenerationSummaryList$lock()
