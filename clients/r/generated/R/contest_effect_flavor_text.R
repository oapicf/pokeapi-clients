#' Create a new ContestEffectFlavorText
#'
#' @description
#' ContestEffectFlavorText Class
#'
#' @docType class
#' @title ContestEffectFlavorText
#' @description ContestEffectFlavorText Class
...
#' @export
ContestEffectFlavorText <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ContestEffectFlavorText class.
    #'
    ...
    #'
    #' @return ContestEffectFlavorText as a base R list.
    #' @examples
    #' # convert array of ContestEffectFlavorText (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ContestEffectFlavorText to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ContestEffectFlavorTextObject <- list()
      if (!is.null(self$`flavor_text`)) {
        ContestEffectFlavorTextObject[["flavor_text"]] <-
          self$`flavor_text`
      }
      if (!is.null(self$`language`)) {
        ContestEffectFlavorTextObject[["language"]] <-
          self$`language`$toSimpleType()
      }
      return(ContestEffectFlavorTextObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ContestEffectFlavorText
    #'
    #' @param input_json the JSON input
    #' @return the instance of ContestEffectFlavorText
    ...
    #' @return ContestEffectFlavorText in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ContestEffectFlavorText and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`flavor_text`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ContestEffectFlavorText: the required field `flavor_text` is missing."))
      }
      # check the required field `language`
      if (!is.null(input_json$`language`)) {
        stopifnot(R6::is.R6(input_json$`language`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ContestEffectFlavorText: the required field `language` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ContestEffectFlavorText
    toString = function() {
      self$toJSONString()
    },
...
# ContestEffectFlavorText$unlock()
#
## Below is an example to define the print function
# ContestEffectFlavorText$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ContestEffectFlavorText$lock()
