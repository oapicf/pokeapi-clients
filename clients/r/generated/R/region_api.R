...
RegionApi <- R6::R6Class(
  ...
  public = list(
    ...
    RegionList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$RegionListWithHttpInfo(limit, offset, ...)
    ...
    RegionListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    RegionRead = function(id, ...){
      apiResponse <- self$RegionReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    RegionReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
