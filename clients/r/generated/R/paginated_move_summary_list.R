#' Create a new PaginatedMoveSummaryList
#'
#' @description
#' PaginatedMoveSummaryList Class
#'
#' @docType class
#' @title PaginatedMoveSummaryList
#' @description PaginatedMoveSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{MoveSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedMoveSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedMoveSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedMoveSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedMoveSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedMoveSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedMoveSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedMoveSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedMoveSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedMoveSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedMoveSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedMoveSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedMoveSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedMoveSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[MoveSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedMoveSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedMoveSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedMoveSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedMoveSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedMoveSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedMoveSummaryList$lock()
