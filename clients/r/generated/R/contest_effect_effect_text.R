#' Create a new ContestEffectEffectText
#'
#' @description
#' ContestEffectEffectText Class
#'
#' @docType class
#' @title ContestEffectEffectText
#' @description ContestEffectEffectText Class
...
#' @export
ContestEffectEffectText <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ContestEffectEffectText class.
    #'
    #' @param effect effect
    ...
    #'
    #' @return ContestEffectEffectText as a base R list.
    #' @examples
    #' # convert array of ContestEffectEffectText (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ContestEffectEffectText to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ContestEffectEffectTextObject <- list()
      if (!is.null(self$`effect`)) {
        ContestEffectEffectTextObject[["effect"]] <-
          self$`effect`
      }
      if (!is.null(self$`language`)) {
        ContestEffectEffectTextObject[["language"]] <-
          self$`language`$toSimpleType()
      }
      return(ContestEffectEffectTextObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ContestEffectEffectText
    #'
    #' @param input_json the JSON input
    #' @return the instance of ContestEffectEffectText
    ...
    #' @return ContestEffectEffectText in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ContestEffectEffectText and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`effect`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ContestEffectEffectText: the required field `effect` is missing."))
      }
      # check the required field `language`
      if (!is.null(input_json$`language`)) {
        stopifnot(R6::is.R6(input_json$`language`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ContestEffectEffectText: the required field `language` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ContestEffectEffectText
    toString = function() {
      self$toJSONString()
    },
...
# ContestEffectEffectText$unlock()
#
## Below is an example to define the print function
# ContestEffectEffectText$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ContestEffectEffectText$lock()
