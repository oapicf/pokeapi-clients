...
StatApi <- R6::R6Class(
  ...
  public = list(
    ...
    StatList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$StatListWithHttpInfo(limit, offset, ...)
    ...
    StatListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    StatRead = function(id, ...){
      apiResponse <- self$StatReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    StatReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
