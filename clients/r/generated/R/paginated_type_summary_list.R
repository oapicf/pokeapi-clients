#' Create a new PaginatedTypeSummaryList
#'
#' @description
#' PaginatedTypeSummaryList Class
#'
#' @docType class
#' @title PaginatedTypeSummaryList
#' @description PaginatedTypeSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{TypeSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedTypeSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedTypeSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedTypeSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedTypeSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedTypeSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedTypeSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedTypeSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedTypeSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedTypeSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedTypeSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedTypeSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedTypeSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedTypeSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[TypeSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedTypeSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedTypeSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedTypeSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedTypeSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedTypeSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedTypeSummaryList$lock()
