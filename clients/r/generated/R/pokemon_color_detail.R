#' Create a new PokemonColorDetail
#'
#' @description
#' PokemonColorDetail Class
#'
#' @docType class
#' @title PokemonColorDetail
#' @description PokemonColorDetail Class
#' @format An \code{R6Class} generator object
#' @field id  integer
#' @field name  character
#' @field names  list(\link{PokemonColorName})
#' @field pokemon_species  list(\link{PokemonSpeciesSummary})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PokemonColorDetail <- R6::R6Class(
  "PokemonColorDetail",
  public = list(
    `id` = NULL,
    `name` = NULL,
    ...
    #' @description
    #' Initialize a new PokemonColorDetail class.
    #'
    #' @param id id
    #' @param name name
    #' @param names names
    ...
    #'
    #' @return PokemonColorDetail as a base R list.
    #' @examples
    #' # convert array of PokemonColorDetail (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PokemonColorDetail to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PokemonColorDetailObject <- list()
      if (!is.null(self$`id`)) {
        PokemonColorDetailObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        PokemonColorDetailObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`names`)) {
        PokemonColorDetailObject[["names"]] <-
          lapply(self$`names`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`pokemon_species`)) {
        PokemonColorDetailObject[["pokemon_species"]] <-
          lapply(self$`pokemon_species`, function(x) x$toSimpleType())
      }
      return(PokemonColorDetailObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PokemonColorDetail
    #'
    #' @param input_json the JSON input
    #' @return the instance of PokemonColorDetail
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`names`)) {
        self$`names` <- ApiClient$new()$deserializeObj(this_object$`names`, "array[PokemonColorName]", loadNamespace("openapi"))
      }
    ...
    #' @return PokemonColorDetail in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PokemonColorDetail and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PokemonColorDetail: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PokemonColorDetail: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`names`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PokemonColorDetail: the required field `names` is missing."))
      }
      ...
      if (!is.null(input_json$`pokemon_species`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PokemonColorDetail: the required field `pokemon_species` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PokemonColorDetail
    toString = function() {
      self$toJSONString()
    },
...
# PokemonColorDetail$unlock()
#
## Below is an example to define the print function
# PokemonColorDetail$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PokemonColorDetail$lock()
