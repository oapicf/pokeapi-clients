#' Create a new PaginatedContestTypeSummaryList
#'
#' @description
#' PaginatedContestTypeSummaryList Class
#'
#' @docType class
#' @title PaginatedContestTypeSummaryList
#' @description PaginatedContestTypeSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{ContestTypeSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedContestTypeSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedContestTypeSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedContestTypeSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedContestTypeSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedContestTypeSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedContestTypeSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedContestTypeSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedContestTypeSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedContestTypeSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedContestTypeSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedContestTypeSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedContestTypeSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedContestTypeSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[ContestTypeSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedContestTypeSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedContestTypeSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedContestTypeSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedContestTypeSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedContestTypeSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedContestTypeSummaryList$lock()
