...
MoveName <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MoveName class.
    #'
    #' @param name name
    ...
    #'
    #' @return MoveName as a base R list.
    #' @examples
    #' # convert array of MoveName (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MoveName to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`language`)) {
        MoveNameObject[["language"]] <-
          self$`language`$toSimpleType()
      }
      return(MoveNameObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of MoveName
    #'
    #' @param input_json the JSON input
    #' @return the instance of MoveName
    ...
    #' @return MoveName in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MoveName and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveName: the required field `name` is missing."))
      }
      # check the required field `language`
      if (!is.null(input_json$`language`)) {
        stopifnot(R6::is.R6(input_json$`language`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for MoveName: the required field `language` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MoveName
    toString = function() {
      self$toJSONString()
    },
...
# MoveName$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
