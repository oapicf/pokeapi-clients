...
BerryApi <- R6::R6Class(
  ...
  public = list(
    ...
    BerryList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$BerryListWithHttpInfo(limit, offset, ...)
    ...
    BerryListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    BerryRead = function(id, ...){
      apiResponse <- self$BerryReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    BerryReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
