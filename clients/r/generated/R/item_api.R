...
ItemApi <- R6::R6Class(
  ...
  public = list(
    ...
    ItemList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$ItemListWithHttpInfo(limit, offset, ...)
    ...
    ItemListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    ItemRead = function(id, ...){
      apiResponse <- self$ItemReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    ItemReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
