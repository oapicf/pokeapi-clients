...
GrowthRateApi <- R6::R6Class(
  ...
  public = list(
    ...
    GrowthRateList = function(limit = NULL, offset = NULL, data_file = NULL, ...) {
      local_var_response <- self$GrowthRateListWithHttpInfo(limit, offset, data_file = data_file, ...)
    ...
    GrowthRateRead = function(id, data_file = NULL, ...) {
      local_var_response <- self$GrowthRateReadWithHttpInfo(id, data_file = data_file, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        local_var_response$content
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        local_var_response
