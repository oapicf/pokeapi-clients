...
TypeApi <- R6::R6Class(
  ...
  public = list(
    ...
    TypeList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$TypeListWithHttpInfo(limit, offset, ...)
    ...
    TypeListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    TypeRead = function(id, ...){
      apiResponse <- self$TypeReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    TypeReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
