#' Create a new MoveTargetDetail
#'
#' @description
#' MoveTargetDetail Class
#'
#' @docType class
#' @title MoveTargetDetail
#' @description MoveTargetDetail Class
#' @format An \code{R6Class} generator object
#' @field id  integer
#' @field name  character
#' @field descriptions  list(\link{MoveTargetDescription})
#' @field moves  list(\link{MoveSummary})
#' @field names  list(\link{MoveTargetName})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MoveTargetDetail <- R6::R6Class(
  "MoveTargetDetail",
  public = list(
    `id` = NULL,
    `name` = NULL,
    ...
    #' @description
    #' Initialize a new MoveTargetDetail class.
    #'
    #' @param id id
    #' @param name name
    ...
    #'
    #' @return MoveTargetDetail as a base R list.
    #' @examples
    #' # convert array of MoveTargetDetail (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MoveTargetDetail to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MoveTargetDetailObject <- list()
      if (!is.null(self$`id`)) {
        MoveTargetDetailObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        MoveTargetDetailObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`descriptions`)) {
        MoveTargetDetailObject[["descriptions"]] <-
          lapply(self$`descriptions`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`moves`)) {
        MoveTargetDetailObject[["moves"]] <-
          lapply(self$`moves`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`names`)) {
        MoveTargetDetailObject[["names"]] <-
          lapply(self$`names`, function(x) x$toSimpleType())
      }
      return(MoveTargetDetailObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of MoveTargetDetail
    #'
    #' @param input_json the JSON input
    #' @return the instance of MoveTargetDetail
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`descriptions`)) {
        self$`descriptions` <- ApiClient$new()$deserializeObj(this_object$`descriptions`, "array[MoveTargetDescription]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`names`)) {
        self$`names` <- ApiClient$new()$deserializeObj(this_object$`names`, "array[MoveTargetName]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return MoveTargetDetail in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MoveTargetDetail and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveTargetDetail: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveTargetDetail: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`descriptions`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveTargetDetail: the required field `descriptions` is missing."))
      }
      ...
      if (!is.null(input_json$`moves`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveTargetDetail: the required field `moves` is missing."))
      }
      ...
      if (!is.null(input_json$`names`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveTargetDetail: the required field `names` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MoveTargetDetail
    toString = function() {
      self$toJSONString()
    },
...
# MoveTargetDetail$unlock()
#
## Below is an example to define the print function
# MoveTargetDetail$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MoveTargetDetail$lock()
