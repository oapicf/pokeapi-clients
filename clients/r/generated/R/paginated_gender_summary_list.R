#' Create a new PaginatedGenderSummaryList
#'
#' @description
#' PaginatedGenderSummaryList Class
#'
#' @docType class
#' @title PaginatedGenderSummaryList
#' @description PaginatedGenderSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{GenderSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedGenderSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedGenderSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedGenderSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedGenderSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedGenderSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedGenderSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedGenderSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedGenderSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedGenderSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedGenderSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedGenderSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedGenderSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedGenderSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[GenderSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedGenderSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedGenderSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedGenderSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedGenderSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedGenderSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedGenderSummaryList$lock()
