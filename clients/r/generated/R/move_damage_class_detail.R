#' Create a new MoveDamageClassDetail
#'
#' @description
#' MoveDamageClassDetail Class
#'
#' @docType class
#' @title MoveDamageClassDetail
#' @description MoveDamageClassDetail Class
#' @format An \code{R6Class} generator object
#' @field id  integer
#' @field name  character
#' @field descriptions  list(\link{MoveDamageClassDescription})
#' @field moves  list(\link{MoveSummary})
#' @field names  list(\link{MoveDamageClassName})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MoveDamageClassDetail <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MoveDamageClassDetail class.
    #'
    #' @param id id
    #' @param name name
    ...
    initialize = function(`id`, `name`, `descriptions`, `moves`, `names`, ...) {
      if (!missing(`id`)) {
    ...
    #'
    #' @return MoveDamageClassDetail as a base R list.
    #' @examples
    #' # convert array of MoveDamageClassDetail (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MoveDamageClassDetail to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MoveDamageClassDetailObject <- list()
      if (!is.null(self$`id`)) {
        MoveDamageClassDetailObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`name`)) {
        MoveDamageClassDetailObject[["name"]] <-
          self$`name`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of MoveDamageClassDetail
    #'
    #' @param input_json the JSON input
    #' @return the instance of MoveDamageClassDetail
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`descriptions`)) {
        self$`descriptions` <- ApiClient$new()$deserializeObj(this_object$`descriptions`, "array[MoveDamageClassDescription]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`names`)) {
        self$`names` <- ApiClient$new()$deserializeObj(this_object$`names`, "array[MoveDamageClassName]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return MoveDamageClassDetail in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MoveDamageClassDetail and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveDamageClassDetail: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveDamageClassDetail: the required field `name` is missing."))
      }
      ...
      if (!is.null(input_json$`descriptions`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveDamageClassDetail: the required field `descriptions` is missing."))
      }
      ...
      if (!is.null(input_json$`moves`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveDamageClassDetail: the required field `moves` is missing."))
      }
      ...
      if (!is.null(input_json$`names`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for MoveDamageClassDetail: the required field `names` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of MoveDamageClassDetail
    toString = function() {
      self$toJSONString()
    },
...
# MoveDamageClassDetail$unlock()
#
## Below is an example to define the print function
# MoveDamageClassDetail$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MoveDamageClassDetail$lock()
