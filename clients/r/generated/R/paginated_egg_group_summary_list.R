#' Create a new PaginatedEggGroupSummaryList
#'
#' @description
#' PaginatedEggGroupSummaryList Class
#'
#' @docType class
#' @title PaginatedEggGroupSummaryList
#' @description PaginatedEggGroupSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{EggGroupSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedEggGroupSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedEggGroupSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedEggGroupSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedEggGroupSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedEggGroupSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedEggGroupSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedEggGroupSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedEggGroupSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedEggGroupSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedEggGroupSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedEggGroupSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedEggGroupSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedEggGroupSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[EggGroupSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedEggGroupSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedEggGroupSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedEggGroupSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedEggGroupSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedEggGroupSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedEggGroupSummaryList$lock()
