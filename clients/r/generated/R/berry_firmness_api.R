...
BerryFirmnessApi <- R6::R6Class(
  ...
  public = list(
    ...
    BerryFirmnessList = function(limit=NULL, offset=NULL, data_file=NULL, ...) {
      api_response <- self$BerryFirmnessListWithHttpInfo(limit, offset, data_file = data_file, ...)
    ...
    BerryFirmnessListWithHttpInfo = function(limit=NULL, offset=NULL, data_file = NULL, ...) {
      ...
      body <- NULL
      url_path <- "/api/v2/berry-firmness/"
    ...
    BerryFirmnessRead = function(id, data_file=NULL, ...) {
      api_response <- self$BerryFirmnessReadWithHttpInfo(id, data_file = data_file, ...)
      resp <- api_response$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        api_response$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    BerryFirmnessReadWithHttpInfo = function(id, data_file = NULL, ...) {
      ...
      body <- NULL
      url_path <- "/api/v2/berry-firmness/{id}/"
      if (!missing(`id`)) {
