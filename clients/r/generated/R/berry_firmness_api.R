...
#' @description openapi.BerryFirmness
...
BerryFirmnessApi <- R6::R6Class(
  ...
  public = list(
    ...
    BerryFirmnessList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$BerryFirmnessListWithHttpInfo(limit, offset, ...)
    ...
    BerryFirmnessListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    BerryFirmnessRead = function(id, ...){
      apiResponse <- self$BerryFirmnessReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    BerryFirmnessReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      body <- NULL
      urlPath <- "/api/v2/berry-firmness/{id}/"
      if (!missing(`id`)) {
