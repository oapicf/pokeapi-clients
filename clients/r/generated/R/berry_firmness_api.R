...
#'
#' @docType class
#' @title BerryFirmness operations
#' @description BerryFirmnessApi
  ...
  public = list(
    ...
    BerryFirmnessListWithHttpInfo = function(limit = NULL, offset = NULL, data_file = NULL, ...) {
      ...
      if (!missing(`limit`) && is.null(`limit`)) {
        stop("Invalid value for `limit` when calling BerryFirmnessApi$BerryFirmnessList, `limit` is not nullable")
      }

      if (!missing(`offset`) && is.null(`offset`)) {
        stop("Invalid value for `offset` when calling BerryFirmnessApi$BerryFirmnessList, `offset` is not nullable")
      }
    ...
    BerryFirmnessReadWithHttpInfo = function(id, data_file = NULL, ...) {
      ...
      if (!missing(`id`) && is.null(`id`)) {
        stop("Invalid value for `id` when calling BerryFirmnessApi$BerryFirmnessRead, `id` is not nullable")
      }
