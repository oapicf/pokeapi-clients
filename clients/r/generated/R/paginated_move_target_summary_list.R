#' Create a new PaginatedMoveTargetSummaryList
#'
#' @description
#' PaginatedMoveTargetSummaryList Class
#'
#' @docType class
#' @title PaginatedMoveTargetSummaryList
#' @description PaginatedMoveTargetSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{MoveTargetSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedMoveTargetSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedMoveTargetSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedMoveTargetSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedMoveTargetSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedMoveTargetSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedMoveTargetSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedMoveTargetSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedMoveTargetSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedMoveTargetSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedMoveTargetSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedMoveTargetSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedMoveTargetSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedMoveTargetSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[MoveTargetSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedMoveTargetSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedMoveTargetSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedMoveTargetSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedMoveTargetSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedMoveTargetSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedMoveTargetSummaryList$lock()
