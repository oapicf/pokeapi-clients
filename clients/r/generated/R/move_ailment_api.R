...
MoveAilmentApi <- R6::R6Class(
  ...
  public = list(
    ...
    MoveAilmentList = function(limit=NULL, offset=NULL, data_file=NULL, ...) {
      api_response <- self$MoveAilmentListWithHttpInfo(limit, offset, data_file = data_file, ...)
    ...
    MoveAilmentRead = function(id, data_file=NULL, ...) {
      api_response <- self$MoveAilmentReadWithHttpInfo(id, data_file = data_file, ...)
      resp <- api_response$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        api_response$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    MoveAilmentReadWithHttpInfo = function(id, data_file = NULL, ...) {
      ...
      body <- NULL
      url_path <- "/api/v2/move-ailment/{id}/"
      if (!missing(`id`)) {
