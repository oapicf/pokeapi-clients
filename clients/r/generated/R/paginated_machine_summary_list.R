#' Create a new PaginatedMachineSummaryList
#'
#' @description
#' PaginatedMachineSummaryList Class
#'
#' @docType class
#' @title PaginatedMachineSummaryList
#' @description PaginatedMachineSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{MachineSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedMachineSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedMachineSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedMachineSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedMachineSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedMachineSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedMachineSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedMachineSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedMachineSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedMachineSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedMachineSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedMachineSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedMachineSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedMachineSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[MachineSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedMachineSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedMachineSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedMachineSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedMachineSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedMachineSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedMachineSummaryList$lock()
