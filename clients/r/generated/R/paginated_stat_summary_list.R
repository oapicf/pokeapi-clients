#' Create a new PaginatedStatSummaryList
#'
#' @description
#' PaginatedStatSummaryList Class
#'
#' @docType class
#' @title PaginatedStatSummaryList
#' @description PaginatedStatSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{StatSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedStatSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedStatSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedStatSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedStatSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedStatSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedStatSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedStatSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedStatSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedStatSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedStatSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedStatSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedStatSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedStatSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[StatSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedStatSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedStatSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedStatSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedStatSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedStatSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedStatSummaryList$lock()
