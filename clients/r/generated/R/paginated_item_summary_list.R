#' Create a new PaginatedItemSummaryList
#'
#' @description
#' PaginatedItemSummaryList Class
#'
#' @docType class
#' @title PaginatedItemSummaryList
#' @description PaginatedItemSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{ItemSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedItemSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedItemSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedItemSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedItemSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedItemSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedItemSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedItemSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedItemSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedItemSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedItemSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedItemSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedItemSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedItemSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[ItemSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedItemSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedItemSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedItemSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedItemSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedItemSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedItemSummaryList$lock()
