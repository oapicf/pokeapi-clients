...
GenerationApi <- R6::R6Class(
  ...
  public = list(
    ...
    GenerationList = function(limit=NULL, offset=NULL, ...){
      apiResponse <- self$GenerationListWithHttpInfo(limit, offset, ...)
    ...
    GenerationListWithHttpInfo = function(limit=NULL, offset=NULL, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
    ...
    GenerationRead = function(id, ...){
      apiResponse <- self$GenerationReadWithHttpInfo(id, ...)
      resp <- apiResponse$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        apiResponse$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    GenerationReadWithHttpInfo = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
