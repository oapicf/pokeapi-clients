#' Create a new PaginatedGrowthRateSummaryList
#'
#' @description
#' PaginatedGrowthRateSummaryList Class
#'
#' @docType class
#' @title PaginatedGrowthRateSummaryList
#' @description PaginatedGrowthRateSummaryList Class
#' @format An \code{R6Class} generator object
#' @field count  integer [optional]
#' @field next  character [optional]
#' @field previous  character [optional]
#' @field results  list(\link{GrowthRateSummary}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PaginatedGrowthRateSummaryList <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PaginatedGrowthRateSummaryList class.
    #'
    #' @param count count
    #' @param next next
    ...
    #'
    #' @return PaginatedGrowthRateSummaryList as a base R list.
    #' @examples
    #' # convert array of PaginatedGrowthRateSummaryList (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PaginatedGrowthRateSummaryList to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PaginatedGrowthRateSummaryListObject <- list()
      if (!is.null(self$`count`)) {
        PaginatedGrowthRateSummaryListObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`next`)) {
        PaginatedGrowthRateSummaryListObject[["next"]] <-
          self$`next`
      }
      if (!is.null(self$`previous`)) {
        PaginatedGrowthRateSummaryListObject[["previous"]] <-
          self$`previous`
      }
      if (!is.null(self$`results`)) {
        PaginatedGrowthRateSummaryListObject[["results"]] <-
          lapply(self$`results`, function(x) x$toSimpleType())
      }
      return(PaginatedGrowthRateSummaryListObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PaginatedGrowthRateSummaryList
    #'
    #' @param input_json the JSON input
    #' @return the instance of PaginatedGrowthRateSummaryList
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`results`)) {
        self$`results` <- ApiClient$new()$deserializeObj(this_object$`results`, "array[GrowthRateSummary]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return PaginatedGrowthRateSummaryList in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PaginatedGrowthRateSummaryList and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PaginatedGrowthRateSummaryList
    toString = function() {
      self$toJSONString()
    },
...
# PaginatedGrowthRateSummaryList$unlock()
#
## Below is an example to define the print function
# PaginatedGrowthRateSummaryList$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PaginatedGrowthRateSummaryList$lock()
