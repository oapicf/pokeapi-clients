# openapi::EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner
...
**min_level** | **integer** |  | 
**needs_overworld_rain** | **character** |  | 
**party_species** | **character** |  | 
**party_type** | **character** |  | 
**relative_physical_stats** | **character** |  | 
**time_of_day** | **character** |  | 
**trade_species** | **character** |  | 
**trigger** | [**AbilityDetailPokemonInnerPokemon**](AbilityDetail_pokemon_inner_pokemon.md) |  | 
**turn_upside_down** | **character** |  | 
