...
// AssertPaginatedEvolutionTriggerSummaryListConstraints checks if the values respects the defined constraints
func AssertPaginatedEvolutionTriggerSummaryListConstraints(obj PaginatedEvolutionTriggerSummaryList) error {
	for _, el := range obj.Results {
		if err := AssertEvolutionTriggerSummaryConstraints(el); err != nil {
			return err
		}
	}
	return nil
