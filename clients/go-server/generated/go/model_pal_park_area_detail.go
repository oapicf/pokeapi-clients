...
// UnmarshalJSON validates required property keys then unmarshals into PalParkAreaDetail
...
// AssertPalParkAreaDetailRequired checks complex required fields (models, arrays, maps) and embedded parents.
