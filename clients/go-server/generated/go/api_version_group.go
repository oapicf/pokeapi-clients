...
func NewVersionGroupAPIController(s VersionGroupAPIServicer, opts ...VersionGroupAPIOption) *VersionGroupAPIController {
...
// OrderedRoutes returns all the api routes in a deterministic order for the VersionGroupAPIController
func (c *VersionGroupAPIController) OrderedRoutes() []Route {
	return []Route{
		Route{
			"VersionGroupList",
			strings.ToUpper("Get"),
