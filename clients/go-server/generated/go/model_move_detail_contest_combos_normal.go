...
// AssertMoveDetailContestCombosNormalConstraints checks if the values respects the defined constraints
func AssertMoveDetailContestCombosNormalConstraints(obj MoveDetailContestCombosNormal) error {
	for _, el := range obj.UseBefore {
