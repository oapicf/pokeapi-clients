...
// AssertPaginatedGenerationSummaryListConstraints checks if the values respects the defined constraints
func AssertPaginatedGenerationSummaryListConstraints(obj PaginatedGenerationSummaryList) error {
	for _, el := range obj.Results {
		if err := AssertGenerationSummaryConstraints(el); err != nil {
			return err
		}
	}
	return nil
