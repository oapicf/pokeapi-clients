...
// UnmarshalJSON validates required property keys then unmarshals into EggGroupDetail
...
// AssertEggGroupDetailRequired checks complex required fields (models, arrays, maps) and embedded parents.
