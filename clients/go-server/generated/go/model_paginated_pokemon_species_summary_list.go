...
// AssertPaginatedPokemonSpeciesSummaryListConstraints checks if the values respects the defined constraints
func AssertPaginatedPokemonSpeciesSummaryListConstraints(obj PaginatedPokemonSpeciesSummaryList) error {
	for _, el := range obj.Results {
