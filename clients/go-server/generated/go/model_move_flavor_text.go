...
// UnmarshalJSON validates required property keys then unmarshals into MoveFlavorText
...
// AssertMoveFlavorTextRequired checks complex required fields (models, arrays, maps) and embedded parents.
// Primitive required fields are validated for JSON request bodies in UnmarshalJSON so zero values remain valid.
func AssertMoveFlavorTextRequired(obj MoveFlavorText) error {
...
// AssertMoveFlavorTextConstraints checks if the values respects the defined constraints
func AssertMoveFlavorTextConstraints(obj MoveFlavorText) error {
