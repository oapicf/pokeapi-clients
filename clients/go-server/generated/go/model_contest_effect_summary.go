...
// AssertContestEffectSummaryConstraints checks if the values respects the defined constraints
func AssertContestEffectSummaryConstraints(obj ContestEffectSummary) error {
	return nil
}
