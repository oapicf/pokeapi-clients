...
// UnmarshalJSON validates required property keys then unmarshals into MoveLearnMethodDetail
func (o *MoveLearnMethodDetail) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded MoveLearnMethodDetail
...
// AssertMoveLearnMethodDetailRequired checks complex required fields (models, arrays, maps) and embedded parents.
