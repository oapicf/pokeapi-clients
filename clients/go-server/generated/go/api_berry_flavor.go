...
func NewBerryFlavorAPIController(s BerryFlavorAPIServicer, opts ...BerryFlavorAPIOption) *BerryFlavorAPIController {
...
// OrderedRoutes returns all the api routes in a deterministic order for the BerryFlavorAPIController
func (c *BerryFlavorAPIController) OrderedRoutes() []Route {
	return []Route{
		Route{
			"BerryFlavorList",
			strings.ToUpper("Get"),
