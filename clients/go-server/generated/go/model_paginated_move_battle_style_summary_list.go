...
// AssertPaginatedMoveBattleStyleSummaryListConstraints checks if the values respects the defined constraints
func AssertPaginatedMoveBattleStyleSummaryListConstraints(obj PaginatedMoveBattleStyleSummaryList) error {
	for _, el := range obj.Results {
		if err := AssertMoveBattleStyleSummaryConstraints(el); err != nil {
			return err
		}
	}
	return nil
