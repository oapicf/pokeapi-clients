...
// AssertBerryFlavorDetailBerriesInnerBerryConstraints checks if the values respects the defined constraints
func AssertBerryFlavorDetailBerriesInnerBerryConstraints(obj BerryFlavorDetailBerriesInnerBerry) error {
	return nil
}
