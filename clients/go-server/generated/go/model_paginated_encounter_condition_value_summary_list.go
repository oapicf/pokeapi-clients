...
// AssertPaginatedEncounterConditionValueSummaryListConstraints checks if the values respects the defined constraints
func AssertPaginatedEncounterConditionValueSummaryListConstraints(obj PaginatedEncounterConditionValueSummaryList) error {
	for _, el := range obj.Results {
