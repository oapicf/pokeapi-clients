...
// AssertMoveDetailMachinesInnerMachineConstraints checks if the values respects the defined constraints
func AssertMoveDetailMachinesInnerMachineConstraints(obj MoveDetailMachinesInnerMachine) error {
	return nil
}
