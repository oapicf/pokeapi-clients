...
// UnmarshalJSON validates required property keys then unmarshals into ItemAttributeDetail
func (o *ItemAttributeDetail) UnmarshalJSON(data []byte) (err error) {
	...
	var decoded ItemAttributeDetail
...
// AssertItemAttributeDetailRequired checks complex required fields (models, arrays, maps) and embedded parents.
