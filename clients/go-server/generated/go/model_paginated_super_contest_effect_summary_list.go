...
// AssertPaginatedSuperContestEffectSummaryListConstraints checks if the values respects the defined constraints
func AssertPaginatedSuperContestEffectSummaryListConstraints(obj PaginatedSuperContestEffectSummaryList) error {
	for _, el := range obj.Results {
		if err := AssertSuperContestEffectSummaryConstraints(el); err != nil {
			return err
		}
	}
	return nil
