...
public:
    ...
    virtual ~EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerGender() = default;
    ...
    NLOHMANN_DEFINE_TYPE_INTRUSIVE(EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerGender,
         name, url)
