...
/**
 * EvolutionTriggerDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EvolutionTriggerDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EvolutionTriggerDetail';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'names' => '\OpenAPI\Client\Model\EvolutionTriggerName[]',
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EvolutionTriggerDetail., must be smaller than or equal to 100.');
        }
     ...
     * Gets names
     *
     * @return \OpenAPI\Client\Model\EvolutionTriggerName[]
     */
     ...
     * Sets names
     *
     * @param \OpenAPI\Client\Model\EvolutionTriggerName[] $names names
     *
     * @return self
     */
