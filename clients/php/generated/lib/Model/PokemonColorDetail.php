...
/**
 * PokemonColorDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PokemonColorDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PokemonColorDetail';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'names' => '\OpenAPI\Client\Model\PokemonColorName[]',
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PokemonColorDetail., must be smaller than or equal to 100.');
        }
     ...
     * Gets names
     *
     * @return \OpenAPI\Client\Model\PokemonColorName[]
     */
     ...
     * Sets names
     *
     * @param \OpenAPI\Client\Model\PokemonColorName[] $names names
     *
     * @return self
     */
