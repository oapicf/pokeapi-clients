...
/**
 * BerryFirmnessDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BerryFirmnessDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BerryFirmnessDetail';
    ...
    protected static $openAPITypes = [
        ...
        'names' => '\OpenAPI\Client\Model\BerryFirmnessName[]'
    ];
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BerryFirmnessDetail., must be smaller than or equal to 100.');
        }
     ...
     * Gets names
     *
     * @return \OpenAPI\Client\Model\BerryFirmnessName[]
     */
     ...
     * Sets names
     *
     * @param \OpenAPI\Client\Model\BerryFirmnessName[] $names names
     *
     * @return self
     */
