...
{ 
    ...
    /// </summary>
    [ApiController]
    public class MoveLearnMethodApiController : ControllerBase
    { 
        /// <summary>
        /// 
        /// </summary>
        ...
        public virtual IActionResult MoveLearnMethodList([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset)
        {
        ...
        [SwaggerResponse(statusCode: 0, type: typeof(string), description: "Default response")]
        public virtual IActionResult MoveLearnMethodRead([FromRoute (Name = "id")][Required]int id)
        {
