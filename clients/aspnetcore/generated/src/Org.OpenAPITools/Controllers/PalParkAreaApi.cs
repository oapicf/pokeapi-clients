...
{ 
    ...
    /// </summary>
    [ApiController]
    public class PalParkAreaApiController : ControllerBase
    { 
        /// <summary>
        /// 
        /// </summary>
        ...
        public virtual IActionResult PalParkAreaList([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset)
        {
        ...
        [SwaggerResponse(statusCode: 0, type: typeof(string), description: "Default response")]
        public virtual IActionResult PalParkAreaRead([FromRoute (Name = "id")][Required]int id)
        {
