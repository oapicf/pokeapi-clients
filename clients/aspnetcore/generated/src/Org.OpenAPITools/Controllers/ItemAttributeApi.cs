...
{ 
    ...
    /// </summary>
    [ApiController]
    public class ItemAttributeApiController : ControllerBase
    { 
        /// <summary>
        /// 
        /// </summary>
        ...
        public virtual IActionResult ItemAttributeList([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset)
        {
        ...
        [SwaggerResponse(statusCode: 0, type: typeof(string), description: "Default response")]
        public virtual IActionResult ItemAttributeRead([FromRoute (Name = "id")][Required]int id)
        {
