...
{ 
    ...
    /// </summary>
    [ApiController]
    public class EvolutionChainApiController : ControllerBase
    { 
        /// <summary>
        /// 
        /// </summary>
        ...
        public virtual IActionResult EvolutionChainList([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset)
        {
        ...
        [SwaggerResponse(statusCode: 0, type: typeof(string), description: "Default response")]
        public virtual IActionResult EvolutionChainRead([FromRoute (Name = "id")][Required]int id)
        {
