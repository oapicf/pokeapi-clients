...
{ 
    ...
    { 
        ...
        public virtual IActionResult GenderList([FromQuery (Name = "limit")]int? limit, [FromQuery (Name = "offset")]int? offset)
        {
        ...
        [SwaggerResponse(statusCode: 0, type: typeof(string), description: "Default response")]
        public virtual IActionResult GenderRead([FromRoute (Name = "id")][Required]int id)
        {
