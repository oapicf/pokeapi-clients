...
class MoveLearnMethodSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MoveLearnMethodSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MoveLearnMethodSummary:
        """Create an instance of MoveLearnMethodSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MoveLearnMethodSummary.parse_obj(obj)

        _obj = MoveLearnMethodSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
