...
class MoveBattleStyleSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MoveBattleStyleSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MoveBattleStyleSummary:
        """Create an instance of MoveBattleStyleSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MoveBattleStyleSummary.parse_obj(obj)

        _obj = MoveBattleStyleSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
