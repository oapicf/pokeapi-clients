...
class PokedexSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PokedexSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PokedexSummary:
        """Create an instance of PokedexSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PokedexSummary.parse_obj(obj)

        _obj = PokedexSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
