...
class ItemPocketSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ItemPocketSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ItemPocketSummary:
        """Create an instance of ItemPocketSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ItemPocketSummary.parse_obj(obj)

        _obj = ItemPocketSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
