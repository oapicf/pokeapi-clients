...
class PokemonFormSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PokemonFormSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PokemonFormSummary:
        """Create an instance of PokemonFormSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PokemonFormSummary.parse_obj(obj)

        _obj = PokemonFormSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
