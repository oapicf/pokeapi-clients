...
class EncounterConditionValueSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EncounterConditionValueSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EncounterConditionValueSummary:
        """Create an instance of EncounterConditionValueSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EncounterConditionValueSummary.parse_obj(obj)

        _obj = EncounterConditionValueSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
