...
class EggGroupSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EggGroupSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EggGroupSummary:
        """Create an instance of EggGroupSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EggGroupSummary.parse_obj(obj)

        _obj = EggGroupSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
