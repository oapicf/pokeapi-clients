...
class PokemonSpeciesSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PokemonSpeciesSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PokemonSpeciesSummary:
        """Create an instance of PokemonSpeciesSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PokemonSpeciesSummary.parse_obj(obj)

        _obj = PokemonSpeciesSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
