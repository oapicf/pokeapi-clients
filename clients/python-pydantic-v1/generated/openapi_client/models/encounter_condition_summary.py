...
class EncounterConditionSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EncounterConditionSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EncounterConditionSummary:
        """Create an instance of EncounterConditionSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EncounterConditionSummary.parse_obj(obj)

        _obj = EncounterConditionSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
