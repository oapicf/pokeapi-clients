...
class EvolutionTriggerSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EvolutionTriggerSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EvolutionTriggerSummary:
        """Create an instance of EvolutionTriggerSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EvolutionTriggerSummary.parse_obj(obj)

        _obj = EvolutionTriggerSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
