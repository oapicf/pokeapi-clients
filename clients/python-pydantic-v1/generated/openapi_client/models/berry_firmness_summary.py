...
class BerryFirmnessSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BerryFirmnessSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BerryFirmnessSummary:
        """Create an instance of BerryFirmnessSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BerryFirmnessSummary.parse_obj(obj)

        _obj = BerryFirmnessSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
