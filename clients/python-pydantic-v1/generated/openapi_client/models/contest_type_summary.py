...
class ContestTypeSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContestTypeSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContestTypeSummary:
        """Create an instance of ContestTypeSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContestTypeSummary.parse_obj(obj)

        _obj = ContestTypeSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
