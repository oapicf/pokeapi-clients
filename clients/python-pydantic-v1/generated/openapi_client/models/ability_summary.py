...
class AbilitySummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbilitySummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbilitySummary:
        """Create an instance of AbilitySummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbilitySummary.parse_obj(obj)

        _obj = AbilitySummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
