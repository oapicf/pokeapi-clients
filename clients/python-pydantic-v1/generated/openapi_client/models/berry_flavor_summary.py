...
class BerryFlavorSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BerryFlavorSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BerryFlavorSummary:
        """Create an instance of BerryFlavorSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BerryFlavorSummary.parse_obj(obj)

        _obj = BerryFlavorSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
