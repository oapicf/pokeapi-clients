...
class PokemonShapeSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PokemonShapeSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PokemonShapeSummary:
        """Create an instance of PokemonShapeSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PokemonShapeSummary.parse_obj(obj)

        _obj = PokemonShapeSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
