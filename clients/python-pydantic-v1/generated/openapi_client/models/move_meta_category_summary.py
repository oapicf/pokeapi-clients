...
class MoveMetaCategorySummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MoveMetaCategorySummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MoveMetaCategorySummary:
        """Create an instance of MoveMetaCategorySummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MoveMetaCategorySummary.parse_obj(obj)

        _obj = MoveMetaCategorySummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
