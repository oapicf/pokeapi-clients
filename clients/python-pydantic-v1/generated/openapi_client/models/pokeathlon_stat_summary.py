...
class PokeathlonStatSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PokeathlonStatSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PokeathlonStatSummary:
        """Create an instance of PokeathlonStatSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PokeathlonStatSummary.parse_obj(obj)

        _obj = PokeathlonStatSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
