...
class PokemonColorSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PokemonColorSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PokemonColorSummary:
        """Create an instance of PokemonColorSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PokemonColorSummary.parse_obj(obj)

        _obj = PokemonColorSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
