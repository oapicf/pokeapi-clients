...
class ItemFlingEffectSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ItemFlingEffectSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ItemFlingEffectSummary:
        """Create an instance of ItemFlingEffectSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ItemFlingEffectSummary.parse_obj(obj)

        _obj = ItemFlingEffectSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
