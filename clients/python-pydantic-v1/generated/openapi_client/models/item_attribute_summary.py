...
class ItemAttributeSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ItemAttributeSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ItemAttributeSummary:
        """Create an instance of ItemAttributeSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ItemAttributeSummary.parse_obj(obj)

        _obj = ItemAttributeSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
