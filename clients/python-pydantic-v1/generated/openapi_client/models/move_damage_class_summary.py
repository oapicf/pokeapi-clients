...
class MoveDamageClassSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MoveDamageClassSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MoveDamageClassSummary:
        """Create an instance of MoveDamageClassSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MoveDamageClassSummary.parse_obj(obj)

        _obj = MoveDamageClassSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
