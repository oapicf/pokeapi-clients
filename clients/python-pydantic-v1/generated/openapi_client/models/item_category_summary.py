...
class ItemCategorySummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ItemCategorySummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ItemCategorySummary:
        """Create an instance of ItemCategorySummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ItemCategorySummary.parse_obj(obj)

        _obj = ItemCategorySummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
