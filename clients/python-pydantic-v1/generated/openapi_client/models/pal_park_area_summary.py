...
class PalParkAreaSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PalParkAreaSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PalParkAreaSummary:
        """Create an instance of PalParkAreaSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PalParkAreaSummary.parse_obj(obj)

        _obj = PalParkAreaSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
