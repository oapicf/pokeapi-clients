...
class GrowthRateSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrowthRateSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrowthRateSummary:
        """Create an instance of GrowthRateSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrowthRateSummary.parse_obj(obj)

        _obj = GrowthRateSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
