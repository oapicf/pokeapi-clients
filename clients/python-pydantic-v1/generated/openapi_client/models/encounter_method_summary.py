...
class EncounterMethodSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EncounterMethodSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EncounterMethodSummary:
        """Create an instance of EncounterMethodSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EncounterMethodSummary.parse_obj(obj)

        _obj = EncounterMethodSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
