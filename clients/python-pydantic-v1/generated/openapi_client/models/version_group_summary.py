...
class VersionGroupSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VersionGroupSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VersionGroupSummary:
        """Create an instance of VersionGroupSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VersionGroupSummary.parse_obj(obj)

        _obj = VersionGroupSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
