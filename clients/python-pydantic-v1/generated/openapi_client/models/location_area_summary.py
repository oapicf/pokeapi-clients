...
class LocationAreaSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocationAreaSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LocationAreaSummary:
        """Create an instance of LocationAreaSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocationAreaSummary.parse_obj(obj)

        _obj = LocationAreaSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
