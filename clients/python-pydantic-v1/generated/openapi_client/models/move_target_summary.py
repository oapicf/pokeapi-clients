...
class MoveTargetSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MoveTargetSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MoveTargetSummary:
        """Create an instance of MoveTargetSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MoveTargetSummary.parse_obj(obj)

        _obj = MoveTargetSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
