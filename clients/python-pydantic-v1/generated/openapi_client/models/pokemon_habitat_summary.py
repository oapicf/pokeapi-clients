...
class PokemonHabitatSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PokemonHabitatSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PokemonHabitatSummary:
        """Create an instance of PokemonHabitatSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PokemonHabitatSummary.parse_obj(obj)

        _obj = PokemonHabitatSummary.parse_obj({
            "name": obj.get("name"),
            "url": obj.get("url")
        })
        return _obj
