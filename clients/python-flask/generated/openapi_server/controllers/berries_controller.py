...
def berry_firmness_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedBerryFirmnessSummaryList, Tuple[PaginatedBerryFirmnessSummaryList, int], Tuple[PaginatedBerryFirmnessSummaryList, int, Dict[str, str]]
    """
...
def berry_firmness_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[BerryFirmnessDetail, Tuple[BerryFirmnessDetail, int], Tuple[BerryFirmnessDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def berry_flavor_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedBerryFlavorSummaryList, Tuple[PaginatedBerryFlavorSummaryList, int], Tuple[PaginatedBerryFlavorSummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def berry_flavor_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[BerryFlavorDetail, Tuple[BerryFlavorDetail, int], Tuple[BerryFlavorDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def berry_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedBerrySummaryList, Tuple[PaginatedBerrySummaryList, int], Tuple[PaginatedBerrySummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def berry_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[BerryDetail, Tuple[BerryDetail, int], Tuple[BerryDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
