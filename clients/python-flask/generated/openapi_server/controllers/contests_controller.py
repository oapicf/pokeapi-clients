...
def contest_effect_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedContestEffectSummaryList, Tuple[PaginatedContestEffectSummaryList, int], Tuple[PaginatedContestEffectSummaryList, int, Dict[str, str]]
    """
...
def contest_effect_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[ContestEffectDetail, Tuple[ContestEffectDetail, int], Tuple[ContestEffectDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def contest_type_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedContestTypeSummaryList, Tuple[PaginatedContestTypeSummaryList, int], Tuple[PaginatedContestTypeSummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def contest_type_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[ContestTypeDetail, Tuple[ContestTypeDetail, int], Tuple[ContestTypeDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def super_contest_effect_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedSuperContestEffectSummaryList, Tuple[PaginatedSuperContestEffectSummaryList, int], Tuple[PaginatedSuperContestEffectSummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def super_contest_effect_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[SuperContestEffectDetail, Tuple[SuperContestEffectDetail, int], Tuple[SuperContestEffectDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
