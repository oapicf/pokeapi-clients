...
def move_ailment_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedMoveMetaAilmentSummaryList, Tuple[PaginatedMoveMetaAilmentSummaryList, int], Tuple[PaginatedMoveMetaAilmentSummaryList, int, Dict[str, str]]
    """
...
def move_ailment_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[MoveMetaAilmentDetail, Tuple[MoveMetaAilmentDetail, int], Tuple[MoveMetaAilmentDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_battle_style_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedMoveBattleStyleSummaryList, Tuple[PaginatedMoveBattleStyleSummaryList, int], Tuple[PaginatedMoveBattleStyleSummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_battle_style_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[MoveBattleStyleDetail, Tuple[MoveBattleStyleDetail, int], Tuple[MoveBattleStyleDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_category_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedMoveMetaCategorySummaryList, Tuple[PaginatedMoveMetaCategorySummaryList, int], Tuple[PaginatedMoveMetaCategorySummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_category_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[MoveMetaCategoryDetail, Tuple[MoveMetaCategoryDetail, int], Tuple[MoveMetaCategoryDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_learn_method_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedMoveLearnMethodSummaryList, Tuple[PaginatedMoveLearnMethodSummaryList, int], Tuple[PaginatedMoveLearnMethodSummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_learn_method_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[MoveLearnMethodDetail, Tuple[MoveLearnMethodDetail, int], Tuple[MoveLearnMethodDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedMoveSummaryList, Tuple[PaginatedMoveSummaryList, int], Tuple[PaginatedMoveSummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[MoveDetail, Tuple[MoveDetail, int], Tuple[MoveDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_target_list(limit=None, offset=None, q=None):  # noqa: E501
    ...
    :rtype: Union[PaginatedMoveTargetSummaryList, Tuple[PaginatedMoveTargetSummaryList, int], Tuple[PaginatedMoveTargetSummaryList, int, Dict[str, str]]
    """
    return 'do some magic!'
...
def move_target_retrieve(id):  # noqa: E501
    ...
    :rtype: Union[MoveTargetDetail, Tuple[MoveTargetDetail, int], Tuple[MoveTargetDetail, int, Dict[str, str]]
    """
    return 'do some magic!'
