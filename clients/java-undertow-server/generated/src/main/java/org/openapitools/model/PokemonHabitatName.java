...
public class PokemonHabitatName   {
  ...
  /**
   */
  public PokemonHabitatName name(String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   */
  public PokemonHabitatName language(LanguageSummary language) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(name, pokemonHabitatName.name) &&
        Objects.equals(language, pokemonHabitatName.language);
  }
