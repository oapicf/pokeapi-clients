...
def asData : CharacteristicSummaryData = {
CharacteristicSummaryData(
    url = url.asData /* 8 */
...
given RW[CharacteristicSummary] = summon[RW[ujson.Value]].bimap[CharacteristicSummary](_.asJson, json => read[CharacteristicSummaryData](json).asModel)
