...
def asData : ItemAttributeDetailData = {
ItemAttributeDetailData(
    id = id /* 2 */,
    name = name /* 2 */,
...
given RW[ItemAttributeDetail] = summon[RW[ujson.Value]].bimap[ItemAttributeDetail](_.asJson, json => read[ItemAttributeDetailData](json).asModel)
