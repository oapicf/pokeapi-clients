...
def asData : EncounterConditionSummaryData = {
EncounterConditionSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[EncounterConditionSummary] = summon[RW[ujson.Value]].bimap[EncounterConditionSummary](_.asJson, json => read[EncounterConditionSummaryData](json).asModel)
