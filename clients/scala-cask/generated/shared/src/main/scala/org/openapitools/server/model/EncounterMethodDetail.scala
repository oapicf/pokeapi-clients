...
def asData : EncounterMethodDetailData = {
EncounterMethodDetailData(
    id = id /* 2 */,
    name = name /* 2 */,
...
given RW[EncounterMethodDetail] = summon[RW[ujson.Value]].bimap[EncounterMethodDetail](_.asJson, json => read[EncounterMethodDetailData](json).asModel)
