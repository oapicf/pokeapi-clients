...
def asData : PalParkAreaSummaryData = {
PalParkAreaSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[PalParkAreaSummary] = summon[RW[ujson.Value]].bimap[PalParkAreaSummary](_.asJson, json => read[PalParkAreaSummaryData](json).asModel)
