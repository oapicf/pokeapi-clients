...
def asData : MoveBattleStyleSummaryData = {
MoveBattleStyleSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[MoveBattleStyleSummary] = summon[RW[ujson.Value]].bimap[MoveBattleStyleSummary](_.asJson, json => read[MoveBattleStyleSummaryData](json).asModel)
