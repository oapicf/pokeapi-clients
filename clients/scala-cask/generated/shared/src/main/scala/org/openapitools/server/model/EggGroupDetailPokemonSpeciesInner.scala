...
def asData : EggGroupDetailPokemonSpeciesInnerData = {
EggGroupDetailPokemonSpeciesInnerData(
...
given RW[EggGroupDetailPokemonSpeciesInner] = summon[RW[ujson.Value]].bimap[EggGroupDetailPokemonSpeciesInner](_.asJson, json => read[EggGroupDetailPokemonSpeciesInnerData](json).asModel)
