...
def asData : MoveMetaAilmentSummaryData = {
MoveMetaAilmentSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[MoveMetaAilmentSummary] = summon[RW[ujson.Value]].bimap[MoveMetaAilmentSummary](_.asJson, json => read[MoveMetaAilmentSummaryData](json).asModel)
