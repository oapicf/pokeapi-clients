...
def asData : PokemonColorSummaryData = {
PokemonColorSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[PokemonColorSummary] = summon[RW[ujson.Value]].bimap[PokemonColorSummary](_.asJson, json => read[PokemonColorSummaryData](json).asModel)
