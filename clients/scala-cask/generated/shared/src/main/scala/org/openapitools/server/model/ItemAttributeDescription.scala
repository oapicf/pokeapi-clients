...
def asData : ItemAttributeDescriptionData = {
ItemAttributeDescriptionData(
...
given RW[ItemAttributeDescription] = summon[RW[ujson.Value]].bimap[ItemAttributeDescription](_.asJson, json => read[ItemAttributeDescriptionData](json).asModel)
