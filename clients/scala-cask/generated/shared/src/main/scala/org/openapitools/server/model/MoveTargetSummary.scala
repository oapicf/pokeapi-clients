...
def asData : MoveTargetSummaryData = {
MoveTargetSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[MoveTargetSummary] = summon[RW[ujson.Value]].bimap[MoveTargetSummary](_.asJson, json => read[MoveTargetSummaryData](json).asModel)
