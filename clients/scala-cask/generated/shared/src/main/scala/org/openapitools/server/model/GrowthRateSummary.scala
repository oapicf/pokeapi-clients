...
def asData : GrowthRateSummaryData = {
GrowthRateSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[GrowthRateSummary] = summon[RW[ujson.Value]].bimap[GrowthRateSummary](_.asJson, json => read[GrowthRateSummaryData](json).asModel)
