...
def asData : PokemonHabitatSummaryData = {
PokemonHabitatSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[PokemonHabitatSummary] = summon[RW[ujson.Value]].bimap[PokemonHabitatSummary](_.asJson, json => read[PokemonHabitatSummaryData](json).asModel)
