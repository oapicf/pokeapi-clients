...
def asData : PokemonSpeciesSummaryData = {
PokemonSpeciesSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[PokemonSpeciesSummary] = summon[RW[ujson.Value]].bimap[PokemonSpeciesSummary](_.asJson, json => read[PokemonSpeciesSummaryData](json).asModel)
