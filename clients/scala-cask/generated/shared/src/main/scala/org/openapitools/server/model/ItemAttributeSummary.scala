...
def asData : ItemAttributeSummaryData = {
ItemAttributeSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[ItemAttributeSummary] = summon[RW[ujson.Value]].bimap[ItemAttributeSummary](_.asJson, json => read[ItemAttributeSummaryData](json).asModel)
