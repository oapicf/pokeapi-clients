...
def asData : MoveLearnMethodSummaryData = {
MoveLearnMethodSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[MoveLearnMethodSummary] = summon[RW[ujson.Value]].bimap[MoveLearnMethodSummary](_.asJson, json => read[MoveLearnMethodSummaryData](json).asModel)
