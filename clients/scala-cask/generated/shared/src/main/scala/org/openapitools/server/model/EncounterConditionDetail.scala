...
def asData : EncounterConditionDetailData = {
EncounterConditionDetailData(
    id = id /* 2 */,
    name = name /* 2 */,
...
given RW[EncounterConditionDetail] = summon[RW[ujson.Value]].bimap[EncounterConditionDetail](_.asJson, json => read[EncounterConditionDetailData](json).asModel)
