...
def asData : TypeDetailPokemonInnerPokemonData = {
TypeDetailPokemonInnerPokemonData(
...
given RW[TypeDetailPokemonInnerPokemon] = summon[RW[ujson.Value]].bimap[TypeDetailPokemonInnerPokemon](_.asJson, json => read[TypeDetailPokemonInnerPokemonData](json).asModel)
