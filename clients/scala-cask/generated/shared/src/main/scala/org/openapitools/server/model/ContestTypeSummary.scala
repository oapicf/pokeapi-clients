...
def asData : ContestTypeSummaryData = {
ContestTypeSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[ContestTypeSummary] = summon[RW[ujson.Value]].bimap[ContestTypeSummary](_.asJson, json => read[ContestTypeSummaryData](json).asModel)
