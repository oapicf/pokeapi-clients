...
def asData : EvolutionChainSummaryData = {
EvolutionChainSummaryData(
    url = url.asData /* 8 */
...
given RW[EvolutionChainSummary] = summon[RW[ujson.Value]].bimap[EvolutionChainSummary](_.asJson, json => read[EvolutionChainSummaryData](json).asModel)
