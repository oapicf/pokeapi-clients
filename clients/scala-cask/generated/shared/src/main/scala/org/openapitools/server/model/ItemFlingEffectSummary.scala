...
def asData : ItemFlingEffectSummaryData = {
ItemFlingEffectSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[ItemFlingEffectSummary] = summon[RW[ujson.Value]].bimap[ItemFlingEffectSummary](_.asJson, json => read[ItemFlingEffectSummaryData](json).asModel)
