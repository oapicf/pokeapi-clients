...
def asData : LocationSummaryData = {
LocationSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[LocationSummary] = summon[RW[ujson.Value]].bimap[LocationSummary](_.asJson, json => read[LocationSummaryData](json).asModel)
