...
def asData : MoveMetaCategorySummaryData = {
MoveMetaCategorySummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[MoveMetaCategorySummary] = summon[RW[ujson.Value]].bimap[MoveMetaCategorySummary](_.asJson, json => read[MoveMetaCategorySummaryData](json).asModel)
