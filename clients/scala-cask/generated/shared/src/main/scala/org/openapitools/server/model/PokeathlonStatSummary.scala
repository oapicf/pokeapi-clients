...
def asData : PokeathlonStatSummaryData = {
PokeathlonStatSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[PokeathlonStatSummary] = summon[RW[ujson.Value]].bimap[PokeathlonStatSummary](_.asJson, json => read[PokeathlonStatSummaryData](json).asModel)
