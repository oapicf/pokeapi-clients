...
def asData : MoveDamageClassSummaryData = {
MoveDamageClassSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[MoveDamageClassSummary] = summon[RW[ujson.Value]].bimap[MoveDamageClassSummary](_.asJson, json => read[MoveDamageClassSummaryData](json).asModel)
