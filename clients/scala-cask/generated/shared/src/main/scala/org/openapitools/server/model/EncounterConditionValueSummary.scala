...
def asData : EncounterConditionValueSummaryData = {
EncounterConditionValueSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[EncounterConditionValueSummary] = summon[RW[ujson.Value]].bimap[EncounterConditionValueSummary](_.asJson, json => read[EncounterConditionValueSummaryData](json).asModel)
