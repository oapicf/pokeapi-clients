...
def asData : LanguageSummaryData = {
LanguageSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[LanguageSummary] = summon[RW[ujson.Value]].bimap[LanguageSummary](_.asJson, json => read[LanguageSummaryData](json).asModel)
