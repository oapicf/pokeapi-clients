...
def asData : LocationAreaSummaryData = {
LocationAreaSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[LocationAreaSummary] = summon[RW[ujson.Value]].bimap[LocationAreaSummary](_.asJson, json => read[LocationAreaSummaryData](json).asModel)
