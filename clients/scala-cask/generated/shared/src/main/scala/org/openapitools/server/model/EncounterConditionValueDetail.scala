...
def asData : EncounterConditionValueDetailData = {
EncounterConditionValueDetailData(
    id = id /* 2 */,
    name = name /* 2 */,
...
given RW[EncounterConditionValueDetail] = summon[RW[ujson.Value]].bimap[EncounterConditionValueDetail](_.asJson, json => read[EncounterConditionValueDetailData](json).asModel)
