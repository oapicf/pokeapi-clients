...
given RW[ItemCategoryDetail] = summon[RW[ujson.Value]].bimap[ItemCategoryDetail](_.asJson, json => read[ItemCategoryDetailData](json).asModel)
...
enum Fields(val fieldName : String) extends Field(fieldName) {
    ...
    case pocket extends Fields("pocket")
}
