...
def asData : VersionGroupSummaryData = {
VersionGroupSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[VersionGroupSummary] = summon[RW[ujson.Value]].bimap[VersionGroupSummary](_.asJson, json => read[VersionGroupSummaryData](json).asModel)
