...
def asData : GrowthRateDescriptionData = {
GrowthRateDescriptionData(
...
given RW[GrowthRateDescription] = summon[RW[ujson.Value]].bimap[GrowthRateDescription](_.asJson, json => read[GrowthRateDescriptionData](json).asModel)
