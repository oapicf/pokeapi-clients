...
def asData : AbilityDetailPokemonInnerPokemonData = {
AbilityDetailPokemonInnerPokemonData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[AbilityDetailPokemonInnerPokemon] = summon[RW[ujson.Value]].bimap[AbilityDetailPokemonInnerPokemon](_.asJson, json => read[AbilityDetailPokemonInnerPokemonData](json).asModel)
