...
def asData : BerryFlavorDetailBerriesInnerBerryData = {
BerryFlavorDetailBerriesInnerBerryData(
    name = name.getOrElse("") /*  1 */,
    url = url.map(_.asData).getOrElse("") /* 4 */
...
given RW[BerryFlavorDetailBerriesInnerBerry] = summon[RW[ujson.Value]].bimap[BerryFlavorDetailBerriesInnerBerry](_.asJson, json => read[BerryFlavorDetailBerriesInnerBerryData](json).asModel)
