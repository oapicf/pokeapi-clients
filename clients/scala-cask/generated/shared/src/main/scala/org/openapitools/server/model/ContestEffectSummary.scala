...
def asData : ContestEffectSummaryData = {
ContestEffectSummaryData(
    url = url.asData /* 8 */
...
given RW[ContestEffectSummary] = summon[RW[ujson.Value]].bimap[ContestEffectSummary](_.asJson, json => read[ContestEffectSummaryData](json).asModel)
