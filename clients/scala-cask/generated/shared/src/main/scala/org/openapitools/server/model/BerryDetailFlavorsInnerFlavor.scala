...
def asData : BerryDetailFlavorsInnerFlavorData = {
BerryDetailFlavorsInnerFlavorData(
...
given RW[BerryDetailFlavorsInnerFlavor] = summon[RW[ujson.Value]].bimap[BerryDetailFlavorsInnerFlavor](_.asJson, json => read[BerryDetailFlavorsInnerFlavorData](json).asModel)
