...
def asData : GenerationSummaryData = {
...
given RW[GenerationSummary] = summon[RW[ujson.Value]].bimap[GenerationSummary](_.asJson, json => read[GenerationSummaryData](json).asModel)
