...
def asData : PokedexDescriptionData = {
PokedexDescriptionData(
...
given RW[PokedexDescription] = summon[RW[ujson.Value]].bimap[PokedexDescription](_.asJson, json => read[PokedexDescriptionData](json).asModel)
