...
def asData : EggGroupSummaryData = {
EggGroupSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[EggGroupSummary] = summon[RW[ujson.Value]].bimap[EggGroupSummary](_.asJson, json => read[EggGroupSummaryData](json).asModel)
