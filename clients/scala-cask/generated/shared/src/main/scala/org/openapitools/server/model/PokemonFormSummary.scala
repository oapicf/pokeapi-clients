...
def asData : PokemonFormSummaryData = {
PokemonFormSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[PokemonFormSummary] = summon[RW[ujson.Value]].bimap[PokemonFormSummary](_.asJson, json => read[PokemonFormSummaryData](json).asModel)
