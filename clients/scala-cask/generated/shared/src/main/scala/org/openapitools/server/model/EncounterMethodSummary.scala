...
def asData : EncounterMethodSummaryData = {
EncounterMethodSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[EncounterMethodSummary] = summon[RW[ujson.Value]].bimap[EncounterMethodSummary](_.asJson, json => read[EncounterMethodSummaryData](json).asModel)
