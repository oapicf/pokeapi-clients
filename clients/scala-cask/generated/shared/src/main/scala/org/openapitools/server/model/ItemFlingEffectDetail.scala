...
def asData : ItemFlingEffectDetailData = {
ItemFlingEffectDetailData(
    id = id /* 2 */,
    name = name /* 2 */,
...
given RW[ItemFlingEffectDetail] = summon[RW[ujson.Value]].bimap[ItemFlingEffectDetail](_.asJson, json => read[ItemFlingEffectDetailData](json).asModel)
