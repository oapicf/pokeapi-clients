...
def asData : PokemonShapeDetailNamesInnerData = {
PokemonShapeDetailNamesInnerData(
    url = url.asData /* 8 */,
    name = name /* 2 */
...
given RW[PokemonShapeDetailNamesInner] = summon[RW[ujson.Value]].bimap[PokemonShapeDetailNamesInner](_.asJson, json => read[PokemonShapeDetailNamesInnerData](json).asModel)
