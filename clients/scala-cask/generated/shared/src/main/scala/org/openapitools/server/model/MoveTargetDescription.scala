...
def asData : MoveTargetDescriptionData = {
MoveTargetDescriptionData(
...
given RW[MoveTargetDescription] = summon[RW[ujson.Value]].bimap[MoveTargetDescription](_.asJson, json => read[MoveTargetDescriptionData](json).asModel)
