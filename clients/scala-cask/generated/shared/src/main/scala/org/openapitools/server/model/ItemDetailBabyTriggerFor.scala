...
def asData : ItemDetailBabyTriggerForData = {
ItemDetailBabyTriggerForData(
    url = url.asData /* 8 */
...
given RW[ItemDetailBabyTriggerFor] = summon[RW[ujson.Value]].bimap[ItemDetailBabyTriggerFor](_.asJson, json => read[ItemDetailBabyTriggerForData](json).asModel)
