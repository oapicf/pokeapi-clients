...
def asData : PokemonDetailTypesInnerData = {
PokemonDetailTypesInnerData(
    slot = slot /* 2 */,
    `type` = `type`.asData /* 8 */
...
given RW[PokemonDetailTypesInner] = summon[RW[ujson.Value]].bimap[PokemonDetailTypesInner](_.asJson, json => read[PokemonDetailTypesInnerData](json).asModel)
