...
def asData : ItemCategorySummaryData = {
ItemCategorySummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[ItemCategorySummary] = summon[RW[ujson.Value]].bimap[ItemCategorySummary](_.asJson, json => read[ItemCategorySummaryData](json).asModel)
