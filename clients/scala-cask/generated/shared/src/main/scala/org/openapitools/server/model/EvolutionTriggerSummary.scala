...
def asData : EvolutionTriggerSummaryData = {
EvolutionTriggerSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[EvolutionTriggerSummary] = summon[RW[ujson.Value]].bimap[EvolutionTriggerSummary](_.asJson, json => read[EvolutionTriggerSummaryData](json).asModel)
