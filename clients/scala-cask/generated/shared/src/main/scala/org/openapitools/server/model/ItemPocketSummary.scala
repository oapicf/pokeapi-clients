...
def asData : ItemPocketSummaryData = {
ItemPocketSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[ItemPocketSummary] = summon[RW[ujson.Value]].bimap[ItemPocketSummary](_.asJson, json => read[ItemPocketSummaryData](json).asModel)
