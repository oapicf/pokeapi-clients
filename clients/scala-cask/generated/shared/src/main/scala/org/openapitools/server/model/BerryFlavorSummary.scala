...
def asData : BerryFlavorSummaryData = {
BerryFlavorSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[BerryFlavorSummary] = summon[RW[ujson.Value]].bimap[BerryFlavorSummary](_.asJson, json => read[BerryFlavorSummaryData](json).asModel)
