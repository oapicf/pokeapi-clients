...
def asData : BerryFirmnessSummaryData = {
BerryFirmnessSummaryData(
    name = name /* 2 */,
    url = url.asData /* 8 */
...
given RW[BerryFirmnessSummary] = summon[RW[ujson.Value]].bimap[BerryFirmnessSummary](_.asJson, json => read[BerryFirmnessSummaryData](json).asModel)
