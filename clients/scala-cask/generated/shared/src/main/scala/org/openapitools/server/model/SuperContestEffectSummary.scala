...
def asData : SuperContestEffectSummaryData = {
SuperContestEffectSummaryData(
    url = url.asData /* 8 */
...
given RW[SuperContestEffectSummary] = summon[RW[ujson.Value]].bimap[SuperContestEffectSummary](_.asJson, json => read[SuperContestEffectSummaryData](json).asModel)
