...
```shell
gem install ./pokeapi_client-1.0.0-pre.0.gem
```

(for development, run `gem install --dev ./pokeapi_client-1.0.0-pre.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'pokeapi_client', '~> 1.0.0-pre.0'
