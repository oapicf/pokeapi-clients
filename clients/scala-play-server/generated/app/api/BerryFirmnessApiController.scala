...
@Singleton
class BerryFirmnessApiController @Inject()(cc: ControllerComponents, api: BerryFirmnessApi) extends AbstractController(cc) {
  /**
  ...
  /**
    ...
    */
  def berryFirmnessRead(id: Int): Action[AnyContent] = Action { request =>
    def executeApi(): String = {
