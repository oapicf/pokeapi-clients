...
public class PaginatedEvolutionChainSummaryList {
  ...
  public PaginatedEvolutionChainSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedEvolutionChainSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedEvolutionChainSummaryList previous(@Nullable URI previous) {
