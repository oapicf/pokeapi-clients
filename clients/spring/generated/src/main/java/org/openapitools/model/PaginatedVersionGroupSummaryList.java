...
public class PaginatedVersionGroupSummaryList {
  ...
  public PaginatedVersionGroupSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedVersionGroupSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedVersionGroupSummaryList previous(@Nullable URI previous) {
