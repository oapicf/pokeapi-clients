...
public class PaginatedBerryFlavorSummaryList {
  ...
  public PaginatedBerryFlavorSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedBerryFlavorSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedBerryFlavorSummaryList previous(@Nullable URI previous) {
