...
public class PaginatedEncounterMethodSummaryList {
  ...
  public PaginatedEncounterMethodSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedEncounterMethodSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedEncounterMethodSummaryList previous(@Nullable URI previous) {
