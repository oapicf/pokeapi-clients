...
public class PaginatedEggGroupSummaryList {
  ...
  public PaginatedEggGroupSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedEggGroupSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedEggGroupSummaryList previous(@Nullable URI previous) {
