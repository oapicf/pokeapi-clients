...
public class PaginatedItemFlingEffectSummaryList {
  ...
  @Valid
  private List<@Valid ItemFlingEffectSummary> results = new ArrayList<>();

  public PaginatedItemFlingEffectSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedItemFlingEffectSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedItemFlingEffectSummaryList previous(@Nullable URI previous) {
