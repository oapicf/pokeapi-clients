...
public class PaginatedVersionSummaryList {
  ...
  public PaginatedVersionSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedVersionSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedVersionSummaryList previous(@Nullable URI previous) {
