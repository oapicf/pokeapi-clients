...
public class PaginatedStatSummaryList {
  ...
  public PaginatedStatSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedStatSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedStatSummaryList previous(@Nullable URI previous) {
