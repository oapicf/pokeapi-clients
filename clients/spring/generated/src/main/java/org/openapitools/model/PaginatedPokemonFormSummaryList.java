...
public class PaginatedPokemonFormSummaryList {
  ...
  public PaginatedPokemonFormSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedPokemonFormSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedPokemonFormSummaryList previous(@Nullable URI previous) {
