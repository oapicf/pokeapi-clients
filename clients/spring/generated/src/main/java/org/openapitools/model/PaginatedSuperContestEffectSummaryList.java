...
public class PaginatedSuperContestEffectSummaryList {
  ...
  public PaginatedSuperContestEffectSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedSuperContestEffectSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedSuperContestEffectSummaryList previous(@Nullable URI previous) {
