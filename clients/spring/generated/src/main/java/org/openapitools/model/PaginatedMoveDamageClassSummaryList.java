...
public class PaginatedMoveDamageClassSummaryList {
  ...
  @Valid
  private List<@Valid MoveDamageClassSummary> results = new ArrayList<>();

  public PaginatedMoveDamageClassSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedMoveDamageClassSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedMoveDamageClassSummaryList previous(@Nullable URI previous) {
