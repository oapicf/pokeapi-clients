...
public class PaginatedBerryFirmnessSummaryList {
  ...
  @Valid
  private List<@Valid BerryFirmnessSummary> results = new ArrayList<>();

  public PaginatedBerryFirmnessSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedBerryFirmnessSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedBerryFirmnessSummaryList previous(@Nullable URI previous) {
