...
public class PaginatedAbilitySummaryList {
  ...
  @Valid
  private List<@Valid AbilitySummary> results = new ArrayList<>();

  public PaginatedAbilitySummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedAbilitySummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedAbilitySummaryList previous(@Nullable URI previous) {
  ...
  public List<@Valid AbilitySummary> getResults() {
    return results;
  }
