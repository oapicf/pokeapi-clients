...
public class PaginatedMoveMetaCategorySummaryList {
  ...
  @Valid
  private List<@Valid MoveMetaCategorySummary> results = new ArrayList<>();

  public PaginatedMoveMetaCategorySummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedMoveMetaCategorySummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedMoveMetaCategorySummaryList previous(@Nullable URI previous) {
  ...
  public PaginatedMoveMetaCategorySummaryList results(List<@Valid MoveMetaCategorySummary> results) {
  ...
  public List<@Valid MoveMetaCategorySummary> getResults() {
    return results;
  }

  public void setResults(List<@Valid MoveMetaCategorySummary> results) {
    this.results = results;
  }
