...
public class PaginatedCharacteristicSummaryList {
  ...
  public PaginatedCharacteristicSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedCharacteristicSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedCharacteristicSummaryList previous(@Nullable URI previous) {
