...
public class PaginatedPokemonSummaryList {
  ...
  public PaginatedPokemonSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedPokemonSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedPokemonSummaryList previous(@Nullable URI previous) {
