...
public class PaginatedPokeathlonStatSummaryList {
  ...
  @Valid
  private List<@Valid PokeathlonStatSummary> results = new ArrayList<>();

  public PaginatedPokeathlonStatSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedPokeathlonStatSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedPokeathlonStatSummaryList previous(@Nullable URI previous) {
