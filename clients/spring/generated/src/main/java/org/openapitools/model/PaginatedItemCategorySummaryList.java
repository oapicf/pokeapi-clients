...
public class PaginatedItemCategorySummaryList {
  ...
  public PaginatedItemCategorySummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedItemCategorySummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedItemCategorySummaryList previous(@Nullable URI previous) {
