...
public class PokemonEncountersRetrieve200ResponseInnerLocationArea {
   ...
   */
  public PokemonEncountersRetrieve200ResponseInnerLocationArea(String name, URI url) {
    this.name = name;
    this.url = url;
  }
   ...
   */
  @NotNull 
  @Schema(name = "name", example = "cerulean-city-area", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("name")
   ...
   */
  @NotNull @Valid 
  @Schema(name = "url", example = "https://pokeapi.co/api/v2/location-area/281/", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("url")
  public URI getUrl() {
    return url;
  }
