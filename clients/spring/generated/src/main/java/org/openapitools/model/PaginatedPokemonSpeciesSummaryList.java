...
public class PaginatedPokemonSpeciesSummaryList {
  ...
  @Valid
  private List<@Valid PokemonSpeciesSummary> results = new ArrayList<>();

  public PaginatedPokemonSpeciesSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedPokemonSpeciesSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedPokemonSpeciesSummaryList previous(@Nullable URI previous) {
