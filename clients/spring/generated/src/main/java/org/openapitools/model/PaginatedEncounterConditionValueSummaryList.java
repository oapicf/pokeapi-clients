...
public class PaginatedEncounterConditionValueSummaryList {
  ...
  @Valid
  private List<@Valid EncounterConditionValueSummary> results = new ArrayList<>();

  public PaginatedEncounterConditionValueSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedEncounterConditionValueSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedEncounterConditionValueSummaryList previous(@Nullable URI previous) {
