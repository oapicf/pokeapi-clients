...
public class PaginatedEncounterConditionSummaryList {
  ...
  public PaginatedEncounterConditionSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedEncounterConditionSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedEncounterConditionSummaryList previous(@Nullable URI previous) {
