...
public class PaginatedPokemonColorSummaryList {
  ...
  public PaginatedPokemonColorSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedPokemonColorSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedPokemonColorSummaryList previous(@Nullable URI previous) {
