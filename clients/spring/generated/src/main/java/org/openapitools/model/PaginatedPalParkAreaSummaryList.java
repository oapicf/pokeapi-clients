...
public class PaginatedPalParkAreaSummaryList {
  ...
  @Valid
  private List<@Valid PalParkAreaSummary> results = new ArrayList<>();

  public PaginatedPalParkAreaSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedPalParkAreaSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedPalParkAreaSummaryList previous(@Nullable URI previous) {
