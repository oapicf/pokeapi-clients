...
public class PaginatedLanguageSummaryList {
  ...
  public PaginatedLanguageSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedLanguageSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedLanguageSummaryList previous(@Nullable URI previous) {
