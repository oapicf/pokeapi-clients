...
public class PaginatedItemSummaryList {
  ...
  public PaginatedItemSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedItemSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedItemSummaryList previous(@Nullable URI previous) {
