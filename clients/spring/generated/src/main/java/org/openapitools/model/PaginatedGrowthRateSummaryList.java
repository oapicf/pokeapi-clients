...
public class PaginatedGrowthRateSummaryList {
  ...
  public PaginatedGrowthRateSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedGrowthRateSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedGrowthRateSummaryList previous(@Nullable URI previous) {
