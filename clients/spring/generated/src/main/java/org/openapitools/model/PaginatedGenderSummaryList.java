...
public class PaginatedGenderSummaryList {
  ...
  public PaginatedGenderSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedGenderSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedGenderSummaryList previous(@Nullable URI previous) {
