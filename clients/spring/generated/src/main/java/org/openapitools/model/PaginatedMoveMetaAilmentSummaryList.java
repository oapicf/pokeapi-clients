...
public class PaginatedMoveMetaAilmentSummaryList {
  ...
  @Valid
  private List<@Valid MoveMetaAilmentSummary> results = new ArrayList<>();

  public PaginatedMoveMetaAilmentSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedMoveMetaAilmentSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedMoveMetaAilmentSummaryList previous(@Nullable URI previous) {
  ...
  public PaginatedMoveMetaAilmentSummaryList results(List<@Valid MoveMetaAilmentSummary> results) {
  ...
  public List<@Valid MoveMetaAilmentSummary> getResults() {
    return results;
  }

  public void setResults(List<@Valid MoveMetaAilmentSummary> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, paginatedMoveMetaAilmentSummaryList.count) &&
        Objects.equals(this.next, paginatedMoveMetaAilmentSummaryList.next) &&
        Objects.equals(this.previous, paginatedMoveMetaAilmentSummaryList.previous) &&
        Objects.equals(this.results, paginatedMoveMetaAilmentSummaryList.results);
  }
