...
public class PaginatedTypeSummaryList {
  ...
  public PaginatedTypeSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedTypeSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedTypeSummaryList previous(@Nullable URI previous) {
