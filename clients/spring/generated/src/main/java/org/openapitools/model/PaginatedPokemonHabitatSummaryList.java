...
public class PaginatedPokemonHabitatSummaryList {
  ...
  public PaginatedPokemonHabitatSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedPokemonHabitatSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedPokemonHabitatSummaryList previous(@Nullable URI previous) {
