...
public class PaginatedLocationAreaSummaryList {
  ...
  @Valid
  private List<@Valid LocationAreaSummary> results = new ArrayList<>();

  public PaginatedLocationAreaSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedLocationAreaSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedLocationAreaSummaryList previous(@Nullable URI previous) {
