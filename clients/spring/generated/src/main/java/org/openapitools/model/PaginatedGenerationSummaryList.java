...
public class PaginatedGenerationSummaryList {
  ...
  public PaginatedGenerationSummaryList count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginatedGenerationSummaryList next(@Nullable URI next) {
    this.next = next;
    return this;
  }
  ...
  public PaginatedGenerationSummaryList previous(@Nullable URI previous) {
