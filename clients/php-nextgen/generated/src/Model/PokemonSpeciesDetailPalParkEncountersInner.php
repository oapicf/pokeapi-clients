...
class PokemonSpeciesDetailPalParkEncountersInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PokemonSpeciesDetail_pal_park_encounters_inner';
     ...
     */
    public function getArea(): \OpenAPI\Client\Model\AbilityDetailPokemonInnerPokemon
    {
     ...
     * @return $this
     */
    public function setArea(\OpenAPI\Client\Model\AbilityDetailPokemonInnerPokemon $area): static
    {
        if (is_null($area)) {
