...
class VersionDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'VersionDetail';
    ...
    protected static array $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'names' => '\OpenAPI\Client\Model\VersionName[]',
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling VersionDetail., must be smaller than or equal to 100.');
        }
     ...
     * Gets names
     *
     * @return \OpenAPI\Client\Model\VersionName[]
     */
     ...
     * Sets names
     *
     * @param \OpenAPI\Client\Model\VersionName[] $names names
     *
     * @return $this
     */
