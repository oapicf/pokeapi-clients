...
/**
 * PokemonDetailCries Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PokemonDetailCries implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PokemonDetail_cries';
     ...
     * @return $this
     */
    public function setLegacy(string $legacy): static
    {
        if (is_null($legacy)) {
