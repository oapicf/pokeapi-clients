...
/**
 * PokemonDetailAbilitiesInner Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PokemonDetailAbilitiesInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'PokemonDetail_abilities_inner';
    ...
    protected static array $openAPITypes = [
        'ability' => '\OpenAPI\Client\Model\AbilityDetailPokemonInnerPokemon',
        'is_hidden' => 'bool',
        'slot' => 'int'
    ];
    ...
    {
        $this->setIfExists('ability', $data ?? [], null);
     ...
     */
    public function getAbility(): \OpenAPI\Client\Model\AbilityDetailPokemonInnerPokemon
    {
     ...
     * Sets ability
     *
     * @param \OpenAPI\Client\Model\AbilityDetailPokemonInnerPokemon $ability ability
     *
     * @return $this
     */
    public function setAbility(\OpenAPI\Client\Model\AbilityDetailPokemonInnerPokemon $ability): static
    {
        if (is_null($ability)) {
            throw new InvalidArgumentException('non-nullable ability cannot be null');
        }
