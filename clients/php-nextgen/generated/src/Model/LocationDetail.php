...
/**
 * LocationDetail Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LocationDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'LocationDetail';
    ...
    protected static array $openAPITypes = [
        ...
        'names' => '\OpenAPI\Client\Model\LocationName[]',
        'game_indices' => '\OpenAPI\Client\Model\LocationGameIndex[]',
        'areas' => '\OpenAPI\Client\Model\LocationAreaSummary[]'
    ];
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling LocationDetail., must be smaller than or equal to 100.');
        }
     ...
     * Gets names
     *
     * @return \OpenAPI\Client\Model\LocationName[]
     */
     ...
     * Sets names
     *
     * @param \OpenAPI\Client\Model\LocationName[] $names names
     *
     * @return $this
     */
     ...
     * Gets game_indices
     *
     * @return \OpenAPI\Client\Model\LocationGameIndex[]
     */
     ...
     * Sets game_indices
     *
     * @param \OpenAPI\Client\Model\LocationGameIndex[] $game_indices game_indices
     *
     * @return $this
     */
     ...
     * Gets areas
     *
     * @return \OpenAPI\Client\Model\LocationAreaSummary[]
     */
     ...
     * Sets areas
     *
     * @param \OpenAPI\Client\Model\LocationAreaSummary[] $areas areas
     *
     * @return $this
     */
