...
/**
 * MoveDamageClassDetail Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MoveDamageClassDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MoveDamageClassDetail';
    ...
    protected static array $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'descriptions' => '\OpenAPI\Client\Model\MoveDamageClassDescription[]',
        'moves' => '\OpenAPI\Client\Model\MoveSummary[]',
        'names' => '\OpenAPI\Client\Model\MoveDamageClassName[]'
    ];
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling MoveDamageClassDetail., must be smaller than or equal to 100.');
        }
     ...
     * Gets descriptions
     *
     * @return \OpenAPI\Client\Model\MoveDamageClassDescription[]
     */
     ...
     * Sets descriptions
     *
     * @param \OpenAPI\Client\Model\MoveDamageClassDescription[] $descriptions descriptions
     *
     * @return $this
     */
     ...
     * Gets names
     *
     * @return \OpenAPI\Client\Model\MoveDamageClassName[]
     */
     ...
     * Sets names
     *
     * @param \OpenAPI\Client\Model\MoveDamageClassName[] $names names
     *
     * @return $this
     */
