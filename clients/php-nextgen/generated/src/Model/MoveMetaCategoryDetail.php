...
/**
 * MoveMetaCategoryDetail Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MoveMetaCategoryDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MoveMetaCategoryDetail';
    ...
    protected static array $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'descriptions' => '\OpenAPI\Client\Model\MoveMetaCategoryDescription[]',
        'moves' => '\OpenAPI\Client\Model\AbilityDetailPokemonInnerPokemon[]'
    ];
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling MoveMetaCategoryDetail., must be smaller than or equal to 100.');
        }
     ...
     * Gets descriptions
     *
     * @return \OpenAPI\Client\Model\MoveMetaCategoryDescription[]
     */
     ...
     * Sets descriptions
     *
     * @param \OpenAPI\Client\Model\MoveMetaCategoryDescription[] $descriptions descriptions
     *
     * @return $this
     */
     ...
     * Sets moves
     *
     * @param \OpenAPI\Client\Model\AbilityDetailPokemonInnerPokemon[] $moves moves
     *
     * @return $this
     */
