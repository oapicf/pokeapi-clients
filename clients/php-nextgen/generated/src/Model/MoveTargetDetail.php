...
/**
 * MoveTargetDetail Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MoveTargetDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'MoveTargetDetail';
    ...
    protected static array $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'descriptions' => '\OpenAPI\Client\Model\MoveTargetDescription[]',
        'moves' => '\OpenAPI\Client\Model\MoveSummary[]',
        'names' => '\OpenAPI\Client\Model\MoveTargetName[]'
    ];
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling MoveTargetDetail., must be smaller than or equal to 100.');
        }
     ...
     * Gets descriptions
     *
     * @return \OpenAPI\Client\Model\MoveTargetDescription[]
     */
     ...
     * Sets descriptions
     *
     * @param \OpenAPI\Client\Model\MoveTargetDescription[] $descriptions descriptions
     *
     * @return $this
     */
     ...
     * Gets names
     *
     * @return \OpenAPI\Client\Model\MoveTargetName[]
     */
     ...
     * Sets names
     *
     * @param \OpenAPI\Client\Model\MoveTargetName[] $names names
     *
     * @return $this
     */
