...
public struct BerryDetail: Codable {
    public var id: Int
    ...
    public init(from decoder: Decoder) throws {
        ...
        firmness = try container.decode(BerryFirmnessSummary.self, forKey: .firmness)
        flavors = try container.decode([BerryDetailFlavorsInner].self, forKey: .flavors)
        item = try container.decode(ItemSummary.self, forKey: .item)
        naturalGiftType = try container.decode(TypeSummary.self, forKey: .naturalGiftType)
    }
