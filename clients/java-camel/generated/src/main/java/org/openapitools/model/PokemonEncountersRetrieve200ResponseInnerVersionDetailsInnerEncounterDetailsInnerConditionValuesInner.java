...
@JsonTypeName("pokemon_encounters_retrieve_200_response_inner_version_details_inner_encounter_details_inner_condition_values_inner")
...
public class PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerConditionValuesInner {
  ...
  public PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerConditionValuesInner() {
    super();
  }
   ...
   */
  public PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerConditionValuesInner(String name, URI url) {
    this.name = name;
    this.url = url;
  }
   ...
   */
  @NotNull 
  @Schema(name = "name", example = "story-progress-beat-red", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("name")
   ...
   */
  @NotNull @Valid 
  @Schema(name = "url", example = "https://pokeapi.co/api/v2/encounter-condition-value/55/", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("url")
  public URI getUrl() {
    return url;
  }
