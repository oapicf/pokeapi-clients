...
import 'package:openapi/src/model/berry_detail.dart';
import 'package:openapi/src/model/berry_firmness_detail.dart';
import 'package:openapi/src/model/berry_flavor_detail.dart';
import 'package:openapi/src/model/paginated_berry_firmness_summary_list.dart';
import 'package:openapi/src/model/paginated_berry_flavor_summary_list.dart';
import 'package:openapi/src/model/paginated_berry_summary_list.dart';
...
class BerriesApi {
  ...
  const BerriesApi(this._dio, this._serializers);
  ...
  Future<Response<PaginatedBerryFirmnessSummaryList>> berryFirmnessList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedBerryFirmnessSummaryList),
  ...
  Future<Response<BerryFirmnessDetail>> berryFirmnessRetrieve({ 
    ...
    final _path = r'/api/v2/berry-firmness/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BerryFirmnessDetail),
  ...
  Future<Response<PaginatedBerryFlavorSummaryList>> berryFlavorList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedBerryFlavorSummaryList),
  ...
  Future<Response<BerryFlavorDetail>> berryFlavorRetrieve({ 
    ...
    final _path = r'/api/v2/berry-flavor/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BerryFlavorDetail),
  ...
  Future<Response<PaginatedBerrySummaryList>> berryList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedBerrySummaryList),
  ...
  Future<Response<BerryDetail>> berryRetrieve({ 
    ...
    final _path = r'/api/v2/berry/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BerryDetail),
      ) as BerryDetail;
