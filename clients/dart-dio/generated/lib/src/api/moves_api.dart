...
import 'package:openapi/src/model/move_battle_style_detail.dart';
import 'package:openapi/src/model/move_detail.dart';
import 'package:openapi/src/model/move_learn_method_detail.dart';
import 'package:openapi/src/model/move_meta_ailment_detail.dart';
import 'package:openapi/src/model/move_meta_category_detail.dart';
import 'package:openapi/src/model/move_target_detail.dart';
import 'package:openapi/src/model/paginated_move_battle_style_summary_list.dart';
import 'package:openapi/src/model/paginated_move_learn_method_summary_list.dart';
import 'package:openapi/src/model/paginated_move_meta_ailment_summary_list.dart';
import 'package:openapi/src/model/paginated_move_meta_category_summary_list.dart';
import 'package:openapi/src/model/paginated_move_summary_list.dart';
import 'package:openapi/src/model/paginated_move_target_summary_list.dart';
...
class MovesApi {
  ...
  Future<Response<PaginatedMoveMetaAilmentSummaryList>> moveAilmentList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedMoveMetaAilmentSummaryList),
  ...
  Future<Response<MoveMetaAilmentDetail>> moveAilmentRetrieve({ 
    ...
    final _path = r'/api/v2/move-ailment/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PaginatedMoveBattleStyleSummaryList>> moveBattleStyleList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedMoveBattleStyleSummaryList),
  ...
  Future<Response<MoveBattleStyleDetail>> moveBattleStyleRetrieve({ 
    ...
    final _path = r'/api/v2/move-battle-style/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PaginatedMoveMetaCategorySummaryList>> moveCategoryList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedMoveMetaCategorySummaryList),
  ...
  Future<Response<MoveMetaCategoryDetail>> moveCategoryRetrieve({ 
    ...
    final _path = r'/api/v2/move-category/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PaginatedMoveLearnMethodSummaryList>> moveLearnMethodList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedMoveLearnMethodSummaryList),
  ...
  Future<Response<MoveLearnMethodDetail>> moveLearnMethodRetrieve({ 
    ...
    final _path = r'/api/v2/move-learn-method/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<MoveDetail>> moveRetrieve({ 
    ...
    final _path = r'/api/v2/move/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<MoveTargetDetail>> moveTargetRetrieve({ 
    ...
    final _path = r'/api/v2/move-target/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
