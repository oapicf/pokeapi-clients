...
import 'package:openapi/src/model/evolution_chain_detail.dart';
import 'package:openapi/src/model/evolution_trigger_detail.dart';
import 'package:openapi/src/model/paginated_evolution_chain_summary_list.dart';
import 'package:openapi/src/model/paginated_evolution_trigger_summary_list.dart';
...
class EvolutionApi {
  ...
  const EvolutionApi(this._dio, this._serializers);
  ...
  Future<Response<PaginatedEvolutionChainSummaryList>> evolutionChainList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedEvolutionChainSummaryList),
  ...
  Future<Response<EvolutionChainDetail>> evolutionChainRetrieve({ 
    ...
    final _path = r'/api/v2/evolution-chain/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EvolutionChainDetail),
  ...
  Future<Response<PaginatedEvolutionTriggerSummaryList>> evolutionTriggerList({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedEvolutionTriggerSummaryList),
  ...
  Future<Response<EvolutionTriggerDetail>> evolutionTriggerRetrieve({ 
    ...
    final _path = r'/api/v2/evolution-trigger/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EvolutionTriggerDetail),
