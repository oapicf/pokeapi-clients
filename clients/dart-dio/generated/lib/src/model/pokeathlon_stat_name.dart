...
/// * [language] 
@BuiltValue()
abstract class PokeathlonStatName implements Built<PokeathlonStatName, PokeathlonStatNameBuilder> {
  ...
  factory PokeathlonStatName([void updates(PokeathlonStatNameBuilder b)]) = _$PokeathlonStatName;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PokeathlonStatNameBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PokeathlonStatName> get serializer => _$PokeathlonStatNameSerializer();
}

class _$PokeathlonStatNameSerializer implements PrimitiveSerializer<PokeathlonStatName> {
  @override
