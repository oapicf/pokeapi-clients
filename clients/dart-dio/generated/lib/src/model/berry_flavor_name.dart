...
/// * [language] 
@BuiltValue()
abstract class BerryFlavorName implements Built<BerryFlavorName, BerryFlavorNameBuilder> {
  ...
  factory BerryFlavorName([void updates(BerryFlavorNameBuilder b)]) = _$BerryFlavorName;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BerryFlavorNameBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BerryFlavorName> get serializer => _$BerryFlavorNameSerializer();
}

class _$BerryFlavorNameSerializer implements PrimitiveSerializer<BerryFlavorName> {
  @override
