...
/// * [language] 
@BuiltValue()
abstract class PokedexDescription implements Built<PokedexDescription, PokedexDescriptionBuilder> {
  ...
  factory PokedexDescription([void updates(PokedexDescriptionBuilder b)]) = _$PokedexDescription;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PokedexDescriptionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PokedexDescription> get serializer => _$PokedexDescriptionSerializer();
}

class _$PokedexDescriptionSerializer implements PrimitiveSerializer<PokedexDescription> {
  @override
