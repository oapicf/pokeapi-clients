...
/// * [results] 
@BuiltValue()
abstract class PaginatedItemSummaryList implements Built<PaginatedItemSummaryList, PaginatedItemSummaryListBuilder> {
  ...
  factory PaginatedItemSummaryList([void updates(PaginatedItemSummaryListBuilder b)]) = _$PaginatedItemSummaryList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedItemSummaryListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedItemSummaryList> get serializer => _$PaginatedItemSummaryListSerializer();
}

class _$PaginatedItemSummaryListSerializer implements PrimitiveSerializer<PaginatedItemSummaryList> {
  @override
  final Iterable<Type> types = const [PaginatedItemSummaryList, _$PaginatedItemSummaryList];
