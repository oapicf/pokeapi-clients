...
/// * [results] 
@BuiltValue()
abstract class PaginatedMoveSummaryList implements Built<PaginatedMoveSummaryList, PaginatedMoveSummaryListBuilder> {
  ...
  factory PaginatedMoveSummaryList([void updates(PaginatedMoveSummaryListBuilder b)]) = _$PaginatedMoveSummaryList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedMoveSummaryListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedMoveSummaryList> get serializer => _$PaginatedMoveSummaryListSerializer();
}

class _$PaginatedMoveSummaryListSerializer implements PrimitiveSerializer<PaginatedMoveSummaryList> {
  @override
  final Iterable<Type> types = const [PaginatedMoveSummaryList, _$PaginatedMoveSummaryList];
