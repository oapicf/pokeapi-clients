...
export default {
    Query: {
        ...
        VersionGroupList: ($limit, $offset, $q) => {
            return {
                "limit": "56",
                "offset": "56",
                "q": "q_example"
