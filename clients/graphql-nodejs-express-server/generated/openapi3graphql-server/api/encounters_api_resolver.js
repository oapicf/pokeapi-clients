...
export default {
    Query: {
        ...
        EncounterConditionList: ($limit, $offset, $q) => {
            return {
                "limit": "56",
                "offset": "56",
                "q": "q_example"
        ...
        EncounterConditionRetrieve: ($Id_) => {
            return {
                "Id_": "Id__example"
            };
        },
        ...
        EncounterConditionValueList: ($limit, $offset, $q) => {
            return {
                "limit": "56",
                "offset": "56",
                "q": "q_example"
        ...
        EncounterConditionValueRetrieve: ($Id_) => {
            return {
                "Id_": "Id__example"
            };
        },
        ...
        EncounterMethodList: ($limit, $offset, $q) => {
            return {
                "limit": "56",
                "offset": "56",
                "q": "q_example"
