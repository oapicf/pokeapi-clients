...
@Controller
@Tag(name = "BerryFirmness", description = "The BerryFirmness API")
public class BerryFirmnessController {
    ...
    public Mono<String> berryFirmnessList(
    ...
    @Produces(value = {"text/plain"})
    @Secured({SecurityRule.IS_ANONYMOUS})
    public Mono<String> berryFirmnessRead(
        @PathVariable(value="id") @NotNull Integer id
    ) {
        // TODO implement berryFirmnessRead();
        return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
    }
