...
@Controller
@Tag(name = "BerryFlavor", description = "The BerryFlavor API")
public class BerryFlavorController {
    ...
    public Mono<String> berryFlavorList(
    ...
    @Produces(value = {"text/plain"})
    @Secured({SecurityRule.IS_ANONYMOUS})
    public Mono<String> berryFlavorRead(
        @PathVariable(value="id") @NotNull Integer id
    ) {
        // TODO implement berryFlavorRead();
        return Mono.error(new HttpStatusException(HttpStatus.NOT_IMPLEMENTED, null));
    }
