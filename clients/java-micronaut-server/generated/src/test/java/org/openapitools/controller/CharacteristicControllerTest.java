...
/**
 * API tests for CharacteristicController
 */
@MicronautTest
public class CharacteristicControllerTest {
    ...
    void characteristicListMethodTest() {
        ...
        // when
        String result = controller.characteristicList(limit, offset).block();
    ...
    void characteristicListClientApiTest() throws IOException {
        ...
        MutableHttpRequest<?> request = HttpRequest.GET(uri)
            .accept("[Ljava.lang.String;@5be052ca");
    ...
    /**
     * This test is used to validate the implementation of characteristicRead() method
     *
     * The method should: 
     *
     * TODO fill in the parameters and test return value.
    ...
    @Test
    @Disabled("Not Implemented")
    void characteristicReadMethodTest() {
        // given
        Integer id = 56;

        // when
        String result = controller.characteristicRead(id).block();
    ...
    /**
     * This test is used to check that the api available to client through
     * '/api/v2/characteristic/{id}/' to the features of characteristicRead() works as desired.
     *
     * TODO fill in the request parameters and test response.
     */
    @Test
    @Disabled("Not Implemented")
    void characteristicReadClientApiTest() throws IOException {
        // given
        ...
        MutableHttpRequest<?> request = HttpRequest.GET(uri)
            .accept("[Ljava.lang.String;@2007435e");
