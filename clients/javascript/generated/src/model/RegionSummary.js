...
class RegionSummary {
    ...
    constructor(name, url) { 
        ...
        RegionSummary.initialize(this, name, url);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of RegionSummary.RequiredProperties) {
...
RegionSummary.RequiredProperties = ["name", "url"];
 ...
 * @member {String} url
 */
RegionSummary.prototype['url'] = undefined;
