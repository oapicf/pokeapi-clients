...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PokeapiClient.ItemAttributeDetail();
  });
  ...
  describe('ItemAttributeDetail', function() {
    it('should create an instance of ItemAttributeDetail', function() {
      // uncomment below and update the code to test ItemAttributeDetail
      //var instance = new PokeapiClient.ItemAttributeDetail();
      //expect(instance).to.be.a(PokeapiClient.ItemAttributeDetail);
    });
