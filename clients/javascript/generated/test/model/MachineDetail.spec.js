...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PokeapiClient.MachineDetail();
  });
  ...
  describe('MachineDetail', function() {
    it('should create an instance of MachineDetail', function() {
      // uncomment below and update the code to test MachineDetail
      //var instance = new PokeapiClient.MachineDetail();
      //expect(instance).to.be.a(PokeapiClient.MachineDetail);
    });
