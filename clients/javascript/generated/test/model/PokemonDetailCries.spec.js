...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PokeapiClient.PokemonDetailCries();
  });
  ...
  describe('PokemonDetailCries', function() {
    it('should create an instance of PokemonDetailCries', function() {
      // uncomment below and update the code to test PokemonDetailCries
      //var instance = new PokeapiClient.PokemonDetailCries();
      //expect(instance).to.be.a(PokeapiClient.PokemonDetailCries);
    });
