...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PokeapiClient.PokemonDetailAbilitiesInner();
  });
  ...
  describe('PokemonDetailAbilitiesInner', function() {
    it('should create an instance of PokemonDetailAbilitiesInner', function() {
      // uncomment below and update the code to test PokemonDetailAbilitiesInner
      //var instance = new PokeapiClient.PokemonDetailAbilitiesInner();
      //expect(instance).to.be.a(PokeapiClient.PokemonDetailAbilitiesInner);
    });
