...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PokeapiClient.VersionDetail();
  });
  ...
  describe('VersionDetail', function() {
    it('should create an instance of VersionDetail', function() {
      // uncomment below and update the code to test VersionDetail
      //var instance = new PokeapiClient.VersionDetail();
      //expect(instance).to.be.a(PokeapiClient.VersionDetail);
    });
