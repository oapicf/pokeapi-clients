...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PokeapiClient.GrowthRateDetail();
  });
  ...
  describe('GrowthRateDetail', function() {
    it('should create an instance of GrowthRateDetail', function() {
      // uncomment below and update the code to test GrowthRateDetail
      //var instance = new PokeapiClient.GrowthRateDetail();
      //expect(instance).to.be.a(PokeapiClient.GrowthRateDetail);
    });
