...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.LocationApi();
  });
  ...
  describe('LocationApi', function() {
    ...
    describe('locationRead', function() {
      it('should call locationRead successfully', function(done) {
        //uncomment below and update the code to test locationRead
        //instance.locationRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
