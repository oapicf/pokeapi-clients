# openapi_client.EncounterConditionApi
...
from openapi_client.api import encounter_condition_api
...
Type | Description | Notes
------------- | ------------- | -------------
**int** | A unique integer value identifying this encounter condition. | 
