...
import org.openapitools.vertxweb.server.model.EggGroupSummary;
...
public class PaginatedEggGroupSummaryList   {
  ...
  public PaginatedEggGroupSummaryList (Integer count, URI next, URI previous, List<EggGroupSummary> results) {
    this.count = count;
    this.next = next;
