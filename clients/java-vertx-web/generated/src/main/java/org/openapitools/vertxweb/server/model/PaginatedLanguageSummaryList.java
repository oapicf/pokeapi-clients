...
public class PaginatedLanguageSummaryList   {
  ...
  private List<LanguageSummary> results = new ArrayList<>();

  public PaginatedLanguageSummaryList () {

  }

  public PaginatedLanguageSummaryList (Integer count, URI next, URI previous, List<LanguageSummary> results) {
    this.count = count;
    this.next = next;
  ...
  public List<LanguageSummary> getResults() {
    return results;
  }
  public void setResults(List<LanguageSummary> results) {
    this.results = results;
  }
