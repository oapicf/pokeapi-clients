...
public class MoveAilmentApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(MoveAilmentApiHandler.class);

    private final MoveAilmentApi api;

    public MoveAilmentApiHandler(MoveAilmentApi api) {
        this.api = api;
    }

    @Deprecated
    public MoveAilmentApiHandler() {
        this(new MoveAilmentApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("moveAilmentList").handler(this::moveAilmentList);
        builder.operation("moveAilmentRead").handler(this::moveAilmentRead);
    }
    ...
    private void moveAilmentRead(RoutingContext routingContext) {
        logger.info("moveAilmentRead()");
