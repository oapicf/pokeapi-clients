...
public class EvolutionTriggerApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(EvolutionTriggerApiHandler.class);

    private final EvolutionTriggerApi api;

    public EvolutionTriggerApiHandler(EvolutionTriggerApi api) {
        this.api = api;
    }

    @Deprecated
    public EvolutionTriggerApiHandler() {
        this(new EvolutionTriggerApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("evolutionTriggerList").handler(this::evolutionTriggerList);
        builder.operation("evolutionTriggerRead").handler(this::evolutionTriggerRead);
    }
    ...
    private void evolutionTriggerRead(RoutingContext routingContext) {
        logger.info("evolutionTriggerRead()");
