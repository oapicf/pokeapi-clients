...
public class MoveApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(MoveApiHandler.class);

    private final MoveApi api;

    public MoveApiHandler(MoveApi api) {
        this.api = api;
    }

    @Deprecated
    public MoveApiHandler() {
        this(new MoveApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("moveList").handler(this::moveList);
        builder.operation("moveRead").handler(this::moveRead);
    }
    ...
    private void moveRead(RoutingContext routingContext) {
        logger.info("moveRead()");
