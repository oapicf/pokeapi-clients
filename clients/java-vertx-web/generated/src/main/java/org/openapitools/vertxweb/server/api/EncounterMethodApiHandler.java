...
public class EncounterMethodApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(EncounterMethodApiHandler.class);

    private final EncounterMethodApi api;

    public EncounterMethodApiHandler(EncounterMethodApi api) {
        this.api = api;
    }

    @Deprecated
    public EncounterMethodApiHandler() {
        this(new EncounterMethodApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("encounterMethodList").handler(this::encounterMethodList);
        builder.operation("encounterMethodRead").handler(this::encounterMethodRead);
    }
    ...
    private void encounterMethodRead(RoutingContext routingContext) {
        logger.info("encounterMethodRead()");
