...
public class PokemonShapeApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(PokemonShapeApiHandler.class);

    private final PokemonShapeApi api;

    public PokemonShapeApiHandler(PokemonShapeApi api) {
        this.api = api;
    }

    @Deprecated
    public PokemonShapeApiHandler() {
        this(new PokemonShapeApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("pokemonShapeList").handler(this::pokemonShapeList);
        builder.operation("pokemonShapeRead").handler(this::pokemonShapeRead);
    }
    ...
    private void pokemonShapeRead(RoutingContext routingContext) {
        logger.info("pokemonShapeRead()");
