...
public class MachineApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(MachineApiHandler.class);

    private final MachineApi api;

    public MachineApiHandler(MachineApi api) {
        this.api = api;
    }

    @Deprecated
    public MachineApiHandler() {
        this(new MachineApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("machineList").handler(this::machineList);
        builder.operation("machineRead").handler(this::machineRead);
    }
    ...
    private void machineRead(RoutingContext routingContext) {
        logger.info("machineRead()");
