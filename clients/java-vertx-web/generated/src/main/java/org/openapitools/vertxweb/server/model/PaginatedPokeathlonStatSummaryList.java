...
import org.openapitools.vertxweb.server.model.PokeathlonStatSummary;
...
public class PaginatedPokeathlonStatSummaryList   {
  ...
  public PaginatedPokeathlonStatSummaryList (Integer count, URI next, URI previous, List<PokeathlonStatSummary> results) {
    this.count = count;
    this.next = next;
