...
public class PaginatedStatSummaryList   {
  ...
  private List<StatSummary> results = new ArrayList<>();

  public PaginatedStatSummaryList () {

  }

  public PaginatedStatSummaryList (Integer count, URI next, URI previous, List<StatSummary> results) {
    this.count = count;
    this.next = next;
  ...
  public List<StatSummary> getResults() {
    return results;
  }
  public void setResults(List<StatSummary> results) {
    this.results = results;
  }
