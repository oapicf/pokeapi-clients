...
public class StatApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(StatApiHandler.class);

    private final StatApi api;

    public StatApiHandler(StatApi api) {
        this.api = api;
    }

    @Deprecated
    public StatApiHandler() {
        this(new StatApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("statList").handler(this::statList);
        builder.operation("statRead").handler(this::statRead);
    }
    ...
    private void statRead(RoutingContext routingContext) {
        logger.info("statRead()");
