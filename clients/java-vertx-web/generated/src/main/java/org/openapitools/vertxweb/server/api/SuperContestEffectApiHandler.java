...
public class SuperContestEffectApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(SuperContestEffectApiHandler.class);

    private final SuperContestEffectApi api;

    public SuperContestEffectApiHandler(SuperContestEffectApi api) {
        this.api = api;
    }

    @Deprecated
    public SuperContestEffectApiHandler() {
        this(new SuperContestEffectApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("superContestEffectList").handler(this::superContestEffectList);
        builder.operation("superContestEffectRead").handler(this::superContestEffectRead);
    }
    ...
    private void superContestEffectRead(RoutingContext routingContext) {
        logger.info("superContestEffectRead()");
