...
public class MoveTargetApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(MoveTargetApiHandler.class);

    private final MoveTargetApi api;

    public MoveTargetApiHandler(MoveTargetApi api) {
        this.api = api;
    }

    @Deprecated
    public MoveTargetApiHandler() {
        this(new MoveTargetApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("moveTargetList").handler(this::moveTargetList);
        builder.operation("moveTargetRead").handler(this::moveTargetRead);
    }
    ...
    private void moveTargetList(RoutingContext routingContext) {
        ...
        api.moveTargetList(limit, offset)
    ...
    private void moveTargetRead(RoutingContext routingContext) {
        logger.info("moveTargetRead()");
