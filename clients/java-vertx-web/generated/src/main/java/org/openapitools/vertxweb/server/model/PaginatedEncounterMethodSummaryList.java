...
import org.openapitools.vertxweb.server.model.EncounterMethodSummary;
...
public class PaginatedEncounterMethodSummaryList   {
  ...
  private List<EncounterMethodSummary> results = new ArrayList<>();

  public PaginatedEncounterMethodSummaryList () {

  }

  public PaginatedEncounterMethodSummaryList (Integer count, URI next, URI previous, List<EncounterMethodSummary> results) {
    this.count = count;
    this.next = next;
