...
public class GamesApiHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GamesApiHandler.class);

    private final GamesApi api;

    public GamesApiHandler(GamesApi api) {
        this.api = api;
    }

    @Deprecated
    public GamesApiHandler() {
        this(new GamesApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("generationList").handler(this::generationList);
        builder.operation("generationRetrieve").handler(this::generationRetrieve);
        builder.operation("pokedexList").handler(this::pokedexList);
        builder.operation("pokedexRetrieve").handler(this::pokedexRetrieve);
        builder.operation("versionGroupList").handler(this::versionGroupList);
        builder.operation("versionGroupRetrieve").handler(this::versionGroupRetrieve);
        builder.operation("versionList").handler(this::versionList);
        builder.operation("versionRetrieve").handler(this::versionRetrieve);
    }
    ...
    private void generationRetrieve(RoutingContext routingContext) {
        logger.info("generationRetrieve()");
    ...
    private void pokedexRetrieve(RoutingContext routingContext) {
        logger.info("pokedexRetrieve()");
    ...
    private void versionGroupRetrieve(RoutingContext routingContext) {
        logger.info("versionGroupRetrieve()");
    ...
    private void versionRetrieve(RoutingContext routingContext) {
        logger.info("versionRetrieve()");
