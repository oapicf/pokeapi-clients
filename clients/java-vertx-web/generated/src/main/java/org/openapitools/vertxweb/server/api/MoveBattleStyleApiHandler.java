...
public class MoveBattleStyleApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(MoveBattleStyleApiHandler.class);

    private final MoveBattleStyleApi api;

    public MoveBattleStyleApiHandler(MoveBattleStyleApi api) {
        this.api = api;
    }

    @Deprecated
    public MoveBattleStyleApiHandler() {
        this(new MoveBattleStyleApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("moveBattleStyleList").handler(this::moveBattleStyleList);
        builder.operation("moveBattleStyleRead").handler(this::moveBattleStyleRead);
    }
    ...
    private void moveBattleStyleRead(RoutingContext routingContext) {
        logger.info("moveBattleStyleRead()");
