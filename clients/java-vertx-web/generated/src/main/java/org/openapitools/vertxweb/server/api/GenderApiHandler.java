...
public class GenderApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(GenderApiHandler.class);

    private final GenderApi api;

    public GenderApiHandler(GenderApi api) {
        this.api = api;
    }

    @Deprecated
    public GenderApiHandler() {
        this(new GenderApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("genderList").handler(this::genderList);
        builder.operation("genderRead").handler(this::genderRead);
    }
    ...
    private void genderRead(RoutingContext routingContext) {
        logger.info("genderRead()");
