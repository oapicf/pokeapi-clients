...
public class BerryFlavorApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(BerryFlavorApiHandler.class);

    private final BerryFlavorApi api;

    public BerryFlavorApiHandler(BerryFlavorApi api) {
        this.api = api;
    }

    @Deprecated
    public BerryFlavorApiHandler() {
        this(new BerryFlavorApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("berryFlavorList").handler(this::berryFlavorList);
        builder.operation("berryFlavorRead").handler(this::berryFlavorRead);
    }
    ...
    private void berryFlavorRead(RoutingContext routingContext) {
        logger.info("berryFlavorRead()");
