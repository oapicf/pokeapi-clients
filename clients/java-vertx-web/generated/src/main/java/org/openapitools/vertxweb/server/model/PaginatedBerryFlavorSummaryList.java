...
public class PaginatedBerryFlavorSummaryList   {
  ...
  private List<BerryFlavorSummary> results = new ArrayList<>();

  public PaginatedBerryFlavorSummaryList () {

  }

  public PaginatedBerryFlavorSummaryList (Integer count, URI next, URI previous, List<BerryFlavorSummary> results) {
    this.count = count;
    this.next = next;
