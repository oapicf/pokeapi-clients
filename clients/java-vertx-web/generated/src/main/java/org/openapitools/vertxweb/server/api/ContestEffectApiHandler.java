...
public class ContestEffectApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(ContestEffectApiHandler.class);

    private final ContestEffectApi api;

    public ContestEffectApiHandler(ContestEffectApi api) {
        this.api = api;
    }

    @Deprecated
    public ContestEffectApiHandler() {
        this(new ContestEffectApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("contestEffectList").handler(this::contestEffectList);
        builder.operation("contestEffectRead").handler(this::contestEffectRead);
    }
    ...
    private void contestEffectRead(RoutingContext routingContext) {
        logger.info("contestEffectRead()");
