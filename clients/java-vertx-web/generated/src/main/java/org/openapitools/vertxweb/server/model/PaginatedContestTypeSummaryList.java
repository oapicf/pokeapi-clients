...
public class PaginatedContestTypeSummaryList   {
  ...
  public PaginatedContestTypeSummaryList (Integer count, URI next, URI previous, List<ContestTypeSummary> results) {
    this.count = count;
    this.next = next;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(count, paginatedContestTypeSummaryList.count) &&
        Objects.equals(next, paginatedContestTypeSummaryList.next) &&
        Objects.equals(previous, paginatedContestTypeSummaryList.previous) &&
        Objects.equals(results, paginatedContestTypeSummaryList.results);
  }
