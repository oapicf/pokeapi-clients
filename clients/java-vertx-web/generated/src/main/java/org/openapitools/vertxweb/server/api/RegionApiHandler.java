...
public class RegionApiHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RegionApiHandler.class);

    private final RegionApi api;

    public RegionApiHandler(RegionApi api) {
        this.api = api;
    }

    @Deprecated
    public RegionApiHandler() {
        this(new RegionApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("regionList").handler(this::regionList);
        builder.operation("regionRead").handler(this::regionRead);
    }
    ...
    private void regionRead(RoutingContext routingContext) {
        logger.info("regionRead()");
