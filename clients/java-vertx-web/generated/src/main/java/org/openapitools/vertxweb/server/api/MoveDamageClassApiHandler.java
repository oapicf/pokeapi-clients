...
public class MoveDamageClassApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(MoveDamageClassApiHandler.class);

    private final MoveDamageClassApi api;

    public MoveDamageClassApiHandler(MoveDamageClassApi api) {
        this.api = api;
    }

    @Deprecated
    public MoveDamageClassApiHandler() {
        this(new MoveDamageClassApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("moveDamageClassList").handler(this::moveDamageClassList);
        builder.operation("moveDamageClassRead").handler(this::moveDamageClassRead);
    }
    ...
    private void moveDamageClassRead(RoutingContext routingContext) {
        logger.info("moveDamageClassRead()");
