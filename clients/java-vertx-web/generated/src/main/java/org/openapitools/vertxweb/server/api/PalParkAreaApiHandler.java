...
public class PalParkAreaApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(PalParkAreaApiHandler.class);

    private final PalParkAreaApi api;

    public PalParkAreaApiHandler(PalParkAreaApi api) {
        this.api = api;
    }

    @Deprecated
    public PalParkAreaApiHandler() {
        this(new PalParkAreaApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("palParkAreaList").handler(this::palParkAreaList);
        builder.operation("palParkAreaRead").handler(this::palParkAreaRead);
    }
    ...
    private void palParkAreaRead(RoutingContext routingContext) {
        logger.info("palParkAreaRead()");
