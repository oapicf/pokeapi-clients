...
public class CharacteristicApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(CharacteristicApiHandler.class);

    private final CharacteristicApi api;

    public CharacteristicApiHandler(CharacteristicApi api) {
        this.api = api;
    }

    @Deprecated
    public CharacteristicApiHandler() {
        this(new CharacteristicApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("characteristicList").handler(this::characteristicList);
        builder.operation("characteristicRead").handler(this::characteristicRead);
    }
    ...
    private void characteristicList(RoutingContext routingContext) {
        ...
        api.characteristicList(limit, offset)
    ...
    private void characteristicRead(RoutingContext routingContext) {
        logger.info("characteristicRead()");
