...
public class TypeApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(TypeApiHandler.class);

    private final TypeApi api;

    public TypeApiHandler(TypeApi api) {
        this.api = api;
    }

    @Deprecated
    public TypeApiHandler() {
        this(new TypeApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("typeList").handler(this::typeList);
        builder.operation("typeRead").handler(this::typeRead);
    }
    ...
    private void typeRead(RoutingContext routingContext) {
        logger.info("typeRead()");
