...
public class MoveCategoryApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(MoveCategoryApiHandler.class);

    private final MoveCategoryApi api;

    public MoveCategoryApiHandler(MoveCategoryApi api) {
        this.api = api;
    }

    @Deprecated
    public MoveCategoryApiHandler() {
        this(new MoveCategoryApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("moveCategoryList").handler(this::moveCategoryList);
        builder.operation("moveCategoryRead").handler(this::moveCategoryRead);
    }
    ...
    private void moveCategoryRead(RoutingContext routingContext) {
        logger.info("moveCategoryRead()");
