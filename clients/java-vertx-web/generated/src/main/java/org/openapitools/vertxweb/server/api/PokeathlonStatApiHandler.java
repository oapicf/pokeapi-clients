...
public class PokeathlonStatApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(PokeathlonStatApiHandler.class);

    private final PokeathlonStatApi api;

    public PokeathlonStatApiHandler(PokeathlonStatApi api) {
        this.api = api;
    }

    @Deprecated
    public PokeathlonStatApiHandler() {
        this(new PokeathlonStatApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("pokeathlonStatList").handler(this::pokeathlonStatList);
        builder.operation("pokeathlonStatRead").handler(this::pokeathlonStatRead);
    }
    ...
    private void pokeathlonStatRead(RoutingContext routingContext) {
        logger.info("pokeathlonStatRead()");
