...
public class LocationAreaApiHandler {

    private static final Logger logger = LoggerFactory.getLogger(LocationAreaApiHandler.class);

    private final LocationAreaApi api;

    public LocationAreaApiHandler(LocationAreaApi api) {
        this.api = api;
    }

    @Deprecated
    public LocationAreaApiHandler() {
        this(new LocationAreaApiImpl());
    }

    public void mount(RouterBuilder builder) {
        builder.operation("locationAreaList").handler(this::locationAreaList);
        builder.operation("locationAreaRead").handler(this::locationAreaRead);
    }
    ...
    private void locationAreaRead(RoutingContext routingContext) {
        logger.info("locationAreaRead()");
