...
private:
    ...
    virtual void item_list(const std::optional<int32_t> &limit, const std::optional<int32_t> &offset, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="id"></param>
    virtual void item_read(const int32_t &id, Pistache::Http::ResponseWriter &response) = 0;
