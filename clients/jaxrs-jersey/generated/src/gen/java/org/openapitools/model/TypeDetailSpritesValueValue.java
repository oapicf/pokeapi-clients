 ...
 */
@JsonPropertyOrder({
  TypeDetailSpritesValueValue.JSON_PROPERTY_NAME_ICON
})
...
public class TypeDetailSpritesValueValue   {
  public static final String JSON_PROPERTY_NAME_ICON = "name-icon";
  @JsonProperty(JSON_PROPERTY_NAME_ICON)
