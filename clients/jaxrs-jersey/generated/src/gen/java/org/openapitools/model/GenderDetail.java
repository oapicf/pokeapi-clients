...
public class GenderDetail   {
   ...
   **/
  @JsonProperty(value = "pokemon_species_details", access = JsonProperty.Access.READ_ONLY)
  @ApiModelProperty(required = true, value = "")
  @Valid 
   ...
   **/
  @JsonProperty(value = "required_for_evolution", access = JsonProperty.Access.READ_ONLY)
  @ApiModelProperty(required = true, value = "")
  @Valid 
