...
public interface EvolutionApi  {
    ...
    @ApiOperation(value = "List evolution chains", tags={ "evolution" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get evolution chain", tags={ "evolution" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List evolution triggers", tags={ "evolution" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get evolution trigger", tags={ "evolution" })
    @ApiResponses(value = { 
