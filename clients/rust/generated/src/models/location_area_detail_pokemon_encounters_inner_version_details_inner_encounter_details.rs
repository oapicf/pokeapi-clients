...
pub struct LocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetails {
    ...
    pub max_level: i32,
    #[serde(rename = "condition_values", skip_serializing_if = "Option::is_none")]
    pub condition_values: Option<Box<models::AbilityDetailPokemonInnerPokemon>>,
    #[serde(rename = "chance")]
    pub chance: i32,
    #[serde(rename = "method")]
    pub method: Box<models::AbilityDetailPokemonInnerPokemon>,
}
