...
export function TypeDetailPokemonInnerFromJSON(json: any): TypeDetailPokemonInner {
    return {
        ...
        'pokemon': !exists(json, 'pokemon') ? undefined : TypeDetailPokemonInnerPokemonFromJSON(json['pokemon']),
    };
}

export function TypeDetailPokemonInnerToJSON(value?: TypeDetailPokemonInner): any {
    if (value === undefined) {
        return undefined;
    }
    return {
