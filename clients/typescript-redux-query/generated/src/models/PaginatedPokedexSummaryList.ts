...
export function PaginatedPokedexSummaryListFromJSON(json: any): PaginatedPokedexSummaryList {
    return {
        ...
        'results': !exists(json, 'results') ? undefined : (json['results'] as Array<any>).map(PokedexSummaryFromJSON),
    };
}

export function PaginatedPokedexSummaryListToJSON(value?: PaginatedPokedexSummaryList): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'results': value.results === undefined ? undefined : (value.results as Array<any>).map(PokedexSummaryToJSON),
    };
}
