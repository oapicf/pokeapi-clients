...
export function PaginatedBerrySummaryListFromJSON(json: any): PaginatedBerrySummaryList {
    return {
        ...
        'results': !exists(json, 'results') ? undefined : (json['results'] as Array<any>).map(BerrySummaryFromJSON),
    };
}

export function PaginatedBerrySummaryListToJSON(value?: PaginatedBerrySummaryList): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'results': value.results === undefined ? undefined : (value.results as Array<any>).map(BerrySummaryToJSON),
    };
}
