...
export function PaginatedMoveTargetSummaryListFromJSON(json: any): PaginatedMoveTargetSummaryList {
    return {
        ...
        'results': !exists(json, 'results') ? undefined : (json['results'] as Array<any>).map(MoveTargetSummaryFromJSON),
    };
}

export function PaginatedMoveTargetSummaryListToJSON(value?: PaginatedMoveTargetSummaryList): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'results': value.results === undefined ? undefined : (value.results as Array<any>).map(MoveTargetSummaryToJSON),
    };
}
