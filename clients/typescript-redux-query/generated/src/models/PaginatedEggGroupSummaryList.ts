...
export function PaginatedEggGroupSummaryListFromJSON(json: any): PaginatedEggGroupSummaryList {
    return {
        ...
        'results': !exists(json, 'results') ? undefined : (json['results'] as Array<any>).map(EggGroupSummaryFromJSON),
    };
}

export function PaginatedEggGroupSummaryListToJSON(value?: PaginatedEggGroupSummaryList): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'results': value.results === undefined ? undefined : (value.results as Array<any>).map(EggGroupSummaryToJSON),
    };
}
