...
export function PaginatedRegionSummaryListFromJSON(json: any): PaginatedRegionSummaryList {
    return {
        ...
        'results': !exists(json, 'results') ? undefined : (json['results'] as Array<any>).map(RegionSummaryFromJSON),
    };
}

export function PaginatedRegionSummaryListToJSON(value?: PaginatedRegionSummaryList): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'results': value.results === undefined ? undefined : (value.results as Array<any>).map(RegionSummaryToJSON),
    };
}
