...
export function PaginatedContestTypeSummaryListFromJSON(json: any): PaginatedContestTypeSummaryList {
    return {
        ...
        'results': !exists(json, 'results') ? undefined : (json['results'] as Array<any>).map(ContestTypeSummaryFromJSON),
    };
}

export function PaginatedContestTypeSummaryListToJSON(value?: PaginatedContestTypeSummaryList): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'results': value.results === undefined ? undefined : (value.results as Array<any>).map(ContestTypeSummaryToJSON),
    };
}
