...
function Invoke-LanguageList {
    ...
    Process {
        'Calling method: Invoke-LanguageList' | Write-Debug
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "PaginatedLanguageSummaryList" `
...
LanguageDetail
#>
function Invoke-LanguageRetrieve {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-LanguageRetrieve' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v2/language/{id}/'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling languageRetrieve."
        }
