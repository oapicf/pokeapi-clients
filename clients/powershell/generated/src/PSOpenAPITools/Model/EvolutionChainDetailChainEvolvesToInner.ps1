...
EvolutionChainDetailChainEvolvesToInner<PSCustomObject>
#>

function Initialize-EvolutionChainDetailChainEvolvesToInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EvolutionChainDetailChainEvolvesToInner' | Write-Debug
...
Convert from JSON to EvolutionChainDetailChainEvolvesToInner<PSCustomObject>
...
EvolutionChainDetailChainEvolvesToInner<PSCustomObject>
#>
function ConvertFrom-JsonToEvolutionChainDetailChainEvolvesToInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EvolutionChainDetailChainEvolvesToInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
