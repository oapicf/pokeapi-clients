...
PaginatedEggGroupSummaryList<PSCustomObject>
#>

function Initialize-PaginatedEggGroupSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedEggGroupSummaryList' | Write-Debug
...
Convert from JSON to PaginatedEggGroupSummaryList<PSCustomObject>
...
PaginatedEggGroupSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedEggGroupSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedEggGroupSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedEggGroupSummaryList
