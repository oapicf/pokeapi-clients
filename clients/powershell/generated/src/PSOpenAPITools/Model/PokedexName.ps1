...
PokedexName<PSCustomObject>
#>

function Initialize-PokedexName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokedexName' | Write-Debug
...
Convert from JSON to PokedexName<PSCustomObject>
...
PokedexName<PSCustomObject>
#>
function ConvertFrom-JsonToPokedexName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokedexName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PokedexName
