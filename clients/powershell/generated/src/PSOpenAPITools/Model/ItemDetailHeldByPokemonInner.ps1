...
ItemDetailHeldByPokemonInner<PSCustomObject>
#>

function Initialize-ItemDetailHeldByPokemonInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemDetailHeldByPokemonInner' | Write-Debug
...
Convert from JSON to ItemDetailHeldByPokemonInner<PSCustomObject>
...
ItemDetailHeldByPokemonInner<PSCustomObject>
#>
function ConvertFrom-JsonToItemDetailHeldByPokemonInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemDetailHeldByPokemonInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
