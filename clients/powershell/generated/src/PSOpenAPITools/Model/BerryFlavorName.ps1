...
BerryFlavorName<PSCustomObject>
#>

function Initialize-BerryFlavorName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BerryFlavorName' | Write-Debug
...
Convert from JSON to BerryFlavorName<PSCustomObject>
...
BerryFlavorName<PSCustomObject>
#>
function ConvertFrom-JsonToBerryFlavorName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BerryFlavorName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BerryFlavorName
