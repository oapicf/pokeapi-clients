...
MoveFlavorText<PSCustomObject>
#>

function Initialize-MoveFlavorText {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveFlavorText' | Write-Debug
...
Convert from JSON to MoveFlavorText<PSCustomObject>
...
MoveFlavorText<PSCustomObject>
#>
function ConvertFrom-JsonToMoveFlavorText {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveFlavorText' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveFlavorText
