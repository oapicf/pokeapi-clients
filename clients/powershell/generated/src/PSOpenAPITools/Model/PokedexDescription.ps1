...
PokedexDescription<PSCustomObject>
#>

function Initialize-PokedexDescription {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokedexDescription' | Write-Debug
...
Convert from JSON to PokedexDescription<PSCustomObject>
...
PokedexDescription<PSCustomObject>
#>
function ConvertFrom-JsonToPokedexDescription {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokedexDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PokedexDescription
