...
PaginatedMoveMetaAilmentSummaryList<PSCustomObject>
#>

function Initialize-PaginatedMoveMetaAilmentSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedMoveMetaAilmentSummaryList' | Write-Debug
...
Convert from JSON to PaginatedMoveMetaAilmentSummaryList<PSCustomObject>
...
PaginatedMoveMetaAilmentSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedMoveMetaAilmentSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedMoveMetaAilmentSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedMoveMetaAilmentSummaryList
