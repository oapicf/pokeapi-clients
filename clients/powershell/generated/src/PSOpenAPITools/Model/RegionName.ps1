...
RegionName<PSCustomObject>
#>

function Initialize-RegionName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RegionName' | Write-Debug
...
Convert from JSON to RegionName<PSCustomObject>
...
RegionName<PSCustomObject>
#>
function ConvertFrom-JsonToRegionName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RegionName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RegionName
