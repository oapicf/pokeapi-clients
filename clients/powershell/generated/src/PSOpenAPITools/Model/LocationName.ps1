...
function Initialize-LocationName {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocationName' | Write-Debug
...
Convert from JSON to LocationName<PSCustomObject>
...
LocationName<PSCustomObject>
#>
function ConvertFrom-JsonToLocationName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocationName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocationName
