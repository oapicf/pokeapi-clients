...
MoveMetaAilmentDetail<PSCustomObject>
#>

function Initialize-MoveMetaAilmentDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveMetaAilmentDetail' | Write-Debug
...
Convert from JSON to MoveMetaAilmentDetail<PSCustomObject>
...
MoveMetaAilmentDetail<PSCustomObject>
#>
function ConvertFrom-JsonToMoveMetaAilmentDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveMetaAilmentDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveMetaAilmentDetail
        $AllProperties = ("id", "name", "moves", "names")
