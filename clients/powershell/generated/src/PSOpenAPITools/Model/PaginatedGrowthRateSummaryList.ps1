...
PaginatedGrowthRateSummaryList<PSCustomObject>
#>

function Initialize-PaginatedGrowthRateSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedGrowthRateSummaryList' | Write-Debug
...
Convert from JSON to PaginatedGrowthRateSummaryList<PSCustomObject>
...
PaginatedGrowthRateSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedGrowthRateSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedGrowthRateSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedGrowthRateSummaryList
