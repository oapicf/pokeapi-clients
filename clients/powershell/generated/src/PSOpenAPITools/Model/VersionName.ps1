...
VersionName<PSCustomObject>
#>

function Initialize-VersionName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VersionName' | Write-Debug
...
Convert from JSON to VersionName<PSCustomObject>
...
VersionName<PSCustomObject>
#>
function ConvertFrom-JsonToVersionName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VersionName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VersionName
