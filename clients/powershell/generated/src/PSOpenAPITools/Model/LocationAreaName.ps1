...
LocationAreaName<PSCustomObject>
#>

function Initialize-LocationAreaName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocationAreaName' | Write-Debug
...
Convert from JSON to LocationAreaName<PSCustomObject>
...
LocationAreaName<PSCustomObject>
#>
function ConvertFrom-JsonToLocationAreaName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocationAreaName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocationAreaName
