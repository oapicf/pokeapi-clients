...
PokemonColorName<PSCustomObject>
#>

function Initialize-PokemonColorName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokemonColorName' | Write-Debug
...
Convert from JSON to PokemonColorName<PSCustomObject>
...
PokemonColorName<PSCustomObject>
#>
function ConvertFrom-JsonToPokemonColorName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokemonColorName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PokemonColorName
