...
PaginatedEvolutionChainSummaryList<PSCustomObject>
#>

function Initialize-PaginatedEvolutionChainSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedEvolutionChainSummaryList' | Write-Debug
...
Convert from JSON to PaginatedEvolutionChainSummaryList<PSCustomObject>
...
PaginatedEvolutionChainSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedEvolutionChainSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedEvolutionChainSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedEvolutionChainSummaryList
