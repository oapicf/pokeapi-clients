...
PaginatedGenderSummaryList<PSCustomObject>
#>

function Initialize-PaginatedGenderSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedGenderSummaryList' | Write-Debug
...
Convert from JSON to PaginatedGenderSummaryList<PSCustomObject>
...
PaginatedGenderSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedGenderSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedGenderSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedGenderSummaryList
