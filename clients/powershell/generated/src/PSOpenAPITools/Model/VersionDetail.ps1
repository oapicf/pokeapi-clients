...
VersionDetail<PSCustomObject>
#>

function Initialize-VersionDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VersionDetail' | Write-Debug
...
Convert from JSON to VersionDetail<PSCustomObject>
...
VersionDetail<PSCustomObject>
#>
function ConvertFrom-JsonToVersionDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VersionDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
