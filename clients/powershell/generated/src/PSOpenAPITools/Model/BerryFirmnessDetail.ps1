...
BerryFirmnessDetail<PSCustomObject>
#>

function Initialize-BerryFirmnessDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BerryFirmnessDetail' | Write-Debug
...
Convert from JSON to BerryFirmnessDetail<PSCustomObject>
...
BerryFirmnessDetail<PSCustomObject>
#>
function ConvertFrom-JsonToBerryFirmnessDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BerryFirmnessDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BerryFirmnessDetail
        $AllProperties = ("id", "name", "berries", "names")
