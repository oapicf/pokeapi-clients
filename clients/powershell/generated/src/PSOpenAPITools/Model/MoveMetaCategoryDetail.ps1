...
MoveMetaCategoryDetail<PSCustomObject>
#>

function Initialize-MoveMetaCategoryDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveMetaCategoryDetail' | Write-Debug
...
Convert from JSON to MoveMetaCategoryDetail<PSCustomObject>
...
MoveMetaCategoryDetail<PSCustomObject>
#>
function ConvertFrom-JsonToMoveMetaCategoryDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveMetaCategoryDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
