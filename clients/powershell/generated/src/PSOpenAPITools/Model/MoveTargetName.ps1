...
MoveTargetName<PSCustomObject>
#>

function Initialize-MoveTargetName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveTargetName' | Write-Debug
...
Convert from JSON to MoveTargetName<PSCustomObject>
...
MoveTargetName<PSCustomObject>
#>
function ConvertFrom-JsonToMoveTargetName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveTargetName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveTargetName
