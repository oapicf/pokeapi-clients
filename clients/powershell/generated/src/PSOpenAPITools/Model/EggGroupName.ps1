...
EggGroupName<PSCustomObject>
#>

function Initialize-EggGroupName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EggGroupName' | Write-Debug
...
Convert from JSON to EggGroupName<PSCustomObject>
...
EggGroupName<PSCustomObject>
#>
function ConvertFrom-JsonToEggGroupName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EggGroupName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EggGroupName
