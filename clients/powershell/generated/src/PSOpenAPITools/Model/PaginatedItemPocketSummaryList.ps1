...
PaginatedItemPocketSummaryList<PSCustomObject>
#>

function Initialize-PaginatedItemPocketSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedItemPocketSummaryList' | Write-Debug
...
Convert from JSON to PaginatedItemPocketSummaryList<PSCustomObject>
...
PaginatedItemPocketSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedItemPocketSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedItemPocketSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedItemPocketSummaryList
