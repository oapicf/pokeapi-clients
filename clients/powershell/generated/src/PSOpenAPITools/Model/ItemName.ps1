...
ItemName<PSCustomObject>
#>

function Initialize-ItemName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemName' | Write-Debug
...
Convert from JSON to ItemName<PSCustomObject>
...
ItemName<PSCustomObject>
#>
function ConvertFrom-JsonToItemName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
