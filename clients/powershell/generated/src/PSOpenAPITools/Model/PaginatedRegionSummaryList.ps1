...
PaginatedRegionSummaryList<PSCustomObject>
#>

function Initialize-PaginatedRegionSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedRegionSummaryList' | Write-Debug
...
Convert from JSON to PaginatedRegionSummaryList<PSCustomObject>
...
PaginatedRegionSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedRegionSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedRegionSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedRegionSummaryList
