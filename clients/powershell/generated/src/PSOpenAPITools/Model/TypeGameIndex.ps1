...
TypeGameIndex<PSCustomObject>
#>

function Initialize-TypeGameIndex {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TypeGameIndex' | Write-Debug
...
Convert from JSON to TypeGameIndex<PSCustomObject>
...
TypeGameIndex<PSCustomObject>
#>
function ConvertFrom-JsonToTypeGameIndex {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TypeGameIndex' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TypeGameIndex
