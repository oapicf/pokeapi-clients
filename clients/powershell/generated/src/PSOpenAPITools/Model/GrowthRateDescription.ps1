...
GrowthRateDescription<PSCustomObject>
#>

function Initialize-GrowthRateDescription {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GrowthRateDescription' | Write-Debug
...
Convert from JSON to GrowthRateDescription<PSCustomObject>
...
GrowthRateDescription<PSCustomObject>
#>
function ConvertFrom-JsonToGrowthRateDescription {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GrowthRateDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
