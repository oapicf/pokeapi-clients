...
PaginatedPokemonShapeSummaryList<PSCustomObject>
#>

function Initialize-PaginatedPokemonShapeSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPokemonShapeSummaryList' | Write-Debug
...
Convert from JSON to PaginatedPokemonShapeSummaryList<PSCustomObject>
...
PaginatedPokemonShapeSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPokemonShapeSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPokemonShapeSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPokemonShapeSummaryList
