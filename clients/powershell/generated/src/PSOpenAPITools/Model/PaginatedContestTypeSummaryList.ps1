...
PaginatedContestTypeSummaryList<PSCustomObject>
#>

function Initialize-PaginatedContestTypeSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedContestTypeSummaryList' | Write-Debug
...
Convert from JSON to PaginatedContestTypeSummaryList<PSCustomObject>
...
PaginatedContestTypeSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedContestTypeSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedContestTypeSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedContestTypeSummaryList
