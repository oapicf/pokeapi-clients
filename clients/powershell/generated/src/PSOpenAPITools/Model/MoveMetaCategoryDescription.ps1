...
MoveMetaCategoryDescription<PSCustomObject>
#>

function Initialize-MoveMetaCategoryDescription {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveMetaCategoryDescription' | Write-Debug
...
Convert from JSON to MoveMetaCategoryDescription<PSCustomObject>
...
MoveMetaCategoryDescription<PSCustomObject>
#>
function ConvertFrom-JsonToMoveMetaCategoryDescription {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveMetaCategoryDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveMetaCategoryDescription
