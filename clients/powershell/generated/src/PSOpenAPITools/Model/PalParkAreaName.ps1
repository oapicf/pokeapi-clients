...
PalParkAreaName<PSCustomObject>
#>

function Initialize-PalParkAreaName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PalParkAreaName' | Write-Debug
...
Convert from JSON to PalParkAreaName<PSCustomObject>
...
PalParkAreaName<PSCustomObject>
#>
function ConvertFrom-JsonToPalParkAreaName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PalParkAreaName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PalParkAreaName
