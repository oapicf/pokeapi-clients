...
.PARAMETER AwesomeName
No description available.
.PARAMETER Language
No description available.
.OUTPUTS

PokemonShapeDetailAwesomeNamesInner<PSCustomObject>
#>

function Initialize-PokemonShapeDetailAwesomeNamesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokemonShapeDetailAwesomeNamesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        if ($null -eq $AwesomeName) {
            throw "invalid value for 'AwesomeName', 'AwesomeName' cannot be null."
        }
...
Convert from JSON to PokemonShapeDetailAwesomeNamesInner<PSCustomObject>
...
PokemonShapeDetailAwesomeNamesInner<PSCustomObject>
#>
function ConvertFrom-JsonToPokemonShapeDetailAwesomeNamesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokemonShapeDetailAwesomeNamesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
