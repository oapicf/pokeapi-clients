...
GenderDetailPokemonSpeciesDetailsInner<PSCustomObject>
#>

function Initialize-GenderDetailPokemonSpeciesDetailsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GenderDetailPokemonSpeciesDetailsInner' | Write-Debug
...
Convert from JSON to GenderDetailPokemonSpeciesDetailsInner<PSCustomObject>
...
GenderDetailPokemonSpeciesDetailsInner<PSCustomObject>
#>
function ConvertFrom-JsonToGenderDetailPokemonSpeciesDetailsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GenderDetailPokemonSpeciesDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
