...
PaginatedItemFlingEffectSummaryList<PSCustomObject>
#>

function Initialize-PaginatedItemFlingEffectSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedItemFlingEffectSummaryList' | Write-Debug
...
Convert from JSON to PaginatedItemFlingEffectSummaryList<PSCustomObject>
...
PaginatedItemFlingEffectSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedItemFlingEffectSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedItemFlingEffectSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedItemFlingEffectSummaryList
