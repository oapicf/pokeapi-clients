...
ItemPocketDetail<PSCustomObject>
#>

function Initialize-ItemPocketDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPocketDetail' | Write-Debug
...
Convert from JSON to ItemPocketDetail<PSCustomObject>
...
ItemPocketDetail<PSCustomObject>
#>
function ConvertFrom-JsonToItemPocketDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPocketDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemPocketDetail
        $AllProperties = ("id", "name", "categories", "names")
