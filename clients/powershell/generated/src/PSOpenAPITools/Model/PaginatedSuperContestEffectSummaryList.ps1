...
PaginatedSuperContestEffectSummaryList<PSCustomObject>
#>

function Initialize-PaginatedSuperContestEffectSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedSuperContestEffectSummaryList' | Write-Debug
...
Convert from JSON to PaginatedSuperContestEffectSummaryList<PSCustomObject>
...
PaginatedSuperContestEffectSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedSuperContestEffectSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedSuperContestEffectSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedSuperContestEffectSummaryList
