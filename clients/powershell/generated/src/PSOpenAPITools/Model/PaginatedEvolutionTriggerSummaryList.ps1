...
PaginatedEvolutionTriggerSummaryList<PSCustomObject>
#>

function Initialize-PaginatedEvolutionTriggerSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedEvolutionTriggerSummaryList' | Write-Debug
...
Convert from JSON to PaginatedEvolutionTriggerSummaryList<PSCustomObject>
...
PaginatedEvolutionTriggerSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedEvolutionTriggerSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedEvolutionTriggerSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedEvolutionTriggerSummaryList
