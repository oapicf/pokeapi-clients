...
PaginatedPokemonColorSummaryList<PSCustomObject>
#>

function Initialize-PaginatedPokemonColorSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPokemonColorSummaryList' | Write-Debug
...
Convert from JSON to PaginatedPokemonColorSummaryList<PSCustomObject>
...
PaginatedPokemonColorSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPokemonColorSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPokemonColorSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPokemonColorSummaryList
