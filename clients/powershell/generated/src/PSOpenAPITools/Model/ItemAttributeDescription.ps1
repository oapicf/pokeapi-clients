...
ItemAttributeDescription<PSCustomObject>
#>

function Initialize-ItemAttributeDescription {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttributeDescription' | Write-Debug
...
Convert from JSON to ItemAttributeDescription<PSCustomObject>
...
ItemAttributeDescription<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttributeDescription {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttributeDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttributeDescription
