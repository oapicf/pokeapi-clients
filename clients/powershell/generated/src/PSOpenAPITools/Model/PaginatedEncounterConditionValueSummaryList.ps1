...
PaginatedEncounterConditionValueSummaryList<PSCustomObject>
#>

function Initialize-PaginatedEncounterConditionValueSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedEncounterConditionValueSummaryList' | Write-Debug
...
Convert from JSON to PaginatedEncounterConditionValueSummaryList<PSCustomObject>
...
PaginatedEncounterConditionValueSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedEncounterConditionValueSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedEncounterConditionValueSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedEncounterConditionValueSummaryList
