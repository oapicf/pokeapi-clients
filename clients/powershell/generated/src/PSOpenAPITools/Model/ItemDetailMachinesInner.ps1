...
ItemDetailMachinesInner<PSCustomObject>
#>

function Initialize-ItemDetailMachinesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemDetailMachinesInner' | Write-Debug
...
Convert from JSON to ItemDetailMachinesInner<PSCustomObject>
...
ItemDetailMachinesInner<PSCustomObject>
#>
function ConvertFrom-JsonToItemDetailMachinesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemDetailMachinesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemDetailMachinesInner
