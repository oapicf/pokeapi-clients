...
PaginatedMoveSummaryList<PSCustomObject>
#>

function Initialize-PaginatedMoveSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedMoveSummaryList' | Write-Debug
...
Convert from JSON to PaginatedMoveSummaryList<PSCustomObject>
...
PaginatedMoveSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedMoveSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedMoveSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedMoveSummaryList
