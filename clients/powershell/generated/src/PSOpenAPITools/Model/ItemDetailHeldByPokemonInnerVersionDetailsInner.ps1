...
ItemDetailHeldByPokemonInnerVersionDetailsInner<PSCustomObject>
#>

function Initialize-ItemDetailHeldByPokemonInnerVersionDetailsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemDetailHeldByPokemonInnerVersionDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        if ($null -eq $Rarity) {
            throw "invalid value for 'Rarity', 'Rarity' cannot be null."
        }
...
Convert from JSON to ItemDetailHeldByPokemonInnerVersionDetailsInner<PSCustomObject>
...
ItemDetailHeldByPokemonInnerVersionDetailsInner<PSCustomObject>
#>
function ConvertFrom-JsonToItemDetailHeldByPokemonInnerVersionDetailsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemDetailHeldByPokemonInnerVersionDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
