...
PaginatedItemCategorySummaryList<PSCustomObject>
#>

function Initialize-PaginatedItemCategorySummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedItemCategorySummaryList' | Write-Debug
...
Convert from JSON to PaginatedItemCategorySummaryList<PSCustomObject>
...
PaginatedItemCategorySummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedItemCategorySummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedItemCategorySummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedItemCategorySummaryList
