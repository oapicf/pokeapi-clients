...
TypeDetailDamageRelations<PSCustomObject>
#>

function Initialize-TypeDetailDamageRelations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TypeDetailDamageRelations' | Write-Debug
...
Convert from JSON to TypeDetailDamageRelations<PSCustomObject>
...
TypeDetailDamageRelations<PSCustomObject>
#>
function ConvertFrom-JsonToTypeDetailDamageRelations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TypeDetailDamageRelations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
