...
PaginatedPokeathlonStatSummaryList<PSCustomObject>
#>

function Initialize-PaginatedPokeathlonStatSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPokeathlonStatSummaryList' | Write-Debug
...
Convert from JSON to PaginatedPokeathlonStatSummaryList<PSCustomObject>
...
PaginatedPokeathlonStatSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPokeathlonStatSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPokeathlonStatSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPokeathlonStatSummaryList
