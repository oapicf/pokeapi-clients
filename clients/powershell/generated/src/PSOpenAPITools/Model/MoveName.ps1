...
MoveName<PSCustomObject>
#>

function Initialize-MoveName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveName' | Write-Debug
...
Convert from JSON to MoveName<PSCustomObject>
...
MoveName<PSCustomObject>
#>
function ConvertFrom-JsonToMoveName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveName
