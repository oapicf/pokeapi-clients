...
MoveTargetDescription<PSCustomObject>
#>

function Initialize-MoveTargetDescription {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveTargetDescription' | Write-Debug
...
Convert from JSON to MoveTargetDescription<PSCustomObject>
...
MoveTargetDescription<PSCustomObject>
#>
function ConvertFrom-JsonToMoveTargetDescription {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveTargetDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveTargetDescription
