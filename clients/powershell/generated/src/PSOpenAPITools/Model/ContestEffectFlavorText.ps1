...
ContestEffectFlavorText<PSCustomObject>
#>

function Initialize-ContestEffectFlavorText {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContestEffectFlavorText' | Write-Debug
...
Convert from JSON to ContestEffectFlavorText<PSCustomObject>
...
ContestEffectFlavorText<PSCustomObject>
#>
function ConvertFrom-JsonToContestEffectFlavorText {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContestEffectFlavorText' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
