...
PokemonSpeciesDetailPalParkEncountersInner<PSCustomObject>
#>

function Initialize-PokemonSpeciesDetailPalParkEncountersInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokemonSpeciesDetailPalParkEncountersInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        if ($null -eq $Area) {
            throw "invalid value for 'Area', 'Area' cannot be null."
        }
...
Convert from JSON to PokemonSpeciesDetailPalParkEncountersInner<PSCustomObject>
...
PokemonSpeciesDetailPalParkEncountersInner<PSCustomObject>
#>
function ConvertFrom-JsonToPokemonSpeciesDetailPalParkEncountersInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokemonSpeciesDetailPalParkEncountersInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
