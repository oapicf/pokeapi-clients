...
PaginatedMachineSummaryList<PSCustomObject>
#>

function Initialize-PaginatedMachineSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedMachineSummaryList' | Write-Debug
...
Convert from JSON to PaginatedMachineSummaryList<PSCustomObject>
...
PaginatedMachineSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedMachineSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedMachineSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedMachineSummaryList
