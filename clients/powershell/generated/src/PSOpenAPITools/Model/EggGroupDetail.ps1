...
EggGroupDetail<PSCustomObject>
#>

function Initialize-EggGroupDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EggGroupDetail' | Write-Debug
...
Convert from JSON to EggGroupDetail<PSCustomObject>
...
EggGroupDetail<PSCustomObject>
#>
function ConvertFrom-JsonToEggGroupDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EggGroupDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EggGroupDetail
