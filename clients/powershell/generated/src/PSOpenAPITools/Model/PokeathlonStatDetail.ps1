...
PokeathlonStatDetail<PSCustomObject>
#>

function Initialize-PokeathlonStatDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokeathlonStatDetail' | Write-Debug
...
Convert from JSON to PokeathlonStatDetail<PSCustomObject>
...
PokeathlonStatDetail<PSCustomObject>
#>
function ConvertFrom-JsonToPokeathlonStatDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokeathlonStatDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
