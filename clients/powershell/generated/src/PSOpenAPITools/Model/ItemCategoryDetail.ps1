...
ItemCategoryDetail<PSCustomObject>
#>

function Initialize-ItemCategoryDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemCategoryDetail' | Write-Debug
        ...
        if ($null -eq $Pocket) {
            throw "invalid value for 'Pocket', 'Pocket' cannot be null."
        }
...
Convert from JSON to ItemCategoryDetail<PSCustomObject>
...
ItemCategoryDetail<PSCustomObject>
#>
function ConvertFrom-JsonToItemCategoryDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemCategoryDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
