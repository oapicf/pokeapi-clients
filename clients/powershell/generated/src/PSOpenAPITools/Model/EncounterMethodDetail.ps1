...
EncounterMethodDetail<PSCustomObject>
#>

function Initialize-EncounterMethodDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EncounterMethodDetail' | Write-Debug
...
Convert from JSON to EncounterMethodDetail<PSCustomObject>
...
EncounterMethodDetail<PSCustomObject>
#>
function ConvertFrom-JsonToEncounterMethodDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EncounterMethodDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EncounterMethodDetail
        $AllProperties = ("id", "name", "order", "names")
