...
PaginatedMoveBattleStyleSummaryList<PSCustomObject>
#>

function Initialize-PaginatedMoveBattleStyleSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedMoveBattleStyleSummaryList' | Write-Debug
...
Convert from JSON to PaginatedMoveBattleStyleSummaryList<PSCustomObject>
...
PaginatedMoveBattleStyleSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedMoveBattleStyleSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedMoveBattleStyleSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedMoveBattleStyleSummaryList
