...
AbilityChangeEffectText<PSCustomObject>
#>

function Initialize-AbilityChangeEffectText {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AbilityChangeEffectText' | Write-Debug
...
Convert from JSON to AbilityChangeEffectText<PSCustomObject>
...
AbilityChangeEffectText<PSCustomObject>
#>
function ConvertFrom-JsonToAbilityChangeEffectText {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AbilityChangeEffectText' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
