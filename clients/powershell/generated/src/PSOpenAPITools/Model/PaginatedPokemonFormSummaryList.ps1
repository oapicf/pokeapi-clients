...
PaginatedPokemonFormSummaryList<PSCustomObject>
#>

function Initialize-PaginatedPokemonFormSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPokemonFormSummaryList' | Write-Debug
...
Convert from JSON to PaginatedPokemonFormSummaryList<PSCustomObject>
...
PaginatedPokemonFormSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPokemonFormSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPokemonFormSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPokemonFormSummaryList
