...
PaginatedItemSummaryList<PSCustomObject>
#>

function Initialize-PaginatedItemSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedItemSummaryList' | Write-Debug
...
Convert from JSON to PaginatedItemSummaryList<PSCustomObject>
...
PaginatedItemSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedItemSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedItemSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedItemSummaryList
