...
MoveLearnMethodDescription<PSCustomObject>
#>

function Initialize-MoveLearnMethodDescription {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveLearnMethodDescription' | Write-Debug
...
Convert from JSON to MoveLearnMethodDescription<PSCustomObject>
...
MoveLearnMethodDescription<PSCustomObject>
#>
function ConvertFrom-JsonToMoveLearnMethodDescription {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveLearnMethodDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveLearnMethodDescription
