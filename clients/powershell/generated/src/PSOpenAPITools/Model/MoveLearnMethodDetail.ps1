...
MoveLearnMethodDetail<PSCustomObject>
#>

function Initialize-MoveLearnMethodDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveLearnMethodDetail' | Write-Debug
...
Convert from JSON to MoveLearnMethodDetail<PSCustomObject>
...
MoveLearnMethodDetail<PSCustomObject>
#>
function ConvertFrom-JsonToMoveLearnMethodDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveLearnMethodDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
