...
PaginatedBerryFlavorSummaryList<PSCustomObject>
#>

function Initialize-PaginatedBerryFlavorSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedBerryFlavorSummaryList' | Write-Debug
...
Convert from JSON to PaginatedBerryFlavorSummaryList<PSCustomObject>
...
PaginatedBerryFlavorSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedBerryFlavorSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedBerryFlavorSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedBerryFlavorSummaryList
