...
GenerationName<PSCustomObject>
#>

function Initialize-GenerationName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GenerationName' | Write-Debug
...
Convert from JSON to GenerationName<PSCustomObject>
...
GenerationName<PSCustomObject>
#>
function ConvertFrom-JsonToGenerationName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GenerationName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GenerationName
