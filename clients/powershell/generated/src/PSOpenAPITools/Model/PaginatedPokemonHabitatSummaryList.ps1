...
PaginatedPokemonHabitatSummaryList<PSCustomObject>
#>

function Initialize-PaginatedPokemonHabitatSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPokemonHabitatSummaryList' | Write-Debug
...
Convert from JSON to PaginatedPokemonHabitatSummaryList<PSCustomObject>
...
PaginatedPokemonHabitatSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPokemonHabitatSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPokemonHabitatSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPokemonHabitatSummaryList
