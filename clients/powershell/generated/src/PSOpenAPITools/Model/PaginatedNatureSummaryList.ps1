...
PaginatedNatureSummaryList<PSCustomObject>
#>

function Initialize-PaginatedNatureSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedNatureSummaryList' | Write-Debug
...
Convert from JSON to PaginatedNatureSummaryList<PSCustomObject>
...
PaginatedNatureSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedNatureSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedNatureSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedNatureSummaryList
