...
MoveDetailEffectChangesInner<PSCustomObject>
#>

function Initialize-MoveDetailEffectChangesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveDetailEffectChangesInner' | Write-Debug
...
Convert from JSON to MoveDetailEffectChangesInner<PSCustomObject>
...
MoveDetailEffectChangesInner<PSCustomObject>
#>
function ConvertFrom-JsonToMoveDetailEffectChangesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveDetailEffectChangesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
