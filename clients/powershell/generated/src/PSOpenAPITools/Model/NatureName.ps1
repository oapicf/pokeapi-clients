...
NatureName<PSCustomObject>
#>

function Initialize-NatureName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NatureName' | Write-Debug
...
Convert from JSON to NatureName<PSCustomObject>
...
NatureName<PSCustomObject>
#>
function ConvertFrom-JsonToNatureName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NatureName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NatureName
