...
StatName<PSCustomObject>
#>

function Initialize-StatName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StatName' | Write-Debug
...
Convert from JSON to StatName<PSCustomObject>
...
StatName<PSCustomObject>
#>
function ConvertFrom-JsonToStatName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StatName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StatName
