...
ItemPocketName<PSCustomObject>
#>

function Initialize-ItemPocketName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemPocketName' | Write-Debug
...
Convert from JSON to ItemPocketName<PSCustomObject>
...
ItemPocketName<PSCustomObject>
#>
function ConvertFrom-JsonToItemPocketName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemPocketName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemPocketName
