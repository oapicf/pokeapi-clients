...
PaginatedEncounterConditionSummaryList<PSCustomObject>
#>

function Initialize-PaginatedEncounterConditionSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedEncounterConditionSummaryList' | Write-Debug
...
Convert from JSON to PaginatedEncounterConditionSummaryList<PSCustomObject>
...
PaginatedEncounterConditionSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedEncounterConditionSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedEncounterConditionSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedEncounterConditionSummaryList
