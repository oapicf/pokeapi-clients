...
ItemCategoryName<PSCustomObject>
#>

function Initialize-ItemCategoryName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemCategoryName' | Write-Debug
...
Convert from JSON to ItemCategoryName<PSCustomObject>
...
ItemCategoryName<PSCustomObject>
#>
function ConvertFrom-JsonToItemCategoryName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemCategoryName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemCategoryName
