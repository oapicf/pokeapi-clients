...
MoveDetailEffectChangesInnerEffectEntriesInner<PSCustomObject>
#>

function Initialize-MoveDetailEffectChangesInnerEffectEntriesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveDetailEffectChangesInnerEffectEntriesInner' | Write-Debug
...
Convert from JSON to MoveDetailEffectChangesInnerEffectEntriesInner<PSCustomObject>
...
MoveDetailEffectChangesInnerEffectEntriesInner<PSCustomObject>
#>
function ConvertFrom-JsonToMoveDetailEffectChangesInnerEffectEntriesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveDetailEffectChangesInnerEffectEntriesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
