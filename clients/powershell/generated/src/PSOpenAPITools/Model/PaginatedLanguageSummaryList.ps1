...
PaginatedLanguageSummaryList<PSCustomObject>
#>

function Initialize-PaginatedLanguageSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedLanguageSummaryList' | Write-Debug
...
Convert from JSON to PaginatedLanguageSummaryList<PSCustomObject>
...
PaginatedLanguageSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedLanguageSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedLanguageSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedLanguageSummaryList
