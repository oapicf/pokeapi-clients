...
PaginatedMoveLearnMethodSummaryList<PSCustomObject>
#>

function Initialize-PaginatedMoveLearnMethodSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedMoveLearnMethodSummaryList' | Write-Debug
...
Convert from JSON to PaginatedMoveLearnMethodSummaryList<PSCustomObject>
...
PaginatedMoveLearnMethodSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedMoveLearnMethodSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedMoveLearnMethodSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedMoveLearnMethodSummaryList
