...
BerryFlavorDetail<PSCustomObject>
#>

function Initialize-BerryFlavorDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BerryFlavorDetail' | Write-Debug
...
Convert from JSON to BerryFlavorDetail<PSCustomObject>
...
BerryFlavorDetail<PSCustomObject>
#>
function ConvertFrom-JsonToBerryFlavorDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BerryFlavorDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BerryFlavorDetail
        $AllProperties = ("id", "name", "berries", "contest_type", "names")
