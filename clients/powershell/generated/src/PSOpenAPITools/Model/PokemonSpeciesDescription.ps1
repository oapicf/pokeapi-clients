...
PokemonSpeciesDescription<PSCustomObject>
#>

function Initialize-PokemonSpeciesDescription {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokemonSpeciesDescription' | Write-Debug
...
Convert from JSON to PokemonSpeciesDescription<PSCustomObject>
...
PokemonSpeciesDescription<PSCustomObject>
#>
function ConvertFrom-JsonToPokemonSpeciesDescription {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokemonSpeciesDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PokemonSpeciesDescription
