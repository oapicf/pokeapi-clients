...
PaginatedCharacteristicSummaryList<PSCustomObject>
#>

function Initialize-PaginatedCharacteristicSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedCharacteristicSummaryList' | Write-Debug
...
Convert from JSON to PaginatedCharacteristicSummaryList<PSCustomObject>
...
PaginatedCharacteristicSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedCharacteristicSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedCharacteristicSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedCharacteristicSummaryList
