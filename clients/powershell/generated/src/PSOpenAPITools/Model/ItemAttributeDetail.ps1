...
ItemAttributeDetail<PSCustomObject>
#>

function Initialize-ItemAttributeDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ItemAttributeDetail' | Write-Debug
...
Convert from JSON to ItemAttributeDetail<PSCustomObject>
...
ItemAttributeDetail<PSCustomObject>
#>
function ConvertFrom-JsonToItemAttributeDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ItemAttributeDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ItemAttributeDetail
        $AllProperties = ("id", "name", "descriptions", "items", "names")
