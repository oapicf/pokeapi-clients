...
PaginatedMoveDamageClassSummaryList<PSCustomObject>
#>

function Initialize-PaginatedMoveDamageClassSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedMoveDamageClassSummaryList' | Write-Debug
...
Convert from JSON to PaginatedMoveDamageClassSummaryList<PSCustomObject>
...
PaginatedMoveDamageClassSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedMoveDamageClassSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedMoveDamageClassSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedMoveDamageClassSummaryList
