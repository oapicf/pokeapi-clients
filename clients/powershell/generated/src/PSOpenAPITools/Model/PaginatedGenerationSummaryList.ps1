...
PaginatedGenerationSummaryList<PSCustomObject>
#>

function Initialize-PaginatedGenerationSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedGenerationSummaryList' | Write-Debug
...
Convert from JSON to PaginatedGenerationSummaryList<PSCustomObject>
...
PaginatedGenerationSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedGenerationSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedGenerationSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedGenerationSummaryList
