...
AbilityName<PSCustomObject>
#>

function Initialize-AbilityName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AbilityName' | Write-Debug
...
Convert from JSON to AbilityName<PSCustomObject>
...
AbilityName<PSCustomObject>
#>
function ConvertFrom-JsonToAbilityName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AbilityName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AbilityName
