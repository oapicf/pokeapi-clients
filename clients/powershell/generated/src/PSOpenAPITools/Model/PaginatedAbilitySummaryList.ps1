...
PaginatedAbilitySummaryList<PSCustomObject>
#>

function Initialize-PaginatedAbilitySummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedAbilitySummaryList' | Write-Debug
...
Convert from JSON to PaginatedAbilitySummaryList<PSCustomObject>
...
PaginatedAbilitySummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedAbilitySummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedAbilitySummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedAbilitySummaryList
