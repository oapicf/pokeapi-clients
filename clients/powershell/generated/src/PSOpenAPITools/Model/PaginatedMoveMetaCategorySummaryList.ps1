...
PaginatedMoveMetaCategorySummaryList<PSCustomObject>
#>

function Initialize-PaginatedMoveMetaCategorySummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedMoveMetaCategorySummaryList' | Write-Debug
...
Convert from JSON to PaginatedMoveMetaCategorySummaryList<PSCustomObject>
...
PaginatedMoveMetaCategorySummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedMoveMetaCategorySummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedMoveMetaCategorySummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedMoveMetaCategorySummaryList
