...
PokemonShapeDetail<PSCustomObject>
#>

function Initialize-PokemonShapeDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokemonShapeDetail' | Write-Debug
        ...
        if ($null -eq $AwesomeNames) {
            throw "invalid value for 'AwesomeNames', 'AwesomeNames' cannot be null."
        }
...
Convert from JSON to PokemonShapeDetail<PSCustomObject>
...
PokemonShapeDetail<PSCustomObject>
#>
function ConvertFrom-JsonToPokemonShapeDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokemonShapeDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
