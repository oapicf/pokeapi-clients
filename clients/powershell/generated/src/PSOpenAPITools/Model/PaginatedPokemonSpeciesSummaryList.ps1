...
PaginatedPokemonSpeciesSummaryList<PSCustomObject>
#>

function Initialize-PaginatedPokemonSpeciesSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedPokemonSpeciesSummaryList' | Write-Debug
...
Convert from JSON to PaginatedPokemonSpeciesSummaryList<PSCustomObject>
...
PaginatedPokemonSpeciesSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedPokemonSpeciesSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedPokemonSpeciesSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedPokemonSpeciesSummaryList
