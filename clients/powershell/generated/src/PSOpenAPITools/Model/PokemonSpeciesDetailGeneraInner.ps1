...
PokemonSpeciesDetailGeneraInner<PSCustomObject>
#>

function Initialize-PokemonSpeciesDetailGeneraInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokemonSpeciesDetailGeneraInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        if ($null -eq $Genus) {
            throw "invalid value for 'Genus', 'Genus' cannot be null."
        }
...
Convert from JSON to PokemonSpeciesDetailGeneraInner<PSCustomObject>
...
PokemonSpeciesDetailGeneraInner<PSCustomObject>
#>
function ConvertFrom-JsonToPokemonSpeciesDetailGeneraInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokemonSpeciesDetailGeneraInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
