...
PaginatedEncounterMethodSummaryList<PSCustomObject>
#>

function Initialize-PaginatedEncounterMethodSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedEncounterMethodSummaryList' | Write-Debug
...
Convert from JSON to PaginatedEncounterMethodSummaryList<PSCustomObject>
...
PaginatedEncounterMethodSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedEncounterMethodSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedEncounterMethodSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedEncounterMethodSummaryList
