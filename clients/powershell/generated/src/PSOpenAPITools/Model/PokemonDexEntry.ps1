...
PokemonDexEntry<PSCustomObject>
#>

function Initialize-PokemonDexEntry {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PokemonDexEntry' | Write-Debug
        ...
        if ($null -eq $Pokedex) {
            throw "invalid value for 'Pokedex', 'Pokedex' cannot be null."
        }
...
Convert from JSON to PokemonDexEntry<PSCustomObject>
...
PokemonDexEntry<PSCustomObject>
#>
function ConvertFrom-JsonToPokemonDexEntry {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PokemonDexEntry' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
