...
PaginatedStatSummaryList<PSCustomObject>
#>

function Initialize-PaginatedStatSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedStatSummaryList' | Write-Debug
...
Convert from JSON to PaginatedStatSummaryList<PSCustomObject>
...
PaginatedStatSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedStatSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedStatSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedStatSummaryList
