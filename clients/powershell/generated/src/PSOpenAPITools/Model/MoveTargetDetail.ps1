...
MoveTargetDetail<PSCustomObject>
#>

function Initialize-MoveTargetDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveTargetDetail' | Write-Debug
...
Convert from JSON to MoveTargetDetail<PSCustomObject>
...
MoveTargetDetail<PSCustomObject>
#>
function ConvertFrom-JsonToMoveTargetDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveTargetDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveTargetDetail
