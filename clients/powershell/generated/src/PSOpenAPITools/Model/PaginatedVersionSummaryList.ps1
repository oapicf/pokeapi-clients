...
PaginatedVersionSummaryList<PSCustomObject>
#>

function Initialize-PaginatedVersionSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVersionSummaryList' | Write-Debug
...
Convert from JSON to PaginatedVersionSummaryList<PSCustomObject>
...
PaginatedVersionSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVersionSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVersionSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
