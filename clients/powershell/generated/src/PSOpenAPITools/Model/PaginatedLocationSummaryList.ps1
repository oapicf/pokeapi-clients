...
PaginatedLocationSummaryList<PSCustomObject>
#>

function Initialize-PaginatedLocationSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedLocationSummaryList' | Write-Debug
...
Convert from JSON to PaginatedLocationSummaryList<PSCustomObject>
...
PaginatedLocationSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedLocationSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedLocationSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedLocationSummaryList
