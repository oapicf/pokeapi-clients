...
PaginatedBerryFirmnessSummaryList<PSCustomObject>
#>

function Initialize-PaginatedBerryFirmnessSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedBerryFirmnessSummaryList' | Write-Debug
...
Convert from JSON to PaginatedBerryFirmnessSummaryList<PSCustomObject>
...
PaginatedBerryFirmnessSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedBerryFirmnessSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedBerryFirmnessSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedBerryFirmnessSummaryList
