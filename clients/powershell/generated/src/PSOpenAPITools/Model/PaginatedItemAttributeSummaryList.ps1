...
PaginatedItemAttributeSummaryList<PSCustomObject>
#>

function Initialize-PaginatedItemAttributeSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedItemAttributeSummaryList' | Write-Debug
...
Convert from JSON to PaginatedItemAttributeSummaryList<PSCustomObject>
...
PaginatedItemAttributeSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedItemAttributeSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedItemAttributeSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedItemAttributeSummaryList
