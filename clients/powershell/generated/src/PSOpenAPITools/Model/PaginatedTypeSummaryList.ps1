...
PaginatedTypeSummaryList<PSCustomObject>
#>

function Initialize-PaginatedTypeSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedTypeSummaryList' | Write-Debug
...
Convert from JSON to PaginatedTypeSummaryList<PSCustomObject>
...
PaginatedTypeSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedTypeSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedTypeSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedTypeSummaryList
