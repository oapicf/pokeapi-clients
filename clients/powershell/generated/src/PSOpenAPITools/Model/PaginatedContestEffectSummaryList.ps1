...
PaginatedContestEffectSummaryList<PSCustomObject>
#>

function Initialize-PaginatedContestEffectSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedContestEffectSummaryList' | Write-Debug
...
Convert from JSON to PaginatedContestEffectSummaryList<PSCustomObject>
...
PaginatedContestEffectSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedContestEffectSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedContestEffectSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedContestEffectSummaryList
