...
MoveDamageClassDescription<PSCustomObject>
#>

function Initialize-MoveDamageClassDescription {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MoveDamageClassDescription' | Write-Debug
...
Convert from JSON to MoveDamageClassDescription<PSCustomObject>
...
MoveDamageClassDescription<PSCustomObject>
#>
function ConvertFrom-JsonToMoveDamageClassDescription {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MoveDamageClassDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MoveDamageClassDescription
