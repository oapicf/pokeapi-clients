...
PaginatedVersionGroupSummaryList<PSCustomObject>
#>

function Initialize-PaginatedVersionGroupSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedVersionGroupSummaryList' | Write-Debug
...
Convert from JSON to PaginatedVersionGroupSummaryList<PSCustomObject>
...
PaginatedVersionGroupSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedVersionGroupSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedVersionGroupSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedVersionGroupSummaryList
