...
PaginatedMoveTargetSummaryList<PSCustomObject>
#>

function Initialize-PaginatedMoveTargetSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaginatedMoveTargetSummaryList' | Write-Debug
...
Convert from JSON to PaginatedMoveTargetSummaryList<PSCustomObject>
...
PaginatedMoveTargetSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPaginatedMoveTargetSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaginatedMoveTargetSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaginatedMoveTargetSummaryList
