...
```powershell
$TypeDetailPastDamageRelationsInnerDamageRelations = Initialize-PSOpenAPIToolsTypeDetailPastDamageRelationsInnerDamageRelations  -NoDamageTo null `
 -HalfDamageTo null `
 -DoubleDamageTo null `
 -NoDamageFrom null `
 -HalfDamageFrom null `
...
```powershell
$TypeDetailPastDamageRelationsInnerDamageRelations | ConvertTo-JSON
```
