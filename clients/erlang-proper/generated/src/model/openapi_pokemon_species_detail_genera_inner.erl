...
-export([openapi_pokemon_species_detail_genera_inner/0]).

-export([openapi_pokemon_species_detail_genera_inner/1]).
...
openapi_pokemon_species_detail_genera_inner() ->
    openapi_pokemon_species_detail_genera_inner([]).

openapi_pokemon_species_detail_genera_inner(Fields) ->
  Default = [ {'genus', binary() }
            , {'language', openapi_ability_detail_pokemon_inner_pokemon:openapi_ability_detail_pokemon_inner_pokemon() }
            ],
