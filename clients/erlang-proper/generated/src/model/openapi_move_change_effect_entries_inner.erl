...
-export([openapi_move_change_effect_entries_inner/0]).

-export([openapi_move_change_effect_entries_inner/1]).
...
openapi_move_change_effect_entries_inner() ->
    openapi_move_change_effect_entries_inner([]).

openapi_move_change_effect_entries_inner(Fields) ->
