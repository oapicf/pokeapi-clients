...
-export([openapi_pokemon_form_detail_sprites/0]).

-export([openapi_pokemon_form_detail_sprites/1]).
...
openapi_pokemon_form_detail_sprites() ->
    openapi_pokemon_form_detail_sprites([]).

openapi_pokemon_form_detail_sprites(Fields) ->
