-module(openapi_type_detail_damage_relations).

-include("openapi.hrl").

-export([openapi_type_detail_damage_relations/0]).

-export([openapi_type_detail_damage_relations/1]).

-export_type([openapi_type_detail_damage_relations/0]).

-type openapi_type_detail_damage_relations() ::
...
openapi_type_detail_damage_relations() ->
    openapi_type_detail_damage_relations([]).

openapi_type_detail_damage_relations(Fields) ->
