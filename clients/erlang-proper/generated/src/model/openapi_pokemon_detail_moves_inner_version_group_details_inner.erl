...
-export([openapi_pokemon_detail_moves_inner_version_group_details_inner/0]).

-export([openapi_pokemon_detail_moves_inner_version_group_details_inner/1]).
...
openapi_pokemon_detail_moves_inner_version_group_details_inner() ->
    openapi_pokemon_detail_moves_inner_version_group_details_inner([]).

openapi_pokemon_detail_moves_inner_version_group_details_inner(Fields) ->
  Default = [ {'level_learned_at', integer() }
            , {'move_learn_method', openapi_ability_detail_pokemon_inner_pokemon:openapi_ability_detail_pokemon_inner_pokemon() }
            , {'version_group', openapi_ability_detail_pokemon_inner_pokemon:openapi_ability_detail_pokemon_inner_pokemon() }
            ],
