...
class MoveSummary {
  ...
  static MoveSummary? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'name'), 'Required key "MoveSummary[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "MoveSummary[name]" has a null value in JSON.');
        assert(json.containsKey(r'url'), 'Required key "MoveSummary[url]" is missing from JSON.');
        assert(json[r'url'] != null, 'Required key "MoveSummary[url]" has a null value in JSON.');
        return true;
      }());
