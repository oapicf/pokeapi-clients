    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "BerryFirmnessSummary[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "BerryFirmnessSummary[$key]" has a null value in JSON.');
        });
        return true;
      }());
