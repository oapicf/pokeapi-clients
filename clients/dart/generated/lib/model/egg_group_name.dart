    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EggGroupName[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EggGroupName[$key]" has a null value in JSON.');
        });
        return true;
      }());
