...
class PokemonDetailHeldItems {
  ...
  static PokemonDetailHeldItems? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'item'), 'Required key "PokemonDetailHeldItems[item]" is missing from JSON.');
        assert(json[r'item'] != null, 'Required key "PokemonDetailHeldItems[item]" has a null value in JSON.');
        assert(json.containsKey(r'version_details'), 'Required key "PokemonDetailHeldItems[version_details]" is missing from JSON.');
        assert(json[r'version_details'] != null, 'Required key "PokemonDetailHeldItems[version_details]" has a null value in JSON.');
        return true;
      }());
