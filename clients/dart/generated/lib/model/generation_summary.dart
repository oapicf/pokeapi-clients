    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GenerationSummary[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GenerationSummary[$key]" has a null value in JSON.');
        });
        return true;
      }());
