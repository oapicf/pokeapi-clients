    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner(
        ...
        knownMove: mapValueOfType<Object>(json, r'known_move')!,
        knownMoveType: mapValueOfType<Object>(json, r'known_move_type')!,
