...
class StatDetailAffectingMoves {
  ...
  static StatDetailAffectingMoves? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'increase'), 'Required key "StatDetailAffectingMoves[increase]" is missing from JSON.');
        assert(json[r'increase'] != null, 'Required key "StatDetailAffectingMoves[increase]" has a null value in JSON.');
        assert(json.containsKey(r'decrease'), 'Required key "StatDetailAffectingMoves[decrease]" is missing from JSON.');
        assert(json[r'decrease'] != null, 'Required key "StatDetailAffectingMoves[decrease]" has a null value in JSON.');
        return true;
      }());
