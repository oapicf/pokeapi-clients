...
class GenderDetailPokemonSpeciesDetailsInner {
  ...
  static GenderDetailPokemonSpeciesDetailsInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'rate'), 'Required key "GenderDetailPokemonSpeciesDetailsInner[rate]" is missing from JSON.');
        assert(json[r'rate'] != null, 'Required key "GenderDetailPokemonSpeciesDetailsInner[rate]" has a null value in JSON.');
        assert(json.containsKey(r'pokemon_species'), 'Required key "GenderDetailPokemonSpeciesDetailsInner[pokemon_species]" is missing from JSON.');
        assert(json[r'pokemon_species'] != null, 'Required key "GenderDetailPokemonSpeciesDetailsInner[pokemon_species]" has a null value in JSON.');
        return true;
      }());
