...
class PokemonHabitatDetail {
  ...
  List<PokemonHabitatName> names;

  List<PokemonSpeciesSummary> pokemonSpecies;

  @override
  bool operator ==(Object other) => identical(this, other) || other is PokemonHabitatDetail &&
    other.id == id &&
    other.name == name &&
  ...
  @override
  String toString() => 'PokemonHabitatDetail[id=$id, name=$name, names=$names, pokemonSpecies=$pokemonSpecies]';
  ...
  /// Returns a new [PokemonHabitatDetail] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PokemonHabitatDetail? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PokemonHabitatDetail(
        ...
        names: PokemonHabitatName.listFromJson(json[r'names']),
  ...
  static List<PokemonHabitatDetail> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PokemonHabitatDetail>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PokemonHabitatDetail.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PokemonHabitatDetail> mapFromJson(dynamic json) {
    final map = <String, PokemonHabitatDetail>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PokemonHabitatDetail.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PokemonHabitatDetail-objects as value to a dart map
  static Map<String, List<PokemonHabitatDetail>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PokemonHabitatDetail>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PokemonHabitatDetail.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
