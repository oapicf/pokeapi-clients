    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PokemonFormSummary[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PokemonFormSummary[$key]" has a null value in JSON.');
        });
        return true;
      }());
