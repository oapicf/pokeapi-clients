...
class ItemCategorySummary {
  ...
  static ItemCategorySummary? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'name'), 'Required key "ItemCategorySummary[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "ItemCategorySummary[name]" has a null value in JSON.');
        assert(json.containsKey(r'url'), 'Required key "ItemCategorySummary[url]" is missing from JSON.');
        assert(json[r'url'] != null, 'Required key "ItemCategorySummary[url]" has a null value in JSON.');
        return true;
      }());
