...
class PalParkAreaSummary {
  ...
  static PalParkAreaSummary? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'name'), 'Required key "PalParkAreaSummary[name]" is missing from JSON.');
        assert(json[r'name'] != null, 'Required key "PalParkAreaSummary[name]" has a null value in JSON.');
        assert(json.containsKey(r'url'), 'Required key "PalParkAreaSummary[url]" is missing from JSON.');
        assert(json[r'url'] != null, 'Required key "PalParkAreaSummary[url]" has a null value in JSON.');
        return true;
      }());
