...
class MachineSummary {
  ...
  static MachineSummary? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'url'), 'Required key "MachineSummary[url]" is missing from JSON.');
        assert(json[r'url'] != null, 'Required key "MachineSummary[url]" has a null value in JSON.');
        return true;
      }());
