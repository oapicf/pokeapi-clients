...
public class ItemAttributeDetail  {
  ...
  protected List<ItemAttributeDescription> descriptions = new ArrayList<>();

  @JsonbProperty("items")
  protected List<AbilityDetailPokemonInnerPokemon> items = new ArrayList<>();

  @JsonbProperty("names")
  protected List<ItemAttributeName> names = new ArrayList<>();
 ...
 @JsonbCreator
  public ItemAttributeDetail(
    ...
    @JsonbProperty(value = "descriptions") List<ItemAttributeDescription> descriptions, 
    @JsonbProperty(value = "items") List<AbilityDetailPokemonInnerPokemon> items, 
    @JsonbProperty(value = "names") List<ItemAttributeName> names
  ) {
    this.id = id;
