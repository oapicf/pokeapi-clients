...
public class EvolutionChainDetailChain  {
  ...
  protected List<Object> evolutionDetails = new ArrayList<>();

  @JsonbProperty("evolves_to")
  protected List<EvolutionChainDetailChainEvolvesToInner> evolvesTo = new ArrayList<>();
