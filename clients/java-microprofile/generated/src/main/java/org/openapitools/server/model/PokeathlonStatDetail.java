...
public class PokeathlonStatDetail  {
  ...
  protected PokeathlonStatDetailAffectingNatures affectingNatures;

  @JsonbProperty("names")
  protected List<PokeathlonStatName> names = new ArrayList<>();
 ...
 @JsonbCreator
  public PokeathlonStatDetail(
    ...
    @JsonbProperty(value = "names") List<PokeathlonStatName> names
  ) {
    this.id = id;
    this.names = names;
  }
