...
public class PalParkAreaDetail  {
  ...
  @JsonbProperty("names")
  protected List<PalParkAreaName> names = new ArrayList<>();

  @JsonbProperty("pokemon_encounters")
  protected List<PalParkAreaDetailPokemonEncountersInner> pokemonEncounters = new ArrayList<>();
 ...
 @JsonbCreator
  public PalParkAreaDetail(
    ...
    @JsonbProperty(value = "names") List<PalParkAreaName> names, 
    @JsonbProperty(value = "pokemon_encounters") List<PalParkAreaDetailPokemonEncountersInner> pokemonEncounters
  ) {
    this.id = id;
    this.names = names;
