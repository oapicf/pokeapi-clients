...
public class StatDetailAffectingMoves  {
  ...
  protected List<StatDetailAffectingMovesIncreaseInner> increase = new ArrayList<>();

  @JsonbProperty("decrease")
  protected List<StatDetailAffectingMovesIncreaseInner> decrease = new ArrayList<>();
