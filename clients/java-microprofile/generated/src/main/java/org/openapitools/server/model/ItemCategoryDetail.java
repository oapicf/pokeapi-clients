...
public class ItemCategoryDetail  {
  ...
  @JsonbProperty("names")
  protected List<ItemCategoryName> names = new ArrayList<>();

  @JsonbProperty("pocket")
  protected ItemPocketSummary pocket;
 ...
 @JsonbCreator
  public ItemCategoryDetail(
    ...
    @JsonbProperty(value = "names") List<ItemCategoryName> names
  ) {
    this.id = id;
    this.items = items;
    this.names = names;
