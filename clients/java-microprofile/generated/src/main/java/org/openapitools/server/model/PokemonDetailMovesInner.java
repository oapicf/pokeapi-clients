...
public class PokemonDetailMovesInner  {
  ...
  @JsonbProperty("move")
  protected AbilityDetailPokemonInnerPokemon move;

  @JsonbProperty("version_group_details")
  protected List<PokemonDetailMovesInnerVersionGroupDetailsInner> versionGroupDetails = new ArrayList<>();
