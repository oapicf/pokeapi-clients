...
public class EggGroupDetail  {
  ...
  @JsonbProperty("names")
  protected List<EggGroupName> names = new ArrayList<>();

  @JsonbProperty("pokemon_species")
  protected List<EggGroupDetailPokemonSpeciesInner> pokemonSpecies = new ArrayList<>();
 ...
 @JsonbCreator
  public EggGroupDetail(
    ...
    @JsonbProperty(value = "names") List<EggGroupName> names, 
    @JsonbProperty(value = "pokemon_species") List<EggGroupDetailPokemonSpeciesInner> pokemonSpecies
  ) {
    this.id = id;
    this.names = names;
