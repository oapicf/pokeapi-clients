...
public class LanguageDetail  {
  ...
  @JsonbProperty("official")
  protected Boolean official;

  @JsonbProperty("iso639")
  protected String iso639;

  @JsonbProperty("iso3166")
  protected String iso3166;

  @JsonbProperty("names")
  protected List<LanguageName> names = new ArrayList<>();
 ...
 @JsonbCreator
  public LanguageDetail(
    ...
    @JsonbProperty(value = "names") List<LanguageName> names
  ) {
    this.id = id;
    this.names = names;
  }
