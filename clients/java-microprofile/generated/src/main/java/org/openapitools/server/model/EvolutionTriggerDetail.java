...
public class EvolutionTriggerDetail  {
  ...
  @JsonbProperty("names")
  protected List<EvolutionTriggerName> names = new ArrayList<>();

  @JsonbProperty("pokemon_species")
  protected List<AbilityDetailPokemonInnerPokemon> pokemonSpecies = new ArrayList<>();
 ...
 @JsonbCreator
  public EvolutionTriggerDetail(
    ...
    @JsonbProperty(value = "names") List<EvolutionTriggerName> names, 
    @JsonbProperty(value = "pokemon_species") List<AbilityDetailPokemonInnerPokemon> pokemonSpecies
  ) {
    this.id = id;
    this.names = names;
