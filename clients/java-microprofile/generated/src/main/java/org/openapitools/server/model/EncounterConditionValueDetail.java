...
public class EncounterConditionValueDetail  {
  ...
  protected EncounterConditionSummary condition;

  @JsonbProperty("names")
  protected List<EncounterConditionValueName> names = new ArrayList<>();
 ...
 @JsonbCreator
  public EncounterConditionValueDetail(
    ...
    @JsonbProperty(value = "names") List<EncounterConditionValueName> names
  ) {
    this.id = id;
    this.names = names;
  }
