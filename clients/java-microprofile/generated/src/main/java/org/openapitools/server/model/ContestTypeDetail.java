...
public class ContestTypeDetail  {
  ...
  @JsonbProperty("berry_flavor")
  protected BerryFlavorSummary berryFlavor;

  @JsonbProperty("names")
  protected List<ContestTypeName> names = new ArrayList<>();
 ...
 @JsonbCreator
  public ContestTypeDetail(
    ...
    @JsonbProperty(value = "berry_flavor") BerryFlavorSummary berryFlavor, 
    @JsonbProperty(value = "names") List<ContestTypeName> names
  ) {
    this.id = id;
