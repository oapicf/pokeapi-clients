...
open class ItemAttributeApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun itemAttributeList(limit: kotlin.Int? = null, offset: kotlin.Int? = null) : kotlin.String {
