...
class BerryApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun berryList(limit: kotlin.Int?, offset: kotlin.Int?) : kotlin.String {
    ...
    */
    fun berryReadRequestConfig(id: kotlin.Int) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/api/v2/berry/{id}/".replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
