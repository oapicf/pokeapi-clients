...
class LocationApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun locationReadRequestConfig(id: kotlin.Int) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/api/v2/location/{id}/".replace("{"+"id"+"}", id.toString()),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
