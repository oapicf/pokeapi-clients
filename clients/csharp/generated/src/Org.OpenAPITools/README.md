...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAbilityApi>();
            AbilityListApiResponse apiResponse = await api.AbilityListAsync("todo");
            string model = apiResponse.Ok();
        }
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {50ECA60C-BA2F-4853-AB96-8B2B6C6CE4A8}
- packageName: Org.OpenAPITools
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
