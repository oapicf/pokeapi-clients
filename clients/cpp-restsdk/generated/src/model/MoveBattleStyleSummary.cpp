...
void MoveBattleStyleSummary::validate()
{
    // TODO: implement validation
}

web::json::value MoveBattleStyleSummary::toJson() const
{
...
bool MoveBattleStyleSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveBattleStyleSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveBattleStyleSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveBattleStyleSummary::getName() const
{
    return m_Name;
}


void MoveBattleStyleSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveBattleStyleSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveBattleStyleSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t MoveBattleStyleSummary::getUrl() const
{
    return m_Url;
}


void MoveBattleStyleSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool MoveBattleStyleSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void MoveBattleStyleSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
