...
void PokemonShapeDetail_names_inner::validate()
{
    // TODO: implement validation
}

web::json::value PokemonShapeDetail_names_inner::toJson() const
{
...
bool PokemonShapeDetail_names_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonShapeDetail_names_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonShapeDetail_names_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonShapeDetail_names_inner::getUrl() const
{
    return m_Url;
}


void PokemonShapeDetail_names_inner::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokemonShapeDetail_names_inner::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokemonShapeDetail_names_inner::unsetUrl()
{
    m_UrlIsSet = false;
}
utility::string_t PokemonShapeDetail_names_inner::getName() const
{
    return m_Name;
}


void PokemonShapeDetail_names_inner::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonShapeDetail_names_inner::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonShapeDetail_names_inner::unsetName()
{
    m_NameIsSet = false;
}
