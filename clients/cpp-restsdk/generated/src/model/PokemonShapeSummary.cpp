...
void PokemonShapeSummary::validate()
{
    // TODO: implement validation
}

web::json::value PokemonShapeSummary::toJson() const
{
...
bool PokemonShapeSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonShapeSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonShapeSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonShapeSummary::getName() const
{
    return m_Name;
}


void PokemonShapeSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonShapeSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonShapeSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PokemonShapeSummary::getUrl() const
{
    return m_Url;
}


void PokemonShapeSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokemonShapeSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokemonShapeSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
