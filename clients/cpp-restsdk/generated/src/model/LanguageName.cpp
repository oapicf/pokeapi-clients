...
void LanguageName::validate()
{
    // TODO: implement validation
}

web::json::value LanguageName::toJson() const
{
...
bool LanguageName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LanguageName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LanguageName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LanguageName::getName() const
{
    return m_Name;
}


void LanguageName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool LanguageName::nameIsSet() const
{
    return m_NameIsSet;
}

void LanguageName::unsetName()
{
    m_NameIsSet = false;
}
...
void LanguageName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool LanguageName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void LanguageName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
