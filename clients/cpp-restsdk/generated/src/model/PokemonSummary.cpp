...
void PokemonSummary::validate()
{
    // TODO: implement validation
}

web::json::value PokemonSummary::toJson() const
{
...
bool PokemonSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonSummary::getName() const
{
    return m_Name;
}


void PokemonSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PokemonSummary::getUrl() const
{
    return m_Url;
}


void PokemonSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokemonSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokemonSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
