...
void EncounterConditionSummary::validate()
{
    // TODO: implement validation
}

web::json::value EncounterConditionSummary::toJson() const
{
...
bool EncounterConditionSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EncounterConditionSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EncounterConditionSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EncounterConditionSummary::getName() const
{
    return m_Name;
}


void EncounterConditionSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EncounterConditionSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void EncounterConditionSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t EncounterConditionSummary::getUrl() const
{
    return m_Url;
}


void EncounterConditionSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool EncounterConditionSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void EncounterConditionSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
