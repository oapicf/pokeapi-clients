...
#include "CppRestOpenAPIClient/model/PokemonColorName.h"
...
void PokemonColorName::validate()
{
    // TODO: implement validation
}

web::json::value PokemonColorName::toJson() const
{
...
bool PokemonColorName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonColorName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonColorName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonColorName::getName() const
{
    return m_Name;
}


void PokemonColorName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonColorName::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonColorName::unsetName()
{
    m_NameIsSet = false;
}
...
void PokemonColorName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool PokemonColorName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void PokemonColorName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
