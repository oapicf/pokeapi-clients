...
void VersionGroupSummary::validate()
{
    // TODO: implement validation
}

web::json::value VersionGroupSummary::toJson() const
{
...
bool VersionGroupSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void VersionGroupSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VersionGroupSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t VersionGroupSummary::getName() const
{
    return m_Name;
}


void VersionGroupSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool VersionGroupSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void VersionGroupSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t VersionGroupSummary::getUrl() const
{
    return m_Url;
}


void VersionGroupSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool VersionGroupSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void VersionGroupSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
