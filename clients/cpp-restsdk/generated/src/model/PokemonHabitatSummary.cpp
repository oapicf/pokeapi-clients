...
void PokemonHabitatSummary::validate()
{
    // TODO: implement validation
}

web::json::value PokemonHabitatSummary::toJson() const
{
...
bool PokemonHabitatSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonHabitatSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonHabitatSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonHabitatSummary::getName() const
{
    return m_Name;
}


void PokemonHabitatSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonHabitatSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonHabitatSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PokemonHabitatSummary::getUrl() const
{
    return m_Url;
}


void PokemonHabitatSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokemonHabitatSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokemonHabitatSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
