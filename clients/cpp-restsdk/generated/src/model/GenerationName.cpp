...
void GenerationName::validate()
{
    // TODO: implement validation
}

web::json::value GenerationName::toJson() const
{
...
bool GenerationName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GenerationName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GenerationName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GenerationName::getName() const
{
    return m_Name;
}


void GenerationName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool GenerationName::nameIsSet() const
{
    return m_NameIsSet;
}

void GenerationName::unsetName()
{
    m_NameIsSet = false;
}
...
void GenerationName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool GenerationName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void GenerationName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
