...
void LocationAreaSummary::validate()
{
    // TODO: implement validation
}

web::json::value LocationAreaSummary::toJson() const
{
...
bool LocationAreaSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LocationAreaSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LocationAreaSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LocationAreaSummary::getName() const
{
    return m_Name;
}


void LocationAreaSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool LocationAreaSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void LocationAreaSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t LocationAreaSummary::getUrl() const
{
    return m_Url;
}


void LocationAreaSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool LocationAreaSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void LocationAreaSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
