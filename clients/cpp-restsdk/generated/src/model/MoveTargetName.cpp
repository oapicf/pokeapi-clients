...
void MoveTargetName::validate()
{
    // TODO: implement validation
}

web::json::value MoveTargetName::toJson() const
{
...
bool MoveTargetName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveTargetName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveTargetName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveTargetName::getName() const
{
    return m_Name;
}


void MoveTargetName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveTargetName::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveTargetName::unsetName()
{
    m_NameIsSet = false;
}
...
void MoveTargetName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveTargetName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveTargetName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
