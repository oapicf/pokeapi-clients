...
void MoveTargetSummary::validate()
{
    // TODO: implement validation
}

web::json::value MoveTargetSummary::toJson() const
{
...
bool MoveTargetSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveTargetSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveTargetSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveTargetSummary::getName() const
{
    return m_Name;
}


void MoveTargetSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveTargetSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveTargetSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t MoveTargetSummary::getUrl() const
{
    return m_Url;
}


void MoveTargetSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool MoveTargetSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void MoveTargetSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
