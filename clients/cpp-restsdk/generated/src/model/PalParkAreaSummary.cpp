...
#include "CppRestOpenAPIClient/model/PalParkAreaSummary.h"
...
void PalParkAreaSummary::validate()
{
    // TODO: implement validation
}

web::json::value PalParkAreaSummary::toJson() const
{
...
bool PalParkAreaSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PalParkAreaSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PalParkAreaSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PalParkAreaSummary::getName() const
{
    return m_Name;
}


void PalParkAreaSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PalParkAreaSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PalParkAreaSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PalParkAreaSummary::getUrl() const
{
    return m_Url;
}


void PalParkAreaSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PalParkAreaSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PalParkAreaSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
