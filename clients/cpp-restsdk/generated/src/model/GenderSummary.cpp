...
#include "CppRestOpenAPIClient/model/GenderSummary.h"
...
void GenderSummary::validate()
{
    // TODO: implement validation
}

web::json::value GenderSummary::toJson() const
{
...
bool GenderSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GenderSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GenderSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GenderSummary::getName() const
{
    return m_Name;
}


void GenderSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool GenderSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void GenderSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t GenderSummary::getUrl() const
{
    return m_Url;
}


void GenderSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool GenderSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void GenderSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
