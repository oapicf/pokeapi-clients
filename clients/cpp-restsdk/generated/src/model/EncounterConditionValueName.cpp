...
void EncounterConditionValueName::validate()
{
    // TODO: implement validation
}

web::json::value EncounterConditionValueName::toJson() const
{
...
bool EncounterConditionValueName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EncounterConditionValueName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EncounterConditionValueName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EncounterConditionValueName::getName() const
{
    return m_Name;
}


void EncounterConditionValueName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EncounterConditionValueName::nameIsSet() const
{
    return m_NameIsSet;
}

void EncounterConditionValueName::unsetName()
{
    m_NameIsSet = false;
}
...
void EncounterConditionValueName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool EncounterConditionValueName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void EncounterConditionValueName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
