...
#include "CppRestOpenAPIClient/model/ItemAttributeSummary.h"
...
void ItemAttributeSummary::validate()
{
    // TODO: implement validation
}

web::json::value ItemAttributeSummary::toJson() const
{
...
bool ItemAttributeSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemAttributeSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemAttributeSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemAttributeSummary::getName() const
{
    return m_Name;
}


void ItemAttributeSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemAttributeSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemAttributeSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t ItemAttributeSummary::getUrl() const
{
    return m_Url;
}


void ItemAttributeSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool ItemAttributeSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void ItemAttributeSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
