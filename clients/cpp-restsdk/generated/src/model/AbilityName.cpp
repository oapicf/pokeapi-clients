...
void AbilityName::validate()
{
    // TODO: implement validation
}

web::json::value AbilityName::toJson() const
{
...
bool AbilityName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AbilityName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AbilityName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AbilityName::getName() const
{
    return m_Name;
}


void AbilityName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AbilityName::nameIsSet() const
{
    return m_NameIsSet;
}

void AbilityName::unsetName()
{
    m_NameIsSet = false;
}
...
void AbilityName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool AbilityName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void AbilityName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
