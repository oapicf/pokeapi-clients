...
#include "CppRestOpenAPIClient/model/ItemPocketName.h"
...
void ItemPocketName::validate()
{
    // TODO: implement validation
}

web::json::value ItemPocketName::toJson() const
{
...
bool ItemPocketName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemPocketName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemPocketName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemPocketName::getName() const
{
    return m_Name;
}


void ItemPocketName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemPocketName::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemPocketName::unsetName()
{
    m_NameIsSet = false;
}
...
void ItemPocketName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool ItemPocketName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void ItemPocketName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
