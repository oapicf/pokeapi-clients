...
void BerryDetail_flavors_inner_flavor::validate()
{
    // TODO: implement validation
}

web::json::value BerryDetail_flavors_inner_flavor::toJson() const
{
...
bool BerryDetail_flavors_inner_flavor::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BerryDetail_flavors_inner_flavor::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BerryDetail_flavors_inner_flavor::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BerryDetail_flavors_inner_flavor::getName() const
{
    return m_Name;
}


void BerryDetail_flavors_inner_flavor::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
utility::string_t BerryDetail_flavors_inner_flavor::getUrl() const
{
    return m_Url;
}


void BerryDetail_flavors_inner_flavor::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}
