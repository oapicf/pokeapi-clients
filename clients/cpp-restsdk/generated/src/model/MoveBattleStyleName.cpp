...
void MoveBattleStyleName::validate()
{
    // TODO: implement validation
}

web::json::value MoveBattleStyleName::toJson() const
{
...
bool MoveBattleStyleName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveBattleStyleName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveBattleStyleName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveBattleStyleName::getName() const
{
    return m_Name;
}


void MoveBattleStyleName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveBattleStyleName::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveBattleStyleName::unsetName()
{
    m_NameIsSet = false;
}
...
void MoveBattleStyleName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveBattleStyleName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveBattleStyleName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
