...
void ItemFlingEffectSummary::validate()
{
    // TODO: implement validation
}

web::json::value ItemFlingEffectSummary::toJson() const
{
...
bool ItemFlingEffectSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemFlingEffectSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemFlingEffectSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemFlingEffectSummary::getName() const
{
    return m_Name;
}


void ItemFlingEffectSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemFlingEffectSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemFlingEffectSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t ItemFlingEffectSummary::getUrl() const
{
    return m_Url;
}


void ItemFlingEffectSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool ItemFlingEffectSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void ItemFlingEffectSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
