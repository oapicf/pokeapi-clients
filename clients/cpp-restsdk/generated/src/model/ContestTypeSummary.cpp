...
void ContestTypeSummary::validate()
{
    // TODO: implement validation
}

web::json::value ContestTypeSummary::toJson() const
{
...
bool ContestTypeSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ContestTypeSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ContestTypeSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ContestTypeSummary::getName() const
{
    return m_Name;
}


void ContestTypeSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ContestTypeSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void ContestTypeSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t ContestTypeSummary::getUrl() const
{
    return m_Url;
}


void ContestTypeSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool ContestTypeSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void ContestTypeSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
