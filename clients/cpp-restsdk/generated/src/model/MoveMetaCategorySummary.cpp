...
void MoveMetaCategorySummary::validate()
{
    // TODO: implement validation
}

web::json::value MoveMetaCategorySummary::toJson() const
{
...
bool MoveMetaCategorySummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveMetaCategorySummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveMetaCategorySummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveMetaCategorySummary::getName() const
{
    return m_Name;
}


void MoveMetaCategorySummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveMetaCategorySummary::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveMetaCategorySummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t MoveMetaCategorySummary::getUrl() const
{
    return m_Url;
}


void MoveMetaCategorySummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool MoveMetaCategorySummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void MoveMetaCategorySummary::unsetUrl()
{
    m_UrlIsSet = false;
}
