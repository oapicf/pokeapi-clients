...
void ItemAttributeDescription::validate()
{
    // TODO: implement validation
}

web::json::value ItemAttributeDescription::toJson() const
{
...
bool ItemAttributeDescription::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemAttributeDescription::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemAttributeDescription::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemAttributeDescription::getDescription() const
{
    return m_Description;
}


void ItemAttributeDescription::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool ItemAttributeDescription::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void ItemAttributeDescription::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void ItemAttributeDescription::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool ItemAttributeDescription::languageIsSet() const
{
    return m_LanguageIsSet;
}

void ItemAttributeDescription::unsetLanguage()
{
    m_LanguageIsSet = false;
}
