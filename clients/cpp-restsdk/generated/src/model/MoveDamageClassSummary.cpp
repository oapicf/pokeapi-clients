...
void MoveDamageClassSummary::validate()
{
    // TODO: implement validation
}

web::json::value MoveDamageClassSummary::toJson() const
{
...
bool MoveDamageClassSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveDamageClassSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveDamageClassSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveDamageClassSummary::getName() const
{
    return m_Name;
}


void MoveDamageClassSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveDamageClassSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveDamageClassSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t MoveDamageClassSummary::getUrl() const
{
    return m_Url;
}


void MoveDamageClassSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool MoveDamageClassSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void MoveDamageClassSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
