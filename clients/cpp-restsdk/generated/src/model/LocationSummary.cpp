...
void LocationSummary::validate()
{
    // TODO: implement validation
}

web::json::value LocationSummary::toJson() const
{
...
bool LocationSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LocationSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LocationSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LocationSummary::getName() const
{
    return m_Name;
}


void LocationSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool LocationSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void LocationSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t LocationSummary::getUrl() const
{
    return m_Url;
}


void LocationSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool LocationSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void LocationSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
