...
void RegionName::validate()
{
    // TODO: implement validation
}

web::json::value RegionName::toJson() const
{
...
bool RegionName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RegionName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RegionName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RegionName::getName() const
{
    return m_Name;
}


void RegionName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool RegionName::nameIsSet() const
{
    return m_NameIsSet;
}

void RegionName::unsetName()
{
    m_NameIsSet = false;
}
...
void RegionName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool RegionName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void RegionName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
