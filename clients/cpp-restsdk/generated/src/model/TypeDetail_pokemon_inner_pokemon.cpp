...
#include "CppRestOpenAPIClient/model/TypeDetail_pokemon_inner_pokemon.h"
...
void TypeDetail_pokemon_inner_pokemon::validate()
{
    // TODO: implement validation
}

web::json::value TypeDetail_pokemon_inner_pokemon::toJson() const
{
...
bool TypeDetail_pokemon_inner_pokemon::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TypeDetail_pokemon_inner_pokemon::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TypeDetail_pokemon_inner_pokemon::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TypeDetail_pokemon_inner_pokemon::getName() const
{
    return m_Name;
}


void TypeDetail_pokemon_inner_pokemon::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
utility::string_t TypeDetail_pokemon_inner_pokemon::getUrl() const
{
    return m_Url;
}


void TypeDetail_pokemon_inner_pokemon::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}
