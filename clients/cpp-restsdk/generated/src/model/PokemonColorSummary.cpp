...
void PokemonColorSummary::validate()
{
    // TODO: implement validation
}

web::json::value PokemonColorSummary::toJson() const
{
...
bool PokemonColorSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonColorSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonColorSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonColorSummary::getName() const
{
    return m_Name;
}


void PokemonColorSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonColorSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonColorSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PokemonColorSummary::getUrl() const
{
    return m_Url;
}


void PokemonColorSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokemonColorSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokemonColorSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
