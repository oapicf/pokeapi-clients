...
#include "CppRestOpenAPIClient/model/PokeathlonStatName.h"
...
void PokeathlonStatName::validate()
{
    // TODO: implement validation
}

web::json::value PokeathlonStatName::toJson() const
{
...
bool PokeathlonStatName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokeathlonStatName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokeathlonStatName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokeathlonStatName::getName() const
{
    return m_Name;
}


void PokeathlonStatName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokeathlonStatName::nameIsSet() const
{
    return m_NameIsSet;
}

void PokeathlonStatName::unsetName()
{
    m_NameIsSet = false;
}
...
void PokeathlonStatName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool PokeathlonStatName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void PokeathlonStatName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
