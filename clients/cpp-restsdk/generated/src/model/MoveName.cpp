...
void MoveName::validate()
{
    // TODO: implement validation
}

web::json::value MoveName::toJson() const
{
...
bool MoveName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveName::getName() const
{
    return m_Name;
}


void MoveName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveName::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveName::unsetName()
{
    m_NameIsSet = false;
}
...
void MoveName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
