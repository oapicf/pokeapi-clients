...
void PokemonSpeciesDescription::validate()
{
    // TODO: implement validation
}

web::json::value PokemonSpeciesDescription::toJson() const
{
...
bool PokemonSpeciesDescription::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonSpeciesDescription::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonSpeciesDescription::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonSpeciesDescription::getDescription() const
{
    return m_Description;
}


void PokemonSpeciesDescription::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool PokemonSpeciesDescription::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void PokemonSpeciesDescription::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void PokemonSpeciesDescription::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool PokemonSpeciesDescription::languageIsSet() const
{
    return m_LanguageIsSet;
}

void PokemonSpeciesDescription::unsetLanguage()
{
    m_LanguageIsSet = false;
}
