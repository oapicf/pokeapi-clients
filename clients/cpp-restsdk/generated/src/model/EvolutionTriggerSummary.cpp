...
#include "CppRestOpenAPIClient/model/EvolutionTriggerSummary.h"
...
void EvolutionTriggerSummary::validate()
{
    // TODO: implement validation
}

web::json::value EvolutionTriggerSummary::toJson() const
{
...
bool EvolutionTriggerSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EvolutionTriggerSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EvolutionTriggerSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EvolutionTriggerSummary::getName() const
{
    return m_Name;
}


void EvolutionTriggerSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EvolutionTriggerSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void EvolutionTriggerSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t EvolutionTriggerSummary::getUrl() const
{
    return m_Url;
}


void EvolutionTriggerSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool EvolutionTriggerSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void EvolutionTriggerSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
