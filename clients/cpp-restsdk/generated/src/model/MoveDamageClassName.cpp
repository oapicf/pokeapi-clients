...
void MoveDamageClassName::validate()
{
    // TODO: implement validation
}

web::json::value MoveDamageClassName::toJson() const
{
...
bool MoveDamageClassName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveDamageClassName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveDamageClassName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveDamageClassName::getName() const
{
    return m_Name;
}


void MoveDamageClassName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveDamageClassName::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveDamageClassName::unsetName()
{
    m_NameIsSet = false;
}
...
void MoveDamageClassName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveDamageClassName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveDamageClassName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
