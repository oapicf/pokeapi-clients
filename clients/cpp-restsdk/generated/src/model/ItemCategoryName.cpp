...
void ItemCategoryName::validate()
{
    // TODO: implement validation
}

web::json::value ItemCategoryName::toJson() const
{
...
bool ItemCategoryName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemCategoryName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemCategoryName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemCategoryName::getName() const
{
    return m_Name;
}


void ItemCategoryName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemCategoryName::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemCategoryName::unsetName()
{
    m_NameIsSet = false;
}
...
void ItemCategoryName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool ItemCategoryName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void ItemCategoryName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
