...
void CharacteristicDescription::validate()
{
    // TODO: implement validation
}

web::json::value CharacteristicDescription::toJson() const
{
...
bool CharacteristicDescription::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CharacteristicDescription::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CharacteristicDescription::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CharacteristicDescription::getDescription() const
{
    return m_Description;
}


void CharacteristicDescription::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool CharacteristicDescription::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void CharacteristicDescription::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void CharacteristicDescription::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool CharacteristicDescription::languageIsSet() const
{
    return m_LanguageIsSet;
}

void CharacteristicDescription::unsetLanguage()
{
    m_LanguageIsSet = false;
}
