...
void BerryFlavorDetail_berries_inner_berry::validate()
{
    // TODO: implement validation
}

web::json::value BerryFlavorDetail_berries_inner_berry::toJson() const
{
...
bool BerryFlavorDetail_berries_inner_berry::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BerryFlavorDetail_berries_inner_berry::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BerryFlavorDetail_berries_inner_berry::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BerryFlavorDetail_berries_inner_berry::getName() const
{
    return m_Name;
}


void BerryFlavorDetail_berries_inner_berry::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
utility::string_t BerryFlavorDetail_berries_inner_berry::getUrl() const
{
    return m_Url;
}


void BerryFlavorDetail_berries_inner_berry::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}
