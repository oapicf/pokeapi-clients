...
void MoveLearnMethodName::validate()
{
    // TODO: implement validation
}

web::json::value MoveLearnMethodName::toJson() const
{
...
bool MoveLearnMethodName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveLearnMethodName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveLearnMethodName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveLearnMethodName::getName() const
{
    return m_Name;
}


void MoveLearnMethodName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveLearnMethodName::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveLearnMethodName::unsetName()
{
    m_NameIsSet = false;
}
...
void MoveLearnMethodName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveLearnMethodName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveLearnMethodName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
