...
void LocationName::validate()
{
    // TODO: implement validation
}

web::json::value LocationName::toJson() const
{
...
bool LocationName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LocationName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LocationName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LocationName::getName() const
{
    return m_Name;
}


void LocationName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool LocationName::nameIsSet() const
{
    return m_NameIsSet;
}

void LocationName::unsetName()
{
    m_NameIsSet = false;
}
...
void LocationName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool LocationName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void LocationName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
