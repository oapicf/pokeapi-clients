...
void BerryFlavorSummary::validate()
{
    // TODO: implement validation
}

web::json::value BerryFlavorSummary::toJson() const
{
...
bool BerryFlavorSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BerryFlavorSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BerryFlavorSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BerryFlavorSummary::getName() const
{
    return m_Name;
}


void BerryFlavorSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BerryFlavorSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void BerryFlavorSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t BerryFlavorSummary::getUrl() const
{
    return m_Url;
}


void BerryFlavorSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool BerryFlavorSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void BerryFlavorSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
