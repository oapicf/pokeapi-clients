...
void VersionName::validate()
{
    // TODO: implement validation
}

web::json::value VersionName::toJson() const
{
...
bool VersionName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void VersionName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VersionName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t VersionName::getName() const
{
    return m_Name;
}


void VersionName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool VersionName::nameIsSet() const
{
    return m_NameIsSet;
}

void VersionName::unsetName()
{
    m_NameIsSet = false;
}
...
void VersionName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool VersionName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void VersionName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
