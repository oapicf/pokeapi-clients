...
void AbilityDetail_pokemon_inner_pokemon::validate()
{
    // TODO: implement validation
}

web::json::value AbilityDetail_pokemon_inner_pokemon::toJson() const
{
...
bool AbilityDetail_pokemon_inner_pokemon::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AbilityDetail_pokemon_inner_pokemon::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AbilityDetail_pokemon_inner_pokemon::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AbilityDetail_pokemon_inner_pokemon::getName() const
{
    return m_Name;
}


void AbilityDetail_pokemon_inner_pokemon::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AbilityDetail_pokemon_inner_pokemon::nameIsSet() const
{
    return m_NameIsSet;
}

void AbilityDetail_pokemon_inner_pokemon::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t AbilityDetail_pokemon_inner_pokemon::getUrl() const
{
    return m_Url;
}


void AbilityDetail_pokemon_inner_pokemon::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool AbilityDetail_pokemon_inner_pokemon::urlIsSet() const
{
    return m_UrlIsSet;
}

void AbilityDetail_pokemon_inner_pokemon::unsetUrl()
{
    m_UrlIsSet = false;
}
