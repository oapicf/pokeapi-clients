...
#include "CppRestOpenAPIClient/model/EggGroupSummary.h"
...
void EggGroupSummary::validate()
{
    // TODO: implement validation
}

web::json::value EggGroupSummary::toJson() const
{
...
bool EggGroupSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EggGroupSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EggGroupSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EggGroupSummary::getName() const
{
    return m_Name;
}


void EggGroupSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EggGroupSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void EggGroupSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t EggGroupSummary::getUrl() const
{
    return m_Url;
}


void EggGroupSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool EggGroupSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void EggGroupSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
