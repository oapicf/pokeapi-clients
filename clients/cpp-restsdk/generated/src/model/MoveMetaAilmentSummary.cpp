...
void MoveMetaAilmentSummary::validate()
{
    // TODO: implement validation
}

web::json::value MoveMetaAilmentSummary::toJson() const
{
...
bool MoveMetaAilmentSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveMetaAilmentSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveMetaAilmentSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveMetaAilmentSummary::getName() const
{
    return m_Name;
}


void MoveMetaAilmentSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveMetaAilmentSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveMetaAilmentSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t MoveMetaAilmentSummary::getUrl() const
{
    return m_Url;
}


void MoveMetaAilmentSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool MoveMetaAilmentSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void MoveMetaAilmentSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
