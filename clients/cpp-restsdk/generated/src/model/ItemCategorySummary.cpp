...
void ItemCategorySummary::validate()
{
    // TODO: implement validation
}

web::json::value ItemCategorySummary::toJson() const
{
...
bool ItemCategorySummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemCategorySummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemCategorySummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemCategorySummary::getName() const
{
    return m_Name;
}


void ItemCategorySummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemCategorySummary::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemCategorySummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t ItemCategorySummary::getUrl() const
{
    return m_Url;
}


void ItemCategorySummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool ItemCategorySummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void ItemCategorySummary::unsetUrl()
{
    m_UrlIsSet = false;
}
