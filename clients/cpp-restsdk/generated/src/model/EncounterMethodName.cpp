...
void EncounterMethodName::validate()
{
    // TODO: implement validation
}

web::json::value EncounterMethodName::toJson() const
{
...
bool EncounterMethodName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EncounterMethodName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EncounterMethodName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EncounterMethodName::getName() const
{
    return m_Name;
}


void EncounterMethodName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EncounterMethodName::nameIsSet() const
{
    return m_NameIsSet;
}

void EncounterMethodName::unsetName()
{
    m_NameIsSet = false;
}
...
void EncounterMethodName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool EncounterMethodName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void EncounterMethodName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
