...
void ItemPocketSummary::validate()
{
    // TODO: implement validation
}

web::json::value ItemPocketSummary::toJson() const
{
...
bool ItemPocketSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemPocketSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemPocketSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemPocketSummary::getName() const
{
    return m_Name;
}


void ItemPocketSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemPocketSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemPocketSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t ItemPocketSummary::getUrl() const
{
    return m_Url;
}


void ItemPocketSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool ItemPocketSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void ItemPocketSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
