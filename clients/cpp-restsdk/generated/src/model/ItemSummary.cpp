...
void ItemSummary::validate()
{
    // TODO: implement validation
}

web::json::value ItemSummary::toJson() const
{
...
bool ItemSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemSummary::getName() const
{
    return m_Name;
}


void ItemSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t ItemSummary::getUrl() const
{
    return m_Url;
}


void ItemSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool ItemSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void ItemSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
