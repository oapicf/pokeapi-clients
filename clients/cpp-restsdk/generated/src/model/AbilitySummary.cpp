...
void AbilitySummary::validate()
{
    // TODO: implement validation
}

web::json::value AbilitySummary::toJson() const
{
...
bool AbilitySummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AbilitySummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AbilitySummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AbilitySummary::getName() const
{
    return m_Name;
}


void AbilitySummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AbilitySummary::nameIsSet() const
{
    return m_NameIsSet;
}

void AbilitySummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t AbilitySummary::getUrl() const
{
    return m_Url;
}


void AbilitySummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool AbilitySummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void AbilitySummary::unsetUrl()
{
    m_UrlIsSet = false;
}
