...
void PalParkAreaName::validate()
{
    // TODO: implement validation
}

web::json::value PalParkAreaName::toJson() const
{
...
bool PalParkAreaName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PalParkAreaName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PalParkAreaName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PalParkAreaName::getName() const
{
    return m_Name;
}


void PalParkAreaName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PalParkAreaName::nameIsSet() const
{
    return m_NameIsSet;
}

void PalParkAreaName::unsetName()
{
    m_NameIsSet = false;
}
...
void PalParkAreaName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool PalParkAreaName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void PalParkAreaName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
