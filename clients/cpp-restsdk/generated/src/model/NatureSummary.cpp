...
#include "CppRestOpenAPIClient/model/NatureSummary.h"
...
void NatureSummary::validate()
{
    // TODO: implement validation
}

web::json::value NatureSummary::toJson() const
{
...
bool NatureSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void NatureSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool NatureSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t NatureSummary::getName() const
{
    return m_Name;
}


void NatureSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool NatureSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void NatureSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t NatureSummary::getUrl() const
{
    return m_Url;
}


void NatureSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool NatureSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void NatureSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
