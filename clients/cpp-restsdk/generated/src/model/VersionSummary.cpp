...
void VersionSummary::validate()
{
    // TODO: implement validation
}

web::json::value VersionSummary::toJson() const
{
...
bool VersionSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void VersionSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VersionSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t VersionSummary::getName() const
{
    return m_Name;
}


void VersionSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool VersionSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void VersionSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t VersionSummary::getUrl() const
{
    return m_Url;
}


void VersionSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool VersionSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void VersionSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
