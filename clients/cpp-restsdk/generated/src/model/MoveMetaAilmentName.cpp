...
void MoveMetaAilmentName::validate()
{
    // TODO: implement validation
}

web::json::value MoveMetaAilmentName::toJson() const
{
...
bool MoveMetaAilmentName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveMetaAilmentName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveMetaAilmentName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveMetaAilmentName::getName() const
{
    return m_Name;
}


void MoveMetaAilmentName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveMetaAilmentName::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveMetaAilmentName::unsetName()
{
    m_NameIsSet = false;
}
...
void MoveMetaAilmentName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveMetaAilmentName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveMetaAilmentName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
