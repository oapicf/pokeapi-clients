...
void EggGroupName::validate()
{
    // TODO: implement validation
}

web::json::value EggGroupName::toJson() const
{
...
bool EggGroupName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EggGroupName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EggGroupName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EggGroupName::getName() const
{
    return m_Name;
}


void EggGroupName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EggGroupName::nameIsSet() const
{
    return m_NameIsSet;
}

void EggGroupName::unsetName()
{
    m_NameIsSet = false;
}
...
void EggGroupName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool EggGroupName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void EggGroupName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
