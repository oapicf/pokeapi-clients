...
void TypeSummary::validate()
{
    // TODO: implement validation
}

web::json::value TypeSummary::toJson() const
{
...
bool TypeSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TypeSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TypeSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TypeSummary::getName() const
{
    return m_Name;
}


void TypeSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool TypeSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void TypeSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t TypeSummary::getUrl() const
{
    return m_Url;
}


void TypeSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool TypeSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void TypeSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
