...
#include "CppRestOpenAPIClient/model/MoveLearnMethodSummary.h"
...
void MoveLearnMethodSummary::validate()
{
    // TODO: implement validation
}

web::json::value MoveLearnMethodSummary::toJson() const
{
...
bool MoveLearnMethodSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveLearnMethodSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveLearnMethodSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveLearnMethodSummary::getName() const
{
    return m_Name;
}


void MoveLearnMethodSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveLearnMethodSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveLearnMethodSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t MoveLearnMethodSummary::getUrl() const
{
    return m_Url;
}


void MoveLearnMethodSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool MoveLearnMethodSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void MoveLearnMethodSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
