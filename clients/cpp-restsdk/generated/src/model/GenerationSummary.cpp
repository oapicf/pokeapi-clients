...
void GenerationSummary::validate()
{
    // TODO: implement validation
}

web::json::value GenerationSummary::toJson() const
{
...
bool GenerationSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GenerationSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GenerationSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GenerationSummary::getName() const
{
    return m_Name;
}


void GenerationSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool GenerationSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void GenerationSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t GenerationSummary::getUrl() const
{
    return m_Url;
}


void GenerationSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool GenerationSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void GenerationSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
