...
void EncounterConditionDetail::validate()
{
    // TODO: implement validation
}

web::json::value EncounterConditionDetail::toJson() const
{
...
bool EncounterConditionDetail::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("values"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<EncounterConditionValueSummary>> refVal_setValues;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("names"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<EncounterConditionName>> refVal_setNames;
...
void EncounterConditionDetail::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EncounterConditionDetail::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool EncounterConditionDetail::idIsSet() const
{
    return m_IdIsSet;
}

void EncounterConditionDetail::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t EncounterConditionDetail::getName() const
{
    return m_Name;
}


void EncounterConditionDetail::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EncounterConditionDetail::nameIsSet() const
{
    return m_NameIsSet;
}

void EncounterConditionDetail::unsetName()
{
    m_NameIsSet = false;
}
...
void EncounterConditionDetail::setValues(const std::vector<std::shared_ptr<EncounterConditionValueSummary>>& value)
{
    m_Values = value;
    m_ValuesIsSet = true;
}

bool EncounterConditionDetail::valuesIsSet() const
{
    return m_ValuesIsSet;
}

void EncounterConditionDetail::unsetValues()
{
    m_ValuesIsSet = false;
}
...
void EncounterConditionDetail::setNames(const std::vector<std::shared_ptr<EncounterConditionName>>& value)
{
    m_Names = value;
    m_NamesIsSet = true;
}

bool EncounterConditionDetail::namesIsSet() const
{
    return m_NamesIsSet;
}

void EncounterConditionDetail::unsetNames()
{
    m_NamesIsSet = false;
}
