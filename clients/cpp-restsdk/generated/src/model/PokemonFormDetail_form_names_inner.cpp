...
void PokemonFormDetail_form_names_inner::validate()
{
    // TODO: implement validation
}

web::json::value PokemonFormDetail_form_names_inner::toJson() const
{
...
bool PokemonFormDetail_form_names_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonFormDetail_form_names_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonFormDetail_form_names_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
void PokemonFormDetail_form_names_inner::setLanguage(const std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool PokemonFormDetail_form_names_inner::languageIsSet() const
{
    return m_LanguageIsSet;
}

void PokemonFormDetail_form_names_inner::unsetLanguage()
{
    m_LanguageIsSet = false;
}
utility::string_t PokemonFormDetail_form_names_inner::getName() const
{
    return m_Name;
}


void PokemonFormDetail_form_names_inner::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonFormDetail_form_names_inner::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonFormDetail_form_names_inner::unsetName()
{
    m_NameIsSet = false;
}
