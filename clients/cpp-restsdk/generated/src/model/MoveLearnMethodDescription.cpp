...
void MoveLearnMethodDescription::validate()
{
    // TODO: implement validation
}

web::json::value MoveLearnMethodDescription::toJson() const
{
...
bool MoveLearnMethodDescription::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveLearnMethodDescription::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveLearnMethodDescription::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveLearnMethodDescription::getDescription() const
{
    return m_Description;
}


void MoveLearnMethodDescription::setDescription(const utility::string_t& value)
{
    m_Description = value;
...
void MoveLearnMethodDescription::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveLearnMethodDescription::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveLearnMethodDescription::unsetLanguage()
{
    m_LanguageIsSet = false;
}
