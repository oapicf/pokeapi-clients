...
#include "CppRestOpenAPIClient/model/PokemonHabitatName.h"
...
void PokemonHabitatName::validate()
{
    // TODO: implement validation
}

web::json::value PokemonHabitatName::toJson() const
{
...
bool PokemonHabitatName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonHabitatName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonHabitatName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonHabitatName::getName() const
{
    return m_Name;
}


void PokemonHabitatName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonHabitatName::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonHabitatName::unsetName()
{
    m_NameIsSet = false;
}
...
void PokemonHabitatName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool PokemonHabitatName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void PokemonHabitatName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
