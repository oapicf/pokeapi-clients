...
void StatSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StatSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t StatSummary::getName() const
{
    return m_Name;
}


void StatSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool StatSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void StatSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t StatSummary::getUrl() const
{
    return m_Url;
}


void StatSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool StatSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void StatSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
