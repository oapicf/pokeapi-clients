...
void MoveTargetDescription::validate()
{
    // TODO: implement validation
}

web::json::value MoveTargetDescription::toJson() const
{
...
bool MoveTargetDescription::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveTargetDescription::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveTargetDescription::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveTargetDescription::getDescription() const
{
    return m_Description;
}


void MoveTargetDescription::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool MoveTargetDescription::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void MoveTargetDescription::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void MoveTargetDescription::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveTargetDescription::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveTargetDescription::unsetLanguage()
{
    m_LanguageIsSet = false;
}
