...
void StatName::validate()
{
    // TODO: implement validation
}

web::json::value StatName::toJson() const
{
...
bool StatName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void StatName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool StatName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t StatName::getName() const
{
    return m_Name;
}


void StatName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool StatName::nameIsSet() const
{
    return m_NameIsSet;
}

void StatName::unsetName()
{
    m_NameIsSet = false;
}
...
void StatName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool StatName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void StatName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
