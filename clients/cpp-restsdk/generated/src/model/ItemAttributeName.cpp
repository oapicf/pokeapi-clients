...
void ItemAttributeName::validate()
{
    // TODO: implement validation
}

web::json::value ItemAttributeName::toJson() const
{
...
bool ItemAttributeName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemAttributeName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemAttributeName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemAttributeName::getName() const
{
    return m_Name;
}


void ItemAttributeName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemAttributeName::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemAttributeName::unsetName()
{
    m_NameIsSet = false;
}
...
void ItemAttributeName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool ItemAttributeName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void ItemAttributeName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
