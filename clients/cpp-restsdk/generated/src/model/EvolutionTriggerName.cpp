...
#include "CppRestOpenAPIClient/model/EvolutionTriggerName.h"
...
void EvolutionTriggerName::validate()
{
    // TODO: implement validation
}

web::json::value EvolutionTriggerName::toJson() const
{
...
bool EvolutionTriggerName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EvolutionTriggerName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EvolutionTriggerName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EvolutionTriggerName::getName() const
{
    return m_Name;
}


void EvolutionTriggerName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EvolutionTriggerName::nameIsSet() const
{
    return m_NameIsSet;
}

void EvolutionTriggerName::unsetName()
{
    m_NameIsSet = false;
}
...
void EvolutionTriggerName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool EvolutionTriggerName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void EvolutionTriggerName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
