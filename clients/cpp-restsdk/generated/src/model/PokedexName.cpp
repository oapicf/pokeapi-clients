...
void PokedexName::validate()
{
    // TODO: implement validation
}

web::json::value PokedexName::toJson() const
{
...
bool PokedexName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokedexName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokedexName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokedexName::getName() const
{
    return m_Name;
}


void PokedexName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokedexName::nameIsSet() const
{
    return m_NameIsSet;
}

void PokedexName::unsetName()
{
    m_NameIsSet = false;
}
...
void PokedexName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool PokedexName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void PokedexName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
