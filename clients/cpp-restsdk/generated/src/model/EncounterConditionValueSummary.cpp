...
#include "CppRestOpenAPIClient/model/EncounterConditionValueSummary.h"
...
void EncounterConditionValueSummary::validate()
{
    // TODO: implement validation
}

web::json::value EncounterConditionValueSummary::toJson() const
{
...
bool EncounterConditionValueSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EncounterConditionValueSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EncounterConditionValueSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EncounterConditionValueSummary::getName() const
{
    return m_Name;
}


void EncounterConditionValueSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EncounterConditionValueSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void EncounterConditionValueSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t EncounterConditionValueSummary::getUrl() const
{
    return m_Url;
}


void EncounterConditionValueSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool EncounterConditionValueSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void EncounterConditionValueSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
