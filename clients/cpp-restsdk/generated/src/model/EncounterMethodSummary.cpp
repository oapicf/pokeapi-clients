...
#include "CppRestOpenAPIClient/model/EncounterMethodSummary.h"
...
void EncounterMethodSummary::validate()
{
    // TODO: implement validation
}

web::json::value EncounterMethodSummary::toJson() const
{
...
bool EncounterMethodSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EncounterMethodSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EncounterMethodSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EncounterMethodSummary::getName() const
{
    return m_Name;
}


void EncounterMethodSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EncounterMethodSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void EncounterMethodSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t EncounterMethodSummary::getUrl() const
{
    return m_Url;
}


void EncounterMethodSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool EncounterMethodSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void EncounterMethodSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
