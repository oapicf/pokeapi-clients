...
void BerryFlavorName::validate()
{
    // TODO: implement validation
}

web::json::value BerryFlavorName::toJson() const
{
...
bool BerryFlavorName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BerryFlavorName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BerryFlavorName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BerryFlavorName::getName() const
{
    return m_Name;
}


void BerryFlavorName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BerryFlavorName::nameIsSet() const
{
    return m_NameIsSet;
}

void BerryFlavorName::unsetName()
{
    m_NameIsSet = false;
}
...
void BerryFlavorName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool BerryFlavorName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void BerryFlavorName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
