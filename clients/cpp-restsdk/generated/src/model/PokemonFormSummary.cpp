...
void PokemonFormSummary::validate()
{
    // TODO: implement validation
}

web::json::value PokemonFormSummary::toJson() const
{
...
bool PokemonFormSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonFormSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonFormSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonFormSummary::getName() const
{
    return m_Name;
}


void PokemonFormSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonFormSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonFormSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PokemonFormSummary::getUrl() const
{
    return m_Url;
}


void PokemonFormSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokemonFormSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokemonFormSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
