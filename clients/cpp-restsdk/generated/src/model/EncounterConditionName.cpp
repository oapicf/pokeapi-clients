...
#include "CppRestOpenAPIClient/model/EncounterConditionName.h"
...
void EncounterConditionName::validate()
{
    // TODO: implement validation
}

web::json::value EncounterConditionName::toJson() const
{
...
bool EncounterConditionName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EncounterConditionName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EncounterConditionName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EncounterConditionName::getName() const
{
    return m_Name;
}


void EncounterConditionName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool EncounterConditionName::nameIsSet() const
{
    return m_NameIsSet;
}

void EncounterConditionName::unsetName()
{
    m_NameIsSet = false;
}
...
void EncounterConditionName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool EncounterConditionName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void EncounterConditionName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
