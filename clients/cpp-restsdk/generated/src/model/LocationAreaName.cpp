...
void LocationAreaName::validate()
{
    // TODO: implement validation
}

web::json::value LocationAreaName::toJson() const
{
...
bool LocationAreaName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LocationAreaName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LocationAreaName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LocationAreaName::getName() const
{
    return m_Name;
}


void LocationAreaName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool LocationAreaName::nameIsSet() const
{
    return m_NameIsSet;
}

void LocationAreaName::unsetName()
{
    m_NameIsSet = false;
}
...
void LocationAreaName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool LocationAreaName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void LocationAreaName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
