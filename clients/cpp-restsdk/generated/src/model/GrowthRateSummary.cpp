...
void GrowthRateSummary::validate()
{
    // TODO: implement validation
}

web::json::value GrowthRateSummary::toJson() const
{
...
bool GrowthRateSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GrowthRateSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GrowthRateSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GrowthRateSummary::getName() const
{
    return m_Name;
}


void GrowthRateSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool GrowthRateSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void GrowthRateSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t GrowthRateSummary::getUrl() const
{
    return m_Url;
}


void GrowthRateSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool GrowthRateSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void GrowthRateSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
