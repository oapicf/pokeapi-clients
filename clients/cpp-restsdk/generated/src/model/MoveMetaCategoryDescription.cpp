...
#include "CppRestOpenAPIClient/model/MoveMetaCategoryDescription.h"
...
void MoveMetaCategoryDescription::validate()
{
    // TODO: implement validation
}

web::json::value MoveMetaCategoryDescription::toJson() const
{
...
bool MoveMetaCategoryDescription::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveMetaCategoryDescription::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveMetaCategoryDescription::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveMetaCategoryDescription::getDescription() const
{
    return m_Description;
}


void MoveMetaCategoryDescription::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool MoveMetaCategoryDescription::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void MoveMetaCategoryDescription::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void MoveMetaCategoryDescription::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveMetaCategoryDescription::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveMetaCategoryDescription::unsetLanguage()
{
    m_LanguageIsSet = false;
}
