...
void RegionSummary::validate()
{
    // TODO: implement validation
}

web::json::value RegionSummary::toJson() const
{
...
bool RegionSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void RegionSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool RegionSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t RegionSummary::getName() const
{
    return m_Name;
}


void RegionSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool RegionSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void RegionSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t RegionSummary::getUrl() const
{
    return m_Url;
}


void RegionSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool RegionSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void RegionSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
