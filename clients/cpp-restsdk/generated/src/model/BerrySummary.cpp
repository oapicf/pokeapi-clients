...
void BerrySummary::validate()
{
    // TODO: implement validation
}

web::json::value BerrySummary::toJson() const
{
...
bool BerrySummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BerrySummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BerrySummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BerrySummary::getName() const
{
    return m_Name;
}


void BerrySummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool BerrySummary::nameIsSet() const
{
    return m_NameIsSet;
}

void BerrySummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t BerrySummary::getUrl() const
{
    return m_Url;
}


void BerrySummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool BerrySummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void BerrySummary::unsetUrl()
{
    m_UrlIsSet = false;
}
