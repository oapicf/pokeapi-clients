...
void MoveDamageClassDescription::validate()
{
    // TODO: implement validation
}

web::json::value MoveDamageClassDescription::toJson() const
{
...
bool MoveDamageClassDescription::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveDamageClassDescription::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveDamageClassDescription::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveDamageClassDescription::getDescription() const
{
    return m_Description;
}


void MoveDamageClassDescription::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool MoveDamageClassDescription::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void MoveDamageClassDescription::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void MoveDamageClassDescription::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool MoveDamageClassDescription::languageIsSet() const
{
    return m_LanguageIsSet;
}

void MoveDamageClassDescription::unsetLanguage()
{
    m_LanguageIsSet = false;
}
