...
void LanguageSummary::validate()
{
    // TODO: implement validation
}

web::json::value LanguageSummary::toJson() const
{
...
bool LanguageSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LanguageSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LanguageSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LanguageSummary::getName() const
{
    return m_Name;
}


void LanguageSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool LanguageSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void LanguageSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t LanguageSummary::getUrl() const
{
    return m_Url;
}


void LanguageSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool LanguageSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void LanguageSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
