...
void ItemName::validate()
{
    // TODO: implement validation
}

web::json::value ItemName::toJson() const
{
...
bool ItemName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ItemName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ItemName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ItemName::getName() const
{
    return m_Name;
}


void ItemName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ItemName::nameIsSet() const
{
    return m_NameIsSet;
}

void ItemName::unsetName()
{
    m_NameIsSet = false;
}
...
void ItemName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool ItemName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void ItemName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
