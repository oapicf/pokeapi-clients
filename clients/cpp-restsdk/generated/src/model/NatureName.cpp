...
void NatureName::validate()
{
    // TODO: implement validation
}

web::json::value NatureName::toJson() const
{
...
bool NatureName::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void NatureName::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool NatureName::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t NatureName::getName() const
{
    return m_Name;
}


void NatureName::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool NatureName::nameIsSet() const
{
    return m_NameIsSet;
}

void NatureName::unsetName()
{
    m_NameIsSet = false;
}
...
void NatureName::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool NatureName::languageIsSet() const
{
    return m_LanguageIsSet;
}

void NatureName::unsetLanguage()
{
    m_LanguageIsSet = false;
}
