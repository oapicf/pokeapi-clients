...
void GrowthRateDescription::validate()
{
    // TODO: implement validation
}

web::json::value GrowthRateDescription::toJson() const
{
...
bool GrowthRateDescription::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GrowthRateDescription::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GrowthRateDescription::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GrowthRateDescription::getDescription() const
{
    return m_Description;
}


void GrowthRateDescription::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool GrowthRateDescription::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void GrowthRateDescription::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void GrowthRateDescription::setLanguage(const std::shared_ptr<LanguageSummary>& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool GrowthRateDescription::languageIsSet() const
{
    return m_LanguageIsSet;
}

void GrowthRateDescription::unsetLanguage()
{
    m_LanguageIsSet = false;
}
