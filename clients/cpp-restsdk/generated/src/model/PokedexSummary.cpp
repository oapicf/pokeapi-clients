...
void PokedexSummary::validate()
{
    // TODO: implement validation
}

web::json::value PokedexSummary::toJson() const
{
...
bool PokedexSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokedexSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokedexSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokedexSummary::getName() const
{
    return m_Name;
}


void PokedexSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokedexSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PokedexSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PokedexSummary::getUrl() const
{
    return m_Url;
}


void PokedexSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokedexSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokedexSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
