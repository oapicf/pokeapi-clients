...
void MoveSummary::validate()
{
    // TODO: implement validation
}

web::json::value MoveSummary::toJson() const
{
...
bool MoveSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MoveSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MoveSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MoveSummary::getName() const
{
    return m_Name;
}


void MoveSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool MoveSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void MoveSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t MoveSummary::getUrl() const
{
    return m_Url;
}


void MoveSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool MoveSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void MoveSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
