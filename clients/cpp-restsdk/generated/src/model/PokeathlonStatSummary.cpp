...
#include "CppRestOpenAPIClient/model/PokeathlonStatSummary.h"
...
void PokeathlonStatSummary::validate()
{
    // TODO: implement validation
}

web::json::value PokeathlonStatSummary::toJson() const
{
...
bool PokeathlonStatSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokeathlonStatSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokeathlonStatSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokeathlonStatSummary::getName() const
{
    return m_Name;
}


void PokeathlonStatSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokeathlonStatSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PokeathlonStatSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PokeathlonStatSummary::getUrl() const
{
    return m_Url;
}


void PokeathlonStatSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokeathlonStatSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokeathlonStatSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
