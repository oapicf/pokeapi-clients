...
void PokemonSpeciesSummary::validate()
{
    // TODO: implement validation
}

web::json::value PokemonSpeciesSummary::toJson() const
{
...
bool PokemonSpeciesSummary::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PokemonSpeciesSummary::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PokemonSpeciesSummary::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PokemonSpeciesSummary::getName() const
{
    return m_Name;
}


void PokemonSpeciesSummary::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PokemonSpeciesSummary::nameIsSet() const
{
    return m_NameIsSet;
}

void PokemonSpeciesSummary::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PokemonSpeciesSummary::getUrl() const
{
    return m_Url;
}


void PokemonSpeciesSummary::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool PokemonSpeciesSummary::urlIsSet() const
{
    return m_UrlIsSet;
}

void PokemonSpeciesSummary::unsetUrl()
{
    m_UrlIsSet = false;
}
