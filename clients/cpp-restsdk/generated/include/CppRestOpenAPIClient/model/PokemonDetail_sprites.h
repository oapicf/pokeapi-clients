...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PokemonDetail_sprites_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PokemonDetail_sprites_H_
...
public:
    ...
    utility::string_t getFrontDefault() const;
    bool frontDefaultIsSet() const;
    void unsetFront_default();
    void setFrontDefault(const utility::string_t& value);
...
protected:
    utility::string_t m_Front_default;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PokemonDetail_sprites_H_ */
