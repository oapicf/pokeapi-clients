...
// checks if the PaginatedMachineSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedMachineSummaryList{}

// PaginatedMachineSummaryList struct for PaginatedMachineSummaryList
...
func NewPaginatedMachineSummaryList() *PaginatedMachineSummaryList {
	this := PaginatedMachineSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []MachineSummary and assigns it to the Results field.
func (o *PaginatedMachineSummaryList) SetResults(v []MachineSummary) {
	o.Results = v
}

func (o PaginatedMachineSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedMachineSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedMachineSummaryList struct {
	value *PaginatedMachineSummaryList
	isSet bool
}

func (v NullablePaginatedMachineSummaryList) Get() *PaginatedMachineSummaryList {
	return v.value
}

func (v *NullablePaginatedMachineSummaryList) Set(val *PaginatedMachineSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedMachineSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedMachineSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedMachineSummaryList(val *PaginatedMachineSummaryList) *NullablePaginatedMachineSummaryList {
	return &NullablePaginatedMachineSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedMachineSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedMachineSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
