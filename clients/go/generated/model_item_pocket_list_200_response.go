...
// ItemPocketList200Response struct for ItemPocketList200Response
type ItemPocketList200Response struct {
	...
	Results []ItemPocket `json:"results,omitempty"`
}
...
func NewItemPocketList200Response() *ItemPocketList200Response {
	this := ItemPocketList200Response{}
	return &this
}
...
func (o *ItemPocketList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ItemPocketList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ItemPocket and assigns it to the Results field.
func (o *ItemPocketList200Response) SetResults(v []ItemPocket) {
	o.Results = v
}

func (o ItemPocketList200Response) MarshalJSON() ([]byte, error) {
...
type NullableItemPocketList200Response struct {
	value *ItemPocketList200Response
	isSet bool
}

func (v NullableItemPocketList200Response) Get() *ItemPocketList200Response {
	return v.value
}

func (v *NullableItemPocketList200Response) Set(val *ItemPocketList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableItemPocketList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableItemPocketList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemPocketList200Response(val *ItemPocketList200Response) *NullableItemPocketList200Response {
	return &NullableItemPocketList200Response{value: val, isSet: true}
}

func (v NullableItemPocketList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemPocketList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
