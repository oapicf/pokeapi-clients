...
// checks if the PaginatedLocationAreaSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedLocationAreaSummaryList{}

// PaginatedLocationAreaSummaryList struct for PaginatedLocationAreaSummaryList
...
func NewPaginatedLocationAreaSummaryList() *PaginatedLocationAreaSummaryList {
	this := PaginatedLocationAreaSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []LocationAreaSummary and assigns it to the Results field.
func (o *PaginatedLocationAreaSummaryList) SetResults(v []LocationAreaSummary) {
	o.Results = v
}

func (o PaginatedLocationAreaSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedLocationAreaSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedLocationAreaSummaryList struct {
	value *PaginatedLocationAreaSummaryList
	isSet bool
}

func (v NullablePaginatedLocationAreaSummaryList) Get() *PaginatedLocationAreaSummaryList {
	return v.value
}

func (v *NullablePaginatedLocationAreaSummaryList) Set(val *PaginatedLocationAreaSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedLocationAreaSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedLocationAreaSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedLocationAreaSummaryList(val *PaginatedLocationAreaSummaryList) *NullablePaginatedLocationAreaSummaryList {
	return &NullablePaginatedLocationAreaSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedLocationAreaSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedLocationAreaSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
