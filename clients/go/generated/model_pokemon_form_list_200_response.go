...
// PokemonFormList200Response struct for PokemonFormList200Response
type PokemonFormList200Response struct {
	...
	Results []PokemonForm `json:"results,omitempty"`
}
...
func NewPokemonFormList200Response() *PokemonFormList200Response {
	this := PokemonFormList200Response{}
	return &this
}
...
func (o *PokemonFormList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PokemonFormList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []PokemonForm and assigns it to the Results field.
func (o *PokemonFormList200Response) SetResults(v []PokemonForm) {
	o.Results = v
}

func (o PokemonFormList200Response) MarshalJSON() ([]byte, error) {
...
type NullablePokemonFormList200Response struct {
	value *PokemonFormList200Response
	isSet bool
}

func (v NullablePokemonFormList200Response) Get() *PokemonFormList200Response {
	return v.value
}

func (v *NullablePokemonFormList200Response) Set(val *PokemonFormList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePokemonFormList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePokemonFormList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePokemonFormList200Response(val *PokemonFormList200Response) *NullablePokemonFormList200Response {
	return &NullablePokemonFormList200Response{value: val, isSet: true}
}

func (v NullablePokemonFormList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePokemonFormList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
