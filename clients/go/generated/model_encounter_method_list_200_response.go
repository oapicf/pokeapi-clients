...
// EncounterMethodList200Response struct for EncounterMethodList200Response
type EncounterMethodList200Response struct {
	...
	Results []EncounterMethod `json:"results,omitempty"`
}
...
func NewEncounterMethodList200Response() *EncounterMethodList200Response {
	this := EncounterMethodList200Response{}
	return &this
}
...
func (o *EncounterMethodList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *EncounterMethodList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []EncounterMethod and assigns it to the Results field.
func (o *EncounterMethodList200Response) SetResults(v []EncounterMethod) {
	o.Results = v
}

func (o EncounterMethodList200Response) MarshalJSON() ([]byte, error) {
...
type NullableEncounterMethodList200Response struct {
	value *EncounterMethodList200Response
	isSet bool
}

func (v NullableEncounterMethodList200Response) Get() *EncounterMethodList200Response {
	return v.value
}

func (v *NullableEncounterMethodList200Response) Set(val *EncounterMethodList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEncounterMethodList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEncounterMethodList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncounterMethodList200Response(val *EncounterMethodList200Response) *NullableEncounterMethodList200Response {
	return &NullableEncounterMethodList200Response{value: val, isSet: true}
}

func (v NullableEncounterMethodList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncounterMethodList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
