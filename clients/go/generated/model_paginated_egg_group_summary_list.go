...
// checks if the PaginatedEggGroupSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedEggGroupSummaryList{}

// PaginatedEggGroupSummaryList struct for PaginatedEggGroupSummaryList
...
func NewPaginatedEggGroupSummaryList() *PaginatedEggGroupSummaryList {
	this := PaginatedEggGroupSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []EggGroupSummary and assigns it to the Results field.
func (o *PaginatedEggGroupSummaryList) SetResults(v []EggGroupSummary) {
	o.Results = v
}

func (o PaginatedEggGroupSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedEggGroupSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedEggGroupSummaryList struct {
	value *PaginatedEggGroupSummaryList
	isSet bool
}

func (v NullablePaginatedEggGroupSummaryList) Get() *PaginatedEggGroupSummaryList {
	return v.value
}

func (v *NullablePaginatedEggGroupSummaryList) Set(val *PaginatedEggGroupSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedEggGroupSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedEggGroupSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedEggGroupSummaryList(val *PaginatedEggGroupSummaryList) *NullablePaginatedEggGroupSummaryList {
	return &NullablePaginatedEggGroupSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedEggGroupSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedEggGroupSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
