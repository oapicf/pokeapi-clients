...
// MoveList200Response struct for MoveList200Response
type MoveList200Response struct {
	...
	Results []Move `json:"results,omitempty"`
}
...
func (o *MoveList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *MoveList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Move and assigns it to the Results field.
func (o *MoveList200Response) SetResults(v []Move) {
	o.Results = v
}

func (o MoveList200Response) MarshalJSON() ([]byte, error) {
...
type NullableMoveList200Response struct {
	value *MoveList200Response
	isSet bool
}

func (v NullableMoveList200Response) Get() *MoveList200Response {
	return v.value
}

func (v *NullableMoveList200Response) Set(val *MoveList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMoveList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMoveList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoveList200Response(val *MoveList200Response) *NullableMoveList200Response {
	return &NullableMoveList200Response{value: val, isSet: true}
}

func (v NullableMoveList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoveList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
