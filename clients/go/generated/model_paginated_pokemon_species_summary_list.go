...
// checks if the PaginatedPokemonSpeciesSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedPokemonSpeciesSummaryList{}

// PaginatedPokemonSpeciesSummaryList struct for PaginatedPokemonSpeciesSummaryList
...
func NewPaginatedPokemonSpeciesSummaryList() *PaginatedPokemonSpeciesSummaryList {
	this := PaginatedPokemonSpeciesSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []PokemonSpeciesSummary and assigns it to the Results field.
func (o *PaginatedPokemonSpeciesSummaryList) SetResults(v []PokemonSpeciesSummary) {
	o.Results = v
}

func (o PaginatedPokemonSpeciesSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedPokemonSpeciesSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedPokemonSpeciesSummaryList struct {
	value *PaginatedPokemonSpeciesSummaryList
	isSet bool
}

func (v NullablePaginatedPokemonSpeciesSummaryList) Get() *PaginatedPokemonSpeciesSummaryList {
	return v.value
}

func (v *NullablePaginatedPokemonSpeciesSummaryList) Set(val *PaginatedPokemonSpeciesSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPokemonSpeciesSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPokemonSpeciesSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPokemonSpeciesSummaryList(val *PaginatedPokemonSpeciesSummaryList) *NullablePaginatedPokemonSpeciesSummaryList {
	return &NullablePaginatedPokemonSpeciesSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedPokemonSpeciesSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedPokemonSpeciesSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
