...
// ContestEffectList200Response struct for ContestEffectList200Response
type ContestEffectList200Response struct {
	...
	Results []ContestEffect `json:"results,omitempty"`
}
...
func NewContestEffectList200Response() *ContestEffectList200Response {
	this := ContestEffectList200Response{}
	return &this
}
...
func (o *ContestEffectList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ContestEffectList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ContestEffect and assigns it to the Results field.
func (o *ContestEffectList200Response) SetResults(v []ContestEffect) {
	o.Results = v
}

func (o ContestEffectList200Response) MarshalJSON() ([]byte, error) {
...
type NullableContestEffectList200Response struct {
	value *ContestEffectList200Response
	isSet bool
}

func (v NullableContestEffectList200Response) Get() *ContestEffectList200Response {
	return v.value
}

func (v *NullableContestEffectList200Response) Set(val *ContestEffectList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableContestEffectList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableContestEffectList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContestEffectList200Response(val *ContestEffectList200Response) *NullableContestEffectList200Response {
	return &NullableContestEffectList200Response{value: val, isSet: true}
}

func (v NullableContestEffectList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContestEffectList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
