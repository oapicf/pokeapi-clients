...
// ItemFlingEffectList200Response struct for ItemFlingEffectList200Response
type ItemFlingEffectList200Response struct {
	...
	Results []ItemFlingEffect `json:"results,omitempty"`
}
...
func NewItemFlingEffectList200Response() *ItemFlingEffectList200Response {
	this := ItemFlingEffectList200Response{}
	return &this
}
...
func (o *ItemFlingEffectList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *ItemFlingEffectList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ItemFlingEffect and assigns it to the Results field.
func (o *ItemFlingEffectList200Response) SetResults(v []ItemFlingEffect) {
	o.Results = v
}

func (o ItemFlingEffectList200Response) MarshalJSON() ([]byte, error) {
...
type NullableItemFlingEffectList200Response struct {
	value *ItemFlingEffectList200Response
	isSet bool
}

func (v NullableItemFlingEffectList200Response) Get() *ItemFlingEffectList200Response {
	return v.value
}

func (v *NullableItemFlingEffectList200Response) Set(val *ItemFlingEffectList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableItemFlingEffectList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableItemFlingEffectList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemFlingEffectList200Response(val *ItemFlingEffectList200Response) *NullableItemFlingEffectList200Response {
	return &NullableItemFlingEffectList200Response{value: val, isSet: true}
}

func (v NullableItemFlingEffectList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemFlingEffectList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
