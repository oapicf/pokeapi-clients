...
// GenderList200Response struct for GenderList200Response
type GenderList200Response struct {
	...
	Results []Gender `json:"results,omitempty"`
}
...
func (o *GenderList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *GenderList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Gender and assigns it to the Results field.
func (o *GenderList200Response) SetResults(v []Gender) {
	o.Results = v
}

func (o GenderList200Response) MarshalJSON() ([]byte, error) {
...
type NullableGenderList200Response struct {
	value *GenderList200Response
	isSet bool
}

func (v NullableGenderList200Response) Get() *GenderList200Response {
	return v.value
}

func (v *NullableGenderList200Response) Set(val *GenderList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGenderList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGenderList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenderList200Response(val *GenderList200Response) *NullableGenderList200Response {
	return &NullableGenderList200Response{value: val, isSet: true}
}

func (v NullableGenderList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenderList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
