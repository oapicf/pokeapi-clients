...
// checks if the PaginatedItemCategorySummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedItemCategorySummaryList{}

// PaginatedItemCategorySummaryList struct for PaginatedItemCategorySummaryList
...
func NewPaginatedItemCategorySummaryList() *PaginatedItemCategorySummaryList {
	this := PaginatedItemCategorySummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []ItemCategorySummary and assigns it to the Results field.
func (o *PaginatedItemCategorySummaryList) SetResults(v []ItemCategorySummary) {
	o.Results = v
}

func (o PaginatedItemCategorySummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedItemCategorySummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedItemCategorySummaryList struct {
	value *PaginatedItemCategorySummaryList
	isSet bool
}

func (v NullablePaginatedItemCategorySummaryList) Get() *PaginatedItemCategorySummaryList {
	return v.value
}

func (v *NullablePaginatedItemCategorySummaryList) Set(val *PaginatedItemCategorySummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedItemCategorySummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedItemCategorySummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedItemCategorySummaryList(val *PaginatedItemCategorySummaryList) *NullablePaginatedItemCategorySummaryList {
	return &NullablePaginatedItemCategorySummaryList{value: val, isSet: true}
}

func (v NullablePaginatedItemCategorySummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedItemCategorySummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
