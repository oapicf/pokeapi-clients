...
// LocationAreaList200Response struct for LocationAreaList200Response
type LocationAreaList200Response struct {
	...
	Results []LocationArea `json:"results,omitempty"`
}
...
func NewLocationAreaList200Response() *LocationAreaList200Response {
	this := LocationAreaList200Response{}
	return &this
}
...
func (o *LocationAreaList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *LocationAreaList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []LocationArea and assigns it to the Results field.
func (o *LocationAreaList200Response) SetResults(v []LocationArea) {
	o.Results = v
}

func (o LocationAreaList200Response) MarshalJSON() ([]byte, error) {
...
type NullableLocationAreaList200Response struct {
	value *LocationAreaList200Response
	isSet bool
}

func (v NullableLocationAreaList200Response) Get() *LocationAreaList200Response {
	return v.value
}

func (v *NullableLocationAreaList200Response) Set(val *LocationAreaList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableLocationAreaList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableLocationAreaList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocationAreaList200Response(val *LocationAreaList200Response) *NullableLocationAreaList200Response {
	return &NullableLocationAreaList200Response{value: val, isSet: true}
}

func (v NullableLocationAreaList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocationAreaList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
