...
// PalParkAreaList200Response struct for PalParkAreaList200Response
type PalParkAreaList200Response struct {
	...
	Results []PalParkArea `json:"results,omitempty"`
}
...
func NewPalParkAreaList200Response() *PalParkAreaList200Response {
	this := PalParkAreaList200Response{}
	return &this
}
...
func (o *PalParkAreaList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PalParkAreaList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []PalParkArea and assigns it to the Results field.
func (o *PalParkAreaList200Response) SetResults(v []PalParkArea) {
	o.Results = v
}

func (o PalParkAreaList200Response) MarshalJSON() ([]byte, error) {
...
type NullablePalParkAreaList200Response struct {
	value *PalParkAreaList200Response
	isSet bool
}

func (v NullablePalParkAreaList200Response) Get() *PalParkAreaList200Response {
	return v.value
}

func (v *NullablePalParkAreaList200Response) Set(val *PalParkAreaList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePalParkAreaList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePalParkAreaList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePalParkAreaList200Response(val *PalParkAreaList200Response) *NullablePalParkAreaList200Response {
	return &NullablePalParkAreaList200Response{value: val, isSet: true}
}

func (v NullablePalParkAreaList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePalParkAreaList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
