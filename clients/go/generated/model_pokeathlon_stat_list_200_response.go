...
// PokeathlonStatList200Response struct for PokeathlonStatList200Response
type PokeathlonStatList200Response struct {
	...
	Results []PokeathlonStat `json:"results,omitempty"`
}
...
func NewPokeathlonStatList200Response() *PokeathlonStatList200Response {
	this := PokeathlonStatList200Response{}
	return &this
}
...
func (o *PokeathlonStatList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PokeathlonStatList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []PokeathlonStat and assigns it to the Results field.
func (o *PokeathlonStatList200Response) SetResults(v []PokeathlonStat) {
	o.Results = v
}

func (o PokeathlonStatList200Response) MarshalJSON() ([]byte, error) {
...
type NullablePokeathlonStatList200Response struct {
	value *PokeathlonStatList200Response
	isSet bool
}

func (v NullablePokeathlonStatList200Response) Get() *PokeathlonStatList200Response {
	return v.value
}

func (v *NullablePokeathlonStatList200Response) Set(val *PokeathlonStatList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePokeathlonStatList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePokeathlonStatList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePokeathlonStatList200Response(val *PokeathlonStatList200Response) *NullablePokeathlonStatList200Response {
	return &NullablePokeathlonStatList200Response{value: val, isSet: true}
}

func (v NullablePokeathlonStatList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePokeathlonStatList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
