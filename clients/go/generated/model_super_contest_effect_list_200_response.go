...
// SuperContestEffectList200Response struct for SuperContestEffectList200Response
type SuperContestEffectList200Response struct {
	...
	Results []SuperContestEffect `json:"results,omitempty"`
}
...
func NewSuperContestEffectList200Response() *SuperContestEffectList200Response {
	this := SuperContestEffectList200Response{}
	return &this
}
...
func (o *SuperContestEffectList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *SuperContestEffectList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []SuperContestEffect and assigns it to the Results field.
func (o *SuperContestEffectList200Response) SetResults(v []SuperContestEffect) {
	o.Results = v
}

func (o SuperContestEffectList200Response) MarshalJSON() ([]byte, error) {
...
type NullableSuperContestEffectList200Response struct {
	value *SuperContestEffectList200Response
	isSet bool
}

func (v NullableSuperContestEffectList200Response) Get() *SuperContestEffectList200Response {
	return v.value
}

func (v *NullableSuperContestEffectList200Response) Set(val *SuperContestEffectList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSuperContestEffectList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSuperContestEffectList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuperContestEffectList200Response(val *SuperContestEffectList200Response) *NullableSuperContestEffectList200Response {
	return &NullableSuperContestEffectList200Response{value: val, isSet: true}
}

func (v NullableSuperContestEffectList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuperContestEffectList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
