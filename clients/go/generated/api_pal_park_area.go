...
func (r ApiPalParkAreaListRequest) Execute() (string, *http.Response, error) {
...
//  @return string
func (a *PalParkAreaApiService) PalParkAreaListExecute(r ApiPalParkAreaListRequest) (string, *http.Response, error) {
	var (
...
func (r ApiPalParkAreaReadRequest) Execute() (string, *http.Response, error) {
...
// Execute executes the request
//  @return string
func (a *PalParkAreaApiService) PalParkAreaReadExecute(r ApiPalParkAreaReadRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
