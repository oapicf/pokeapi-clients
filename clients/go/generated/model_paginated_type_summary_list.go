...
// checks if the PaginatedTypeSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedTypeSummaryList{}

// PaginatedTypeSummaryList struct for PaginatedTypeSummaryList
...
// SetResults gets a reference to the given []TypeSummary and assigns it to the Results field.
func (o *PaginatedTypeSummaryList) SetResults(v []TypeSummary) {
	o.Results = v
}

func (o PaginatedTypeSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedTypeSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedTypeSummaryList struct {
	value *PaginatedTypeSummaryList
	isSet bool
}

func (v NullablePaginatedTypeSummaryList) Get() *PaginatedTypeSummaryList {
	return v.value
}

func (v *NullablePaginatedTypeSummaryList) Set(val *PaginatedTypeSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedTypeSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedTypeSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedTypeSummaryList(val *PaginatedTypeSummaryList) *NullablePaginatedTypeSummaryList {
	return &NullablePaginatedTypeSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedTypeSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedTypeSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
