...
// checks if the PaginatedRegionSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedRegionSummaryList{}

// PaginatedRegionSummaryList struct for PaginatedRegionSummaryList
...
func NewPaginatedRegionSummaryList() *PaginatedRegionSummaryList {
	this := PaginatedRegionSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []RegionSummary and assigns it to the Results field.
func (o *PaginatedRegionSummaryList) SetResults(v []RegionSummary) {
	o.Results = v
}

func (o PaginatedRegionSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedRegionSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedRegionSummaryList struct {
	value *PaginatedRegionSummaryList
	isSet bool
}

func (v NullablePaginatedRegionSummaryList) Get() *PaginatedRegionSummaryList {
	return v.value
}

func (v *NullablePaginatedRegionSummaryList) Set(val *PaginatedRegionSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedRegionSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedRegionSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedRegionSummaryList(val *PaginatedRegionSummaryList) *NullablePaginatedRegionSummaryList {
	return &NullablePaginatedRegionSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedRegionSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedRegionSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
