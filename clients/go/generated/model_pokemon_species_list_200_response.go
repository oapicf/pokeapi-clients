...
// PokemonSpeciesList200Response struct for PokemonSpeciesList200Response
type PokemonSpeciesList200Response struct {
	...
	Results []PokemonSpecies `json:"results,omitempty"`
}
...
func NewPokemonSpeciesList200Response() *PokemonSpeciesList200Response {
	this := PokemonSpeciesList200Response{}
	return &this
}
...
func (o *PokemonSpeciesList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PokemonSpeciesList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []PokemonSpecies and assigns it to the Results field.
func (o *PokemonSpeciesList200Response) SetResults(v []PokemonSpecies) {
	o.Results = v
}

func (o PokemonSpeciesList200Response) MarshalJSON() ([]byte, error) {
...
type NullablePokemonSpeciesList200Response struct {
	value *PokemonSpeciesList200Response
	isSet bool
}

func (v NullablePokemonSpeciesList200Response) Get() *PokemonSpeciesList200Response {
	return v.value
}

func (v *NullablePokemonSpeciesList200Response) Set(val *PokemonSpeciesList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePokemonSpeciesList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePokemonSpeciesList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePokemonSpeciesList200Response(val *PokemonSpeciesList200Response) *NullablePokemonSpeciesList200Response {
	return &NullablePokemonSpeciesList200Response{value: val, isSet: true}
}

func (v NullablePokemonSpeciesList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePokemonSpeciesList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
