...
// BerryFirmnessList200Response struct for BerryFirmnessList200Response
type BerryFirmnessList200Response struct {
	...
	Results []BerryFirmness `json:"results,omitempty"`
}
...
func NewBerryFirmnessList200Response() *BerryFirmnessList200Response {
	this := BerryFirmnessList200Response{}
	return &this
}
...
func (o *BerryFirmnessList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *BerryFirmnessList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []BerryFirmness and assigns it to the Results field.
func (o *BerryFirmnessList200Response) SetResults(v []BerryFirmness) {
	o.Results = v
}

func (o BerryFirmnessList200Response) MarshalJSON() ([]byte, error) {
...
type NullableBerryFirmnessList200Response struct {
	value *BerryFirmnessList200Response
	isSet bool
}

func (v NullableBerryFirmnessList200Response) Get() *BerryFirmnessList200Response {
	return v.value
}

func (v *NullableBerryFirmnessList200Response) Set(val *BerryFirmnessList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBerryFirmnessList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBerryFirmnessList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBerryFirmnessList200Response(val *BerryFirmnessList200Response) *NullableBerryFirmnessList200Response {
	return &NullableBerryFirmnessList200Response{value: val, isSet: true}
}

func (v NullableBerryFirmnessList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBerryFirmnessList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
