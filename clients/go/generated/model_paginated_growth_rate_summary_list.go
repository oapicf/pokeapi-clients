...
// checks if the PaginatedGrowthRateSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGrowthRateSummaryList{}

// PaginatedGrowthRateSummaryList struct for PaginatedGrowthRateSummaryList
...
func NewPaginatedGrowthRateSummaryList() *PaginatedGrowthRateSummaryList {
	this := PaginatedGrowthRateSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []GrowthRateSummary and assigns it to the Results field.
func (o *PaginatedGrowthRateSummaryList) SetResults(v []GrowthRateSummary) {
	o.Results = v
}

func (o PaginatedGrowthRateSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedGrowthRateSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedGrowthRateSummaryList struct {
	value *PaginatedGrowthRateSummaryList
	isSet bool
}

func (v NullablePaginatedGrowthRateSummaryList) Get() *PaginatedGrowthRateSummaryList {
	return v.value
}

func (v *NullablePaginatedGrowthRateSummaryList) Set(val *PaginatedGrowthRateSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedGrowthRateSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedGrowthRateSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedGrowthRateSummaryList(val *PaginatedGrowthRateSummaryList) *NullablePaginatedGrowthRateSummaryList {
	return &NullablePaginatedGrowthRateSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedGrowthRateSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedGrowthRateSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
