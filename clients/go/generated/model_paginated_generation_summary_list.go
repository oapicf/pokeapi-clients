...
// checks if the PaginatedGenerationSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGenerationSummaryList{}

// PaginatedGenerationSummaryList struct for PaginatedGenerationSummaryList
...
func NewPaginatedGenerationSummaryList() *PaginatedGenerationSummaryList {
	this := PaginatedGenerationSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []GenerationSummary and assigns it to the Results field.
func (o *PaginatedGenerationSummaryList) SetResults(v []GenerationSummary) {
	o.Results = v
}

func (o PaginatedGenerationSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedGenerationSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedGenerationSummaryList struct {
	value *PaginatedGenerationSummaryList
	isSet bool
}

func (v NullablePaginatedGenerationSummaryList) Get() *PaginatedGenerationSummaryList {
	return v.value
}

func (v *NullablePaginatedGenerationSummaryList) Set(val *PaginatedGenerationSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedGenerationSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedGenerationSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedGenerationSummaryList(val *PaginatedGenerationSummaryList) *NullablePaginatedGenerationSummaryList {
	return &NullablePaginatedGenerationSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedGenerationSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedGenerationSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
