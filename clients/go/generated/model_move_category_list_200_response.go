...
// MoveCategoryList200Response struct for MoveCategoryList200Response
type MoveCategoryList200Response struct {
	...
	Results []MoveCategory `json:"results,omitempty"`
}
...
func NewMoveCategoryList200Response() *MoveCategoryList200Response {
	this := MoveCategoryList200Response{}
	return &this
}
...
func (o *MoveCategoryList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *MoveCategoryList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []MoveCategory and assigns it to the Results field.
func (o *MoveCategoryList200Response) SetResults(v []MoveCategory) {
	o.Results = v
}

func (o MoveCategoryList200Response) MarshalJSON() ([]byte, error) {
...
type NullableMoveCategoryList200Response struct {
	value *MoveCategoryList200Response
	isSet bool
}

func (v NullableMoveCategoryList200Response) Get() *MoveCategoryList200Response {
	return v.value
}

func (v *NullableMoveCategoryList200Response) Set(val *MoveCategoryList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMoveCategoryList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMoveCategoryList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoveCategoryList200Response(val *MoveCategoryList200Response) *NullableMoveCategoryList200Response {
	return &NullableMoveCategoryList200Response{value: val, isSet: true}
}

func (v NullableMoveCategoryList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoveCategoryList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
