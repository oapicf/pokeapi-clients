...
// MoveBattleStyleList200Response struct for MoveBattleStyleList200Response
type MoveBattleStyleList200Response struct {
	...
	Results []MoveBattleStyle `json:"results,omitempty"`
}
...
func NewMoveBattleStyleList200Response() *MoveBattleStyleList200Response {
	this := MoveBattleStyleList200Response{}
	return &this
}
...
func (o *MoveBattleStyleList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *MoveBattleStyleList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []MoveBattleStyle and assigns it to the Results field.
func (o *MoveBattleStyleList200Response) SetResults(v []MoveBattleStyle) {
	o.Results = v
}

func (o MoveBattleStyleList200Response) MarshalJSON() ([]byte, error) {
...
type NullableMoveBattleStyleList200Response struct {
	value *MoveBattleStyleList200Response
	isSet bool
}

func (v NullableMoveBattleStyleList200Response) Get() *MoveBattleStyleList200Response {
	return v.value
}

func (v *NullableMoveBattleStyleList200Response) Set(val *MoveBattleStyleList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMoveBattleStyleList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMoveBattleStyleList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoveBattleStyleList200Response(val *MoveBattleStyleList200Response) *NullableMoveBattleStyleList200Response {
	return &NullableMoveBattleStyleList200Response{value: val, isSet: true}
}

func (v NullableMoveBattleStyleList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoveBattleStyleList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
