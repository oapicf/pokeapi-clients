...
// VersionGroupList200Response struct for VersionGroupList200Response
type VersionGroupList200Response struct {
	...
	Results []VersionGroup `json:"results,omitempty"`
}
...
func NewVersionGroupList200Response() *VersionGroupList200Response {
	this := VersionGroupList200Response{}
	return &this
}
...
func (o *VersionGroupList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *VersionGroupList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []VersionGroup and assigns it to the Results field.
func (o *VersionGroupList200Response) SetResults(v []VersionGroup) {
	o.Results = v
}

func (o VersionGroupList200Response) MarshalJSON() ([]byte, error) {
...
type NullableVersionGroupList200Response struct {
	value *VersionGroupList200Response
	isSet bool
}

func (v NullableVersionGroupList200Response) Get() *VersionGroupList200Response {
	return v.value
}

func (v *NullableVersionGroupList200Response) Set(val *VersionGroupList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionGroupList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionGroupList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionGroupList200Response(val *VersionGroupList200Response) *NullableVersionGroupList200Response {
	return &NullableVersionGroupList200Response{value: val, isSet: true}
}

func (v NullableVersionGroupList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionGroupList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
