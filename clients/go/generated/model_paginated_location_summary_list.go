...
// checks if the PaginatedLocationSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedLocationSummaryList{}

// PaginatedLocationSummaryList struct for PaginatedLocationSummaryList
...
func NewPaginatedLocationSummaryList() *PaginatedLocationSummaryList {
	this := PaginatedLocationSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []LocationSummary and assigns it to the Results field.
func (o *PaginatedLocationSummaryList) SetResults(v []LocationSummary) {
	o.Results = v
}

func (o PaginatedLocationSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedLocationSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedLocationSummaryList struct {
	value *PaginatedLocationSummaryList
	isSet bool
}

func (v NullablePaginatedLocationSummaryList) Get() *PaginatedLocationSummaryList {
	return v.value
}

func (v *NullablePaginatedLocationSummaryList) Set(val *PaginatedLocationSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedLocationSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedLocationSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedLocationSummaryList(val *PaginatedLocationSummaryList) *NullablePaginatedLocationSummaryList {
	return &NullablePaginatedLocationSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedLocationSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedLocationSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
