...
// EvolutionTriggerList200Response struct for EvolutionTriggerList200Response
type EvolutionTriggerList200Response struct {
	...
	Results []EvolutionTrigger `json:"results,omitempty"`
}
...
func NewEvolutionTriggerList200Response() *EvolutionTriggerList200Response {
	this := EvolutionTriggerList200Response{}
	return &this
}
...
func (o *EvolutionTriggerList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *EvolutionTriggerList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []EvolutionTrigger and assigns it to the Results field.
func (o *EvolutionTriggerList200Response) SetResults(v []EvolutionTrigger) {
	o.Results = v
}

func (o EvolutionTriggerList200Response) MarshalJSON() ([]byte, error) {
...
type NullableEvolutionTriggerList200Response struct {
	value *EvolutionTriggerList200Response
	isSet bool
}

func (v NullableEvolutionTriggerList200Response) Get() *EvolutionTriggerList200Response {
	return v.value
}

func (v *NullableEvolutionTriggerList200Response) Set(val *EvolutionTriggerList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEvolutionTriggerList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEvolutionTriggerList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEvolutionTriggerList200Response(val *EvolutionTriggerList200Response) *NullableEvolutionTriggerList200Response {
	return &NullableEvolutionTriggerList200Response{value: val, isSet: true}
}

func (v NullableEvolutionTriggerList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEvolutionTriggerList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
