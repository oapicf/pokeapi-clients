...
// PokemonHabitat struct for PokemonHabitat
...
func (o PokemonHabitat) MarshalJSON() ([]byte, error) {
...
type NullablePokemonHabitat struct {
	value *PokemonHabitat
	isSet bool
}

func (v NullablePokemonHabitat) Get() *PokemonHabitat {
	return v.value
}

func (v *NullablePokemonHabitat) Set(val *PokemonHabitat) {
	v.value = val
	v.isSet = true
}

func (v NullablePokemonHabitat) IsSet() bool {
	return v.isSet
}

func (v *NullablePokemonHabitat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePokemonHabitat(val *PokemonHabitat) *NullablePokemonHabitat {
	return &NullablePokemonHabitat{value: val, isSet: true}
}

func (v NullablePokemonHabitat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePokemonHabitat) UnmarshalJSON(src []byte) error {
	v.isSet = true
