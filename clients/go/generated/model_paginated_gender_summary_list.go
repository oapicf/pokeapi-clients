...
// checks if the PaginatedGenderSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGenderSummaryList{}

// PaginatedGenderSummaryList struct for PaginatedGenderSummaryList
...
func NewPaginatedGenderSummaryList() *PaginatedGenderSummaryList {
	this := PaginatedGenderSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []GenderSummary and assigns it to the Results field.
func (o *PaginatedGenderSummaryList) SetResults(v []GenderSummary) {
	o.Results = v
}

func (o PaginatedGenderSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedGenderSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedGenderSummaryList struct {
	value *PaginatedGenderSummaryList
	isSet bool
}

func (v NullablePaginatedGenderSummaryList) Get() *PaginatedGenderSummaryList {
	return v.value
}

func (v *NullablePaginatedGenderSummaryList) Set(val *PaginatedGenderSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedGenderSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedGenderSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedGenderSummaryList(val *PaginatedGenderSummaryList) *NullablePaginatedGenderSummaryList {
	return &NullablePaginatedGenderSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedGenderSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedGenderSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
