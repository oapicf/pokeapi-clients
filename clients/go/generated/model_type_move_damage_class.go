...
// TypeMoveDamageClass struct for TypeMoveDamageClass
...
func (o TypeMoveDamageClass) MarshalJSON() ([]byte, error) {
...
type NullableTypeMoveDamageClass struct {
	value *TypeMoveDamageClass
	isSet bool
}

func (v NullableTypeMoveDamageClass) Get() *TypeMoveDamageClass {
	return v.value
}

func (v *NullableTypeMoveDamageClass) Set(val *TypeMoveDamageClass) {
	v.value = val
	v.isSet = true
}

func (v NullableTypeMoveDamageClass) IsSet() bool {
	return v.isSet
}

func (v *NullableTypeMoveDamageClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTypeMoveDamageClass(val *TypeMoveDamageClass) *NullableTypeMoveDamageClass {
	return &NullableTypeMoveDamageClass{value: val, isSet: true}
}

func (v NullableTypeMoveDamageClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTypeMoveDamageClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
