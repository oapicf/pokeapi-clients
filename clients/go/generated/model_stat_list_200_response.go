...
// StatList200Response struct for StatList200Response
type StatList200Response struct {
	...
	Results []Stat `json:"results,omitempty"`
}
...
func (o *StatList200Response) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *StatList200Response) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Stat and assigns it to the Results field.
func (o *StatList200Response) SetResults(v []Stat) {
	o.Results = v
}

func (o StatList200Response) MarshalJSON() ([]byte, error) {
...
type NullableStatList200Response struct {
	value *StatList200Response
	isSet bool
}

func (v NullableStatList200Response) Get() *StatList200Response {
	return v.value
}

func (v *NullableStatList200Response) Set(val *StatList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableStatList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableStatList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatList200Response(val *StatList200Response) *NullableStatList200Response {
	return &NullableStatList200Response{value: val, isSet: true}
}

func (v NullableStatList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
