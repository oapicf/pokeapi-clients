...
// checks if the PaginatedVersionSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedVersionSummaryList{}

// PaginatedVersionSummaryList struct for PaginatedVersionSummaryList
...
func NewPaginatedVersionSummaryList() *PaginatedVersionSummaryList {
	this := PaginatedVersionSummaryList{}
	return &this
}
...
// SetResults gets a reference to the given []VersionSummary and assigns it to the Results field.
func (o *PaginatedVersionSummaryList) SetResults(v []VersionSummary) {
	o.Results = v
}

func (o PaginatedVersionSummaryList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedVersionSummaryList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedVersionSummaryList struct {
	value *PaginatedVersionSummaryList
	isSet bool
}

func (v NullablePaginatedVersionSummaryList) Get() *PaginatedVersionSummaryList {
	return v.value
}

func (v *NullablePaginatedVersionSummaryList) Set(val *PaginatedVersionSummaryList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVersionSummaryList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVersionSummaryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVersionSummaryList(val *PaginatedVersionSummaryList) *NullablePaginatedVersionSummaryList {
	return &NullablePaginatedVersionSummaryList{value: val, isSet: true}
}

func (v NullablePaginatedVersionSummaryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVersionSummaryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
