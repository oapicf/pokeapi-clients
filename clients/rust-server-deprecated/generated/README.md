...
- API version: 2.7.0
- Build date: 2026-08-30T01:59:55.062156339Z[Etc/UTC]
...
cargo run --example openapi_client-client BerryFirmnessRetrieve
cargo run --example openapi_client-client BerryFlavorRetrieve
cargo run --example openapi_client-client BerryRetrieve
...
cargo run --example openapi_client-client ContestEffectRetrieve
cargo run --example openapi_client-client ContestTypeRetrieve
cargo run --example openapi_client-client SuperContestEffectRetrieve
...
cargo run --example openapi_client-client EncounterConditionRetrieve
cargo run --example openapi_client-client EncounterConditionValueRetrieve
cargo run --example openapi_client-client EncounterMethodRetrieve
cargo run --example openapi_client-client EvolutionChainList
cargo run --example openapi_client-client EvolutionTriggerList
cargo run --example openapi_client-client EvolutionChainRetrieve
cargo run --example openapi_client-client EvolutionTriggerRetrieve
...
cargo run --example openapi_client-client GenerationRetrieve
cargo run --example openapi_client-client PokedexRetrieve
cargo run --example openapi_client-client VersionGroupRetrieve
cargo run --example openapi_client-client VersionRetrieve
...
cargo run --example openapi_client-client ItemAttributeRetrieve
cargo run --example openapi_client-client ItemCategoryRetrieve
cargo run --example openapi_client-client ItemFlingEffectRetrieve
cargo run --example openapi_client-client ItemPocketRetrieve
cargo run --example openapi_client-client ItemRetrieve
...
cargo run --example openapi_client-client LocationRetrieve
cargo run --example openapi_client-client PalParkAreaRetrieve
cargo run --example openapi_client-client RegionRetrieve
cargo run --example openapi_client-client MachineList
cargo run --example openapi_client-client MachineRetrieve
...
cargo run --example openapi_client-client MoveAilmentRetrieve
cargo run --example openapi_client-client MoveBattleStyleRetrieve
cargo run --example openapi_client-client MoveCategoryRetrieve
cargo run --example openapi_client-client MoveLearnMethodRetrieve
cargo run --example openapi_client-client MoveRetrieve
cargo run --example openapi_client-client MoveTargetRetrieve
...
cargo run --example openapi_client-client AbilityRetrieve
cargo run --example openapi_client-client CharacteristicRetrieve
cargo run --example openapi_client-client EggGroupRetrieve
cargo run --example openapi_client-client GenderRetrieve
cargo run --example openapi_client-client GrowthRateRetrieve
cargo run --example openapi_client-client MoveDamageClassRetrieve
cargo run --example openapi_client-client NatureRetrieve
cargo run --example openapi_client-client PokeathlonStatRetrieve
cargo run --example openapi_client-client PokemonColorRetrieve
cargo run --example openapi_client-client PokemonFormRetrieve
cargo run --example openapi_client-client PokemonHabitatRetrieve
cargo run --example openapi_client-client PokemonRetrieve
cargo run --example openapi_client-client PokemonShapeRetrieve
cargo run --example openapi_client-client PokemonSpeciesRetrieve
cargo run --example openapi_client-client StatRetrieve
cargo run --example openapi_client-client TypeRetrieve
cargo run --example openapi_client-client LanguageList
cargo run --example openapi_client-client LanguageRetrieve
```
