...
class LocationApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val locationListOperation = (apiOperation[String]("locationList")
    summary ""
  ...
  val locationReadOperation = (apiOperation[String]("locationRead")
    summary ""
    parameters(pathParam[Int]("id").description(""))
  )

  get("/api/v2/location/:id/", operation(locationReadOperation)) {
