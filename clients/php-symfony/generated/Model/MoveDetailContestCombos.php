...
class MoveDetailContestCombos 
{
    ...
    */
    ...
    protected ?MoveDetailContestCombosNormal $normal = null;
    ...
    */
    ...
    #[Assert\Valid]
    #[Assert\Type("OpenAPI\Server\Model\MoveDetailContestCombosNormal")]
    protected ?MoveDetailContestCombosNormal $super = null;
    ...
    {
        if (is_array($data)) {
            $this->normal = array_key_exists('normal', $data) ? $data['normal'] : $this->normal;
            $this->super = array_key_exists('super', $data) ? $data['super'] : $this->super;
        }
    }
     ...
     * Gets normal.
     *
     * @return MoveDetailContestCombosNormal|null
     */
    ...
    */
     ...
     * @return MoveDetailContestCombosNormal|null
     */
    public function getSuper(): ?MoveDetailContestCombosNormal
    {
        return $this->super;
    }
