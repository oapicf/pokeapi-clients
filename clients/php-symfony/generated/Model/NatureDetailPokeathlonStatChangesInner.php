...
class NatureDetailPokeathlonStatChangesInner 
{
    ...
    */
    ...
    protected ?AbilityDetailPokemonInnerPokemon $pokeathlonStat = null;
    ...
    public function __construct(?array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->pokeathlonStat = array_key_exists('pokeathlonStat', $data) ? $data['pokeathlonStat'] : $this->pokeathlonStat;
        }
    }
    ...
    */
     ...
     */
    public function getPokeathlonStat(): ?AbilityDetailPokemonInnerPokemon
    {
