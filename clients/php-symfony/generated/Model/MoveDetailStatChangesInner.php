...
class MoveDetailStatChangesInner 
{
    ...
    */
    ...
    protected ?AbilityDetailPokemonInnerPokemon $stat = null;
    ...
    {
        if (is_array($data)) {
            $this->change = array_key_exists('change', $data) ? $data['change'] : $this->change;
    ...
    */
     ...
     */
    public function getStat(): ?AbilityDetailPokemonInnerPokemon
    {
        return $this->stat;
    }
