...
/**
 * MachinesController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class MachinesController extends Controller
{
     ...
     */
    public function machineListAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->machineList($limit, $offset, $q, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function machineRetrieveAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->machineRetrieve($id, $responseCode, $responseHeaders);
     ...
     * @return MachinesApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('machines');
    }
}
