...
class LanguageController extends Controller
{
    ...
    public function languageListAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->languageList($limit, $offset, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function languageReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->languageRead($id, $responseCode, $responseHeaders);
     ...
     * @return LanguageApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('language');
    }
}
