...
class LocationController extends Controller
{
    ...
    public function locationListAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->locationList($limit, $offset, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function locationReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->locationRead($id, $responseCode, $responseHeaders);
