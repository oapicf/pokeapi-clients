...
class EncountersController extends Controller
{
     ...
     */
    public function encounterConditionListAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->encounterConditionList($limit, $offset, $q, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function encounterConditionRetrieveAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->encounterConditionRetrieve($id, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function encounterConditionValueListAction(Request $request)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->encounterConditionValueList($limit, $offset, $q, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function encounterConditionValueRetrieveAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->encounterConditionValueRetrieve($id, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function encounterMethodListAction(Request $request)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->encounterMethodList($limit, $offset, $q, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function encounterMethodRetrieveAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
     ...
     * @return EncountersApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('encounters');
    }
}
