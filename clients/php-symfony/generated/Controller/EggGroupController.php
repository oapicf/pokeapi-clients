...
/**
 * EggGroupController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class EggGroupController extends Controller
{
     ...
     * @return Response The Symfony response.
     */
    public function eggGroupReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
     ...
     * @return EggGroupApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('eggGroup');
    }
}
