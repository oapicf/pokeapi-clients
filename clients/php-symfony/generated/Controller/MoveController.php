...
/**
 * MoveController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class MoveController extends Controller
{
    ...
    public function moveListAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->moveList($limit, $offset, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function moveReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->moveRead($id, $responseCode, $responseHeaders);
     ...
     * @return MoveApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('move');
    }
}
