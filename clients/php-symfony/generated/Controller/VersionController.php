...
/**
 * VersionController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class VersionController extends Controller
{
    ...
    public function versionListAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->versionList($limit, $offset, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function versionReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->versionRead($id, $responseCode, $responseHeaders);
     ...
     * @return VersionApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('version');
    }
}
