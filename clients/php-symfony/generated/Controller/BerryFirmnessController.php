...
/**
 * BerryFirmnessController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class BerryFirmnessController extends Controller
{
     ...
     * @return Response The Symfony response.
     */
    public function berryFirmnessReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
     ...
     * @return BerryFirmnessApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('berryFirmness');
    }
}
