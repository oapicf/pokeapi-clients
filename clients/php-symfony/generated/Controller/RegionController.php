...
/**
 * RegionController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class RegionController extends Controller
{
    ...
    public function regionListAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->regionList($limit, $offset, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function regionReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->regionRead($id, $responseCode, $responseHeaders);
     ...
     * @return RegionApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('region');
    }
}
