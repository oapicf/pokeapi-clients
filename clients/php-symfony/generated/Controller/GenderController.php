...
class GenderController extends Controller
{
    ...
    public function genderListAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->genderList($limit, $offset, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function genderReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->genderRead($id, $responseCode, $responseHeaders);
     ...
     * @return GenderApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('gender');
    }
}
