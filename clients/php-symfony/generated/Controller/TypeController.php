...
/**
 * TypeController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class TypeController extends Controller
{
    ...
    public function typeListAction(Request $request)
    {
        ...
        try {
            ...
            $result = $handler->typeList($limit, $offset, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function typeReadAction(Request $request, $id)
    {
        // Figure out what data format to return to the client
        $produces = ['text/plain'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $result = $handler->typeRead($id, $responseCode, $responseHeaders);
     ...
     * @return TypeApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('type');
    }
}
