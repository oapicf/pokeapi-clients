...
**effect_changes** | [**list_t**](move_detail_effect_changes_inner.md) \* |  | [readonly] 
**generation** | [**generation_summary_t**](generation_summary.md) \* |  | 
**meta** | [**move_meta_t**](move_meta.md) \* |  | [readonly] 
**names** | [**list_t**](move_name.md) \* |  | [readonly] 
**past_values** | [**list_t**](move_change.md) \* |  | [readonly] 
**stat_changes** | [**list_t**](move_detail_stat_changes_inner.md) \* |  | [readonly] 
...
**machines** | [**list_t**](move_detail_machines_inner.md) \* |  | [readonly] 
**flavor_text_entries** | [**list_t**](move_flavor_text.md) \* |  | [readonly] 
**learned_by_pokemon** | [**list_t**](ability_detail_pokemon_inner_pokemon.md) \* |  | [readonly] 
