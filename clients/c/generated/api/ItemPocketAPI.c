...
ItemPocketAPI_itemPocketList(apiClient_t *apiClient, int *limit, int *offset)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/item-pocket/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/item-pocket/");
...
ItemPocketAPI_itemPocketRead(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/item-pocket/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/item-pocket/{id}/");
