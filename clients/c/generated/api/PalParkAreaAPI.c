...
PalParkAreaAPI_palParkAreaList(apiClient_t *apiClient, int limit , int offset )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/pal-park-area/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/pal-park-area/");
...
PalParkAreaAPI_palParkAreaRead(apiClient_t *apiClient, int id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/pal-park-area/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/pal-park-area/{id}/");
