...
ItemsAPI_itemAttributeList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item-attribute/");
    ...
    paginated_item_attribute_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_item_attribute_summary_list_parseFromJSON(ItemsAPIlocalVarJSON);
...
ItemsAPI_itemAttributeRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item-attribute/{id}/");
    ...
    //}
    //nonprimitive not container
    item_attribute_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = item_attribute_detail_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ItemsAPI_itemCategoryList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item-category/");
    ...
    //}
    //nonprimitive not container
    paginated_item_category_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_item_category_summary_list_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ItemsAPI_itemCategoryRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item-category/{id}/");
    ...
    //}
    //nonprimitive not container
    item_category_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = item_category_detail_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ItemsAPI_itemFlingEffectList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item-fling-effect/");
    ...
    //}
    //nonprimitive not container
    paginated_item_fling_effect_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_item_fling_effect_summary_list_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ItemsAPI_itemFlingEffectRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item-fling-effect/{id}/");
    ...
    //}
    //nonprimitive not container
    item_fling_effect_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = item_fling_effect_detail_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ItemsAPI_itemList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item/");
    ...
    //}
    //nonprimitive not container
    paginated_item_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_item_summary_list_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ItemsAPI_itemPocketList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item-pocket/");
    ...
    //}
    //nonprimitive not container
    paginated_item_pocket_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_item_pocket_summary_list_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ItemsAPI_itemPocketRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item-pocket/{id}/");
    ...
    //}
    //nonprimitive not container
    item_pocket_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = item_pocket_detail_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ItemsAPI_itemRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/item/{id}/");
    ...
    //}
    //nonprimitive not container
    item_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ItemsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = item_detail_parseFromJSON(ItemsAPIlocalVarJSON);
        cJSON_Delete(ItemsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
