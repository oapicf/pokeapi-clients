...
ItemAPI_itemList(apiClient_t *apiClient, int *limit, int *offset)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/item/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/item/");
...
ItemAPI_itemRead(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/item/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/item/{id}/");
