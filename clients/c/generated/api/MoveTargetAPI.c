...
char*
MoveTargetAPI_moveTargetList(apiClient_t *apiClient, int *limit, int *offset)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/move-target/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/move-target/");
...
char*
MoveTargetAPI_moveTargetRead(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/move-target/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/move-target/{id}/");
