...
PokemonColorAPI_pokemonColorList(apiClient_t *apiClient, int limit , int offset )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/pokemon-color/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/pokemon-color/");
...
PokemonColorAPI_pokemonColorRead(apiClient_t *apiClient, int id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/pokemon-color/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/pokemon-color/{id}/");
