...
RegionAPI_regionList(apiClient_t *apiClient, int limit , int offset )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/region/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/region/");
...
RegionAPI_regionRead(apiClient_t *apiClient, int id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/region/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/region/{id}/");
