...
MoveDamageClassAPI_moveDamageClassList(apiClient_t *apiClient, int limit , int offset )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/move-damage-class/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/move-damage-class/");
...
MoveDamageClassAPI_moveDamageClassRead(apiClient_t *apiClient, int id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/move-damage-class/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/move-damage-class/{id}/");
