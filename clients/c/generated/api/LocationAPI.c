...
LocationAPI_locationAreaList(apiClient_t *apiClient, int *limit, int *offset)
{
    ...
    paginated_location_area_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_location_area_summary_list_parseFromJSON(LocationAPIlocalVarJSON);
...
LocationAPI_locationAreaRetrieve(apiClient_t *apiClient, int *id)
{
    ...
    //}
    //nonprimitive not container
    location_area_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = location_area_detail_parseFromJSON(LocationAPIlocalVarJSON);
        cJSON_Delete(LocationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LocationAPI_locationList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    //}
    //nonprimitive not container
    paginated_location_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_location_summary_list_parseFromJSON(LocationAPIlocalVarJSON);
        cJSON_Delete(LocationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LocationAPI_locationRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    //}
    //nonprimitive not container
    location_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = location_detail_parseFromJSON(LocationAPIlocalVarJSON);
        cJSON_Delete(LocationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LocationAPI_palParkAreaList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    //}
    //nonprimitive not container
    paginated_pal_park_area_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_pal_park_area_summary_list_parseFromJSON(LocationAPIlocalVarJSON);
        cJSON_Delete(LocationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LocationAPI_palParkAreaRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    //}
    //nonprimitive not container
    pal_park_area_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = pal_park_area_detail_parseFromJSON(LocationAPIlocalVarJSON);
        cJSON_Delete(LocationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LocationAPI_regionList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    //}
    //nonprimitive not container
    paginated_region_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_region_summary_list_parseFromJSON(LocationAPIlocalVarJSON);
        cJSON_Delete(LocationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LocationAPI_regionRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    //}
    //nonprimitive not container
    region_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = region_detail_parseFromJSON(LocationAPIlocalVarJSON);
        cJSON_Delete(LocationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
