...
EvolutionAPI_evolutionChainList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/evolution-chain/");
    ...
    paginated_evolution_chain_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *EvolutionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_evolution_chain_summary_list_parseFromJSON(EvolutionAPIlocalVarJSON);
        cJSON_Delete(EvolutionAPIlocalVarJSON);
...
EvolutionAPI_evolutionChainRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/evolution-chain/{id}/");
    ...
    //}
    //nonprimitive not container
    evolution_chain_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *EvolutionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = evolution_chain_detail_parseFromJSON(EvolutionAPIlocalVarJSON);
        cJSON_Delete(EvolutionAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
EvolutionAPI_evolutionTriggerList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/evolution-trigger/");
    ...
    //}
    //nonprimitive not container
    paginated_evolution_trigger_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *EvolutionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_evolution_trigger_summary_list_parseFromJSON(EvolutionAPIlocalVarJSON);
        cJSON_Delete(EvolutionAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
EvolutionAPI_evolutionTriggerRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/api/v2/evolution-trigger/{id}/");
    ...
    //}
    //nonprimitive not container
    evolution_trigger_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *EvolutionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = evolution_trigger_detail_parseFromJSON(EvolutionAPIlocalVarJSON);
        cJSON_Delete(EvolutionAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
