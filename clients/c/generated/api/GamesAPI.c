...
GamesAPI_generationList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    paginated_generation_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *GamesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_generation_summary_list_parseFromJSON(GamesAPIlocalVarJSON);
        cJSON_Delete(GamesAPIlocalVarJSON);
...
GamesAPI_generationRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    //}
    //nonprimitive not container
    generation_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *GamesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = generation_detail_parseFromJSON(GamesAPIlocalVarJSON);
        cJSON_Delete(GamesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
GamesAPI_pokedexList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    //}
    //nonprimitive not container
    paginated_pokedex_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *GamesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_pokedex_summary_list_parseFromJSON(GamesAPIlocalVarJSON);
        cJSON_Delete(GamesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
GamesAPI_pokedexRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    //}
    //nonprimitive not container
    pokedex_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *GamesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = pokedex_detail_parseFromJSON(GamesAPIlocalVarJSON);
        cJSON_Delete(GamesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
GamesAPI_versionGroupList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    //}
    //nonprimitive not container
    paginated_version_group_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *GamesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_version_group_summary_list_parseFromJSON(GamesAPIlocalVarJSON);
        cJSON_Delete(GamesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
GamesAPI_versionGroupRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    //}
    //nonprimitive not container
    version_group_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *GamesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = version_group_detail_parseFromJSON(GamesAPIlocalVarJSON);
        cJSON_Delete(GamesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
GamesAPI_versionList(apiClient_t *apiClient, int *limit, int *offset, char *q)
{
    ...
    //}
    //nonprimitive not container
    paginated_version_summary_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *GamesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = paginated_version_summary_list_parseFromJSON(GamesAPIlocalVarJSON);
        cJSON_Delete(GamesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
GamesAPI_versionRetrieve(apiClient_t *apiClient, char *id)
{
    ...
    //}
    //nonprimitive not container
    version_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *GamesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = version_detail_parseFromJSON(GamesAPIlocalVarJSON);
        cJSON_Delete(GamesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
