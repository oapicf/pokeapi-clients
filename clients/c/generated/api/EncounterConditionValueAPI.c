...
char*
EncounterConditionValueAPI_encounterConditionValueList(apiClient_t *apiClient, int limit , int offset )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/encounter-condition-value/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/encounter-condition-value/");
...
char*
EncounterConditionValueAPI_encounterConditionValueRead(apiClient_t *apiClient, int id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/encounter-condition-value/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/encounter-condition-value/{id}/");
