...
LocationAreaAPI_locationAreaList(apiClient_t *apiClient, int limit , int offset )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/location-area/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/location-area/");
...
LocationAreaAPI_locationAreaRead(apiClient_t *apiClient, int id )
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/location-area/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/location-area/{id}/");
