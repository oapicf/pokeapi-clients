...
PokedexAPI_pokedexList(apiClient_t *apiClient, int *limit, int *offset)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/pokedex/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/pokedex/");
...
PokedexAPI_pokedexRead(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/pokedex/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/pokedex/{id}/");
