...
ItemFlingEffectAPI_itemFlingEffectList(apiClient_t *apiClient, int *limit, int *offset)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/item-fling-effect/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/item-fling-effect/");
...
ItemFlingEffectAPI_itemFlingEffectRead(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/api/v2/item-fling-effect/{id}/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/api/v2/item-fling-effect/{id}/");
