/*
 * move_meta_category_description.h
 *
 * 
 */

#ifndef _move_meta_category_description_H_
#define _move_meta_category_description_H_
...
typedef struct move_meta_category_description_t move_meta_category_description_t;

#include "language_summary.h"



typedef struct move_meta_category_description_t {
    char *description; // string
    struct language_summary_t *language; //model

    int _library_owned; // Is the library responsible for freeing this object?
} move_meta_category_description_t;
...
#endif /* _move_meta_category_description_H_ */
