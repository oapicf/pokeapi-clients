...
static location_area_detail_pokemon_encounters_inner_t *location_area_detail_pokemon_encounters_inner_create_internal(
    ...
    memset(location_area_detail_pokemon_encounters_inner_local_var, 0, sizeof(location_area_detail_pokemon_encounters_inner_t));
...
__attribute__((deprecated)) location_area_detail_pokemon_encounters_inner_t *location_area_detail_pokemon_encounters_inner_create(
    ...
    location_area_detail_pokemon_encounters_inner_t *result = location_area_detail_pokemon_encounters_inner_create_internal (
        pokemon,
        version_details
        );
    if (!result) {
