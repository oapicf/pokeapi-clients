...
static evolution_chain_detail_chain_evolves_to_inner_evolution_details_inner_gender_t *evolution_chain_detail_chain_evolves_to_inner_evolution_details_inner_gender_create_internal(
    ...
    memset(evolution_chain_detail_chain_evolves_to_inner_evolution_details_inner_gender_local_var, 0, sizeof(evolution_chain_detail_chain_evolves_to_inner_evolution_details_inner_gender_t));
...
__attribute__((deprecated)) evolution_chain_detail_chain_evolves_to_inner_evolution_details_inner_gender_t *evolution_chain_detail_chain_evolves_to_inner_evolution_details_inner_gender_create(
    ...
    evolution_chain_detail_chain_evolves_to_inner_evolution_details_inner_gender_t *result = evolution_chain_detail_chain_evolves_to_inner_evolution_details_inner_gender_create_internal (
        name,
        url
        );
    if (!result) {
