...
static move_detail_contest_combos_normal_t *move_detail_contest_combos_normal_create_internal(
    ...
    memset(move_detail_contest_combos_normal_local_var, 0, sizeof(move_detail_contest_combos_normal_t));
...
__attribute__((deprecated)) move_detail_contest_combos_normal_t *move_detail_contest_combos_normal_create(
    ...
    move_detail_contest_combos_normal_t *result = move_detail_contest_combos_normal_create_internal (
        use_before,
        use_after
        );
    if (!result) {
