...
static encounter_condition_value_summary_t *encounter_condition_value_summary_create_internal(
    ...
    memset(encounter_condition_value_summary_local_var, 0, sizeof(encounter_condition_value_summary_t));
...
__attribute__((deprecated)) encounter_condition_value_summary_t *encounter_condition_value_summary_create(
    ...
    encounter_condition_value_summary_t *result = encounter_condition_value_summary_create_internal (
        name,
        url
        );
    if (!result) {
