...
static move_damage_class_summary_t *move_damage_class_summary_create_internal(
    ...
    memset(move_damage_class_summary_local_var, 0, sizeof(move_damage_class_summary_t));
...
__attribute__((deprecated)) move_damage_class_summary_t *move_damage_class_summary_create(
    ...
    move_damage_class_summary_t *result = move_damage_class_summary_create_internal (
        name,
        url
        );
    if (!result) {
