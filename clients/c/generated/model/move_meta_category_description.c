...
static move_meta_category_description_t *move_meta_category_description_create_internal(
    ...
    memset(move_meta_category_description_local_var, 0, sizeof(move_meta_category_description_t));
...
__attribute__((deprecated)) move_meta_category_description_t *move_meta_category_description_create(
    ...
    move_meta_category_description_t *result = move_meta_category_description_create_internal (
        description,
        language
        );
    if (!result) {
