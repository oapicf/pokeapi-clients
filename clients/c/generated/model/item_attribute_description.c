...
static item_attribute_description_t *item_attribute_description_create_internal(
    ...
    memset(item_attribute_description_local_var, 0, sizeof(item_attribute_description_t));
...
__attribute__((deprecated)) item_attribute_description_t *item_attribute_description_create(
    ...
    item_attribute_description_t *result = item_attribute_description_create_internal (
        description,
        language
        );
    if (!result) {
