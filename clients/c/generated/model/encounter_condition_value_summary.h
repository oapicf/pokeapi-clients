/*
 * encounter_condition_value_summary.h
 *
 * 
 */

#ifndef _encounter_condition_value_summary_H_
#define _encounter_condition_value_summary_H_
...
typedef struct encounter_condition_value_summary_t encounter_condition_value_summary_t;




typedef struct encounter_condition_value_summary_t {
    char *name; // string
    char *url; // string

    int _library_owned; // Is the library responsible for freeing this object?
} encounter_condition_value_summary_t;
...
#endif /* _encounter_condition_value_summary_H_ */
