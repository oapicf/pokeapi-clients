...
static type_detail_damage_relations_t *type_detail_damage_relations_create_internal(
    ...
    memset(type_detail_damage_relations_local_var, 0, sizeof(type_detail_damage_relations_t));
...
__attribute__((deprecated)) type_detail_damage_relations_t *type_detail_damage_relations_create(
    ...
    type_detail_damage_relations_t *result = type_detail_damage_relations_create_internal (
        no_damage_to,
        half_damage_to,
        double_damage_to,
        no_damage_from,
