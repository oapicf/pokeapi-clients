...
static type_detail_past_damage_relations_inner_damage_relations_t *type_detail_past_damage_relations_inner_damage_relations_create_internal(
    list_t *no_damage_to,
    ...
    type_detail_past_damage_relations_inner_damage_relations_t *type_detail_past_damage_relations_inner_damage_relations_local_var = malloc(sizeof(type_detail_past_damage_relations_inner_damage_relations_t));
...
void type_detail_past_damage_relations_inner_damage_relations_free(type_detail_past_damage_relations_inner_damage_relations_t *type_detail_past_damage_relations_inner_damage_relations) {
    if(NULL == type_detail_past_damage_relations_inner_damage_relations){
        return ;
    }
    if(type_detail_past_damage_relations_inner_damage_relations->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "type_detail_past_damage_relations_inner_damage_relations_free");
        return ;
    }
    listEntry_t *listEntry;
    if (type_detail_past_damage_relations_inner_damage_relations->no_damage_to) {
        list_ForEach(listEntry, type_detail_past_damage_relations_inner_damage_relations->no_damage_to) {
            ability_detail_pokemon_inner_pokemon_free(listEntry->data);
        }
        list_freeList(type_detail_past_damage_relations_inner_damage_relations->no_damage_to);
        type_detail_past_damage_relations_inner_damage_relations->no_damage_to = NULL;
    }
    if (type_detail_past_damage_relations_inner_damage_relations->half_damage_to) {
        list_ForEach(listEntry, type_detail_past_damage_relations_inner_damage_relations->half_damage_to) {
            ability_detail_pokemon_inner_pokemon_free(listEntry->data);
        }
        list_freeList(type_detail_past_damage_relations_inner_damage_relations->half_damage_to);
        type_detail_past_damage_relations_inner_damage_relations->half_damage_to = NULL;
    }
    if (type_detail_past_damage_relations_inner_damage_relations->double_damage_to) {
        list_ForEach(listEntry, type_detail_past_damage_relations_inner_damage_relations->double_damage_to) {
            ability_detail_pokemon_inner_pokemon_free(listEntry->data);
        }
        list_freeList(type_detail_past_damage_relations_inner_damage_relations->double_damage_to);
        type_detail_past_damage_relations_inner_damage_relations->double_damage_to = NULL;
    }
    if (type_detail_past_damage_relations_inner_damage_relations->no_damage_from) {
        list_ForEach(listEntry, type_detail_past_damage_relations_inner_damage_relations->no_damage_from) {
            ability_detail_pokemon_inner_pokemon_free(listEntry->data);
        }
        list_freeList(type_detail_past_damage_relations_inner_damage_relations->no_damage_from);
        type_detail_past_damage_relations_inner_damage_relations->no_damage_from = NULL;
    }
    if (type_detail_past_damage_relations_inner_damage_relations->half_damage_from) {
        list_ForEach(listEntry, type_detail_past_damage_relations_inner_damage_relations->half_damage_from) {
            ability_detail_pokemon_inner_pokemon_free(listEntry->data);
        }
        list_freeList(type_detail_past_damage_relations_inner_damage_relations->half_damage_from);
        type_detail_past_damage_relations_inner_damage_relations->half_damage_from = NULL;
    }
    if (type_detail_past_damage_relations_inner_damage_relations->double_damage_from) {
        list_ForEach(listEntry, type_detail_past_damage_relations_inner_damage_relations->double_damage_from) {
            ability_detail_pokemon_inner_pokemon_free(listEntry->data);
        }
        list_freeList(type_detail_past_damage_relations_inner_damage_relations->double_damage_from);
        type_detail_past_damage_relations_inner_damage_relations->double_damage_from = NULL;
    }
    free(type_detail_past_damage_relations_inner_damage_relations);
}
...
cJSON *type_detail_past_damage_relations_inner_damage_relations_convertToJSON(type_detail_past_damage_relations_inner_damage_relations_t *type_detail_past_damage_relations_inner_damage_relations) {
    ...
    // type_detail_past_damage_relations_inner_damage_relations->no_damage_to
    if (!type_detail_past_damage_relations_inner_damage_relations->no_damage_to) {
        goto fail;
    }
    ...
    if (type_detail_past_damage_relations_inner_damage_relations->no_damage_to) {
    list_ForEach(no_damage_toListEntry, type_detail_past_damage_relations_inner_damage_relations->no_damage_to) {
    ...
    // type_detail_past_damage_relations_inner_damage_relations->half_damage_to
    if (!type_detail_past_damage_relations_inner_damage_relations->half_damage_to) {
        goto fail;
    }
    ...
    if (type_detail_past_damage_relations_inner_damage_relations->half_damage_to) {
    list_ForEach(half_damage_toListEntry, type_detail_past_damage_relations_inner_damage_relations->half_damage_to) {
    ...
    // type_detail_past_damage_relations_inner_damage_relations->double_damage_to
    if (!type_detail_past_damage_relations_inner_damage_relations->double_damage_to) {
        goto fail;
    }
    ...
    if (type_detail_past_damage_relations_inner_damage_relations->double_damage_to) {
    list_ForEach(double_damage_toListEntry, type_detail_past_damage_relations_inner_damage_relations->double_damage_to) {
    ...
    // type_detail_past_damage_relations_inner_damage_relations->no_damage_from
    if (!type_detail_past_damage_relations_inner_damage_relations->no_damage_from) {
        goto fail;
    }
    ...
    if (type_detail_past_damage_relations_inner_damage_relations->no_damage_from) {
    list_ForEach(no_damage_fromListEntry, type_detail_past_damage_relations_inner_damage_relations->no_damage_from) {
    ...
    // type_detail_past_damage_relations_inner_damage_relations->half_damage_from
    if (!type_detail_past_damage_relations_inner_damage_relations->half_damage_from) {
        goto fail;
    }
    ...
    if (type_detail_past_damage_relations_inner_damage_relations->half_damage_from) {
    list_ForEach(half_damage_fromListEntry, type_detail_past_damage_relations_inner_damage_relations->half_damage_from) {
    ...
    // type_detail_past_damage_relations_inner_damage_relations->double_damage_from
    if (!type_detail_past_damage_relations_inner_damage_relations->double_damage_from) {
        goto fail;
    }
    ...
    if (type_detail_past_damage_relations_inner_damage_relations->double_damage_from) {
    list_ForEach(double_damage_fromListEntry, type_detail_past_damage_relations_inner_damage_relations->double_damage_from) {
...
type_detail_past_damage_relations_inner_damage_relations_t *type_detail_past_damage_relations_inner_damage_relations_parseFromJSON(cJSON *type_detail_past_damage_relations_inner_damage_relationsJSON){
    ...
    type_detail_past_damage_relations_inner_damage_relations_t *type_detail_past_damage_relations_inner_damage_relations_local_var = NULL;

    // define the local list for type_detail_past_damage_relations_inner_damage_relations->no_damage_to
    list_t *no_damage_toList = NULL;

    // define the local list for type_detail_past_damage_relations_inner_damage_relations->half_damage_to
    list_t *half_damage_toList = NULL;

    // define the local list for type_detail_past_damage_relations_inner_damage_relations->double_damage_to
    list_t *double_damage_toList = NULL;

    // define the local list for type_detail_past_damage_relations_inner_damage_relations->no_damage_from
    list_t *no_damage_fromList = NULL;

    // define the local list for type_detail_past_damage_relations_inner_damage_relations->half_damage_from
    list_t *half_damage_fromList = NULL;

    // define the local list for type_detail_past_damage_relations_inner_damage_relations->double_damage_from
    list_t *double_damage_fromList = NULL;

    // type_detail_past_damage_relations_inner_damage_relations->no_damage_to
    cJSON *no_damage_to = cJSON_GetObjectItemCaseSensitive(type_detail_past_damage_relations_inner_damage_relationsJSON, "no_damage_to");
    ...
    // type_detail_past_damage_relations_inner_damage_relations->half_damage_to
    cJSON *half_damage_to = cJSON_GetObjectItemCaseSensitive(type_detail_past_damage_relations_inner_damage_relationsJSON, "half_damage_to");
    ...
    // type_detail_past_damage_relations_inner_damage_relations->double_damage_to
    cJSON *double_damage_to = cJSON_GetObjectItemCaseSensitive(type_detail_past_damage_relations_inner_damage_relationsJSON, "double_damage_to");
    ...
    // type_detail_past_damage_relations_inner_damage_relations->no_damage_from
    cJSON *no_damage_from = cJSON_GetObjectItemCaseSensitive(type_detail_past_damage_relations_inner_damage_relationsJSON, "no_damage_from");
    ...
    // type_detail_past_damage_relations_inner_damage_relations->half_damage_from
    cJSON *half_damage_from = cJSON_GetObjectItemCaseSensitive(type_detail_past_damage_relations_inner_damage_relationsJSON, "half_damage_from");
    ...
    // type_detail_past_damage_relations_inner_damage_relations->double_damage_from
    cJSON *double_damage_from = cJSON_GetObjectItemCaseSensitive(type_detail_past_damage_relations_inner_damage_relationsJSON, "double_damage_from");
