...
static stat_detail_affecting_moves_t *stat_detail_affecting_moves_create_internal(
    ...
    memset(stat_detail_affecting_moves_local_var, 0, sizeof(stat_detail_affecting_moves_t));
...
__attribute__((deprecated)) stat_detail_affecting_moves_t *stat_detail_affecting_moves_create(
    ...
    stat_detail_affecting_moves_t *result = stat_detail_affecting_moves_create_internal (
        increase,
        decrease
        );
    if (!result) {
