...
static move_learn_method_description_t *move_learn_method_description_create_internal(
    ...
    memset(move_learn_method_description_local_var, 0, sizeof(move_learn_method_description_t));
...
__attribute__((deprecated)) move_learn_method_description_t *move_learn_method_description_create(
    ...
    move_learn_method_description_t *result = move_learn_method_description_create_internal (
        description,
        language
        );
    if (!result) {
