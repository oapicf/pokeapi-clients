...
static characteristic_description_t *characteristic_description_create_internal(
    ...
    memset(characteristic_description_local_var, 0, sizeof(characteristic_description_t));
...
__attribute__((deprecated)) characteristic_description_t *characteristic_description_create(
    ...
    characteristic_description_t *result = characteristic_description_create_internal (
        description,
        language
        );
    if (!result) {
