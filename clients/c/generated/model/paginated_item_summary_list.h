/*
 * paginated_item_summary_list.h
 *
 * 
 */

#ifndef _paginated_item_summary_list_H_
#define _paginated_item_summary_list_H_
...
typedef struct paginated_item_summary_list_t paginated_item_summary_list_t;

#include "item_summary.h"



typedef struct paginated_item_summary_list_t {
    int count; //numeric
    char *next; // string
...
#endif /* _paginated_item_summary_list_H_ */
