...
export class MoveBattleStyleApi extends runtime.BaseAPI {
    ...
    /**
     */
    async moveBattleStyleListRaw(requestParameters: MoveBattleStyleListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async moveBattleStyleList(requestParameters: MoveBattleStyleListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async moveBattleStyleReadRaw(requestParameters: MoveBattleStyleReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async moveBattleStyleRead(requestParameters: MoveBattleStyleReadRequest, initOverrides?: RequestInit): Promise<string> {
