...
export class PalParkAreaApi extends runtime.BaseAPI {
    ...
    /**
     */
    async palParkAreaListRaw(requestParameters: PalParkAreaListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async palParkAreaList(requestParameters: PalParkAreaListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async palParkAreaReadRaw(requestParameters: PalParkAreaReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async palParkAreaRead(requestParameters: PalParkAreaReadRequest, initOverrides?: RequestInit): Promise<string> {
