...
export class LocationAreaApi extends runtime.BaseAPI {
    ...
    /**
     */
    async locationAreaListRaw(requestParameters: LocationAreaListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async locationAreaList(requestParameters: LocationAreaListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async locationAreaReadRaw(requestParameters: LocationAreaReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async locationAreaRead(requestParameters: LocationAreaReadRequest, initOverrides?: RequestInit): Promise<string> {
