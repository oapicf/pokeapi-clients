...
export class EncounterMethodApi extends runtime.BaseAPI {
    ...
    /**
     */
    async encounterMethodListRaw(requestParameters: EncounterMethodListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async encounterMethodList(requestParameters: EncounterMethodListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async encounterMethodReadRaw(requestParameters: EncounterMethodReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async encounterMethodRead(requestParameters: EncounterMethodReadRequest, initOverrides?: RequestInit): Promise<string> {
