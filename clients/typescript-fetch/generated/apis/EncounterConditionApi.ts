...
export class EncounterConditionApi extends runtime.BaseAPI {
    ...
    /**
     */
    async encounterConditionListRaw(requestParameters: EncounterConditionListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async encounterConditionList(requestParameters: EncounterConditionListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async encounterConditionReadRaw(requestParameters: EncounterConditionReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async encounterConditionRead(requestParameters: EncounterConditionReadRequest, initOverrides?: RequestInit): Promise<string> {
