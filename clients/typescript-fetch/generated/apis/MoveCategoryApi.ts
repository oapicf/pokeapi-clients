...
export class MoveCategoryApi extends runtime.BaseAPI {
    ...
    /**
     */
    async moveCategoryListRaw(requestParameters: MoveCategoryListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async moveCategoryList(requestParameters: MoveCategoryListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async moveCategoryReadRaw(requestParameters: MoveCategoryReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async moveCategoryRead(requestParameters: MoveCategoryReadRequest, initOverrides?: RequestInit): Promise<string> {
