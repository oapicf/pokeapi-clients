...
export class StatApi extends runtime.BaseAPI {
    ...
    /**
     */
    async statListRaw(requestParameters: StatListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async statList(requestParameters: StatListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async statReadRaw(requestParameters: StatReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async statRead(requestParameters: StatReadRequest, initOverrides?: RequestInit): Promise<string> {
