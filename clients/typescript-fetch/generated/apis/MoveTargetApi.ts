...
export class MoveTargetApi extends runtime.BaseAPI {
    ...
    /**
     */
    async moveTargetListRaw(requestParameters: MoveTargetListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async moveTargetList(requestParameters: MoveTargetListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async moveTargetReadRaw(requestParameters: MoveTargetReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async moveTargetRead(requestParameters: MoveTargetReadRequest, initOverrides?: RequestInit): Promise<string> {
