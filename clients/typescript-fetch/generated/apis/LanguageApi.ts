...
export class LanguageApi extends runtime.BaseAPI {
    ...
    /**
     */
    async languageListRaw(requestParameters: LanguageListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async languageList(requestParameters: LanguageListRequest = {}, initOverrides?: RequestInit): Promise<string> {
    ...
    /**
     */
    async languageReadRaw(requestParameters: LanguageReadRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>> {
    ...
    /**
     */
    async languageRead(requestParameters: LanguageReadRequest, initOverrides?: RequestInit): Promise<string> {
