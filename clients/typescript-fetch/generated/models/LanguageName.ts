...
/**
 * Check if a given object implements the LanguageName interface.
 */
export function instanceOfLanguageName(value: object): value is LanguageName {
...
export function LanguageNameToJSON(json: any): LanguageName {
    return LanguageNameToJSONTyped(json, false);
}

export function LanguageNameToJSONTyped(value?: LanguageName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
