...
export function TypeDetailPokemonInnerPokemonToJSON(json: any): TypeDetailPokemonInnerPokemon {
    return TypeDetailPokemonInnerPokemonToJSONTyped(json, false);
}

export function TypeDetailPokemonInnerPokemonToJSONTyped(value?: TypeDetailPokemonInnerPokemon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
