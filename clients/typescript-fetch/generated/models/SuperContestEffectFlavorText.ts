...
export function SuperContestEffectFlavorTextFromJSON(json: any): SuperContestEffectFlavorText {
    return SuperContestEffectFlavorTextFromJSONTyped(json, false);
}

export function SuperContestEffectFlavorTextFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuperContestEffectFlavorText {
    if (json == null) {
        return json;
    }
    return {
...
export function SuperContestEffectFlavorTextToJSON(json: any): SuperContestEffectFlavorText {
    return SuperContestEffectFlavorTextToJSONTyped(json, false);
}

export function SuperContestEffectFlavorTextToJSONTyped(value?: SuperContestEffectFlavorText | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
