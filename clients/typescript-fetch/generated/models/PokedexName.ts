...
export function PokedexNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): PokedexName {
    if (json == null) {
        return json;
    }
    return {
...
export function PokedexNameToJSON(json: any): PokedexName {
    return PokedexNameToJSONTyped(json, false);
}

export function PokedexNameToJSONTyped(value?: PokedexName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
