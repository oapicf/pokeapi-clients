...
export function NatureNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): NatureName {
    if (json == null) {
        return json;
    }
    return {
...
export function NatureNameToJSON(json: any): NatureName {
    return NatureNameToJSONTyped(json, false);
}

export function NatureNameToJSONTyped(value?: NatureName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
