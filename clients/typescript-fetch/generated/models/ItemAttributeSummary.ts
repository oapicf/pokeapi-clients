...
export function ItemAttributeSummaryToJSON(json: any): ItemAttributeSummary {
    return ItemAttributeSummaryToJSONTyped(json, false);
}

export function ItemAttributeSummaryToJSONTyped(value?: Omit<ItemAttributeSummary, 'url'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
