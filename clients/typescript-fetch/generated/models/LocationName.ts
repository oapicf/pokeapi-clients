...
/**
 * Check if a given object implements the LocationName interface.
 */
export function instanceOfLocationName(value: object): value is LocationName {
...
export function LocationNameToJSON(json: any): LocationName {
    return LocationNameToJSONTyped(json, false);
}

export function LocationNameToJSONTyped(value?: LocationName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
