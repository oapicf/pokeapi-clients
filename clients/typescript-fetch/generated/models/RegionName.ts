...
export function RegionNameToJSON(json: any): RegionName {
    return RegionNameToJSONTyped(json, false);
}

export function RegionNameToJSONTyped(value?: RegionName | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
