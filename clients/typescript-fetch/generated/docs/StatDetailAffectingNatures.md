...
```typescript
import type { StatDetailAffectingNatures } from ''

// TODO: Update the object below with actual values
const example = {
  "increase": null,
  "decrease": null,
} satisfies StatDetailAffectingNatures
...
const exampleParsed = JSON.parse(exampleJSON) as StatDetailAffectingNatures
