...
const { status, data } = await apiInstance.abilityRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.characteristicRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.eggGroupRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.genderRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.growthRateRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.moveDamageClassRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.natureRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.pokeathlonStatRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.pokemonColorRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.pokemonFormRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.pokemonHabitatRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.pokemonRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.pokemonShapeRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.pokemonSpeciesRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.statRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.typeRetrieve(
    id
);
```
