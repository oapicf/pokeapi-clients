...
const { status, data } = await apiInstance.moveAilmentRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.moveBattleStyleRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.moveCategoryRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.moveLearnMethodRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.moveRetrieve(
    id
);
```
...
const { status, data } = await apiInstance.moveTargetRetrieve(
    id
);
```
