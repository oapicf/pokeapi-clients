...
BerriesApiException::BerriesApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status BerriesApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<PaginatedBerryFirmnessSummaryList>
BerriesApi::berryFirmnessList(
    ...
    std::string path = m_context + "/api/v2/berry-firmness";
    ...
    std::shared_ptr<PaginatedBerryFirmnessSummaryList> deserializedResponse = std::make_shared<PaginatedBerryFirmnessSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedBerryFirmnessSummaryList>>::deserialize(
    ...
    throw BerriesApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<BerryFirmnessDetail>
BerriesApi::berryFirmnessRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/berry-firmness/{id}";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<BerryFirmnessDetail> deserializedResponse = std::make_shared<BerryFirmnessDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BerryFirmnessDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedBerryFlavorSummaryList>
BerriesApi::berryFlavorList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/berry-flavor";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedBerryFlavorSummaryList> deserializedResponse = std::make_shared<PaginatedBerryFlavorSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedBerryFlavorSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<BerryFlavorDetail>
BerriesApi::berryFlavorRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/berry-flavor/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<BerryFlavorDetail> deserializedResponse = std::make_shared<BerryFlavorDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BerryFlavorDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedBerrySummaryList>
BerriesApi::berryList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/berry";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedBerrySummaryList> deserializedResponse = std::make_shared<PaginatedBerrySummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedBerrySummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<BerryDetail>
BerriesApi::berryRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/berry/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<BerryDetail> deserializedResponse = std::make_shared<BerryDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BerryDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string BerriesApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void BerriesApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void BerriesApi::handleStdException(const std::exception&) {
    throw;
}

void BerriesApi::handleUncaughtException() {
    throw;
}
