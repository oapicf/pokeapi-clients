...
LocationApiException::LocationApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status LocationApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<PaginatedLocationAreaSummaryList>
LocationApi::locationAreaList(
    ...
    std::string path = m_context + "/api/v2/location-area";
    ...
    std::shared_ptr<PaginatedLocationAreaSummaryList> deserializedResponse = std::make_shared<PaginatedLocationAreaSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedLocationAreaSummaryList>>::deserialize(
    ...
    throw LocationApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<LocationAreaDetail>
LocationApi::locationAreaRetrieve(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/location-area/{id}";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<LocationAreaDetail> deserializedResponse = std::make_shared<LocationAreaDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<LocationAreaDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedLocationSummaryList>
LocationApi::locationList(
    ...
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/location";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedLocationSummaryList> deserializedResponse = std::make_shared<PaginatedLocationSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedLocationSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<LocationDetail>
LocationApi::locationRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/location/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<LocationDetail> deserializedResponse = std::make_shared<LocationDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<LocationDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedPalParkAreaSummaryList>
LocationApi::palParkAreaList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/pal-park-area";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedPalParkAreaSummaryList> deserializedResponse = std::make_shared<PaginatedPalParkAreaSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedPalParkAreaSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PalParkAreaDetail>
LocationApi::palParkAreaRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/pal-park-area/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<PalParkAreaDetail> deserializedResponse = std::make_shared<PalParkAreaDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PalParkAreaDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedRegionSummaryList>
LocationApi::regionList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/region";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedRegionSummaryList> deserializedResponse = std::make_shared<PaginatedRegionSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedRegionSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<RegionDetail>
LocationApi::regionRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/region/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<RegionDetail> deserializedResponse = std::make_shared<RegionDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<RegionDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string LocationApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void LocationApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void LocationApi::handleStdException(const std::exception&) {
    throw;
}

void LocationApi::handleUncaughtException() {
    throw;
}
