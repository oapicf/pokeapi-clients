...
EvolutionApiException::EvolutionApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status EvolutionApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<PaginatedEvolutionChainSummaryList>
EvolutionApi::evolutionChainList(
    ...
    std::string path = m_context + "/api/v2/evolution-chain";
    ...
    std::shared_ptr<PaginatedEvolutionChainSummaryList> deserializedResponse = std::make_shared<PaginatedEvolutionChainSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedEvolutionChainSummaryList>>::deserialize(
    ...
    throw EvolutionApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<EvolutionChainDetail>
EvolutionApi::evolutionChainRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/evolution-chain/{id}";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<EvolutionChainDetail> deserializedResponse = std::make_shared<EvolutionChainDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<EvolutionChainDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedEvolutionTriggerSummaryList>
EvolutionApi::evolutionTriggerList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/evolution-trigger";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedEvolutionTriggerSummaryList> deserializedResponse = std::make_shared<PaginatedEvolutionTriggerSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedEvolutionTriggerSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<EvolutionTriggerDetail>
EvolutionApi::evolutionTriggerRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/evolution-trigger/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<EvolutionTriggerDetail> deserializedResponse = std::make_shared<EvolutionTriggerDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<EvolutionTriggerDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string EvolutionApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void EvolutionApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void EvolutionApi::handleStdException(const std::exception&) {
    throw;
}

void EvolutionApi::handleUncaughtException() {
    throw;
}
