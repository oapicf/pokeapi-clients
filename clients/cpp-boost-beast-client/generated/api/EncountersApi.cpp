...
EncountersApiException::EncountersApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status EncountersApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<PaginatedEncounterConditionSummaryList>
EncountersApi::encounterConditionList(
    ...
    std::string path = m_context + "/api/v2/encounter-condition";
    ...
    std::shared_ptr<PaginatedEncounterConditionSummaryList> deserializedResponse = std::make_shared<PaginatedEncounterConditionSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedEncounterConditionSummaryList>>::deserialize(
    ...
    throw EncountersApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<EncounterConditionDetail>
EncountersApi::encounterConditionRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/encounter-condition/{id}";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<EncounterConditionDetail> deserializedResponse = std::make_shared<EncounterConditionDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<EncounterConditionDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedEncounterConditionValueSummaryList>
EncountersApi::encounterConditionValueList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/encounter-condition-value";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedEncounterConditionValueSummaryList> deserializedResponse = std::make_shared<PaginatedEncounterConditionValueSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedEncounterConditionValueSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<EncounterConditionValueDetail>
EncountersApi::encounterConditionValueRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/encounter-condition-value/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<EncounterConditionValueDetail> deserializedResponse = std::make_shared<EncounterConditionValueDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<EncounterConditionValueDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedEncounterMethodSummaryList>
EncountersApi::encounterMethodList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/encounter-method";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedEncounterMethodSummaryList> deserializedResponse = std::make_shared<PaginatedEncounterMethodSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedEncounterMethodSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<EncounterMethodDetail>
EncountersApi::encounterMethodRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/encounter-method/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<EncounterMethodDetail> deserializedResponse = std::make_shared<EncounterMethodDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<EncounterMethodDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string EncountersApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void EncountersApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void EncountersApi::handleStdException(const std::exception&) {
    throw;
}

void EncountersApi::handleUncaughtException() {
    throw;
}
