...
ContestsApiException::ContestsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status ContestsApiException::getStatus() const
{
    return m_status;
}
...
std::shared_ptr<PaginatedContestEffectSummaryList>
ContestsApi::contestEffectList(
    ...
    std::string path = m_context + "/api/v2/contest-effect";
    ...
    std::shared_ptr<PaginatedContestEffectSummaryList> deserializedResponse = std::make_shared<PaginatedContestEffectSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedContestEffectSummaryList>>::deserialize(
    ...
    throw ContestsApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<ContestEffectDetail>
ContestsApi::contestEffectRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/contest-effect/{id}";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<ContestEffectDetail> deserializedResponse = std::make_shared<ContestEffectDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ContestEffectDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedContestTypeSummaryList>
ContestsApi::contestTypeList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/contest-type";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedContestTypeSummaryList> deserializedResponse = std::make_shared<PaginatedContestTypeSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedContestTypeSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<ContestTypeDetail>
ContestsApi::contestTypeRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/contest-type/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<ContestTypeDetail> deserializedResponse = std::make_shared<ContestTypeDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ContestTypeDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PaginatedSuperContestEffectSummaryList>
ContestsApi::superContestEffectList(
    const boost::optional<int32_t>& limit, const boost::optional<int32_t>& offset, const boost::optional<std::string>& q) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/super-contest-effect";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<PaginatedSuperContestEffectSummaryList> deserializedResponse = std::make_shared<PaginatedSuperContestEffectSummaryList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PaginatedSuperContestEffectSummaryList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<SuperContestEffectDetail>
ContestsApi::superContestEffectRetrieve(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/api/v2/super-contest-effect/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<SuperContestEffectDetail> deserializedResponse = std::make_shared<SuperContestEffectDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<SuperContestEffectDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string ContestsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void ContestsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void ContestsApi::handleStdException(const std::exception&) {
    throw;
}

void ContestsApi::handleUncaughtException() {
    throw;
}
