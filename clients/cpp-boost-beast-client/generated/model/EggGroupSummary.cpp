...
EggGroupSummary::EggGroupSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EggGroupSummary::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value EggGroupSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EggGroupSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EggGroupSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EggGroupSummary::toJsonObject_internal() const
{
...
void EggGroupSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EggGroupSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EggGroupSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EggGroupSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EggGroupSummary>>>::fromJsonValue(boost::json::parse(json));
}
