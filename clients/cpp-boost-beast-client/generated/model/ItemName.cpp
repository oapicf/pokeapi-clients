...
ItemName::ItemName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemName::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemName::toJsonObject_internal() const
{
...
void ItemName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> ItemName::getLanguage() const
{
    return m_Language;
}

void ItemName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemName>>>::fromJsonValue(boost::json::parse(json));
}
