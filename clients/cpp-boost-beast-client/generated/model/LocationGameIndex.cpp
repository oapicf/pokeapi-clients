...
LocationGameIndex::LocationGameIndex(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LocationGameIndex::toJsonString(bool prettyJson /* = false */) const
{
...
void LocationGameIndex::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LocationGameIndex::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LocationGameIndex::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LocationGameIndex");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LocationGameIndex::toJsonObject_internal() const
{
...
void LocationGameIndex::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void LocationGameIndex::setGeneration(std::shared_ptr<GenerationSummary> value)
{
    
    m_Generation = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LocationGameIndex>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LocationGameIndex>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LocationGameIndex>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LocationGameIndex>>>::fromJsonValue(boost::json::parse(json));
}
