...
RegionName::RegionName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string RegionName::toJsonString(bool prettyJson /* = false */) const
{
...
void RegionName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value RegionName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void RegionName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for RegionName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object RegionName::toJsonObject_internal() const
{
...
void RegionName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void RegionName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> RegionName::getLanguage() const
{
    return m_Language;
}

void RegionName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<RegionName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<RegionName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<RegionName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<RegionName>>>::fromJsonValue(boost::json::parse(json));
}
