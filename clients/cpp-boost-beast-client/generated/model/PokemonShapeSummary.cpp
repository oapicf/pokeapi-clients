...
PokemonShapeSummary::PokemonShapeSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonShapeSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonShapeSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonShapeSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonShapeSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonShapeSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonShapeSummary::toJsonObject_internal() const
{
...
void PokemonShapeSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokemonShapeSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string PokemonShapeSummary::getUrl() const
{
    return m_Url;
}

void PokemonShapeSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonShapeSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonShapeSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonShapeSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonShapeSummary>>>::fromJsonValue(boost::json::parse(json));
}
