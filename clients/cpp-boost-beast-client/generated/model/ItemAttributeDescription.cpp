...
ItemAttributeDescription::ItemAttributeDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemAttributeDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemAttributeDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemAttributeDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemAttributeDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemAttributeDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemAttributeDescription::toJsonObject_internal() const
{
...
void ItemAttributeDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void ItemAttributeDescription::setDescription(std::string value)
{
    
    m_Description = std::move(value);
    m_DescriptionIsSet = true;
}
std::shared_ptr<LanguageSummary> ItemAttributeDescription::getLanguage() const
{
    return m_Language;
}

void ItemAttributeDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemAttributeDescription>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemAttributeDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemAttributeDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemAttributeDescription>>>::fromJsonValue(boost::json::parse(json));
}
