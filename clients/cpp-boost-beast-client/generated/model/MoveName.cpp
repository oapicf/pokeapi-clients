...
MoveName::MoveName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveName::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveName::toJsonObject_internal() const
{
...
void MoveName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> MoveName::getLanguage() const
{
    return m_Language;
}

void MoveName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveName>>>::fromJsonValue(boost::json::parse(json));
}
