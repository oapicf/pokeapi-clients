...
MoveTargetDescription::MoveTargetDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveTargetDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveTargetDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveTargetDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveTargetDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveTargetDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveTargetDescription::toJsonObject_internal() const
{
...
void MoveTargetDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void MoveTargetDescription::setDescription(std::string value)
{
    
    m_Description = std::move(value);
    m_DescriptionIsSet = true;
}
std::shared_ptr<LanguageSummary> MoveTargetDescription::getLanguage() const
{
    return m_Language;
}

void MoveTargetDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveTargetDescription>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveTargetDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveTargetDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveTargetDescription>>>::fromJsonValue(boost::json::parse(json));
}
