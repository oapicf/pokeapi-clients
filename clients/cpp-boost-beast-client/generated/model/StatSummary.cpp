...
StatSummary::StatSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string StatSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void StatSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value StatSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void StatSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for StatSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object StatSummary::toJsonObject_internal() const
{
...
void StatSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void StatSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string StatSummary::getUrl() const
{
    return m_Url;
}

void StatSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<StatSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<StatSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<StatSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<StatSummary>>>::fromJsonValue(boost::json::parse(json));
}
