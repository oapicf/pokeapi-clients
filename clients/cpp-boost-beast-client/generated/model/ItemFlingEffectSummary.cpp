...
ItemFlingEffectSummary::ItemFlingEffectSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemFlingEffectSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemFlingEffectSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemFlingEffectSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemFlingEffectSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemFlingEffectSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemFlingEffectSummary::toJsonObject_internal() const
{
...
void ItemFlingEffectSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemFlingEffectSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string ItemFlingEffectSummary::getUrl() const
{
    return m_Url;
}

void ItemFlingEffectSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemFlingEffectSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemFlingEffectSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemFlingEffectSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemFlingEffectSummary>>>::fromJsonValue(boost::json::parse(json));
}
