...
PokemonColorSummary::PokemonColorSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonColorSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonColorSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonColorSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonColorSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonColorSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonColorSummary::toJsonObject_internal() const
{
...
void PokemonColorSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokemonColorSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string PokemonColorSummary::getUrl() const
{
    return m_Url;
}

void PokemonColorSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonColorSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonColorSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonColorSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonColorSummary>>>::fromJsonValue(boost::json::parse(json));
}
