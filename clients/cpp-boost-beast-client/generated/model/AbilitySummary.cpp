...
AbilitySummary::AbilitySummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AbilitySummary::toJsonString(bool prettyJson /* = false */) const
{
...
void AbilitySummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AbilitySummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AbilitySummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AbilitySummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AbilitySummary::toJsonObject_internal() const
{
...
void AbilitySummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void AbilitySummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string AbilitySummary::getUrl() const
{
    return m_Url;
}

void AbilitySummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AbilitySummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AbilitySummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AbilitySummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AbilitySummary>>>::fromJsonValue(boost::json::parse(json));
}
