...
LanguageName::LanguageName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LanguageName::toJsonString(bool prettyJson /* = false */) const
{
...
void LanguageName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LanguageName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LanguageName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LanguageName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LanguageName::toJsonObject_internal() const
{
...
void LanguageName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void LanguageName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> LanguageName::getLanguage() const
{
    return m_Language;
}

void LanguageName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LanguageName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LanguageName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LanguageName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LanguageName>>>::fromJsonValue(boost::json::parse(json));
}
