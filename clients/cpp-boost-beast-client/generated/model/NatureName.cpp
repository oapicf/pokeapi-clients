...
NatureName::NatureName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NatureName::toJsonString(bool prettyJson /* = false */) const
{
...
void NatureName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value NatureName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NatureName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NatureName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NatureName::toJsonObject_internal() const
{
...
void NatureName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void NatureName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> NatureName::getLanguage() const
{
    return m_Language;
}

void NatureName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<NatureName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NatureName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NatureName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NatureName>>>::fromJsonValue(boost::json::parse(json));
}
