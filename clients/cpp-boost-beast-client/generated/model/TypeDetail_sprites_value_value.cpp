...
TypeDetail_sprites_value_value::TypeDetail_sprites_value_value(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TypeDetail_sprites_value_value::toJsonString(bool prettyJson /* = false */) const
{
...
void TypeDetail_sprites_value_value::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TypeDetail_sprites_value_value::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TypeDetail_sprites_value_value::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TypeDetail_sprites_value_value");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TypeDetail_sprites_value_value::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Name_iconIsSet) {
            object["name-icon"] = JsonValueConverter<std::string>::toJsonValue(getNameIcon());
        }
    return object;
}

void TypeDetail_sprites_value_value::fromJsonObject_internal(boost::json::object const& object)
{
    m_Name_iconIsSet = false;
    {
        const auto Name_iconIt = object.find("name-icon");
        if (Name_iconIt != object.end()) {
            setNameIcon(JsonValueConverter<std::string>::fromJsonValue(Name_iconIt->value()));
        }
    }
}
...
void TypeDetail_sprites_value_value::setNameIcon(std::string value)
{
    
    m_Name_icon = std::move(value);
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TypeDetail_sprites_value_value>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TypeDetail_sprites_value_value>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TypeDetail_sprites_value_value>>>::fromJsonValue(boost::json::parse(json));
}
