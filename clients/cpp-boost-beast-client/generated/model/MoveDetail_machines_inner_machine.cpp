...
MoveDetail_machines_inner_machine::MoveDetail_machines_inner_machine(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveDetail_machines_inner_machine::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveDetail_machines_inner_machine::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveDetail_machines_inner_machine::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveDetail_machines_inner_machine::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveDetail_machines_inner_machine");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveDetail_machines_inner_machine::toJsonObject_internal() const
{
...
void MoveDetail_machines_inner_machine::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveDetail_machines_inner_machine::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveDetail_machines_inner_machine>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveDetail_machines_inner_machine>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveDetail_machines_inner_machine>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveDetail_machines_inner_machine>>>::fromJsonValue(boost::json::parse(json));
}
