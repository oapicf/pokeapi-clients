...
StatName::StatName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string StatName::toJsonString(bool prettyJson /* = false */) const
{
...
void StatName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value StatName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void StatName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for StatName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object StatName::toJsonObject_internal() const
{
...
void StatName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void StatName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> StatName::getLanguage() const
{
    return m_Language;
}

void StatName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<StatName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<StatName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<StatName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<StatName>>>::fromJsonValue(boost::json::parse(json));
}
