...
PokemonHabitatSummary::PokemonHabitatSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonHabitatSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonHabitatSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonHabitatSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonHabitatSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonHabitatSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonHabitatSummary::toJsonObject_internal() const
{
...
void PokemonHabitatSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokemonHabitatSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string PokemonHabitatSummary::getUrl() const
{
    return m_Url;
}

void PokemonHabitatSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonHabitatSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonHabitatSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonHabitatSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonHabitatSummary>>>::fromJsonValue(boost::json::parse(json));
}
