...
ItemGameIndex::ItemGameIndex(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemGameIndex::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ItemGameIndex::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemGameIndex::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemGameIndex");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemGameIndex::toJsonObject_internal() const
{
...
void ItemGameIndex::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemGameIndex>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemGameIndex>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemGameIndex>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemGameIndex>>>::fromJsonValue(boost::json::parse(json));
}
