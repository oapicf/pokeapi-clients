...
MoveDamageClassSummary::MoveDamageClassSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveDamageClassSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveDamageClassSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveDamageClassSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveDamageClassSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveDamageClassSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveDamageClassSummary::toJsonObject_internal() const
{
...
void MoveDamageClassSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveDamageClassSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string MoveDamageClassSummary::getUrl() const
{
    return m_Url;
}

void MoveDamageClassSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveDamageClassSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveDamageClassSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveDamageClassSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveDamageClassSummary>>>::fromJsonValue(boost::json::parse(json));
}
