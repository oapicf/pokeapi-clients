...
PokemonDetail_cries::PokemonDetail_cries(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonDetail_cries::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonDetail_cries::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonDetail_cries::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonDetail_cries::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonDetail_cries");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonDetail_cries::toJsonObject_internal() const
{
    boost::json::object object;
        object["latest"] = JsonValueConverter<std::string>::toJsonValue(getLatest());
        object["legacy"] = JsonValueConverter<std::string>::toJsonValue(getLegacy());
    return object;
}

void PokemonDetail_cries::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto LatestIt = object.find("latest");
        if (LatestIt != object.end()) {
            setLatest(JsonValueConverter<std::string>::fromJsonValue(LatestIt->value()));
        }
    }
    {
        const auto LegacyIt = object.find("legacy");
        if (LegacyIt != object.end()) {
            setLegacy(JsonValueConverter<std::string>::fromJsonValue(LegacyIt->value()));
        }
    }
}
...
void PokemonDetail_cries::setLatest(std::string value)
{
...
void PokemonDetail_cries::setLegacy(std::string value)
{
    
    m_Legacy = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonDetail_cries>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonDetail_cries>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonDetail_cries>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonDetail_cries>>>::fromJsonValue(boost::json::parse(json));
}
