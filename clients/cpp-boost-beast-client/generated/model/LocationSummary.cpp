...
LocationSummary::LocationSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LocationSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void LocationSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LocationSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LocationSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LocationSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LocationSummary::toJsonObject_internal() const
{
...
void LocationSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void LocationSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string LocationSummary::getUrl() const
{
    return m_Url;
}

void LocationSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LocationSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LocationSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LocationSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LocationSummary>>>::fromJsonValue(boost::json::parse(json));
}
