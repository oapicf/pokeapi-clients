...
VersionDetail::VersionDetail(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value VersionDetail::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VersionDetail::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VersionDetail");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VersionDetail::toJsonObject_internal() const
{
    boost::json::object object;
        object["id"] = JsonValueConverter<int32_t>::toJsonValue(getId());
        object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
        object["names"] = JsonValueConverter<std::vector<std::shared_ptr<VersionName>>>::toJsonValue(getNames());
        object["version_group"] = JsonValueConverter<std::shared_ptr<VersionGroupSummary>>::toJsonValue(getVersionGroup());
    return object;
}

void VersionDetail::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (NamesIt != object.end()) {
            setNames(JsonValueConverter<std::vector<std::shared_ptr<VersionName>>>::fromJsonValue(NamesIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VersionDetail>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VersionDetail>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VersionDetail>>>::fromJsonValue(boost::json::parse(json));
}
