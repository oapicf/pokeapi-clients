...
MoveBattleStyleSummary::MoveBattleStyleSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveBattleStyleSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveBattleStyleSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveBattleStyleSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveBattleStyleSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveBattleStyleSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveBattleStyleSummary::toJsonObject_internal() const
{
...
void MoveBattleStyleSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveBattleStyleSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string MoveBattleStyleSummary::getUrl() const
{
    return m_Url;
}

void MoveBattleStyleSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveBattleStyleSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveBattleStyleSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveBattleStyleSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveBattleStyleSummary>>>::fromJsonValue(boost::json::parse(json));
}
