...
BerryFlavorName::BerryFlavorName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BerryFlavorName::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value BerryFlavorName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BerryFlavorName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BerryFlavorName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BerryFlavorName::toJsonObject_internal() const
{
...
void BerryFlavorName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BerryFlavorName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BerryFlavorName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BerryFlavorName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BerryFlavorName>>>::fromJsonValue(boost::json::parse(json));
}
