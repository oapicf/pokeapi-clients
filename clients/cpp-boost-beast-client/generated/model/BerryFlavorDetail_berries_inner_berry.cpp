...
BerryFlavorDetail_berries_inner_berry::BerryFlavorDetail_berries_inner_berry(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BerryFlavorDetail_berries_inner_berry::toJsonString(bool prettyJson /* = false */) const
{
...
void BerryFlavorDetail_berries_inner_berry::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BerryFlavorDetail_berries_inner_berry::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BerryFlavorDetail_berries_inner_berry::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BerryFlavorDetail_berries_inner_berry");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BerryFlavorDetail_berries_inner_berry::toJsonObject_internal() const
{
...
void BerryFlavorDetail_berries_inner_berry::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_UrlIsSet = false;
    {
...
void BerryFlavorDetail_berries_inner_berry::setName(std::string value)
{
...
void BerryFlavorDetail_berries_inner_berry::setUrl(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BerryFlavorDetail_berries_inner_berry>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BerryFlavorDetail_berries_inner_berry>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BerryFlavorDetail_berries_inner_berry>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BerryFlavorDetail_berries_inner_berry>>>::fromJsonValue(boost::json::parse(json));
}
