...
ContestEffectEffectText::ContestEffectEffectText(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ContestEffectEffectText::toJsonString(bool prettyJson /* = false */) const
{
...
void ContestEffectEffectText::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ContestEffectEffectText::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ContestEffectEffectText::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ContestEffectEffectText");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ContestEffectEffectText::toJsonObject_internal() const
{
...
void ContestEffectEffectText::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ContestEffectEffectText::setEffect(std::string value)
{
    
    m_Effect = std::move(value);
}
std::shared_ptr<LanguageSummary> ContestEffectEffectText::getLanguage() const
{
    return m_Language;
}

void ContestEffectEffectText::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ContestEffectEffectText>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ContestEffectEffectText>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ContestEffectEffectText>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ContestEffectEffectText>>>::fromJsonValue(boost::json::parse(json));
}
