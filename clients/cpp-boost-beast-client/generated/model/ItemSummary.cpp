...
ItemSummary::ItemSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemSummary::toJsonObject_internal() const
{
...
void ItemSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string ItemSummary::getUrl() const
{
    return m_Url;
}

void ItemSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemSummary>>>::fromJsonValue(boost::json::parse(json));
}
