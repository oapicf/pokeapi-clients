...
BerryDetail_flavors_inner_flavor::BerryDetail_flavors_inner_flavor(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BerryDetail_flavors_inner_flavor::toJsonString(bool prettyJson /* = false */) const
{
...
void BerryDetail_flavors_inner_flavor::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BerryDetail_flavors_inner_flavor::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BerryDetail_flavors_inner_flavor::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BerryDetail_flavors_inner_flavor");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BerryDetail_flavors_inner_flavor::toJsonObject_internal() const
{
...
void BerryDetail_flavors_inner_flavor::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_UrlIsSet = false;
    {
...
void BerryDetail_flavors_inner_flavor::setName(std::string value)
{
...
void BerryDetail_flavors_inner_flavor::setUrl(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BerryDetail_flavors_inner_flavor>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BerryDetail_flavors_inner_flavor>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BerryDetail_flavors_inner_flavor>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BerryDetail_flavors_inner_flavor>>>::fromJsonValue(boost::json::parse(json));
}
