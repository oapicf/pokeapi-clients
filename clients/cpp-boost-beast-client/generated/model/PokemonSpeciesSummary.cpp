...
PokemonSpeciesSummary::PokemonSpeciesSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonSpeciesSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonSpeciesSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonSpeciesSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonSpeciesSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonSpeciesSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonSpeciesSummary::toJsonObject_internal() const
{
...
void PokemonSpeciesSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokemonSpeciesSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string PokemonSpeciesSummary::getUrl() const
{
    return m_Url;
}

void PokemonSpeciesSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonSpeciesSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonSpeciesSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonSpeciesSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonSpeciesSummary>>>::fromJsonValue(boost::json::parse(json));
}
