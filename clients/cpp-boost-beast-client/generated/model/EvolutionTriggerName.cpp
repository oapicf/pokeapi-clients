...
EvolutionTriggerName::EvolutionTriggerName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EvolutionTriggerName::toJsonString(bool prettyJson /* = false */) const
{
...
void EvolutionTriggerName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EvolutionTriggerName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EvolutionTriggerName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EvolutionTriggerName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EvolutionTriggerName::toJsonObject_internal() const
{
...
void EvolutionTriggerName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void EvolutionTriggerName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> EvolutionTriggerName::getLanguage() const
{
    return m_Language;
}

void EvolutionTriggerName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EvolutionTriggerName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EvolutionTriggerName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EvolutionTriggerName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EvolutionTriggerName>>>::fromJsonValue(boost::json::parse(json));
}
