...
EncounterMethodDetail::EncounterMethodDetail(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EncounterMethodDetail::toJsonString(bool prettyJson /* = false */) const
{
...
void EncounterMethodDetail::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EncounterMethodDetail::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EncounterMethodDetail::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EncounterMethodDetail");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EncounterMethodDetail::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["names"] = JsonValueConverter<std::vector<std::shared_ptr<EncounterMethodName>>>::toJsonValue(getNames());
    return object;
}

void EncounterMethodDetail::fromJsonObject_internal(boost::json::object const& object)
{
    m_OrderIsSet = false;
    {
    ...
    }
    {
        ...
        if (NamesIt != object.end()) {
            setNames(JsonValueConverter<std::vector<std::shared_ptr<EncounterMethodName>>>::fromJsonValue(NamesIt->value()));
        }
    }
}
...
void EncounterMethodDetail::setName(std::string value)
{
...
void EncounterMethodDetail::setNames(std::vector<std::shared_ptr<EncounterMethodName>> value)
{
    
    m_Names = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EncounterMethodDetail>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EncounterMethodDetail>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EncounterMethodDetail>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EncounterMethodDetail>>>::fromJsonValue(boost::json::parse(json));
}
