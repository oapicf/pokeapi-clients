...
MoveBattleStyleName::MoveBattleStyleName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveBattleStyleName::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MoveBattleStyleName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveBattleStyleName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveBattleStyleName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveBattleStyleName::toJsonObject_internal() const
{
...
void MoveBattleStyleName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveBattleStyleName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveBattleStyleName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveBattleStyleName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveBattleStyleName>>>::fromJsonValue(boost::json::parse(json));
}
