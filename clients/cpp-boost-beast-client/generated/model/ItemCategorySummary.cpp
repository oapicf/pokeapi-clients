...
ItemCategorySummary::ItemCategorySummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemCategorySummary::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemCategorySummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemCategorySummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemCategorySummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemCategorySummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemCategorySummary::toJsonObject_internal() const
{
...
void ItemCategorySummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemCategorySummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string ItemCategorySummary::getUrl() const
{
    return m_Url;
}

void ItemCategorySummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemCategorySummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemCategorySummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemCategorySummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemCategorySummary>>>::fromJsonValue(boost::json::parse(json));
}
