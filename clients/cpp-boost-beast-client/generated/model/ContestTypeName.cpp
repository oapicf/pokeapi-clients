...
ContestTypeName::ContestTypeName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ContestTypeName::toJsonString(bool prettyJson /* = false */) const
{
...
void ContestTypeName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ContestTypeName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ContestTypeName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ContestTypeName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ContestTypeName::toJsonObject_internal() const
{
...
void ContestTypeName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ContestTypeName::setName(std::string value)
{
...
void ContestTypeName::setColor(std::string value)
{
...
void ContestTypeName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ContestTypeName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ContestTypeName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ContestTypeName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ContestTypeName>>>::fromJsonValue(boost::json::parse(json));
}
