...
GrowthRateSummary::GrowthRateSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GrowthRateSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void GrowthRateSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GrowthRateSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GrowthRateSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GrowthRateSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GrowthRateSummary::toJsonObject_internal() const
{
...
void GrowthRateSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void GrowthRateSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string GrowthRateSummary::getUrl() const
{
    return m_Url;
}

void GrowthRateSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GrowthRateSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GrowthRateSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GrowthRateSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GrowthRateSummary>>>::fromJsonValue(boost::json::parse(json));
}
