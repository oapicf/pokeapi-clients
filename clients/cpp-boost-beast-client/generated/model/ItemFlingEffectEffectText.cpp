...
ItemFlingEffectEffectText::ItemFlingEffectEffectText(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemFlingEffectEffectText::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemFlingEffectEffectText::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemFlingEffectEffectText::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemFlingEffectEffectText::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemFlingEffectEffectText");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemFlingEffectEffectText::toJsonObject_internal() const
{
...
void ItemFlingEffectEffectText::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemFlingEffectEffectText::setEffect(std::string value)
{
    
    m_Effect = std::move(value);
}
std::shared_ptr<LanguageSummary> ItemFlingEffectEffectText::getLanguage() const
{
    return m_Language;
}

void ItemFlingEffectEffectText::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemFlingEffectEffectText>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemFlingEffectEffectText>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemFlingEffectEffectText>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemFlingEffectEffectText>>>::fromJsonValue(boost::json::parse(json));
}
