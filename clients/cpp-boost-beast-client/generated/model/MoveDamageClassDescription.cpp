...
MoveDamageClassDescription::MoveDamageClassDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveDamageClassDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveDamageClassDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveDamageClassDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveDamageClassDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveDamageClassDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveDamageClassDescription::toJsonObject_internal() const
{
...
void MoveDamageClassDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void MoveDamageClassDescription::setDescription(std::string value)
{
    
    m_Description = std::move(value);
    m_DescriptionIsSet = true;
}
std::shared_ptr<LanguageSummary> MoveDamageClassDescription::getLanguage() const
{
    return m_Language;
}

void MoveDamageClassDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveDamageClassDescription>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveDamageClassDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveDamageClassDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveDamageClassDescription>>>::fromJsonValue(boost::json::parse(json));
}
