...
PokemonShapeDetail_names_inner::PokemonShapeDetail_names_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonShapeDetail_names_inner::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PokemonShapeDetail_names_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonShapeDetail_names_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonShapeDetail_names_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonShapeDetail_names_inner::toJsonObject_internal() const
{
...
void PokemonShapeDetail_names_inner::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonShapeDetail_names_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonShapeDetail_names_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonShapeDetail_names_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonShapeDetail_names_inner>>>::fromJsonValue(boost::json::parse(json));
}
