...
MoveBattleStyleDetail::MoveBattleStyleDetail(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveBattleStyleDetail::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveBattleStyleDetail::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveBattleStyleDetail::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveBattleStyleDetail::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveBattleStyleDetail");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveBattleStyleDetail::toJsonObject_internal() const
{
    boost::json::object object;
        object["id"] = JsonValueConverter<int32_t>::toJsonValue(getId());
        object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
        object["names"] = JsonValueConverter<std::vector<std::shared_ptr<MoveBattleStyleName>>>::toJsonValue(getNames());
    return object;
}

void MoveBattleStyleDetail::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (NamesIt != object.end()) {
            setNames(JsonValueConverter<std::vector<std::shared_ptr<MoveBattleStyleName>>>::fromJsonValue(NamesIt->value()));
        }
    }
}
...
void MoveBattleStyleDetail::setName(std::string value)
{
...
void MoveBattleStyleDetail::setNames(std::vector<std::shared_ptr<MoveBattleStyleName>> value)
{
    
    m_Names = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveBattleStyleDetail>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveBattleStyleDetail>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveBattleStyleDetail>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveBattleStyleDetail>>>::fromJsonValue(boost::json::parse(json));
}
