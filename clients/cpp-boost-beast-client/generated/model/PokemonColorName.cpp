...
PokemonColorName::PokemonColorName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonColorName::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PokemonColorName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonColorName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonColorName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonColorName::toJsonObject_internal() const
{
...
void PokemonColorName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonColorName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonColorName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonColorName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonColorName>>>::fromJsonValue(boost::json::parse(json));
}
