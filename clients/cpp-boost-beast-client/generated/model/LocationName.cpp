...
LocationName::LocationName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LocationName::toJsonString(bool prettyJson /* = false */) const
{
...
void LocationName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LocationName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LocationName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LocationName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LocationName::toJsonObject_internal() const
{
...
void LocationName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void LocationName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> LocationName::getLanguage() const
{
    return m_Language;
}

void LocationName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LocationName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LocationName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LocationName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LocationName>>>::fromJsonValue(boost::json::parse(json));
}
