...
ItemFlavorText::ItemFlavorText(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ItemFlavorText::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemFlavorText::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemFlavorText");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemFlavorText::toJsonObject_internal() const
{
...
void ItemFlavorText::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemFlavorText>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemFlavorText>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemFlavorText>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemFlavorText>>>::fromJsonValue(boost::json::parse(json));
}
