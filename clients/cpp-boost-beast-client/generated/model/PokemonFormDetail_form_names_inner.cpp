...
PokemonFormDetail_form_names_inner::PokemonFormDetail_form_names_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonFormDetail_form_names_inner::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PokemonFormDetail_form_names_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonFormDetail_form_names_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonFormDetail_form_names_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonFormDetail_form_names_inner::toJsonObject_internal() const
{
...
void PokemonFormDetail_form_names_inner::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonFormDetail_form_names_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonFormDetail_form_names_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonFormDetail_form_names_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonFormDetail_form_names_inner>>>::fromJsonValue(boost::json::parse(json));
}
