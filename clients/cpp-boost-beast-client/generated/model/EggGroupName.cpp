...
EggGroupName::EggGroupName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EggGroupName::toJsonString(bool prettyJson /* = false */) const
{
...
void EggGroupName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EggGroupName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EggGroupName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EggGroupName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EggGroupName::toJsonObject_internal() const
{
...
void EggGroupName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void EggGroupName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> EggGroupName::getLanguage() const
{
    return m_Language;
}

void EggGroupName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EggGroupName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EggGroupName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EggGroupName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EggGroupName>>>::fromJsonValue(boost::json::parse(json));
}
