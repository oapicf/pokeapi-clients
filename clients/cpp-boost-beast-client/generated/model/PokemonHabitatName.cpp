...
PokemonHabitatName::PokemonHabitatName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonHabitatName::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonHabitatName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonHabitatName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonHabitatName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonHabitatName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonHabitatName::toJsonObject_internal() const
{
...
void PokemonHabitatName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokemonHabitatName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> PokemonHabitatName::getLanguage() const
{
    return m_Language;
}

void PokemonHabitatName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonHabitatName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonHabitatName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonHabitatName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonHabitatName>>>::fromJsonValue(boost::json::parse(json));
}
