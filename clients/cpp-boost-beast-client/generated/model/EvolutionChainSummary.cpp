...
EvolutionChainSummary::EvolutionChainSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EvolutionChainSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void EvolutionChainSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EvolutionChainSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EvolutionChainSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EvolutionChainSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EvolutionChainSummary::toJsonObject_internal() const
{
...
void EvolutionChainSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string EvolutionChainSummary::getUrl() const
{
    return m_Url;
}

void EvolutionChainSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EvolutionChainSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EvolutionChainSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EvolutionChainSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EvolutionChainSummary>>>::fromJsonValue(boost::json::parse(json));
}
