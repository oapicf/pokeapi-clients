...
SuperContestEffectFlavorText::SuperContestEffectFlavorText(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SuperContestEffectFlavorText::toJsonString(bool prettyJson /* = false */) const
{
...
void SuperContestEffectFlavorText::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SuperContestEffectFlavorText::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SuperContestEffectFlavorText::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SuperContestEffectFlavorText");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SuperContestEffectFlavorText::toJsonObject_internal() const
{
...
void SuperContestEffectFlavorText::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void SuperContestEffectFlavorText::setFlavorText(std::string value)
{
    
    m_Flavor_text = std::move(value);
}
std::shared_ptr<LanguageSummary> SuperContestEffectFlavorText::getLanguage() const
{
    return m_Language;
}

void SuperContestEffectFlavorText::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SuperContestEffectFlavorText>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SuperContestEffectFlavorText>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SuperContestEffectFlavorText>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SuperContestEffectFlavorText>>>::fromJsonValue(boost::json::parse(json));
}
