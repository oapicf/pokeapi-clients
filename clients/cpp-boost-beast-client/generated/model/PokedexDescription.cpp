...
PokedexDescription::PokedexDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokedexDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void PokedexDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokedexDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokedexDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokedexDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokedexDescription::toJsonObject_internal() const
{
...
void PokedexDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void PokedexDescription::setDescription(std::string value)
{
...
void PokedexDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokedexDescription>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokedexDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokedexDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokedexDescription>>>::fromJsonValue(boost::json::parse(json));
}
