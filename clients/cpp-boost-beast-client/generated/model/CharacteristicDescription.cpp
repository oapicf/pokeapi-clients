...
CharacteristicDescription::CharacteristicDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CharacteristicDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void CharacteristicDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CharacteristicDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CharacteristicDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CharacteristicDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CharacteristicDescription::toJsonObject_internal() const
{
...
void CharacteristicDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void CharacteristicDescription::setDescription(std::string value)
{
    
    m_Description = std::move(value);
    m_DescriptionIsSet = true;
}
std::shared_ptr<LanguageSummary> CharacteristicDescription::getLanguage() const
{
    return m_Language;
}

void CharacteristicDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CharacteristicDescription>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CharacteristicDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CharacteristicDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CharacteristicDescription>>>::fromJsonValue(boost::json::parse(json));
}
