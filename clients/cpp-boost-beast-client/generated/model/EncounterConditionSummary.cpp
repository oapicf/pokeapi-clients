...
EncounterConditionSummary::EncounterConditionSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EncounterConditionSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void EncounterConditionSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EncounterConditionSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EncounterConditionSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EncounterConditionSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EncounterConditionSummary::toJsonObject_internal() const
{
...
void EncounterConditionSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void EncounterConditionSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string EncounterConditionSummary::getUrl() const
{
    return m_Url;
}

void EncounterConditionSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EncounterConditionSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EncounterConditionSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EncounterConditionSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EncounterConditionSummary>>>::fromJsonValue(boost::json::parse(json));
}
