...
GenderSummary::GenderSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GenderSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void GenderSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GenderSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GenderSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GenderSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GenderSummary::toJsonObject_internal() const
{
...
void GenderSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void GenderSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string GenderSummary::getUrl() const
{
    return m_Url;
}

void GenderSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GenderSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GenderSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GenderSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GenderSummary>>>::fromJsonValue(boost::json::parse(json));
}
