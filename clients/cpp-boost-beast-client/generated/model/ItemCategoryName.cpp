...
ItemCategoryName::ItemCategoryName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemCategoryName::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemCategoryName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemCategoryName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemCategoryName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemCategoryName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemCategoryName::toJsonObject_internal() const
{
...
void ItemCategoryName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemCategoryName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> ItemCategoryName::getLanguage() const
{
    return m_Language;
}

void ItemCategoryName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemCategoryName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemCategoryName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemCategoryName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemCategoryName>>>::fromJsonValue(boost::json::parse(json));
}
