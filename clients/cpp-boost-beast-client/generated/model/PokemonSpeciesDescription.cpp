...
PokemonSpeciesDescription::PokemonSpeciesDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonSpeciesDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonSpeciesDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonSpeciesDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonSpeciesDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonSpeciesDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonSpeciesDescription::toJsonObject_internal() const
{
...
void PokemonSpeciesDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void PokemonSpeciesDescription::setDescription(std::string value)
{
    
    m_Description = std::move(value);
    m_DescriptionIsSet = true;
}
std::shared_ptr<LanguageSummary> PokemonSpeciesDescription::getLanguage() const
{
    return m_Language;
}

void PokemonSpeciesDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonSpeciesDescription>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonSpeciesDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonSpeciesDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonSpeciesDescription>>>::fromJsonValue(boost::json::parse(json));
}
