...
MoveMetaCategorySummary::MoveMetaCategorySummary(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value MoveMetaCategorySummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveMetaCategorySummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveMetaCategorySummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveMetaCategorySummary::toJsonObject_internal() const
{
...
void MoveMetaCategorySummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveMetaCategorySummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveMetaCategorySummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveMetaCategorySummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveMetaCategorySummary>>>::fromJsonValue(boost::json::parse(json));
}
