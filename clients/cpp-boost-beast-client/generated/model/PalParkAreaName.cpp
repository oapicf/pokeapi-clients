...
PalParkAreaName::PalParkAreaName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PalParkAreaName::toJsonString(bool prettyJson /* = false */) const
{
...
void PalParkAreaName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PalParkAreaName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PalParkAreaName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PalParkAreaName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PalParkAreaName::toJsonObject_internal() const
{
...
void PalParkAreaName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PalParkAreaName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> PalParkAreaName::getLanguage() const
{
    return m_Language;
}

void PalParkAreaName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PalParkAreaName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PalParkAreaName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PalParkAreaName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PalParkAreaName>>>::fromJsonValue(boost::json::parse(json));
}
