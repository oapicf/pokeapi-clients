...
PokemonGameIndex::PokemonGameIndex(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonGameIndex::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PokemonGameIndex::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonGameIndex::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonGameIndex");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonGameIndex::toJsonObject_internal() const
{
...
void PokemonGameIndex::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonGameIndex>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonGameIndex>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonGameIndex>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonGameIndex>>>::fromJsonValue(boost::json::parse(json));
}
