...
RegionSummary::RegionSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string RegionSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void RegionSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value RegionSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void RegionSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for RegionSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object RegionSummary::toJsonObject_internal() const
{
...
void RegionSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void RegionSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string RegionSummary::getUrl() const
{
    return m_Url;
}

void RegionSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<RegionSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<RegionSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<RegionSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<RegionSummary>>>::fromJsonValue(boost::json::parse(json));
}
