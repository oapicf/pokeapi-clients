...
PalParkAreaSummary::PalParkAreaSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PalParkAreaSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void PalParkAreaSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PalParkAreaSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PalParkAreaSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PalParkAreaSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PalParkAreaSummary::toJsonObject_internal() const
{
...
void PalParkAreaSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PalParkAreaSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string PalParkAreaSummary::getUrl() const
{
    return m_Url;
}

void PalParkAreaSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PalParkAreaSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PalParkAreaSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PalParkAreaSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PalParkAreaSummary>>>::fromJsonValue(boost::json::parse(json));
}
