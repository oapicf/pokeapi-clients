...
BerryFirmnessSummary::BerryFirmnessSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BerryFirmnessSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void BerryFirmnessSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BerryFirmnessSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BerryFirmnessSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BerryFirmnessSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BerryFirmnessSummary::toJsonObject_internal() const
{
...
void BerryFirmnessSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void BerryFirmnessSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string BerryFirmnessSummary::getUrl() const
{
    return m_Url;
}

void BerryFirmnessSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BerryFirmnessSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BerryFirmnessSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BerryFirmnessSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BerryFirmnessSummary>>>::fromJsonValue(boost::json::parse(json));
}
