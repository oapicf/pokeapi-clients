...
CharacteristicSummary::CharacteristicSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CharacteristicSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void CharacteristicSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CharacteristicSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CharacteristicSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CharacteristicSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CharacteristicSummary::toJsonObject_internal() const
{
...
void CharacteristicSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string CharacteristicSummary::getUrl() const
{
    return m_Url;
}

void CharacteristicSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CharacteristicSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CharacteristicSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CharacteristicSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CharacteristicSummary>>>::fromJsonValue(boost::json::parse(json));
}
