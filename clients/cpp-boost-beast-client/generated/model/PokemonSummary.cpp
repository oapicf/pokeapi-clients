...
PokemonSummary::PokemonSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonSummary::toJsonObject_internal() const
{
...
void PokemonSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokemonSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string PokemonSummary::getUrl() const
{
    return m_Url;
}

void PokemonSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonSummary>>>::fromJsonValue(boost::json::parse(json));
}
