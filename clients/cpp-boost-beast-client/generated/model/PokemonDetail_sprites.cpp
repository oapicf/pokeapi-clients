...
PokemonDetail_sprites::PokemonDetail_sprites(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonDetail_sprites::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonDetail_sprites::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonDetail_sprites::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonDetail_sprites::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonDetail_sprites");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonDetail_sprites::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Front_defaultIsSet) {
            object["front_default"] = JsonValueConverter<std::string>::toJsonValue(getFrontDefault());
        }
    return object;
}

void PokemonDetail_sprites::fromJsonObject_internal(boost::json::object const& object)
{
    m_Front_defaultIsSet = false;
    {
        const auto Front_defaultIt = object.find("front_default");
        if (Front_defaultIt != object.end()) {
            setFrontDefault(JsonValueConverter<std::string>::fromJsonValue(Front_defaultIt->value()));
        }
    }
}
...
void PokemonDetail_sprites::setFrontDefault(std::string value)
{
    
    m_Front_default = std::move(value);
    m_Front_defaultIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonDetail_sprites>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonDetail_sprites>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonDetail_sprites>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonDetail_sprites>>>::fromJsonValue(boost::json::parse(json));
}
