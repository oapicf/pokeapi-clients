...
EncounterConditionValueName::EncounterConditionValueName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EncounterConditionValueName::toJsonString(bool prettyJson /* = false */) const
{
...
void EncounterConditionValueName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EncounterConditionValueName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EncounterConditionValueName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EncounterConditionValueName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EncounterConditionValueName::toJsonObject_internal() const
{
...
void EncounterConditionValueName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void EncounterConditionValueName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> EncounterConditionValueName::getLanguage() const
{
    return m_Language;
}

void EncounterConditionValueName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EncounterConditionValueName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EncounterConditionValueName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EncounterConditionValueName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EncounterConditionValueName>>>::fromJsonValue(boost::json::parse(json));
}
