...
MoveMetaAilmentSummary::MoveMetaAilmentSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveMetaAilmentSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveMetaAilmentSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveMetaAilmentSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveMetaAilmentSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveMetaAilmentSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveMetaAilmentSummary::toJsonObject_internal() const
{
...
void MoveMetaAilmentSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveMetaAilmentSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string MoveMetaAilmentSummary::getUrl() const
{
    return m_Url;
}

void MoveMetaAilmentSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveMetaAilmentSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveMetaAilmentSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveMetaAilmentSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveMetaAilmentSummary>>>::fromJsonValue(boost::json::parse(json));
}
