...
VersionName::VersionName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VersionName::toJsonString(bool prettyJson /* = false */) const
{
...
void VersionName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VersionName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VersionName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VersionName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VersionName::toJsonObject_internal() const
{
...
void VersionName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void VersionName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> VersionName::getLanguage() const
{
    return m_Language;
}

void VersionName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VersionName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VersionName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VersionName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VersionName>>>::fromJsonValue(boost::json::parse(json));
}
