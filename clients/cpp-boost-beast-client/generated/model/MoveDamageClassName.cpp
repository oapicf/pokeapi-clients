...
MoveDamageClassName::MoveDamageClassName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveDamageClassName::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveDamageClassName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveDamageClassName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveDamageClassName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveDamageClassName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveDamageClassName::toJsonObject_internal() const
{
...
void MoveDamageClassName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveDamageClassName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> MoveDamageClassName::getLanguage() const
{
    return m_Language;
}

void MoveDamageClassName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveDamageClassName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveDamageClassName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveDamageClassName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveDamageClassName>>>::fromJsonValue(boost::json::parse(json));
}
