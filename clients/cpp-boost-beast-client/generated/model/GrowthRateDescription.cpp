...
GrowthRateDescription::GrowthRateDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GrowthRateDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void GrowthRateDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GrowthRateDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GrowthRateDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GrowthRateDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GrowthRateDescription::toJsonObject_internal() const
{
...
void GrowthRateDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void GrowthRateDescription::setDescription(std::string value)
{
    
    m_Description = std::move(value);
    m_DescriptionIsSet = true;
}
std::shared_ptr<LanguageSummary> GrowthRateDescription::getLanguage() const
{
    return m_Language;
}

void GrowthRateDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GrowthRateDescription>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GrowthRateDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GrowthRateDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GrowthRateDescription>>>::fromJsonValue(boost::json::parse(json));
}
