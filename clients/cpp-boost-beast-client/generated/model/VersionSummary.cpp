...
VersionSummary::VersionSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VersionSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void VersionSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VersionSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VersionSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VersionSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VersionSummary::toJsonObject_internal() const
{
...
void VersionSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void VersionSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string VersionSummary::getUrl() const
{
    return m_Url;
}

void VersionSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VersionSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VersionSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VersionSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VersionSummary>>>::fromJsonValue(boost::json::parse(json));
}
