...
SuperContestEffectSummary::SuperContestEffectSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SuperContestEffectSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void SuperContestEffectSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SuperContestEffectSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SuperContestEffectSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SuperContestEffectSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SuperContestEffectSummary::toJsonObject_internal() const
{
...
void SuperContestEffectSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string SuperContestEffectSummary::getUrl() const
{
    return m_Url;
}

void SuperContestEffectSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SuperContestEffectSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SuperContestEffectSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SuperContestEffectSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SuperContestEffectSummary>>>::fromJsonValue(boost::json::parse(json));
}
