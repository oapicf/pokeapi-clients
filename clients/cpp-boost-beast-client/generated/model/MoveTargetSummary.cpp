...
MoveTargetSummary::MoveTargetSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveTargetSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveTargetSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveTargetSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveTargetSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveTargetSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveTargetSummary::toJsonObject_internal() const
{
...
void MoveTargetSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveTargetSummary::setName(std::string value)
{
...
void MoveTargetSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveTargetSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveTargetSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveTargetSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveTargetSummary>>>::fromJsonValue(boost::json::parse(json));
}
