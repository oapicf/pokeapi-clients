...
AbilityName::AbilityName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AbilityName::toJsonString(bool prettyJson /* = false */) const
{
...
void AbilityName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AbilityName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AbilityName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AbilityName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AbilityName::toJsonObject_internal() const
{
...
void AbilityName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void AbilityName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> AbilityName::getLanguage() const
{
    return m_Language;
}

void AbilityName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AbilityName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AbilityName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AbilityName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AbilityName>>>::fromJsonValue(boost::json::parse(json));
}
