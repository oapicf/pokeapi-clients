...
AbilityChangeEffectText::AbilityChangeEffectText(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AbilityChangeEffectText::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value AbilityChangeEffectText::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AbilityChangeEffectText::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AbilityChangeEffectText");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AbilityChangeEffectText::toJsonObject_internal() const
{
...
void AbilityChangeEffectText::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AbilityChangeEffectText>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AbilityChangeEffectText>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AbilityChangeEffectText>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AbilityChangeEffectText>>>::fromJsonValue(boost::json::parse(json));
}
