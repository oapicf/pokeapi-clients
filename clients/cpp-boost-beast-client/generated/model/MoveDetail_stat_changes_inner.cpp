...
MoveDetail_stat_changes_inner::MoveDetail_stat_changes_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveDetail_stat_changes_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveDetail_stat_changes_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveDetail_stat_changes_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveDetail_stat_changes_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveDetail_stat_changes_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveDetail_stat_changes_inner::toJsonObject_internal() const
{
    boost::json::object object;
        object["change"] = JsonValueConverter<int32_t>::toJsonValue(getChange());
        object["stat"] = JsonValueConverter<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>::toJsonValue(getStat());
    return object;
}

void MoveDetail_stat_changes_inner::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    {
        const auto StatIt = object.find("stat");
        if (StatIt != object.end()) {
            setStat(JsonValueConverter<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>::fromJsonValue(StatIt->value()));
        }
    }
}
...
void MoveDetail_stat_changes_inner::setChange(int32_t value)
{
    
    m_Change = std::move(value);
}
std::shared_ptr<AbilityDetail_pokemon_inner_pokemon> MoveDetail_stat_changes_inner::getStat() const
{
    return m_Stat;
}

void MoveDetail_stat_changes_inner::setStat(std::shared_ptr<AbilityDetail_pokemon_inner_pokemon> value)
{
    
    m_Stat = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveDetail_stat_changes_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveDetail_stat_changes_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveDetail_stat_changes_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveDetail_stat_changes_inner>>>::fromJsonValue(boost::json::parse(json));
}
