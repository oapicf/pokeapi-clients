...
PokemonFormDetail_sprites::PokemonFormDetail_sprites(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonFormDetail_sprites::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonFormDetail_sprites::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonFormDetail_sprites::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonFormDetail_sprites::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonFormDetail_sprites");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonFormDetail_sprites::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_defaultIsSet) {
            object["default"] = JsonValueConverter<std::string>::toJsonValue(getRDefault());
        }
    return object;
}

void PokemonFormDetail_sprites::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_defaultIsSet = false;
    {
        const auto r_defaultIt = object.find("default");
        if (r_defaultIt != object.end()) {
            setRDefault(JsonValueConverter<std::string>::fromJsonValue(r_defaultIt->value()));
        }
    }
}
...
void PokemonFormDetail_sprites::setRDefault(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonFormDetail_sprites>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonFormDetail_sprites>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonFormDetail_sprites>>>::fromJsonValue(boost::json::parse(json));
}
