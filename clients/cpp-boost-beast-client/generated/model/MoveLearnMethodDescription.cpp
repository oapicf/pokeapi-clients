...
MoveLearnMethodDescription::MoveLearnMethodDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveLearnMethodDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveLearnMethodDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveLearnMethodDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveLearnMethodDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveLearnMethodDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveLearnMethodDescription::toJsonObject_internal() const
{
...
void MoveLearnMethodDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void MoveLearnMethodDescription::setDescription(std::string value)
{
    
    m_Description = std::move(value);
    m_DescriptionIsSet = true;
}
std::shared_ptr<LanguageSummary> MoveLearnMethodDescription::getLanguage() const
{
    return m_Language;
}

void MoveLearnMethodDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveLearnMethodDescription>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveLearnMethodDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveLearnMethodDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveLearnMethodDescription>>>::fromJsonValue(boost::json::parse(json));
}
