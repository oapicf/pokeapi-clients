...
VersionGroupSummary::VersionGroupSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VersionGroupSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void VersionGroupSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VersionGroupSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VersionGroupSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VersionGroupSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VersionGroupSummary::toJsonObject_internal() const
{
...
void VersionGroupSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void VersionGroupSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string VersionGroupSummary::getUrl() const
{
    return m_Url;
}

void VersionGroupSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VersionGroupSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VersionGroupSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VersionGroupSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VersionGroupSummary>>>::fromJsonValue(boost::json::parse(json));
}
