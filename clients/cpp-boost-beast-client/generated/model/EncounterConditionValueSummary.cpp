...
EncounterConditionValueSummary::EncounterConditionValueSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EncounterConditionValueSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void EncounterConditionValueSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EncounterConditionValueSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EncounterConditionValueSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EncounterConditionValueSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EncounterConditionValueSummary::toJsonObject_internal() const
{
...
void EncounterConditionValueSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void EncounterConditionValueSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string EncounterConditionValueSummary::getUrl() const
{
    return m_Url;
}

void EncounterConditionValueSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EncounterConditionValueSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EncounterConditionValueSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EncounterConditionValueSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EncounterConditionValueSummary>>>::fromJsonValue(boost::json::parse(json));
}
