...
GenerationSummary::GenerationSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GenerationSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void GenerationSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GenerationSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GenerationSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GenerationSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GenerationSummary::toJsonObject_internal() const
{
...
void GenerationSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void GenerationSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string GenerationSummary::getUrl() const
{
    return m_Url;
}

void GenerationSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GenerationSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GenerationSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GenerationSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GenerationSummary>>>::fromJsonValue(boost::json::parse(json));
}
