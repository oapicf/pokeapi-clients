...
PokedexName::PokedexName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokedexName::toJsonString(bool prettyJson /* = false */) const
{
...
void PokedexName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokedexName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokedexName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokedexName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokedexName::toJsonObject_internal() const
{
...
void PokedexName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokedexName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> PokedexName::getLanguage() const
{
    return m_Language;
}

void PokedexName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokedexName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokedexName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokedexName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokedexName>>>::fromJsonValue(boost::json::parse(json));
}
