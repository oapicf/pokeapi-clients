...
LanguageSummary::LanguageSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LanguageSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void LanguageSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LanguageSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LanguageSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LanguageSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LanguageSummary::toJsonObject_internal() const
{
...
void LanguageSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void LanguageSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string LanguageSummary::getUrl() const
{
    return m_Url;
}

void LanguageSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LanguageSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LanguageSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LanguageSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LanguageSummary>>>::fromJsonValue(boost::json::parse(json));
}
