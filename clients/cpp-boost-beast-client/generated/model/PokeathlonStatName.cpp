...
PokeathlonStatName::PokeathlonStatName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokeathlonStatName::toJsonString(bool prettyJson /* = false */) const
{
...
void PokeathlonStatName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokeathlonStatName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokeathlonStatName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokeathlonStatName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokeathlonStatName::toJsonObject_internal() const
{
...
void PokeathlonStatName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokeathlonStatName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> PokeathlonStatName::getLanguage() const
{
    return m_Language;
}

void PokeathlonStatName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokeathlonStatName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokeathlonStatName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokeathlonStatName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokeathlonStatName>>>::fromJsonValue(boost::json::parse(json));
}
