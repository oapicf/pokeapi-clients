...
MoveMetaCategoryDescription::MoveMetaCategoryDescription(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveMetaCategoryDescription::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveMetaCategoryDescription::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveMetaCategoryDescription::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveMetaCategoryDescription::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveMetaCategoryDescription");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveMetaCategoryDescription::toJsonObject_internal() const
{
...
void MoveMetaCategoryDescription::fromJsonObject_internal(boost::json::object const& object)
{
...
void MoveMetaCategoryDescription::setDescription(std::string value)
{
    
    m_Description = std::move(value);
    m_DescriptionIsSet = true;
}
std::shared_ptr<LanguageSummary> MoveMetaCategoryDescription::getLanguage() const
{
    return m_Language;
}

void MoveMetaCategoryDescription::setLanguage(std::shared_ptr<LanguageSummary> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveMetaCategoryDescription>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveMetaCategoryDescription>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveMetaCategoryDescription>>>::fromJsonValue(boost::json::parse(json));
}
