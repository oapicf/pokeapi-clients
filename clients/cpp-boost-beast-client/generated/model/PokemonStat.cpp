...
PokemonStat::PokemonStat(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonStat::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PokemonStat::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonStat::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonStat");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonStat::toJsonObject_internal() const
{
    boost::json::object object;
        object["base_stat"] = JsonValueConverter<int32_t>::toJsonValue(getBaseStat());
        object["effort"] = JsonValueConverter<int32_t>::toJsonValue(getEffort());
        object["stat"] = JsonValueConverter<std::shared_ptr<StatSummary>>::toJsonValue(getStat());
    return object;
}

void PokemonStat::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Base_statIt = object.find("base_stat");
        if (Base_statIt != object.end()) {
            setBaseStat(JsonValueConverter<int32_t>::fromJsonValue(Base_statIt->value()));
        }
    }
    {
        const auto EffortIt = object.find("effort");
        if (EffortIt != object.end()) {
            setEffort(JsonValueConverter<int32_t>::fromJsonValue(EffortIt->value()));
        }
    }
    {
        const auto StatIt = object.find("stat");
        if (StatIt != object.end()) {
            setStat(JsonValueConverter<std::shared_ptr<StatSummary>>::fromJsonValue(StatIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonStat>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonStat>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonStat>>>::fromJsonValue(boost::json::parse(json));
}
