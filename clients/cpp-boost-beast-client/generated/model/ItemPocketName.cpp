...
ItemPocketName::ItemPocketName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemPocketName::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemPocketName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemPocketName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemPocketName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemPocketName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemPocketName::toJsonObject_internal() const
{
...
void ItemPocketName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemPocketName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> ItemPocketName::getLanguage() const
{
    return m_Language;
}

void ItemPocketName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemPocketName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemPocketName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemPocketName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemPocketName>>>::fromJsonValue(boost::json::parse(json));
}
