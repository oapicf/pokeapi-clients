...
EncounterMethodName::EncounterMethodName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EncounterMethodName::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value EncounterMethodName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EncounterMethodName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EncounterMethodName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EncounterMethodName::toJsonObject_internal() const
{
...
void EncounterMethodName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EncounterMethodName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EncounterMethodName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EncounterMethodName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EncounterMethodName>>>::fromJsonValue(boost::json::parse(json));
}
