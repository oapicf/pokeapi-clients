...
EncounterConditionName::EncounterConditionName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EncounterConditionName::toJsonString(bool prettyJson /* = false */) const
{
...
void EncounterConditionName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EncounterConditionName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EncounterConditionName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EncounterConditionName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EncounterConditionName::toJsonObject_internal() const
{
...
void EncounterConditionName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void EncounterConditionName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> EncounterConditionName::getLanguage() const
{
    return m_Language;
}

void EncounterConditionName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EncounterConditionName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EncounterConditionName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EncounterConditionName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EncounterConditionName>>>::fromJsonValue(boost::json::parse(json));
}
