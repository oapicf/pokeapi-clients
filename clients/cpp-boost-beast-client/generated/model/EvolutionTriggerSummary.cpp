...
EvolutionTriggerSummary::EvolutionTriggerSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EvolutionTriggerSummary::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value EvolutionTriggerSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EvolutionTriggerSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EvolutionTriggerSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EvolutionTriggerSummary::toJsonObject_internal() const
{
...
void EvolutionTriggerSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EvolutionTriggerSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EvolutionTriggerSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EvolutionTriggerSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EvolutionTriggerSummary>>>::fromJsonValue(boost::json::parse(json));
}
