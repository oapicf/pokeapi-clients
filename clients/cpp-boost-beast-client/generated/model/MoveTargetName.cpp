...
MoveTargetName::MoveTargetName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveTargetName::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveTargetName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveTargetName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveTargetName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveTargetName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveTargetName::toJsonObject_internal() const
{
...
void MoveTargetName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveTargetName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> MoveTargetName::getLanguage() const
{
    return m_Language;
}

void MoveTargetName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveTargetName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveTargetName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveTargetName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveTargetName>>>::fromJsonValue(boost::json::parse(json));
}
