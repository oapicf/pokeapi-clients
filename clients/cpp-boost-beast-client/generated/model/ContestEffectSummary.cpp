...
ContestEffectSummary::ContestEffectSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ContestEffectSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void ContestEffectSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ContestEffectSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ContestEffectSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ContestEffectSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ContestEffectSummary::toJsonObject_internal() const
{
...
void ContestEffectSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string ContestEffectSummary::getUrl() const
{
    return m_Url;
}

void ContestEffectSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ContestEffectSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ContestEffectSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ContestEffectSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ContestEffectSummary>>>::fromJsonValue(boost::json::parse(json));
}
