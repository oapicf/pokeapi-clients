...
MoveMetaAilmentName::MoveMetaAilmentName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveMetaAilmentName::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveMetaAilmentName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveMetaAilmentName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveMetaAilmentName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveMetaAilmentName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveMetaAilmentName::toJsonObject_internal() const
{
...
void MoveMetaAilmentName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveMetaAilmentName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> MoveMetaAilmentName::getLanguage() const
{
    return m_Language;
}

void MoveMetaAilmentName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveMetaAilmentName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveMetaAilmentName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveMetaAilmentName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveMetaAilmentName>>>::fromJsonValue(boost::json::parse(json));
}
