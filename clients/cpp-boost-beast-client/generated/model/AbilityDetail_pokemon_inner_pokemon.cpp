...
AbilityDetail_pokemon_inner_pokemon::AbilityDetail_pokemon_inner_pokemon(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AbilityDetail_pokemon_inner_pokemon::toJsonString(bool prettyJson /* = false */) const
{
...
void AbilityDetail_pokemon_inner_pokemon::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AbilityDetail_pokemon_inner_pokemon::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AbilityDetail_pokemon_inner_pokemon::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AbilityDetail_pokemon_inner_pokemon");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AbilityDetail_pokemon_inner_pokemon::toJsonObject_internal() const
{
...
void AbilityDetail_pokemon_inner_pokemon::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string AbilityDetail_pokemon_inner_pokemon::getName() const
{
    return m_Name;
}

void AbilityDetail_pokemon_inner_pokemon::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string AbilityDetail_pokemon_inner_pokemon::getUrl() const
{
    return m_Url;
}

void AbilityDetail_pokemon_inner_pokemon::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>>::fromJsonValue(boost::json::parse(json));
}
