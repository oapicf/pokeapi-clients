...
ItemPocketSummary::ItemPocketSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemPocketSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemPocketSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemPocketSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemPocketSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemPocketSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemPocketSummary::toJsonObject_internal() const
{
...
void ItemPocketSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemPocketSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string ItemPocketSummary::getUrl() const
{
    return m_Url;
}

void ItemPocketSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemPocketSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemPocketSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemPocketSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemPocketSummary>>>::fromJsonValue(boost::json::parse(json));
}
