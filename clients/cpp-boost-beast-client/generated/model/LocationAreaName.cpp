...
LocationAreaName::LocationAreaName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LocationAreaName::toJsonString(bool prettyJson /* = false */) const
{
...
void LocationAreaName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LocationAreaName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LocationAreaName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LocationAreaName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LocationAreaName::toJsonObject_internal() const
{
...
void LocationAreaName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void LocationAreaName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> LocationAreaName::getLanguage() const
{
    return m_Language;
}

void LocationAreaName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LocationAreaName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LocationAreaName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LocationAreaName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LocationAreaName>>>::fromJsonValue(boost::json::parse(json));
}
