...
BerryFlavorSummary::BerryFlavorSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BerryFlavorSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void BerryFlavorSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BerryFlavorSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BerryFlavorSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BerryFlavorSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BerryFlavorSummary::toJsonObject_internal() const
{
...
void BerryFlavorSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void BerryFlavorSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string BerryFlavorSummary::getUrl() const
{
    return m_Url;
}

void BerryFlavorSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BerryFlavorSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BerryFlavorSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BerryFlavorSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BerryFlavorSummary>>>::fromJsonValue(boost::json::parse(json));
}
