...
ContestTypeSummary::ContestTypeSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ContestTypeSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void ContestTypeSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ContestTypeSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ContestTypeSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ContestTypeSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ContestTypeSummary::toJsonObject_internal() const
{
...
void ContestTypeSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ContestTypeSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string ContestTypeSummary::getUrl() const
{
    return m_Url;
}

void ContestTypeSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ContestTypeSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ContestTypeSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ContestTypeSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ContestTypeSummary>>>::fromJsonValue(boost::json::parse(json));
}
