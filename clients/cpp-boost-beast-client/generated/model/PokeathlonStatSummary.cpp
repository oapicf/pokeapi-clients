...
PokeathlonStatSummary::PokeathlonStatSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokeathlonStatSummary::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PokeathlonStatSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokeathlonStatSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokeathlonStatSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokeathlonStatSummary::toJsonObject_internal() const
{
...
void PokeathlonStatSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokeathlonStatSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokeathlonStatSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokeathlonStatSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokeathlonStatSummary>>>::fromJsonValue(boost::json::parse(json));
}
