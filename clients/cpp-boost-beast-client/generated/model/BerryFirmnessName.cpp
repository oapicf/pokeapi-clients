...
BerryFirmnessName::BerryFirmnessName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BerryFirmnessName::toJsonString(bool prettyJson /* = false */) const
{
...
void BerryFirmnessName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BerryFirmnessName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BerryFirmnessName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BerryFirmnessName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BerryFirmnessName::toJsonObject_internal() const
{
...
void BerryFirmnessName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void BerryFirmnessName::setName(std::string value)
{
...
void BerryFirmnessName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BerryFirmnessName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BerryFirmnessName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BerryFirmnessName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BerryFirmnessName>>>::fromJsonValue(boost::json::parse(json));
}
