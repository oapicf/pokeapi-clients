...
GenerationName::GenerationName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GenerationName::toJsonString(bool prettyJson /* = false */) const
{
...
void GenerationName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GenerationName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GenerationName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GenerationName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GenerationName::toJsonObject_internal() const
{
...
void GenerationName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void GenerationName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> GenerationName::getLanguage() const
{
    return m_Language;
}

void GenerationName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GenerationName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GenerationName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GenerationName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GenerationName>>>::fromJsonValue(boost::json::parse(json));
}
