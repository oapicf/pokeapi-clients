...
ItemAttributeSummary::ItemAttributeSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemAttributeSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemAttributeSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemAttributeSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemAttributeSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemAttributeSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemAttributeSummary::toJsonObject_internal() const
{
...
void ItemAttributeSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemAttributeSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string ItemAttributeSummary::getUrl() const
{
    return m_Url;
}

void ItemAttributeSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemAttributeSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemAttributeSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemAttributeSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemAttributeSummary>>>::fromJsonValue(boost::json::parse(json));
}
