...
EggGroupDetail_pokemon_species_inner::EggGroupDetail_pokemon_species_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EggGroupDetail_pokemon_species_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void EggGroupDetail_pokemon_species_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EggGroupDetail_pokemon_species_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EggGroupDetail_pokemon_species_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EggGroupDetail_pokemon_species_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EggGroupDetail_pokemon_species_inner::toJsonObject_internal() const
{
...
void EggGroupDetail_pokemon_species_inner::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_UrlIsSet = false;
    {
...
void EggGroupDetail_pokemon_species_inner::setName(std::string value)
{
...
void EggGroupDetail_pokemon_species_inner::setUrl(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EggGroupDetail_pokemon_species_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EggGroupDetail_pokemon_species_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EggGroupDetail_pokemon_species_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EggGroupDetail_pokemon_species_inner>>>::fromJsonValue(boost::json::parse(json));
}
