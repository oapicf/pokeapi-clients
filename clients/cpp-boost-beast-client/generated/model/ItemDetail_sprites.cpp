...
ItemDetail_sprites::ItemDetail_sprites(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemDetail_sprites::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemDetail_sprites::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemDetail_sprites::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemDetail_sprites::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemDetail_sprites");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemDetail_sprites::toJsonObject_internal() const
{
...
void ItemDetail_sprites::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string ItemDetail_sprites::getRDefault() const
{
    return m_r_default;
}

void ItemDetail_sprites::setRDefault(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemDetail_sprites>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemDetail_sprites>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemDetail_sprites>>>::fromJsonValue(boost::json::parse(json));
}
