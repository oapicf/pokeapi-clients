...
PokemonDetail_types_inner::PokemonDetail_types_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonDetail_types_inner::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value PokemonDetail_types_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonDetail_types_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonDetail_types_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonDetail_types_inner::toJsonObject_internal() const
{
    boost::json::object object;
        object["slot"] = JsonValueConverter<int32_t>::toJsonValue(getSlot());
        object["type"] = JsonValueConverter<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>::toJsonValue(getType());
    return object;
}

void PokemonDetail_types_inner::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (TypeIt != object.end()) {
            setType(JsonValueConverter<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>::fromJsonValue(TypeIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonDetail_types_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonDetail_types_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonDetail_types_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonDetail_types_inner>>>::fromJsonValue(boost::json::parse(json));
}
