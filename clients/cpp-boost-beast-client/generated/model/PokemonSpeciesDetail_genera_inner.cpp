...
PokemonSpeciesDetail_genera_inner::PokemonSpeciesDetail_genera_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonSpeciesDetail_genera_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonSpeciesDetail_genera_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonSpeciesDetail_genera_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonSpeciesDetail_genera_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonSpeciesDetail_genera_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonSpeciesDetail_genera_inner::toJsonObject_internal() const
{
    boost::json::object object;
        object["genus"] = JsonValueConverter<std::string>::toJsonValue(getGenus());
        object["language"] = JsonValueConverter<std::shared_ptr<AbilityDetail_pokemon_inner_pokemon>>::toJsonValue(getLanguage());
    return object;
}

void PokemonSpeciesDetail_genera_inner::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto GenusIt = object.find("genus");
        if (GenusIt != object.end()) {
            setGenus(JsonValueConverter<std::string>::fromJsonValue(GenusIt->value()));
        }
    }
    {
...
void PokemonSpeciesDetail_genera_inner::setGenus(std::string value)
{
    
    m_Genus = std::move(value);
}
...
void PokemonSpeciesDetail_genera_inner::setLanguage(std::shared_ptr<AbilityDetail_pokemon_inner_pokemon> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonSpeciesDetail_genera_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonSpeciesDetail_genera_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonSpeciesDetail_genera_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonSpeciesDetail_genera_inner>>>::fromJsonValue(boost::json::parse(json));
}
