...
ItemDetail_baby_trigger_for::ItemDetail_baby_trigger_for(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemDetail_baby_trigger_for::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value ItemDetail_baby_trigger_for::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemDetail_baby_trigger_for::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemDetail_baby_trigger_for");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemDetail_baby_trigger_for::toJsonObject_internal() const
{
...
void ItemDetail_baby_trigger_for::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemDetail_baby_trigger_for>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemDetail_baby_trigger_for>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemDetail_baby_trigger_for>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemDetail_baby_trigger_for>>>::fromJsonValue(boost::json::parse(json));
}
