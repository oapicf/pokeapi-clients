...
MoveLearnMethodName::MoveLearnMethodName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveLearnMethodName::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MoveLearnMethodName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveLearnMethodName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveLearnMethodName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveLearnMethodName::toJsonObject_internal() const
{
...
void MoveLearnMethodName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveLearnMethodName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveLearnMethodName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveLearnMethodName>>>::fromJsonValue(boost::json::parse(json));
}
