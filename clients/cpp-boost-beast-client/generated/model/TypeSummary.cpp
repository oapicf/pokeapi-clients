...
TypeSummary::TypeSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TypeSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void TypeSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TypeSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TypeSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TypeSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TypeSummary::toJsonObject_internal() const
{
...
void TypeSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void TypeSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string TypeSummary::getUrl() const
{
    return m_Url;
}

void TypeSummary::setUrl(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TypeSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TypeSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TypeSummary>>>::fromJsonValue(boost::json::parse(json));
}
