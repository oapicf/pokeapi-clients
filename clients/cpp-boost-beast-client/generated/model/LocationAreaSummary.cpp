...
LocationAreaSummary::LocationAreaSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LocationAreaSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void LocationAreaSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LocationAreaSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LocationAreaSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LocationAreaSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LocationAreaSummary::toJsonObject_internal() const
{
...
void LocationAreaSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void LocationAreaSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string LocationAreaSummary::getUrl() const
{
    return m_Url;
}

void LocationAreaSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LocationAreaSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LocationAreaSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LocationAreaSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LocationAreaSummary>>>::fromJsonValue(boost::json::parse(json));
}
