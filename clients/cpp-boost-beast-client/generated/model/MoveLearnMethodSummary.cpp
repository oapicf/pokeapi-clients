...
MoveLearnMethodSummary::MoveLearnMethodSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveLearnMethodSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveLearnMethodSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveLearnMethodSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveLearnMethodSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveLearnMethodSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveLearnMethodSummary::toJsonObject_internal() const
{
...
void MoveLearnMethodSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveLearnMethodSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string MoveLearnMethodSummary::getUrl() const
{
    return m_Url;
}

void MoveLearnMethodSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveLearnMethodSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveLearnMethodSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveLearnMethodSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveLearnMethodSummary>>>::fromJsonValue(boost::json::parse(json));
}
