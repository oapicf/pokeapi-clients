...
ItemFlingEffectDetail::ItemFlingEffectDetail(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value ItemFlingEffectDetail::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemFlingEffectDetail::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemFlingEffectDetail");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemFlingEffectDetail::toJsonObject_internal() const
{
    boost::json::object object;
        object["id"] = JsonValueConverter<int32_t>::toJsonValue(getId());
        object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
        object["effect_entries"] = JsonValueConverter<std::vector<std::shared_ptr<ItemFlingEffectEffectText>>>::toJsonValue(getEffectEntries());
        object["items"] = JsonValueConverter<std::vector<std::shared_ptr<ItemSummary>>>::toJsonValue(getItems());
    return object;
}

void ItemFlingEffectDetail::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (Effect_entriesIt != object.end()) {
            setEffectEntries(JsonValueConverter<std::vector<std::shared_ptr<ItemFlingEffectEffectText>>>::fromJsonValue(Effect_entriesIt->value()));
        }
    }
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemFlingEffectDetail>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemFlingEffectDetail>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemFlingEffectDetail>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemFlingEffectDetail>>>::fromJsonValue(boost::json::parse(json));
}
