...
TypeDetail_pokemon_inner_pokemon::TypeDetail_pokemon_inner_pokemon(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TypeDetail_pokemon_inner_pokemon::toJsonString(bool prettyJson /* = false */) const
{
...
void TypeDetail_pokemon_inner_pokemon::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TypeDetail_pokemon_inner_pokemon::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TypeDetail_pokemon_inner_pokemon::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TypeDetail_pokemon_inner_pokemon");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TypeDetail_pokemon_inner_pokemon::toJsonObject_internal() const
{
...
void TypeDetail_pokemon_inner_pokemon::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_UrlIsSet = false;
    {
...
void TypeDetail_pokemon_inner_pokemon::setName(std::string value)
{
...
void TypeDetail_pokemon_inner_pokemon::setUrl(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TypeDetail_pokemon_inner_pokemon>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TypeDetail_pokemon_inner_pokemon>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TypeDetail_pokemon_inner_pokemon>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TypeDetail_pokemon_inner_pokemon>>>::fromJsonValue(boost::json::parse(json));
}
