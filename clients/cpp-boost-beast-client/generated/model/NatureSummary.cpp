...
NatureSummary::NatureSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string NatureSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void NatureSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value NatureSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void NatureSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for NatureSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object NatureSummary::toJsonObject_internal() const
{
...
void NatureSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void NatureSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string NatureSummary::getUrl() const
{
    return m_Url;
}

void NatureSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<NatureSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<NatureSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<NatureSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<NatureSummary>>>::fromJsonValue(boost::json::parse(json));
}
