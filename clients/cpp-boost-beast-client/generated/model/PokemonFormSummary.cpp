...
PokemonFormSummary::PokemonFormSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokemonFormSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void PokemonFormSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokemonFormSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokemonFormSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokemonFormSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokemonFormSummary::toJsonObject_internal() const
{
...
void PokemonFormSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokemonFormSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string PokemonFormSummary::getUrl() const
{
    return m_Url;
}

void PokemonFormSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokemonFormSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokemonFormSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokemonFormSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokemonFormSummary>>>::fromJsonValue(boost::json::parse(json));
}
