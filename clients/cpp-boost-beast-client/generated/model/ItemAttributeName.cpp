...
ItemAttributeName::ItemAttributeName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemAttributeName::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemAttributeName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemAttributeName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemAttributeName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemAttributeName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemAttributeName::toJsonObject_internal() const
{
...
void ItemAttributeName::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ItemAttributeName::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::shared_ptr<LanguageSummary> ItemAttributeName::getLanguage() const
{
    return m_Language;
}

void ItemAttributeName::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ItemAttributeName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemAttributeName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemAttributeName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemAttributeName>>>::fromJsonValue(boost::json::parse(json));
}
