...
PokedexSummary::PokedexSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PokedexSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void PokedexSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PokedexSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PokedexSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PokedexSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PokedexSummary::toJsonObject_internal() const
{
...
void PokedexSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void PokedexSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string PokedexSummary::getUrl() const
{
    return m_Url;
}

void PokedexSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PokedexSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PokedexSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PokedexSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PokedexSummary>>>::fromJsonValue(boost::json::parse(json));
}
