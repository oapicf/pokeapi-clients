...
ContestEffectFlavorText::ContestEffectFlavorText(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ContestEffectFlavorText::toJsonString(bool prettyJson /* = false */) const
{
...
void ContestEffectFlavorText::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ContestEffectFlavorText::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ContestEffectFlavorText::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ContestEffectFlavorText");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ContestEffectFlavorText::toJsonObject_internal() const
{
...
void ContestEffectFlavorText::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void ContestEffectFlavorText::setFlavorText(std::string value)
{
    
    m_Flavor_text = std::move(value);
}
std::shared_ptr<LanguageSummary> ContestEffectFlavorText::getLanguage() const
{
    return m_Language;
}

void ContestEffectFlavorText::setLanguage(std::shared_ptr<LanguageSummary> value)
{
    
    m_Language = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ContestEffectFlavorText>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ContestEffectFlavorText>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ContestEffectFlavorText>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ContestEffectFlavorText>>>::fromJsonValue(boost::json::parse(json));
}
