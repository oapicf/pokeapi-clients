...
EncounterMethodSummary::EncounterMethodSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EncounterMethodSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void EncounterMethodSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EncounterMethodSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EncounterMethodSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EncounterMethodSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EncounterMethodSummary::toJsonObject_internal() const
{
...
void EncounterMethodSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void EncounterMethodSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string EncounterMethodSummary::getUrl() const
{
    return m_Url;
}

void EncounterMethodSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EncounterMethodSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EncounterMethodSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EncounterMethodSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EncounterMethodSummary>>>::fromJsonValue(boost::json::parse(json));
}
