...
BerrySummary::BerrySummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BerrySummary::toJsonString(bool prettyJson /* = false */) const
{
...
void BerrySummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BerrySummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BerrySummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BerrySummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BerrySummary::toJsonObject_internal() const
{
...
void BerrySummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void BerrySummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string BerrySummary::getUrl() const
{
    return m_Url;
}

void BerrySummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BerrySummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BerrySummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BerrySummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BerrySummary>>>::fromJsonValue(boost::json::parse(json));
}
