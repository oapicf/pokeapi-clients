...
MoveSummary::MoveSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MoveSummary::toJsonString(bool prettyJson /* = false */) const
{
...
void MoveSummary::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MoveSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MoveSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MoveSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MoveSummary::toJsonObject_internal() const
{
...
void MoveSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
void MoveSummary::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string MoveSummary::getUrl() const
{
    return m_Url;
}

void MoveSummary::setUrl(std::string value)
{
    
    m_Url = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MoveSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MoveSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MoveSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MoveSummary>>>::fromJsonValue(boost::json::parse(json));
}
