...
MachineSummary::MachineSummary(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MachineSummary::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value MachineSummary::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MachineSummary::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MachineSummary");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MachineSummary::toJsonObject_internal() const
{
...
void MachineSummary::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MachineSummary>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MachineSummary>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MachineSummary>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MachineSummary>>>::fromJsonValue(boost::json::parse(json));
}
