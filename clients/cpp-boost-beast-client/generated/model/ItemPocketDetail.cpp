...
ItemPocketDetail::ItemPocketDetail(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ItemPocketDetail::toJsonString(bool prettyJson /* = false */) const
{
...
void ItemPocketDetail::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ItemPocketDetail::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ItemPocketDetail::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ItemPocketDetail");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ItemPocketDetail::toJsonObject_internal() const
{
    boost::json::object object;
        object["id"] = JsonValueConverter<int32_t>::toJsonValue(getId());
        object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
        object["categories"] = JsonValueConverter<std::vector<std::shared_ptr<ItemCategorySummary>>>::toJsonValue(getCategories());
        object["names"] = JsonValueConverter<std::vector<std::shared_ptr<ItemPocketName>>>::toJsonValue(getNames());
    return object;
}

void ItemPocketDetail::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (CategoriesIt != object.end()) {
            setCategories(JsonValueConverter<std::vector<std::shared_ptr<ItemCategorySummary>>>::fromJsonValue(CategoriesIt->value()));
        }
    }
    {
        const auto NamesIt = object.find("names");
        if (NamesIt != object.end()) {
            setNames(JsonValueConverter<std::vector<std::shared_ptr<ItemPocketName>>>::fromJsonValue(NamesIt->value()));
        }
    }
}
...
void ItemPocketDetail::setName(std::string value)
{
...
void ItemPocketDetail::setCategories(std::vector<std::shared_ptr<ItemCategorySummary>> value)
{
...
void ItemPocketDetail::setNames(std::vector<std::shared_ptr<ItemPocketName>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ItemPocketDetail>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ItemPocketDetail>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ItemPocketDetail>>>::fromJsonValue(boost::json::parse(json));
}
