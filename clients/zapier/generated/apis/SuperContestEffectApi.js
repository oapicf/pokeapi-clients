const samples = require('../samples/SuperContestEffectApi');
const utils = require('../utils/utils');

module.exports = {
    superContestEffectList: {
        key: 'superContestEffectList',
        noun: 'super-contest-effect',
        display: {
            label: '',
            description: '',
            hidden: false,
    ...
    superContestEffectRead: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'superContestEffectRead', response.json);
                    return { data: results };
                })
            },
            sample: { data: {} }
