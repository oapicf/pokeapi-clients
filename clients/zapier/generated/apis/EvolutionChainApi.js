const samples = require('../samples/EvolutionChainApi');
const utils = require('../utils/utils');

module.exports = {
    evolutionChainList: {
        key: 'evolutionChainList',
        noun: 'evolution-chain',
        display: {
            label: '',
            description: '',
            hidden: false,
    ...
    evolutionChainRead: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'evolutionChainRead', response.json);
                    return { data: results };
                })
            },
            sample: { data: {} }
