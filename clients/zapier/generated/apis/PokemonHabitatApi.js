const samples = require('../samples/PokemonHabitatApi');
const utils = require('../utils/utils');

module.exports = {
    pokemonHabitatList: {
        key: 'pokemonHabitatList',
        noun: 'pokemon-habitat',
        display: {
            label: '',
            description: '',
            hidden: false,
    ...
    pokemonHabitatRead: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'pokemonHabitatRead', response.json);
                    return { data: results };
                })
            },
            sample: { data: {} }
