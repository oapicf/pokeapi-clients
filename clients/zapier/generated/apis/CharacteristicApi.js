const samples = require('../samples/CharacteristicApi');
    ...
    characteristicRead: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'characteristicRead', response.json);
                    return { data: results };
                })
            },
            sample: { data: {} }
