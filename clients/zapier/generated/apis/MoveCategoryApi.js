const samples = require('../samples/MoveCategoryApi');
    ...
    moveCategoryRead: {
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'moveCategoryRead', response.json);
                    return { data: results };
                })
            },
            sample: { data: {} }
