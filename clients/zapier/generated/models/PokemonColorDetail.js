...
const PokemonColorName = require('../models/PokemonColorName');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                children: PokemonColorName.fields(`${keyPrefix}names${!isInput ? '[]' : ''}`, isInput, true), 
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'names': utils.childMapping(bundle.inputData?.[`${keyPrefix}names`], `${keyPrefix}names`, PokemonColorName),
