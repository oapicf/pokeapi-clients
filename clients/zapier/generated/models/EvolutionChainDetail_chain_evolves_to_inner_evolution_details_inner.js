...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...EvolutionChainDetail_chain_evolves_to_inner_evolution_details_inner_gender.fields(`${keyPrefix}known_move`, isInput),
            ...EvolutionChainDetail_chain_evolves_to_inner_evolution_details_inner_gender.fields(`${keyPrefix}known_move_type`, isInput),
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'known_move': utils.removeIfEmpty(EvolutionChainDetail_chain_evolves_to_inner_evolution_details_inner_gender.mapping(bundle, `${keyPrefix}known_move`)),
            'known_move_type': utils.removeIfEmpty(EvolutionChainDetail_chain_evolves_to_inner_evolution_details_inner_gender.mapping(bundle, `${keyPrefix}known_move_type`)),
