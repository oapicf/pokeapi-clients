...
ItemApiApiV2ItemResource::ItemApiApiV2ItemResource(const std::string& context /* = "/api/v2" */)
{
...
ItemApiApiV2ItemIdResource::ItemApiApiV2ItemIdResource(const std::string& context /* = "/api/v2" */)
{
