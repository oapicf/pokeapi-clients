...
public:
    ...
    virtual void setEggGroupApiApiV2Egg-groupResource(std::shared_ptr<EggGroupApiApiV2Egg-groupResource> spEggGroupApiApiV2Egg-groupResource);
    virtual void setEggGroupApiApiV2Egg-groupIdResource(std::shared_ptr<EggGroupApiApiV2Egg-groupIdResource> spEggGroupApiApiV2Egg-groupIdResource);
...
protected:
	std::shared_ptr<EggGroupApiApiV2Egg-groupResource> m_spEggGroupApiApiV2Egg-groupResource;
	std::shared_ptr<EggGroupApiApiV2Egg-groupIdResource> m_spEggGroupApiApiV2Egg-groupIdResource;
