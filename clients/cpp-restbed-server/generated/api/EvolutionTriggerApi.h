...
public:
    ...
    virtual void setEvolutionTriggerApiApiV2Evolution-triggerResource(std::shared_ptr<EvolutionTriggerApiApiV2Evolution-triggerResource> spEvolutionTriggerApiApiV2Evolution-triggerResource);
    virtual void setEvolutionTriggerApiApiV2Evolution-triggerIdResource(std::shared_ptr<EvolutionTriggerApiApiV2Evolution-triggerIdResource> spEvolutionTriggerApiApiV2Evolution-triggerIdResource);
...
protected:
	std::shared_ptr<EvolutionTriggerApiApiV2Evolution-triggerResource> m_spEvolutionTriggerApiApiV2Evolution-triggerResource;
	std::shared_ptr<EvolutionTriggerApiApiV2Evolution-triggerIdResource> m_spEvolutionTriggerApiApiV2Evolution-triggerIdResource;
