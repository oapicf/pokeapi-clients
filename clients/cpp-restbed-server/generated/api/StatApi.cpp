...
StatApiApiV2StatResource::StatApiApiV2StatResource(const std::string& context /* = "/api/v2" */)
{
...
StatApiApiV2StatIdResource::StatApiApiV2StatIdResource(const std::string& context /* = "/api/v2" */)
{
