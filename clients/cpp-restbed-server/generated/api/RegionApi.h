...
public:
    ...
    virtual void setRegionApiApiV2RegionResource(std::shared_ptr<RegionApiApiV2RegionResource> spRegionApiApiV2RegionResource);
    virtual void setRegionApiApiV2RegionIdResource(std::shared_ptr<RegionApiApiV2RegionIdResource> spRegionApiApiV2RegionIdResource);
...
protected:
	std::shared_ptr<RegionApiApiV2RegionResource> m_spRegionApiApiV2RegionResource;
	std::shared_ptr<RegionApiApiV2RegionIdResource> m_spRegionApiApiV2RegionIdResource;
