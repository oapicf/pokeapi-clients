...
public:
    ...
    virtual void setTypeApiApiV2TypeResource(std::shared_ptr<TypeApiApiV2TypeResource> spTypeApiApiV2TypeResource);
    virtual void setTypeApiApiV2TypeIdResource(std::shared_ptr<TypeApiApiV2TypeIdResource> spTypeApiApiV2TypeIdResource);
...
protected:
	std::shared_ptr<TypeApiApiV2TypeResource> m_spTypeApiApiV2TypeResource;
	std::shared_ptr<TypeApiApiV2TypeIdResource> m_spTypeApiApiV2TypeIdResource;
