...
static bool pokemonReadProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
	void(* handler)(std::string, Error, void* )
	= reinterpret_cast<void(*)(std::string, Error, void* )> (voidHandler);
...
static bool pokemonReadHelper(char * accessToken,
	int id, 
	void(* handler)(std::string, Error, void* )
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		NetClient::easycurl(PokemonManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = pokemonReadProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (PokemonManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), pokemonReadProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool PokemonManager::pokemonReadAsync(char * accessToken,
	int id, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
	return pokemonReadHelper(accessToken,
	id, 
	handler, userData, true);
}

bool PokemonManager::pokemonReadSync(char * accessToken,
	int id, 
	void(* handler)(std::string, Error, void* )
	, void* userData)
{
