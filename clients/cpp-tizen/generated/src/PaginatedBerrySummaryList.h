...
#ifndef _PaginatedBerrySummaryList_H_
#define _PaginatedBerrySummaryList_H_
...
class PaginatedBerrySummaryList : public Object {
public:
	/*! \brief Constructor.
	 */
	PaginatedBerrySummaryList();
	PaginatedBerrySummaryList(char* str);
...
#endif /* _PaginatedBerrySummaryList_H_ */
