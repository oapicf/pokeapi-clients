...
void
PaginatedPokemonSpeciesSummaryList::__init()
{
	//count = int(0);
	//next = std::string();
	//previous = std::string();
...
void
PaginatedPokemonSpeciesSummaryList::__cleanup()
{
	//if(count != NULL) {
	//
	//delete count;
...
void
PaginatedPokemonSpeciesSummaryList::fromJson(char* jsonStr)
{
...
PaginatedPokemonSpeciesSummaryList::PaginatedPokemonSpeciesSummaryList(char* json)
{
	this->fromJson(json);
}
...
PaginatedPokemonSpeciesSummaryList::toJson()
{
	...
	if (isprimitive("PokemonSpeciesSummary")) {
		list<PokemonSpeciesSummary> new_list = static_cast<list <PokemonSpeciesSummary> > (getResults());
