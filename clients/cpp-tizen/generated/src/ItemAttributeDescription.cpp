...
void
ItemAttributeDescription::__init()
{
...
void
ItemAttributeDescription::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
ItemAttributeDescription::fromJson(char* jsonStr)
{
...
ItemAttributeDescription::ItemAttributeDescription(char* json)
{
	this->fromJson(json);
}
