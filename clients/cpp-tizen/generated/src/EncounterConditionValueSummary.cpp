...
void
EncounterConditionValueSummary::__init()
{
	//name = std::string();
	//url = std::string();
}
...
void
EncounterConditionValueSummary::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
EncounterConditionValueSummary::fromJson(char* jsonStr)
{
...
EncounterConditionValueSummary::EncounterConditionValueSummary(char* json)
{
	this->fromJson(json);
}
