...
void
PaginatedItemCategorySummaryList::__init()
{
	//count = int(0);
	//next = std::string();
	//previous = std::string();
...
void
PaginatedItemCategorySummaryList::__cleanup()
{
	//if(count != NULL) {
	//
	//delete count;
...
void
PaginatedItemCategorySummaryList::fromJson(char* jsonStr)
{
...
PaginatedItemCategorySummaryList::PaginatedItemCategorySummaryList(char* json)
{
	this->fromJson(json);
}
...
PaginatedItemCategorySummaryList::toJson()
{
	...
	if (isprimitive("ItemCategorySummary")) {
		list<ItemCategorySummary> new_list = static_cast<list <ItemCategorySummary> > (getResults());
