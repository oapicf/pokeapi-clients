...
#ifndef _PaginatedLanguageSummaryList_H_
#define _PaginatedLanguageSummaryList_H_
...
class PaginatedLanguageSummaryList : public Object {
public:
	/*! \brief Constructor.
	 */
	PaginatedLanguageSummaryList();
	PaginatedLanguageSummaryList(char* str);
...
#endif /* _PaginatedLanguageSummaryList_H_ */
