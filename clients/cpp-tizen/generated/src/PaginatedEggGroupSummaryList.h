...
#ifndef _PaginatedEggGroupSummaryList_H_
#define _PaginatedEggGroupSummaryList_H_
...
class PaginatedEggGroupSummaryList : public Object {
public:
	/*! \brief Constructor.
	 */
	PaginatedEggGroupSummaryList();
	PaginatedEggGroupSummaryList(char* str);
...
#endif /* _PaginatedEggGroupSummaryList_H_ */
