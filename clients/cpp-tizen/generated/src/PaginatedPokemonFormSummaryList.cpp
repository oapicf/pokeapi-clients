...
void
PaginatedPokemonFormSummaryList::__init()
{
	//count = int(0);
	//next = std::string();
	//previous = std::string();
...
void
PaginatedPokemonFormSummaryList::__cleanup()
{
	//if(count != NULL) {
	//
	//delete count;
...
void
PaginatedPokemonFormSummaryList::fromJson(char* jsonStr)
{
...
PaginatedPokemonFormSummaryList::PaginatedPokemonFormSummaryList(char* json)
{
	this->fromJson(json);
}
...
PaginatedPokemonFormSummaryList::toJson()
{
	...
	if (isprimitive("PokemonFormSummary")) {
		list<PokemonFormSummary> new_list = static_cast<list <PokemonFormSummary> > (getResults());
