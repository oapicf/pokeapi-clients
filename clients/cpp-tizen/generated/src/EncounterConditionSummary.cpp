...
void
EncounterConditionSummary::__init()
{
	//name = std::string();
	//url = std::string();
}
...
void
EncounterConditionSummary::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
EncounterConditionSummary::fromJson(char* jsonStr)
{
...
EncounterConditionSummary::EncounterConditionSummary(char* json)
{
	this->fromJson(json);
}
