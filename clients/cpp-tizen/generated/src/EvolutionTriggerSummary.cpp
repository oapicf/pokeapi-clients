...
void
EvolutionTriggerSummary::__init()
{
	//name = std::string();
	//url = std::string();
}
...
void
EvolutionTriggerSummary::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
EvolutionTriggerSummary::fromJson(char* jsonStr)
{
...
EvolutionTriggerSummary::EvolutionTriggerSummary(char* json)
{
	this->fromJson(json);
}
