...
void
MoveBattleStyleSummary::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
MoveBattleStyleSummary::fromJson(char* jsonStr)
{
...
MoveBattleStyleSummary::MoveBattleStyleSummary(char* json)
{
	this->fromJson(json);
}
