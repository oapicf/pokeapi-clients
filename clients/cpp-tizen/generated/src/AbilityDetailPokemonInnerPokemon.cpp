...
void
AbilityDetail_pokemon_inner_pokemon::__init()
{
	//name = std::string();
	//url = std::string();
}
...
void
AbilityDetail_pokemon_inner_pokemon::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
AbilityDetail_pokemon_inner_pokemon::fromJson(char* jsonStr)
{
...
AbilityDetail_pokemon_inner_pokemon::AbilityDetail_pokemon_inner_pokemon(char* json)
{
	this->fromJson(json);
}
