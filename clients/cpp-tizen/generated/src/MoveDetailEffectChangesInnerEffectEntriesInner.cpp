...
void
MoveDetail_effect_changes_inner_effect_entries_inner::__init()
{
	//effect = std::string();
...
void
MoveDetail_effect_changes_inner_effect_entries_inner::__cleanup()
{
	//if(effect != NULL) {
	//
	//delete effect;
...
void
MoveDetail_effect_changes_inner_effect_entries_inner::fromJson(char* jsonStr)
{
...
MoveDetail_effect_changes_inner_effect_entries_inner::MoveDetail_effect_changes_inner_effect_entries_inner(char* json)
{
	this->fromJson(json);
}
