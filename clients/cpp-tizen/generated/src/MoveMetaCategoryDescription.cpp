...
void
MoveMetaCategoryDescription::__init()
{
...
void
MoveMetaCategoryDescription::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
MoveMetaCategoryDescription::fromJson(char* jsonStr)
{
...
MoveMetaCategoryDescription::MoveMetaCategoryDescription(char* json)
{
	this->fromJson(json);
}
