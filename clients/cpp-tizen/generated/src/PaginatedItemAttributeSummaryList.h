...
#ifndef _PaginatedItemAttributeSummaryList_H_
#define _PaginatedItemAttributeSummaryList_H_
...
class PaginatedItemAttributeSummaryList : public Object {
public:
	/*! \brief Constructor.
	 */
	PaginatedItemAttributeSummaryList();
	PaginatedItemAttributeSummaryList(char* str);
...
#endif /* _PaginatedItemAttributeSummaryList_H_ */
