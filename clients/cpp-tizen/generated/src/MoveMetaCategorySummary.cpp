...
void
MoveMetaCategorySummary::__init()
{
	//name = std::string();
	//url = std::string();
}
...
void
MoveMetaCategorySummary::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
MoveMetaCategorySummary::fromJson(char* jsonStr)
{
...
MoveMetaCategorySummary::MoveMetaCategorySummary(char* json)
{
	this->fromJson(json);
}
