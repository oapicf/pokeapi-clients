...
void
PaginatedCharacteristicSummaryList::__init()
{
	//count = int(0);
	//next = std::string();
	//previous = std::string();
...
void
PaginatedCharacteristicSummaryList::__cleanup()
{
	//if(count != NULL) {
	//
	//delete count;
...
void
PaginatedCharacteristicSummaryList::fromJson(char* jsonStr)
{
...
PaginatedCharacteristicSummaryList::PaginatedCharacteristicSummaryList(char* json)
{
	this->fromJson(json);
}
...
PaginatedCharacteristicSummaryList::toJson()
{
	...
	if (isprimitive("CharacteristicSummary")) {
		list<CharacteristicSummary> new_list = static_cast<list <CharacteristicSummary> > (getResults());
