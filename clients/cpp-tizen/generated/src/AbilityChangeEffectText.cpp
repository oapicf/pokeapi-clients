...
void
AbilityChangeEffectText::__init()
{
	//effect = std::string();
...
void
AbilityChangeEffectText::__cleanup()
{
	//if(effect != NULL) {
	//
	//delete effect;
...
void
AbilityChangeEffectText::fromJson(char* jsonStr)
{
...
AbilityChangeEffectText::AbilityChangeEffectText(char* json)
{
	this->fromJson(json);
}
