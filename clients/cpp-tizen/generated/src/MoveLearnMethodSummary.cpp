...
void
MoveLearnMethodSummary::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
MoveLearnMethodSummary::fromJson(char* jsonStr)
{
...
MoveLearnMethodSummary::MoveLearnMethodSummary(char* json)
{
	this->fromJson(json);
}
