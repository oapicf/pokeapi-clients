...
void
GrowthRateDescription::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
GrowthRateDescription::fromJson(char* jsonStr)
{
...
GrowthRateDescription::GrowthRateDescription(char* json)
{
	this->fromJson(json);
}
