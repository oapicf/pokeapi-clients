...
void
EvolutionTriggerName::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
EvolutionTriggerName::fromJson(char* jsonStr)
{
...
EvolutionTriggerName::EvolutionTriggerName(char* json)
{
	this->fromJson(json);
}
