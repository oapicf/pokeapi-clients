...
#ifndef _PaginatedEncounterConditionValueSummaryList_H_
#define _PaginatedEncounterConditionValueSummaryList_H_
...
class PaginatedEncounterConditionValueSummaryList : public Object {
public:
	/*! \brief Constructor.
	 */
	PaginatedEncounterConditionValueSummaryList();
	PaginatedEncounterConditionValueSummaryList(char* str);
...
#endif /* _PaginatedEncounterConditionValueSummaryList_H_ */
