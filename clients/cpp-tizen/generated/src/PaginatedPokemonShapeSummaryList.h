...
#ifndef _PaginatedPokemonShapeSummaryList_H_
#define _PaginatedPokemonShapeSummaryList_H_
...
class PaginatedPokemonShapeSummaryList : public Object {
public:
	/*! \brief Constructor.
	 */
	PaginatedPokemonShapeSummaryList();
	PaginatedPokemonShapeSummaryList(char* str);
...
#endif /* _PaginatedPokemonShapeSummaryList_H_ */
