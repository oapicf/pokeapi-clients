...
void
EvolutionChainSummary::__init()
{
	//url = std::string();
}

void
EvolutionChainSummary::__cleanup()
{
	//if(url != NULL) {
	//
	//delete url;
...
void
EvolutionChainSummary::fromJson(char* jsonStr)
{
...
EvolutionChainSummary::EvolutionChainSummary(char* json)
{
	this->fromJson(json);
}
