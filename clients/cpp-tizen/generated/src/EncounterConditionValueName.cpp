...
void
EncounterConditionValueName::__init()
{
	//name = std::string();
...
void
EncounterConditionValueName::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
EncounterConditionValueName::fromJson(char* jsonStr)
{
...
EncounterConditionValueName::EncounterConditionValueName(char* json)
{
	this->fromJson(json);
}
