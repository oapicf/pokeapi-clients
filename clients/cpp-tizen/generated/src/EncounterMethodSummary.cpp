...
void
EncounterMethodSummary::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
EncounterMethodSummary::fromJson(char* jsonStr)
{
...
EncounterMethodSummary::EncounterMethodSummary(char* json)
{
	this->fromJson(json);
}
