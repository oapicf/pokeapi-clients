...
void
PokemonSpeciesSummary::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
PokemonSpeciesSummary::fromJson(char* jsonStr)
{
...
PokemonSpeciesSummary::PokemonSpeciesSummary(char* json)
{
	this->fromJson(json);
}
