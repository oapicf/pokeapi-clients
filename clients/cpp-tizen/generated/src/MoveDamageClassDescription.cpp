...
void
MoveDamageClassDescription::__init()
{
...
void
MoveDamageClassDescription::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
MoveDamageClassDescription::fromJson(char* jsonStr)
{
...
MoveDamageClassDescription::MoveDamageClassDescription(char* json)
{
	this->fromJson(json);
}
