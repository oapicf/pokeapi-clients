...
void
PokeathlonStatDetail_affecting_natures_decrease_inner::__init()
{
	//max_change = int(0);
...
void
PokeathlonStatDetail_affecting_natures_decrease_inner::__cleanup()
{
	//if(max_change != NULL) {
	//
	//delete max_change;
...
void
PokeathlonStatDetail_affecting_natures_decrease_inner::fromJson(char* jsonStr)
{
...
PokeathlonStatDetail_affecting_natures_decrease_inner::PokeathlonStatDetail_affecting_natures_decrease_inner(char* json)
{
	this->fromJson(json);
}

char*
PokeathlonStatDetail_affecting_natures_decrease_inner::toJson()
{
...
int
PokeathlonStatDetail_affecting_natures_decrease_inner::getMaxChange()
{
	return max_change;
}

void
PokeathlonStatDetail_affecting_natures_decrease_inner::setMaxChange(int  max_change)
{
	this->max_change = max_change;
}

AbilityDetail_pokemon_inner_pokemon
PokeathlonStatDetail_affecting_natures_decrease_inner::getNature()
{
	return nature;
}

void
PokeathlonStatDetail_affecting_natures_decrease_inner::setNature(AbilityDetail_pokemon_inner_pokemon  nature)
{
	this->nature = nature;
}
