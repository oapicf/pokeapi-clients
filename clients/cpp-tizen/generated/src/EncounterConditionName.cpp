...
void
EncounterConditionName::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
EncounterConditionName::fromJson(char* jsonStr)
{
...
EncounterConditionName::EncounterConditionName(char* json)
{
	this->fromJson(json);
}
