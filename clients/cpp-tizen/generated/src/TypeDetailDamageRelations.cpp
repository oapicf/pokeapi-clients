...
void
TypeDetail_damage_relations::__init()
{
...
void
TypeDetail_damage_relations::__cleanup()
{
...
void
TypeDetail_damage_relations::fromJson(char* jsonStr)
{
...
TypeDetail_damage_relations::TypeDetail_damage_relations(char* json)
{
	this->fromJson(json);
}
