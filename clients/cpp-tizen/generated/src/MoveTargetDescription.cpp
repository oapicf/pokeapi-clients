...
void
MoveTargetDescription::__cleanup()
{
	//if(description != NULL) {
	//
	//delete description;
...
void
MoveTargetDescription::fromJson(char* jsonStr)
{
...
MoveTargetDescription::MoveTargetDescription(char* json)
{
	this->fromJson(json);
}
