...
void
PaginatedEncounterConditionValueSummaryList::__init()
{
	//count = int(0);
	//next = std::string();
	//previous = std::string();
...
void
PaginatedEncounterConditionValueSummaryList::__cleanup()
{
	//if(count != NULL) {
	//
	//delete count;
...
void
PaginatedEncounterConditionValueSummaryList::fromJson(char* jsonStr)
{
...
PaginatedEncounterConditionValueSummaryList::PaginatedEncounterConditionValueSummaryList(char* json)
{
	this->fromJson(json);
}
...
PaginatedEncounterConditionValueSummaryList::toJson()
{
	...
	if (isprimitive("EncounterConditionValueSummary")) {
		list<EncounterConditionValueSummary> new_list = static_cast<list <EncounterConditionValueSummary> > (getResults());
