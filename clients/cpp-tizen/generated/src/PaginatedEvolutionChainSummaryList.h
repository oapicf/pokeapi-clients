...
#ifndef _PaginatedEvolutionChainSummaryList_H_
#define _PaginatedEvolutionChainSummaryList_H_
...
class PaginatedEvolutionChainSummaryList : public Object {
public:
	/*! \brief Constructor.
	 */
	PaginatedEvolutionChainSummaryList();
	PaginatedEvolutionChainSummaryList(char* str);
...
#endif /* _PaginatedEvolutionChainSummaryList_H_ */
