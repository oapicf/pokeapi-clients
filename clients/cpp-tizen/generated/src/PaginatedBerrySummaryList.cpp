...
void
PaginatedBerrySummaryList::__init()
{
	//count = int(0);
	//next = std::string();
	//previous = std::string();
...
void
PaginatedBerrySummaryList::__cleanup()
{
	//if(count != NULL) {
	//
	//delete count;
...
void
PaginatedBerrySummaryList::fromJson(char* jsonStr)
{
...
PaginatedBerrySummaryList::PaginatedBerrySummaryList(char* json)
{
	this->fromJson(json);
}

char*
PaginatedBerrySummaryList::toJson()
{
	...
	if (isprimitive("BerrySummary")) {
		list<BerrySummary> new_list = static_cast<list <BerrySummary> > (getResults());
...
int
PaginatedBerrySummaryList::getCount()
{
	return count;
}
...
std::string
PaginatedBerrySummaryList::getNext()
{
	return next;
}
...
std::string
PaginatedBerrySummaryList::getPrevious()
{
	return previous;
}
...
PaginatedBerrySummaryList::getResults()
{
	return results;
}
