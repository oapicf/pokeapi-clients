...
module OpenAPIClient
  class ItemPocketDetail
    ...
    @[JSON::Field(key: "categories", type: Array(ItemCategorySummary), nillable: false, emit_null: false)]
    property categories : Array(ItemCategorySummary)

    @[JSON::Field(key: "names", type: Array(ItemPocketName), nillable: false, emit_null: false)]
    property names : Array(ItemPocketName)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32, @name : String, @categories : Array(ItemCategorySummary), @names : Array(ItemPocketName))
    end
