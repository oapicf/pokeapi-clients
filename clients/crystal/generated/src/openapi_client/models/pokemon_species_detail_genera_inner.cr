...
module OpenAPIClient
  class PokemonSpeciesDetailGeneraInner
    ...
    # Required properties
    @[JSON::Field(key: "genus", type: String, nillable: false, emit_null: false)]
    ...
    def initialize(@genus : String, @language : AbilityDetailPokemonInnerPokemon)
    end
