...
module OpenAPIClient
  class PokemonDetailTypesInner
    ...
    @[JSON::Field(key: "type", type: AbilityDetailPokemonInnerPokemon, nillable: false, emit_null: false)]
    property _type : AbilityDetailPokemonInnerPokemon

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@slot : Int32, @_type : AbilityDetailPokemonInnerPokemon)
    end
