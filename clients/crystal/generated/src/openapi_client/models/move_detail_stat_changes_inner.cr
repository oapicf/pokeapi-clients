...
module OpenAPIClient
  class MoveDetailStatChangesInner
    ...
    @[JSON::Field(key: "stat", type: AbilityDetailPokemonInnerPokemon, nillable: false, emit_null: false)]
    property stat : AbilityDetailPokemonInnerPokemon

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@change : Int32, @stat : AbilityDetailPokemonInnerPokemon)
    end
