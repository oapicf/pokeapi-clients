...
module OpenAPIClient
  class BerryFlavorDetailBerriesInner
    ...
    # Required properties
    @[JSON::Field(key: "potency", type: Int32, nillable: false, emit_null: false)]
    property potency : Int32

    @[JSON::Field(key: "berry", type: BerryFlavorDetailBerriesInnerBerry, nillable: false, emit_null: false)]
    property berry : BerryFlavorDetailBerriesInnerBerry

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@potency : Int32, @berry : BerryFlavorDetailBerriesInnerBerry)
    end
    ...
    def to_h
      ...
      hash["potency"] = _to_h(potency)
      hash["berry"] = _to_h(berry)
      hash.to_h
    end
