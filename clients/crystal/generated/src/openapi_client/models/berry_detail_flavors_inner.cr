...
module OpenAPIClient
  class BerryDetailFlavorsInner
    ...
    @[JSON::Field(key: "flavor", type: BerryDetailFlavorsInnerFlavor, nillable: false, emit_null: false)]
    property flavor : BerryDetailFlavorsInnerFlavor

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@potency : Int32, @flavor : BerryDetailFlavorsInnerFlavor)
    end
