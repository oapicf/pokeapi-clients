...
module OpenAPIClient
  class EncounterMethodDetail
    ...
    @[JSON::Field(key: "names", type: Array(EncounterMethodName), nillable: false, emit_null: false)]
    property names : Array(EncounterMethodName)
    ...
    def initialize(@id : Int32, @name : String, @names : Array(EncounterMethodName), @order : Int32? = nil)
    end
