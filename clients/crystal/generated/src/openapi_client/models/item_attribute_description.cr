...
module OpenAPIClient
  class ItemAttributeDescription
    ...
    def initialize(@language : LanguageSummary, @description : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@description.nil? && @description.try &.to_s.try &.size.try &.> 1000
    ...
    def valid?
      return false if !@description.nil? && @description.try &.to_s.try &.size.try &.> 1000
      true
    end
