...
module OpenAPIClient
  class MoveBattleStyleDetail
    ...
    @[JSON::Field(key: "names", type: Array(MoveBattleStyleName), nillable: false, emit_null: false)]
    property names : Array(MoveBattleStyleName)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32, @name : String, @names : Array(MoveBattleStyleName))
    end
