...
module OpenAPIClient
  class EncounterConditionDetail
    ...
    @[JSON::Field(key: "values", type: Array(EncounterConditionValueSummary), nillable: false, emit_null: false)]
    property values : Array(EncounterConditionValueSummary)

    @[JSON::Field(key: "names", type: Array(EncounterConditionName), nillable: false, emit_null: false)]
    property names : Array(EncounterConditionName)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32, @name : String, @values : Array(EncounterConditionValueSummary), @names : Array(EncounterConditionName))
    end
