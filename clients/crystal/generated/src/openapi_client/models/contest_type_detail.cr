...
module OpenAPIClient
  class ContestTypeDetail
    ...
    @[JSON::Field(key: "berry_flavor", type: BerryFlavorSummary, nillable: false, emit_null: false)]
    property berry_flavor : BerryFlavorSummary

    @[JSON::Field(key: "names", type: Array(ContestTypeName), nillable: false, emit_null: false)]
    property names : Array(ContestTypeName)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32, @name : String, @berry_flavor : BerryFlavorSummary, @names : Array(ContestTypeName))
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          id == other.id &&
          name == other.name &&
          berry_flavor == other.berry_flavor &&
          names == other.names
    end
    ...
    def to_h
      ...
      hash["berry_flavor"] = _to_h(berry_flavor)
