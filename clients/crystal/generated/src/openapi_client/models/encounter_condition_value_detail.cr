...
module OpenAPIClient
  class EncounterConditionValueDetail
    ...
    @[JSON::Field(key: "condition", type: EncounterConditionSummary, nillable: false, emit_null: false)]
    property condition : EncounterConditionSummary

    @[JSON::Field(key: "names", type: Array(EncounterConditionValueName), nillable: false, emit_null: false)]
    property names : Array(EncounterConditionValueName)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32, @name : String, @condition : EncounterConditionSummary, @names : Array(EncounterConditionValueName))
    end
