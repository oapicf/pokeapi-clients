...
module OpenAPIClient
  class StatDetailAffectingMovesIncreaseInner
    ...
    # Required properties
    @[JSON::Field(key: "change", type: Int32, nillable: false, emit_null: false)]
    ...
    def initialize(@change : Int32, @move : AbilityDetailPokemonInnerPokemon)
    end
