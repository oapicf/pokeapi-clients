...
module OpenAPIClient
  ...
  class VersionDetail
    ...
    @[JSON::Field(key: "names", type: Array(VersionName), nillable: false, emit_null: false)]
    property names : Array(VersionName)
    ...
    def initialize(@id : Int32, @name : String, @names : Array(VersionName), @version_group : VersionGroupSummary)
    end
