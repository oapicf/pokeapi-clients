...
module OpenAPIClient
  class Experience
    ...
    # Required properties
    @[JSON::Field(key: "level", type: Int32, nillable: false, emit_null: false)]
    property level : Int32

    @[JSON::Field(key: "experience", type: Int32, nillable: false, emit_null: false)]
    property experience : Int32

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@level : Int32, @experience : Int32)
    end
    ...
    def to_h
      ...
      hash["experience"] = _to_h(experience)
      hash.to_h
    end
