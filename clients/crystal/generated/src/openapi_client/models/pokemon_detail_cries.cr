...
module OpenAPIClient
  class PokemonDetailCries
    ...
    # Required properties
    @[JSON::Field(key: "latest", type: String, nillable: false, emit_null: false)]
    property latest : String

    @[JSON::Field(key: "legacy", type: String, nillable: false, emit_null: false)]
    property legacy : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@latest : String, @legacy : String)
    end
