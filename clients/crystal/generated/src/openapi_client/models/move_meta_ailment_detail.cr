...
module OpenAPIClient
  class MoveMetaAilmentDetail
    ...
    @[JSON::Field(key: "names", type: Array(MoveMetaAilmentName), nillable: false, emit_null: false)]
    property names : Array(MoveMetaAilmentName)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : Int32, @name : String, @moves : Array(AbilityDetailPokemonInnerPokemon), @names : Array(MoveMetaAilmentName))
    end
