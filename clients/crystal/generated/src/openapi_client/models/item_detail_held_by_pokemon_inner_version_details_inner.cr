...
module OpenAPIClient
  class ItemDetailHeldByPokemonInnerVersionDetailsInner
    ...
    # Required properties
    @[JSON::Field(key: "rarity", type: Int32, nillable: false, emit_null: false)]
    ...
    def initialize(@rarity : Int32, @version : AbilityDetailPokemonInnerPokemon)
    end
