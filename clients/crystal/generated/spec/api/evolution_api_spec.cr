...
# Unit tests for OpenAPIClient::EvolutionApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "EvolutionApi" do
  describe "test an instance of EvolutionApi" do
    it "should create an instance of EvolutionApi" do
      api_instance = OpenAPIClient::EvolutionApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::EvolutionApi)
    end
  end
