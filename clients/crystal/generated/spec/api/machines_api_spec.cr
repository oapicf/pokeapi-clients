...
# Unit tests for OpenAPIClient::MachinesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "MachinesApi" do
  describe "test an instance of MachinesApi" do
    it "should create an instance of MachinesApi" do
      api_instance = OpenAPIClient::MachinesApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::MachinesApi)
    end
  end
  ...
  describe "machine_retrieve test" do
    skip "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
