...
/*
 * OAIPaginatedEncounterMethodSummaryList.h
 *
 * 
 */

#ifndef OAIPaginatedEncounterMethodSummaryList_H
#define OAIPaginatedEncounterMethodSummaryList_H
...
namespace OpenAPI {
class OAIEncounterMethodSummary;
...
public:
    ...
    QList<OAIEncounterMethodSummary> getResults() const;
    void setResults(const QList<OAIEncounterMethodSummary> &results);
...
private:
    ...
    QList<OAIEncounterMethodSummary> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginatedEncounterMethodSummaryList)

#endif // OAIPaginatedEncounterMethodSummaryList_H
