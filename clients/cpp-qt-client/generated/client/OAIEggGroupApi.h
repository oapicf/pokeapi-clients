...
#ifndef OAI_OAIEggGroupApi_H
#define OAI_OAIEggGroupApi_H
...
class OAIEggGroupApi : public QObject {
    Q_OBJECT

public:
    OAIEggGroupApi(const int timeOut = 0);
    ~OAIEggGroupApi();
    ...
    */
    virtual void eggGroupList(const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &offset = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void eggGroupRead(const qint32 &id);
...
private:
    ...
    void eggGroupReadCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void eggGroupListSignal(QString summary);
    void eggGroupReadSignal(QString summary);
