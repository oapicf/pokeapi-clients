...
#ifndef OAI_OAIMoveLearnMethodApi_H
#define OAI_OAIMoveLearnMethodApi_H
...
class OAIMoveLearnMethodApi : public QObject {
    Q_OBJECT

public:
    OAIMoveLearnMethodApi(const int timeOut = 0);
...
private:
    ...
    void moveLearnMethodReadCallback(OAIHttpRequestWorker *worker);
