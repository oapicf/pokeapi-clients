...
#ifndef OAI_OAIGrowthRateApi_H
#define OAI_OAIGrowthRateApi_H
...
class OAIGrowthRateApi : public QObject {
    Q_OBJECT

public:
    OAIGrowthRateApi(const int timeOut = 0);
    ~OAIGrowthRateApi();
    ...
    */
    virtual void growthRateList(const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &offset = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void growthRateRead(const qint32 &id);
...
private:
    ...
    void growthRateReadCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void growthRateListSignal(QString summary);
    void growthRateReadSignal(QString summary);
