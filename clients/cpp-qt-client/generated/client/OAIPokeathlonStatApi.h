...
#ifndef OAI_OAIPokeathlonStatApi_H
#define OAI_OAIPokeathlonStatApi_H
...
class OAIPokeathlonStatApi : public QObject {
    Q_OBJECT

public:
    OAIPokeathlonStatApi(const int timeOut = 0);
    ...
    */
    virtual void pokeathlonStatList(const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &offset = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void pokeathlonStatRead(const qint32 &id);
...
private:
    ...
    void pokeathlonStatReadCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void pokeathlonStatListSignal(QString summary);
    void pokeathlonStatReadSignal(QString summary);
