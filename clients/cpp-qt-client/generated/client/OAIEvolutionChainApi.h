...
#ifndef OAI_OAIEvolutionChainApi_H
#define OAI_OAIEvolutionChainApi_H
...
class OAIEvolutionChainApi : public QObject {
    Q_OBJECT

public:
    OAIEvolutionChainApi(const int timeOut = 0);
    ...
    */
    virtual void evolutionChainList(const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &offset = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void evolutionChainRead(const qint32 &id);
...
private:
    ...
    void evolutionChainReadCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void evolutionChainListSignal(QString summary);
    void evolutionChainReadSignal(QString summary);
