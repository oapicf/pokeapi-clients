...
public:
    ...
    */
    virtual void regionList(const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &offset = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void regionRead(const qint32 &id);
...
private:
    ...
    void regionReadCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void regionListSignal(QString summary);
    void regionReadSignal(QString summary);
