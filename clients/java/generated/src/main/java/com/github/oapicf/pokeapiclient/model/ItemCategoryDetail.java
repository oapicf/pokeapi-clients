...
import com.github.oapicf.pokeapiclient.model.ItemCategoryName;
...
public class ItemCategoryDetail {
  ...
  public ItemCategoryDetail name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public void setPocket(@javax.annotation.Nonnull ItemPocketSummary pocket) {
    this.pocket = pocket;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "items", "names", "pocket"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "name", "items", "names", "pocket"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemCategoryDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemCategoryDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ItemCategoryDetail is not found in the empty JSON string", ItemCategoryDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemCategoryDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ItemCategoryDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ItemCategoryDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemCategoryDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemCategoryDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemCategoryDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemCategoryDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemCategoryDetail>() {
           @Override
           public void write(JsonWriter out, ItemCategoryDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemCategoryDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemCategoryDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemCategoryDetail
   * @throws IOException if the JSON string is invalid with respect to ItemCategoryDetail
   */
  public static ItemCategoryDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemCategoryDetail.class);
  }

  /**
   * Convert an instance of ItemCategoryDetail to an JSON string
   *
   * @return JSON string
   */
