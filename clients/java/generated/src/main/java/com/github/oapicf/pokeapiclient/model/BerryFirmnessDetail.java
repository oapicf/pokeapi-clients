...
import com.github.oapicf.pokeapiclient.model.BerryFirmnessName;
...
public class BerryFirmnessDetail {
  ...
  public BerryFirmnessDetail name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "berries", "names"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "name", "berries", "names"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BerryFirmnessDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BerryFirmnessDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BerryFirmnessDetail is not found in the empty JSON string", BerryFirmnessDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BerryFirmnessDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BerryFirmnessDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BerryFirmnessDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BerryFirmnessDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BerryFirmnessDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BerryFirmnessDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BerryFirmnessDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<BerryFirmnessDetail>() {
           @Override
           public void write(JsonWriter out, BerryFirmnessDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BerryFirmnessDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BerryFirmnessDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BerryFirmnessDetail
   * @throws IOException if the JSON string is invalid with respect to BerryFirmnessDetail
   */
  public static BerryFirmnessDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BerryFirmnessDetail.class);
  }

  /**
   * Convert an instance of BerryFirmnessDetail to an JSON string
   *
   * @return JSON string
   */
