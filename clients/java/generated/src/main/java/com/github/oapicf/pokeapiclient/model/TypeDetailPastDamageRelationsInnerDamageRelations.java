...
public class TypeDetailPastDamageRelationsInnerDamageRelations {
  ...
  public TypeDetailPastDamageRelationsInnerDamageRelations noDamageTo(@javax.annotation.Nonnull List<AbilityDetailPokemonInnerPokemon> noDamageTo) {
  ...
  public TypeDetailPastDamageRelationsInnerDamageRelations halfDamageTo(@javax.annotation.Nonnull List<AbilityDetailPokemonInnerPokemon> halfDamageTo) {
  ...
  public TypeDetailPastDamageRelationsInnerDamageRelations doubleDamageTo(@javax.annotation.Nonnull List<AbilityDetailPokemonInnerPokemon> doubleDamageTo) {
  ...
  public TypeDetailPastDamageRelationsInnerDamageRelations noDamageFrom(@javax.annotation.Nonnull List<AbilityDetailPokemonInnerPokemon> noDamageFrom) {
  ...
  public TypeDetailPastDamageRelationsInnerDamageRelations halfDamageFrom(@javax.annotation.Nonnull List<AbilityDetailPokemonInnerPokemon> halfDamageFrom) {
  ...
  public TypeDetailPastDamageRelationsInnerDamageRelations doubleDamageFrom(@javax.annotation.Nonnull List<AbilityDetailPokemonInnerPokemon> doubleDamageFrom) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to TypeDetailPastDamageRelationsInnerDamageRelations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypeDetailPastDamageRelationsInnerDamageRelations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TypeDetailPastDamageRelationsInnerDamageRelations is not found in the empty JSON string", TypeDetailPastDamageRelationsInnerDamageRelations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TypeDetailPastDamageRelationsInnerDamageRelations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TypeDetailPastDamageRelationsInnerDamageRelations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TypeDetailPastDamageRelationsInnerDamageRelations.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TypeDetailPastDamageRelationsInnerDamageRelations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TypeDetailPastDamageRelationsInnerDamageRelations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TypeDetailPastDamageRelationsInnerDamageRelations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TypeDetailPastDamageRelationsInnerDamageRelations.class));

       return (TypeAdapter<T>) new TypeAdapter<TypeDetailPastDamageRelationsInnerDamageRelations>() {
           @Override
           public void write(JsonWriter out, TypeDetailPastDamageRelationsInnerDamageRelations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TypeDetailPastDamageRelationsInnerDamageRelations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TypeDetailPastDamageRelationsInnerDamageRelations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TypeDetailPastDamageRelationsInnerDamageRelations
   * @throws IOException if the JSON string is invalid with respect to TypeDetailPastDamageRelationsInnerDamageRelations
   */
  public static TypeDetailPastDamageRelationsInnerDamageRelations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TypeDetailPastDamageRelationsInnerDamageRelations.class);
  }

  /**
   * Convert an instance of TypeDetailPastDamageRelationsInnerDamageRelations to an JSON string
   *
   * @return JSON string
   */
