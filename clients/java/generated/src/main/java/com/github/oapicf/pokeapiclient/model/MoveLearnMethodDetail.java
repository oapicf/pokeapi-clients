...
import com.github.oapicf.pokeapiclient.model.MoveLearnMethodDescription;
import com.github.oapicf.pokeapiclient.model.MoveLearnMethodName;
...
public class MoveLearnMethodDetail {
  ...
  public MoveLearnMethodDetail name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "names", "descriptions", "version_groups"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "name", "names", "descriptions", "version_groups"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MoveLearnMethodDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MoveLearnMethodDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MoveLearnMethodDetail is not found in the empty JSON string", MoveLearnMethodDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MoveLearnMethodDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MoveLearnMethodDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MoveLearnMethodDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MoveLearnMethodDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MoveLearnMethodDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MoveLearnMethodDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MoveLearnMethodDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<MoveLearnMethodDetail>() {
           @Override
           public void write(JsonWriter out, MoveLearnMethodDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MoveLearnMethodDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MoveLearnMethodDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MoveLearnMethodDetail
   * @throws IOException if the JSON string is invalid with respect to MoveLearnMethodDetail
   */
  public static MoveLearnMethodDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MoveLearnMethodDetail.class);
  }

  /**
   * Convert an instance of MoveLearnMethodDetail to an JSON string
   *
   * @return JSON string
   */
