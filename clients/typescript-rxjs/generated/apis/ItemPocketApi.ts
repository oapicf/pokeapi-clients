...
export class ItemPocketApi extends BaseAPI {
    ...
    itemPocketList({ limit, offset }: ItemPocketListRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    itemPocketList({ limit, offset }: ItemPocketListRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
    ...
    itemPocketRead({ id }: ItemPocketReadRequest, opts?: OperationOpts): Observable<RawAjaxResponse<string>>
    itemPocketRead({ id }: ItemPocketReadRequest, opts?: OperationOpts): Observable<string | RawAjaxResponse<string>> {
