...
export class MoveDamageClassApi {
     ...
     * @param offset
     */
    public moveDamageClassList(limit?: number, offset?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param id
     */
    public moveDamageClassRead(id: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: string;  },
    { response: JQueryXHR; errorThrown: string }
    > {
