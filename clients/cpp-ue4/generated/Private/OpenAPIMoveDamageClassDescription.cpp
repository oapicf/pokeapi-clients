...
void OpenAPIMoveDamageClassDescription::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMoveDamageClassDescription::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
