...
void OpenAPICharacteristicDescription::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICharacteristicDescription::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
