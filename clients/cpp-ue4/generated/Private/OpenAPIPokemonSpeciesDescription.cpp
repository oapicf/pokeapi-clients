...
void OpenAPIPokemonSpeciesDescription::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPokemonSpeciesDescription::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
