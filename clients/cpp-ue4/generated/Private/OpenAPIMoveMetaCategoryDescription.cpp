...
void OpenAPIMoveMetaCategoryDescription::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMoveMetaCategoryDescription::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
