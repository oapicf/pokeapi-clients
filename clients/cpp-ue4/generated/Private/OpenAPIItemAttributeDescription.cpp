...
void OpenAPIItemAttributeDescription::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIItemAttributeDescription::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
