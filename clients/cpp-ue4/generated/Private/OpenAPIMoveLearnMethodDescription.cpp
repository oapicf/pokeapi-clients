...
void OpenAPIMoveLearnMethodDescription::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMoveLearnMethodDescription::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
