...
case class EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner (
    ...
    _knownMove: EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerGender,
    _knownMoveType: EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerGender,
